...
\begin{enumerate}
    \item \ccc{Traits} is a model of the concepts \ccc{PartitionTraits_2}
          %\ccIndexMainItem[c]{PartitionTraits_2}
          and \ccc{YMonotonePartitionTraits_2}.
...
\ccIncludeExampleCode{Partition_2/greene_approx_convex_partition_2.cpp}
