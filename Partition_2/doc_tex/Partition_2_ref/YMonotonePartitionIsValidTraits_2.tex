...
All types required by the concept \ccc{PartitionIsValidTraits_2} are required
except the function object type \ccc{Is_valid}. The following type is
required instead:

\ccNestedType{Is_y_monotone_2}{Model of the concept \ccc{PolygonIsValid} that tests if
