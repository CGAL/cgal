...
\begin{enumerate}
    \item \ccc{Traits} is a model of the concept \ccc{OptimalConvexPartitionTraits_2}%
          ...
          also be a model of \ccc{ConvexPartitionIsValidTraits_2}.
...
\ccIncludeExampleCode{Partition_2/optimal_convex_partition_2.cpp}
