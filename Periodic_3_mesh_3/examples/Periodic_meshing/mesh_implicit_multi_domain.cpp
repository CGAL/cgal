...
typedef CGAL::Mesh_3::Labeled_mesh_domain_3<Wrapper, K>                 Periodic_mesh_domain;
...
//  Periodic_mesh_domain domain(Wrapper(funcs, "--"), CGAL::Bbox_3(0, 0, 0, domain_size, domain_size, domain_size));
  Periodic_mesh_domain domain(Wrapper(sphere_function_1), CGAL::Bbox_3(0, 0, 0, domain_size, domain_size, domain_size));
  ...
  std::cout << "EXITI SUCCESS" << std::endl;
  return 0;
}
