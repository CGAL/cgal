...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Mesh_3/include/CGAL/Mesh_domain_with_corners_3.h $
// $Id: Mesh_domain_with_corners_3.h 60882 2011-01-19 13:53:28Z lrineau $
//
//
// Author(s)     : 
//
...
#ifndef CGAL_MESH_DOMAIN_WITH_CORNERS_3_H
#define CGAL_MESH_DOMAIN_WITH_CORNERS_3_H
...
/**
 * @class Mesh_domain_with_corners_3
 *
 *
 */
...
public:
  ...
  Mesh_domain_with_corners_3()
    : Base() {}
  
#ifndef CGAL_CFG_NO_CPP0X_VARIADIC_TEMPLATES
  template <typename ... T>
  Mesh_domain_with_corners_3(const T& ...t)
    : Base(t...) {}
#else
  template <typename T1>
  Mesh_domain_with_corners_3(const T1& o1)
    : Base(o1) {}

  template <typename T1, typename T2>
  Mesh_domain_with_corners_3(const T1& o1, const T2& o2)
    : Base(o1, o2) {}
...
private:
  ...
  typedef Mesh_domain_with_corners_3 Self;
  Mesh_domain_with_corners_3(const Self& src);
  Self& operator=(const Self& src);

};  // end class Mesh_domain_with_corners_3
...
template <typename OutputIterator>
OutputIterator
Mesh_domain_with_corners_3<MD_>::
...
template <class MD_>
typename Mesh_domain_with_corners_3<MD_>::Index
Mesh_domain_with_corners_3<MD_>::
...
template <class MD_>
typename Mesh_domain_with_corners_3<MD_>::FT
Mesh_domain_with_corners_3<MD_>::
...
template <class MD_>
typename Mesh_domain_with_corners_3<MD_>::Point_3
Mesh_domain_with_corners_3<MD_>::
construct_point_on_curve_segment(const Point_3& starting_point,
                                 const Curve_segment_index& curve_index,
                                 FT distance) const
...
#endif // CGAL_MESH_DOMAIN_WITH_CORNERS_3_H
