...
\ccBenchmarkInstance{Surface/Quadrics/random/Quadrics/*.bff}
\item Random ellipsoids
\ccBenchmarkInstance{Surface/Quadrics/random/Ellipsoids/*.bff}
\item Random non-ellipsoids
\ccBenchmarkInstance{Surface/Quadrics/random/Non-Ellipsoids/*.bff}
\end{itemize}
