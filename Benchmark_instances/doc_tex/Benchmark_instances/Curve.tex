...
\item \ccBenchmarkInstance{Curve/Conics/random/number20/}
\item \ccBenchmarkInstance{Curve/Conics/random/number30/}
\item \ccBenchmarkInstance{Curve/Conics/random/number40/}
\item \ccBenchmarkInstance{Curve/Conics/random/number50/}
\item \ccBenchmarkInstance{Curve/Conics/random/number75/}
\item \ccBenchmarkInstance{Curve/Conics/random/number100/}
\item \ccBenchmarkInstance{Curve/Conics/random/number125/}
\item \ccBenchmarkInstance{Curve/Conics/random/number150/}
\item \ccBenchmarkInstance{Curve/Conics/random/number175/}
...
\ccBenchmarkInstance{Curve/Cubics/random/rand*.bff}

This set contains instances whose cubics have increasing bitlenght of the
coefficients.
\ccBenchmarkInstance{Curve/Cubics/bitgrowth/rand*.bff}
...
\ccBenchmarkInstance{Curve/ArbitraryDegreeCurves/examples/}
