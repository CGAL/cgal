...
/// Triangulates faces of the polygon mesh `p`. Depends on \ref PkgTriangulation2Summary
/// @tparam PolygonMesh a model of `FaceListGraph` and `MutableFaceGraph`
/// \todo `PolygonMesh` should be a model of `FaceListGraph` and `MutableFaceGraph`
template <typename PolygonMesh>
void triangulate_faces(PolygonMesh& pmesh)
{
  internal::Triangulate_modifier<PolygonMesh> modifier;
