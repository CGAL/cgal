...
#ifndef CGAL_POLYGON_MESH_PROCESSING_MINANGLE_REMESH_IMPL_H
#define CGAL_POLYGON_MESH_PROCESSING_MINANGLE_REMESH_IMPL_H
...
#endif  // CGAL_POLYGON_MESH_PROCESSING_MINANGLE_REMESH_IMPL_H
