 ...
 * @param np an optional sequence of \ref namedparameterspmp among the ones listed below
 *
 ...
 *                         and `Parallel_tag`.
 * @tparam TriangleMesh a model of the concept `FaceListGraph`
 * @tparam NamedParameters1 a sequence of \ref namedparameterspmp for `tm1`
 * @tparam NamedParameters2 a sequence of \ref namedparameterspmp for `tm2`
 *
 * @param tm1 the triangle mesh that will be sampled
 * @param tm2 the triangle mesh to compute the distance to
 * @param np1 optional sequence of \ref namedparameterspmp for `tm1` passed to `sample_triangle_mesh()`.
 *
 * @param np2 optional sequence of \ref namedparameterspmp for `tm2` among the ones listed below
 *
 * \cgalNamedParamsBegin
