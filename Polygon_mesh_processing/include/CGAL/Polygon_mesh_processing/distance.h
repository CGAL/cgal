  ...
  typename Kernel::Point_3 hint)
{
  ...
  {
    double hdist = 0;
    CGAL_FOREACH(const typename Kernel::Point_3& pt, sample_points)
    {
                 ...
                 bool add_vertices)
{
  ...
  CGAL_FOREACH(face_descriptor fd, triangles)
  {
                                             ...
                                             const NamedParameters& np)
{
  ...
  CGAL_FOREACH(typename GT::face_descriptor f, faces(tm))
  {
    typename Geom_traits::Point_3 points[3];
