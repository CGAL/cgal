...
public:
  ...
  */
                             ...
                             OutputIterator out) const
  {
    ...
    CGAL_FOREACH(Vertex_pair& vdp, vertices)
    {
    ...
    //   the edge
    CGAL_FOREACH(const edge_descriptor ed, all_coplanar_edges)
    {
    ...
    CGAL_FOREACH(edge_descriptor ed, iedges)
    {
    ...
    CGAL_FOREACH(Halfedge_and_vertices hnv,al_edge_map)
    {
