...
void test()
{
  ...
  //test with SI
  {
    ...
    PMP::split_connected_components(tm1, meshes, params::use_default_values());
...
void test_split()
{
  ...
  CGAL::Polygon_mesh_processing::connected_components(
        tm1, pidmap, CGAL::parameters::use_default_values());
...
void test_isocuboid()
{
  ...
  PMP::split(tm, splitter,
             params::throw_on_self_intersection(true)
             .allow_self_intersections(true));
  PMP::split_connected_components(tm, meshes, params::use_default_values());
