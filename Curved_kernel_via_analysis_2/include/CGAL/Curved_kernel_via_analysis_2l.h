...
protected:
    ...
    friend class Surface_point_2l< Curved_kernel_via_analysis_2l >;
};
...
class Surface_point_2l : 
    public CGALi::Point_2< 
        ...
        CGALi::Surface_point_2l_rep< CurvedKernelViaAnalysis_2l > >
{
public:
    ...
    //! the instance itself
    typedef Surface_point_2l< Curved_kernel_via_analysis_2l > Self;
    
    //! the type of the representation
    typedef CGALi::Surface_point_2l_rep< Curved_kernel_via_analysis_2l > Rep;
...
class Curved_kernel_via_analysis_2l : 
        public Curved_kernel_via_analysis_2< 
            CurveKernel_2, CGALi::Surface_point_2l, CGALi::Surface_arc_2l 
> {
