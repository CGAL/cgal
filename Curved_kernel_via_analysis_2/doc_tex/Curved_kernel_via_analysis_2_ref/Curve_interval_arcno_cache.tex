...
\begin{ccRefFunctionObjectClass}{Curve_interval_arcno_cache}  %% add template arg's if necessary
...
\ccGlue
\ccNestedType{thirg_argument_type}
{
}
\ccGlue
...
\ccConstructor{Curve_interval_arcno_cache();}{default constructor.}
