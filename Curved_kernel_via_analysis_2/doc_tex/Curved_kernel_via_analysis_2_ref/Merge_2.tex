% +------------------------------------------------------------------------+
% | Reference manual page: Merge_2.tex
% +------------------------------------------------------------------------+
% | 26.03.2008   Author
% | Package: Curved_kernel_via_analysis_2
% |
\RCSdef{\RCSMergeRev}{$Id: header.tex 40270 2007-09-07 15:29:10Z lsaboret $}
\RCSdefDate{\RCSMergeDate}{$Date: 2007-09-07 17:29:10 +0200 (Fri, 07 Sep 2007) $}
% |
\ccRefPageBegin
...
\begin{ccRefFunctionObjectClass}[CGALi::Curved_kernel_via_analysis_2_Functors::]{Merge_2}  %% add template arg's if necessary
...
\ccMethod{void operator()(const Arc_2& cv1, const Arc_2& cv2, Arc_2& c) const;}
{
...
\item[Parameters:]
\begin{description}
\item[cv1]The first arc \item[cv2]The second arc \item[c]Output: The resulting arc\end{description}
\end{description}
\begin{description}
...
\ccConstructor{Merge_2();}{default constructor.}

%% \ccIncludeExampleCode{Curved_kernel_via_analysis_2/Merge_2.C}
...
\ccConstructor{Merge_2(Curved_kernel_via_analysis_2 * kernel);}
{
