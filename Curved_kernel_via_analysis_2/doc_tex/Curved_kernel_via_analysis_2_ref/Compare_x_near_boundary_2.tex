...
\ccInclude{Compare_x_near_boundary_2.h}
...
\ccMethod{result_type operator()(const Point_2& p, const Arc_2& cv, CGAL::Arr_curve_end ce) const;}
{
...
\ccGlue
\ccMethod{result_type operator()(const Arc_2& cv1, CGAL::Arr_curve_end ce1, const Arc_2& cv2, CGAL::Arr_curve_end ce2) const;}
{
...
\ccConstructor{Compare_x_near_boundary_2();}{default constructor.}
