% +------------------------------------------------------------------------+
% | Reference manual page: Construct_max_vertex_2.tex
% +------------------------------------------------------------------------+
% | 26.03.2008   Author
...
\begin{ccRefFunctionObjectClass}[CGALi::Curved_kernel_via_analysis_2_Functors::]{Construct_max_vertex_2}  %% add template arg's if necessary
...
\ccInclude{Construct_max_vertex_2.h}
...
class \ccc{Construct_max_vertex_2};
...
\end{description}
\begin{description}
\item[Returns:]The maximum end-point.\end{description}
\begin{description}
\item[Precondition:]maximum end-point is interior \end{description}
\ccGlue
...
\ccConstructor{Construct_max_vertex_2();}{default constructor.}
...
\ccConstructor{Construct_max_vertex_2(Curved_kernel_via_analysis_2 * kernel);}
{
