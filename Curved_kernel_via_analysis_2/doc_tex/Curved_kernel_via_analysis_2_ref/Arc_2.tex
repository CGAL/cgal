...
\end{description}
\begin{description}
\item[Returns:]\ccc{CGAL::SMALLER} if p lies to the left of the arc; \ccc{CGAL::LARGER} if p lies to the right of the arc; \ccc{CGAL::EQUAL} in case of an overlap.\end{description}
\begin{description}
