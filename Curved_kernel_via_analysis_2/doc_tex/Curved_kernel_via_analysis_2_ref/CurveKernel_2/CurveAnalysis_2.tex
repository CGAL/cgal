...
an instance of \ccc{Xy_coordinate_2}.

\ccTypes

\ccNestedType{size_type}{A instance of a size type, e.g., \ccc{int}}

\ccNestedType{X_coordinate_1}{A model of the concept
  \ccc{CurveKernel_2::XCoordinate_1}.}

\ccNestedType{Xy_coordinate_2}{A model of the concept
...
\ccMethod{Xy_coordinate_2 Xy_coordinate_2(size_type j);}{
  returns an object of type \ccc{Xy_coordinate_2} for the $j$-th event
...
such interval only differ in the values of the \ccc{Xy_coordinate_2} entries. 
...
\ccNestedType{Xy_coordinate_2}{A model of the concept
  \ccc{CurveKernel_2::Xy_coordinate_2}.}
...
\ccMethod{Status_line_1 status_line_for_x(X_coordinate_1 x, 
...
\ccMethod{Status_line_1 status_line_at_exact_x(X_coordinate_1 x);}{
...
\ccMethod{CGAL::Object asymptotic_value_of_arc(CGAL::Arr_parameter_space loc, 
  ...
  \ccc{X_coordinate_1}, in case the x-asympote of the arc is finite,
