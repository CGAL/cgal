...
An event can be queried for its coordinates (\ccc{Xy_coordinate_2})
...
\ccNestedType{X_coordinate_1}{Model of the concept
\ccc{CurveKernel_2::XCoordinate_1}.}

\ccNestedType{Xy_coordinate_2}{Model of the concept
...
differ only in the values of the \ccc{Xy_coordinate_2} entries. Topological 
...
\ccMethod{Status_line status_line_for_x(X_coordinate_1 x,
...
\ccMethod{Status_line status_line_at_exact_x(X_coordinate_1 x);}{
...
%\begin{ccAdvanced}
%
%\ccMethod{Xy_coordinate_2_const_iterator solve_begin();}{
%  returns iterator running over all finite intersection of the two curves.
%}
%
%\ccMethod{Xy_coordinate_2_const_iterator solve_end();}{
%  returns past-end-value for all finite intersections of the two curves.
%}

%\ccMethod{size_type find(Xy_coordinate_2 s);}{
