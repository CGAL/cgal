...
\ccInclude{Non_x_monotone_arc_2.h}
...
\ccGlue
\ccMethod{bool is_sweepable() const;}
{
arc is sweepable by construction
\subsubsection{Friends And Related Function Documentation}
\ccMethod{std::ostream& operator<<(std::ostream& os, const Non_x_monotone_arc_2< CurvedKernelViaAnalysis_2, Rep_>& arc);}
{
[related] \\
output operator
}
\ccGlue
\ccMethod{Qt_widget& operator<<(Qt_widget& ws, const Non_x_monotone_arc_2< CurvedKernelViaAnalysis_2, Rep_>& arc);}
{
[related] \\
