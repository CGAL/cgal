...
void Assert_circulator( const C &) {
    ...
    CGAL_static_assertion((std::is_convertible<category, Circulator_tag>::value));
}
...
void Assert_iterator( const I &) {
    ...
    CGAL_USE_TYPE(category);
    CGAL_static_assertion((std::is_convertible<category, Iterator_tag>::value));
}
template <class I> inline
void Assert_input_category( const I &/*i*/) {
    typedef typename std::iterator_traits<I>::iterator_category category;
    CGAL_USE_TYPE(category);
    CGAL_static_assertion((std::is_convertible<category, std::input_iterator_tag>::value));
}
...
void Assert_output_category( const I &/*i*/) {
  typedef typename std::iterator_traits<I>::iterator_category category;
  CGAL_USE_TYPE(category);
  CGAL_static_assertion((std::is_convertible<category, std::output_iterator_tag>::value));
}
template <class IC> inline
void Assert_forward_category( const IC &/*ic*/) {
  typedef typename std::iterator_traits<IC>::iterator_category category;
  CGAL_USE_TYPE(category);
  CGAL_static_assertion((std::is_convertible<category, std::forward_iterator_tag>::value));
}
template <class IC> inline
void Assert_bidirectional_category( const IC &/*ic*/) {
  typedef typename std::iterator_traits<IC>::iterator_category category;
  CGAL_USE_TYPE(category);
  CGAL_static_assertion((std::is_convertible<category, std::bidirectional_iterator_tag>::value));
}
template <class IC> inline
void Assert_random_access_category( const IC &/*ic*/) {
  typedef typename std::iterator_traits<IC>::iterator_category category;
  CGAL_USE_TYPE(category);
  CGAL_static_assertion((std::is_convertible<category, std::random_access_iterator_tag>::value));
}
