...
namespace CGAL {
  ...
  */
  ...
  /// @}
    ...
    typedef Advancing_front_surface_reconstruction<Dt,F,P> Extract;
    ...
    */
    Advancing_front_surface_reconstruction(Triangulation_3& dt,
      ...
      _postprocessing_counter(0), _size_before_postprocessing(0), _number_of_connected_components(0),
        deal_with_2d(false), filter(filter), priority(priority), max_connected_component(-1), K_init(1.1), K_step(.1)
