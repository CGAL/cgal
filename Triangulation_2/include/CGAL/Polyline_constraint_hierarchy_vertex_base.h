...
#ifndef CGAL_POLYLINE_CONSTRAINT_HIERARCHY_VERTEX_BASE_H
#define CGAL_POLYLINE_CONSTRAINT_HIERARCHY_VERTEX_BASE_H
...
#endif /* CGAL_POLYLINE_CONSTRAINT_HIERARCHY_VERTEX_BASE_H */
