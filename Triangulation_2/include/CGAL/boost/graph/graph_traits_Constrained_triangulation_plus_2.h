...
namespace boost { 
  ...
  struct graph_traits< CGAL::Constrained_triangulation_plus_2<Tr> > {
    ...
    typedef CGAL::Constrained_triangulation_plus_2<Tr> Constrained_triangulation;

    typedef typename CGAL::Constrained_triangulation_plus_2<Tr>::Vertex_handle vertex_descriptor;
    typedef typename CGAL::Constrained_triangulation_plus_2<Tr>::Face_handle face_descriptor;
    typedef CGAL::detail::Edge<CGAL::Constrained_triangulation_plus_2<Tr>, typename CGAL::Constrained_triangulation_plus_2<Tr>::Edge>  edge_descriptor;
    typedef typename CGAL::Constrained_triangulation_plus_2<Tr>::All_edges_iterator  edge_iterator;

    typedef CGAL::detail::T2_halfedge_descriptor<typename Constrained_triangulation::Triangulation::Triangulation> halfedge_descriptor;
