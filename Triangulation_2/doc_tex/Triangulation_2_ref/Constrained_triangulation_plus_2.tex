...
%included using the 
%\verb|\ccIncludeExampleCode{examples/Package/Constrained_triangulation_plus_2_prog.cpp}| 
...
%% \ccIncludeExampleCode{examples/Package/Constrained_triangulation_plus_2_prog.cpp}
