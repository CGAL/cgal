...
%included using the 
%\verb|\ccIncludeExampleCode{examples/Package/ConstrainedTriangulationPlusTraits_2_prog.cpp}| 
...
%% \ccIncludeExampleCode{examples/Package/ConstrainedTriangulationPlusTraits_2_prog.cpp}
