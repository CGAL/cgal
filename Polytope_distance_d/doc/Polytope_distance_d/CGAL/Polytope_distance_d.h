...
\require The value type of `InputIterator1` and `InputIterator2` is `Point`. 
...
\require The output operator is defined for `Point_d`. 
...
\require The input operator is defined for `Point_d`. 
\relates Polytope_distance_d 
*/ 
std::istream& 
