...
public:
 ...
 typename K::Construct_point_3 wp2p = K().construct_point_3_object();
 typename K::Construct_weighted_point_3 p2wp = K().construct_weighted_point_3_object();
  ...
  {
    CGAL_precondition(! K().collinear_3_object()(wp2p(p),
                                                 wp2p(q),
                                                 wp2p(r)) );
