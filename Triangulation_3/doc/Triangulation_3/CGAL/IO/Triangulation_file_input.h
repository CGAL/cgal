...
int tr are created using the default constructor, and then filled with the data
...
used to create the vertex from `v_src`.
 ...
 - A model of ConvertCell must provide an operator()'s that are responsible for 
