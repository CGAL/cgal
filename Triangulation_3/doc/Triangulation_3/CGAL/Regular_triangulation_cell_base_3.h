...
/// \name Circumcenters and weighted circumcenters 
/// @{
As a model of the concept `RegularTriangulationCellBase_3` which
refines `TriangulationCellBase_3`, this class provides a
`circumcenter()` member fonction. In this model, we have choosen to
...
*/ 
Traits::Point_3& circumcenter(const Traits& gt = Traits()) const;
