...
\ccMethod{template <class TDS_src, class ConvertVertex, class ConvertCell>
...
{\ccc{tds_src} is copied into \ccc{tds}. As the vertex and cell types might be different
and incompatible, the creation of new cells and vertices is made thanks to the
functors \ccc{convert_vertex} and \ccc{convert_cell}, that convert vertex and cell types.
...
done for cells with the functor \ccc{convert_cell}. If \ccc{v != TDS_src::Vertex_handle()},
