...
\ccTypedef{typedef CGAL::Compact_container<Vertex> Vertex_container;}{Vertex container type.}
\ccGlue
\ccTypedef{typedef CGAL::Compact_container<Cell>   Cell_container;}{Cell container type.}

\ccOperations

\ccMethod{Cell_container & cell_container() const;}
{Returns a reference to the container of cells.}
\ccGlue
\ccMethod{Cell_container & cell_container();}
{Returns a reference to the container of cells.}
\ccGlue
\ccMethod{Vertex_container & vertex_container() const;}
{Returns a reference to the container of vertices.}
\ccGlue
\ccMethod{Vertex_container & vertex_container();}
{Returns a reference to the container of vertices.}
