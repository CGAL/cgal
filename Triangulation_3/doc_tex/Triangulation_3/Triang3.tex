...
\end{ccHtmlOnly}
%<img border=0 src="./sphere.gif" align=middle width=30%>
%<img border=0 src="./grid.gif" align=middle width=30%>
...
\ccIncludeExampleCode{Triangulation_3/example_simple.cpp}
...
\ccIncludeExampleCode{Triangulation_3/example_color.cpp}
...
\ccIncludeExampleCode{Triangulation_3/example_find_conflicts.cpp}
...
\ccIncludeExampleCode{Triangulation_3/example_regular.cpp}
