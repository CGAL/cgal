...
their own vertices and cells. 

In 2005, Christophe Delage implemented the vertex removal function for
regular triangulations, which allowed to release this functionality in CGAL 3.2. 

The authors also wish to thank Jean-Daniel Boissonnat, Olivier Devillers
