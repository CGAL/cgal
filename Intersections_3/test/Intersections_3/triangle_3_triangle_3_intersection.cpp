...
//Intersection is a triangle
  ...
  CGAL_assertion(CGAL::object_cast<Triangle>(&obj)!=NULL);
...
//Intersection is a point  
  ...
  obj=CGAL::intersection(t1,t2);
  CGAL_assertion(CGAL::object_cast<Point>(&obj)!=NULL);
  obj=CGAL::intersection(t2,t1);
  CGAL_assertion(CGAL::object_cast<Point>(&obj)!=NULL);
...
//Intersection is a segment
  ...
  t2=Triangle( Point(0,0,0),Point(0,1,0),Point(-1,0,0) );
  obj=CGAL::intersection(t1,t2);
  CGAL_assertion(CGAL::object_cast<Segment>(&obj)!=NULL);
  obj=CGAL::intersection(t2,t1);
  CGAL_assertion(CGAL::object_cast<Segment>(&obj)!=NULL);
