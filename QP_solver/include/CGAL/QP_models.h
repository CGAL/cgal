...
private:
  ...
  boost::counting_iterator<typename CGAL::Map_with_default<Sparse_r_vector>::size_type> >
...
public:
  ...
  { 
    CGAL_qpe_assertion(is_valid());
    return R_iterator (boost::counting_iterator<typename CGAL::Map_with_default<Sparse_r_vector>::size_type>(0),
