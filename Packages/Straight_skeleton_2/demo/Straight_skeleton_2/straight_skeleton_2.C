...
public:
  MyWindow(int w, int h){
    ...
    vtoolbar = new Layers_toolbar(widget, this, &ssds);
...
private slots:
  void gen_poly(){
    ...
    // TODO: create polygon and compute the new straight line skeleton.
    something_changed();
  }
  ...
  Builder().insert_CCB(outer,outer+4)           // poly.vertices_begin(), poly.vertices_end()
  	     .proceed() ;
  ...
  void load_polygon()
  {
    ...
    Polygon polygon;
    in >> polygon;
    // TODO: create hds and compute the new straight line skeleton.
    something_changed();
  }
