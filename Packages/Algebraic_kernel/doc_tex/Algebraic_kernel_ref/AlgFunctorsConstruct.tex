...
\ccMethod{template < class OutputIterator >
    OutputIterator
    operator()(const AlgebraicKernel_2_2::PolynomialCircle_2_2 &p1,
	const AlgebraicKernel_2_2::PolynomialCircle_2_2 &p2,
	OutputIterator res);}
{Copies in the output iterator the common roots of \ccc{p1} and \ccc{p2}, with their multiplicity, as objects of type \ccc{std::pair< AlgebraicKernel_2_2::RootCircle_2_2, int>}.} 
...
\ccc{p}, as objects of type \ccc{AlgebraicKernel_2_2::RootCircle_2_2}.} 
