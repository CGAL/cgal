...
The class \ccClassTemplateName\ is a dynamic datastructure that 
...
{removes interval \ccc{i} from the interval skip list. Returns \ccc{true} iff removal was succesful.}
