...
% | Package: HalfedgeDS
% | 
\RCSdef{\RCSHalfedgeDShalfedgebaseRev}{$Revision$}
...
macro \ccc{CGAL_CFG_NO_PARTIAL_CLASS_TEMPLATE_SPECIALISATION} or the
macro \ccc{CGAL_CFG_SUNPRO_PARTIAL_SPEC_BUG} are set, then the
implementation here cannot save the space of the optional references
allthough they have not been selected. See
\ccc{CGAL::HalfedgeDS_halfedge_min_base} for a smaller base class in this
case.
