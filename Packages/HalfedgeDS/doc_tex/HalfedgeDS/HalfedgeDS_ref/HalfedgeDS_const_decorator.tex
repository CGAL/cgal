...
\ccc{CGAL::HalfedgeDS_items_decorator<HDS>} provide additional functions
...
\ccc{CGAL::HalfedgeDS_decorator<HDS>} knows a reference to the halfedge
data structure and provides functions that modifies the halfedge data
structure, for example Euler-operators. The class
\ccc{CGAL::HalfedgeDS_const_decorator<HDS>} knows a const reference to
