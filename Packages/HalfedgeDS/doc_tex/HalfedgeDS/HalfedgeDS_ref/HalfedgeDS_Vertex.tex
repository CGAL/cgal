% +------------------------------------------------------------------------+
% | Reference manual page: HalfedgeDS_Vertex.tex
% +------------------------------------------------------------------------+
...
\begin{ccRefConcept}{HalfedgeDS_Vertex}
...
items class, see the \ccc{HalfedgeDS_Items} concept.
...
functions are supported. Figure~\ccTexHtml{\ref{figurePolyOptionalMethods} 
...
\ccGlue
\ccNestedType{Halfedge}{model of \ccc{HalfedgeDS_Halfedge}.}
\ccGlue
\ccNestedType{Face}{model of \ccc{HalfedgeDS_Face}.}
\ccGlue
...
\ccGlue
\ccNestedType{Supports_vertex_halfedge}{either \ccc{CGAL::Tag_true} or 
  \ccc{CGAL::Tag_false}.}
