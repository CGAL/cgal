...
\ccGlue
\ccNestedType{Items}{items, model of \ccc{HalfedgeDSItems} concept.}
...
\ccNestedType{Vertex}{vertex, model of \ccc{HalfedgeDSVertex} concept.}
\ccGlue
\ccNestedType{Halfedge}{halfedge, model of
                        \ccc{HalfedgeDSHalfedge} concept.}
\ccGlue
\ccNestedType{Face}{face, model of \ccc{HalfedgeDSFace} concept.}
...
\mbox{}~~~~~~\ccc{typedef Items::template Vertex_wrapper<Self,Traits>
                 Vertex_wrapper;} \\
...
\ccRefIdfierPage{CGAL::HalfedgeDS_default<Traits>}\\
\ccRefIdfierPage{CGAL::HalfedgeDS_list<Traits,Items>}\\
\ccRefIdfierPage{CGAL::HalfedgeDS_vector<Traits,Items>}
