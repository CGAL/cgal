...
\begin{ccTexOnly}
    ...
    \begin{center}
      \parbox{0.4\textwidth}{%
          \includegraphics[width=0.4\textwidth]{HalfedgeDS/fig/halfedge.ips}%
      }
    \end{center}
    \vspace{-3mm}
\end{ccTexOnly}
...
\begin{ccTexOnly}
  \begin{figure}
    \begin{center}
      \parbox{0.7\textwidth}{%
          \includegraphics[width=0.7\textwidth]{HalfedgeDS/fig/hds_design.ips}%
      }
    \end{center}
...
\begin{ccTexOnly}
    ...
    \begin{center}
      \parbox{0.3\textwidth}{%
          \includegraphics[width=0.3\textwidth]{HalfedgeDS/fig/loop.ips}%
      }
    \end{center}
    \vspace{-3mm}
\end{ccTexOnly}
