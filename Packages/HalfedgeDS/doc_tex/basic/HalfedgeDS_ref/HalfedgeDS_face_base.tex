...
implementation here cannot save the space of the halfedge reference
allthough it has not been selected. See
\ccc{CGAL::HalfedgeDS_face_min_base} for a smaller base class in this
case.
