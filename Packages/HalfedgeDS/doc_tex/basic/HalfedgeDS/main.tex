...
since they broaden that interface but do not hide it.  This helper
class contains operations that are useful to implement the operations
in the next layer, for example, the polyhedron. It adds, for example,
...
edges at a vertex.  Furthermore, the helper class contains adaptive
...
the helper class searches in the positive direction along the face for
...
the differengce between a halfedge and its opposite halfedge is always
