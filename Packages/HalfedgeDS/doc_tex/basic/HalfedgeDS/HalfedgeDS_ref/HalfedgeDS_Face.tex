% +------------------------------------------------------------------------+
% | Reference manual page: HalfedgeDS_Face.tex
% +------------------------------------------------------------------------+
...
\ccGlue
\ccNestedType{Vertex}{model of \ccc{HalfedgeDS_Vertex}.}
\ccGlue
...
\ccGlue
\ccNestedType{Supports_face_halfedge}{either \ccc{CGAL::Tag_true} or 
  \ccc{CGAL::Tag_false}.}
