...
exhibits most of the characteristics of the container class used
...
controlled by us for \ccc{CGAL::In_place_list}. It is true for
\ccc{std::list} and \ccc{std::vector} of major \stl\ distributions,
