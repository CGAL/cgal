% +------------------------------------------------------------------------+
% | Reference manual page: HalfedgeDS_using_list.tex
% +------------------------------------------------------------------------+
% | 22.03.1999   Lutz Kettner
% | Package: HalfedgeDS
% | 
\RCSdef{\RCSHalfedgeDSusinglistRev}{$Revision$}
\RCSdefDate{\RCSHalfedgeDSusinglistDate}{$Date$}
% +------------------------------------------------------------------------+
...
\begin{ccRefClass}{HalfedgeDS_using_list<Traits,Items>}
...
\ccInclude{CGAL/HalfedgeDS_using_list.h}
...
\ccRefName\ uses internally the \stl\ \ccc{std::list} container class.
