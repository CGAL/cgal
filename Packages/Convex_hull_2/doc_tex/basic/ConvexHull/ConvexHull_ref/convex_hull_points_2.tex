% +------------------------------------------------------------------------+
% | Reference manual page: convex_hull_points_2.tex
% +------------------------------------------------------------------------+
...
\begin{ccRefFunction}{convex_hull_points_2}  %% add template arg's if necessary
...
\ccFunction{template <class InputIterator, class OutputIterator>
            ...
            \ccPrecond %\ccIndexSubitem[C]{convex_hull_points_2}{preconditions}
            The source range [\ccc{first},\ccc{beyond}) does not contain
            \ccc{result}.}

The default traits class \ccc{Default_traits} is the \cgal\ 
\ccc{Kernel_traits_2} class,%\ccIndexTraitsClassDefault{convex_hull_points_2}
