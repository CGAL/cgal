...
\ccc{Kernel_traits_2} class,%\ccIndexTraitsClassDefault{ch_graham_andrew_scan}
with the representation type determined by \ccc{BidirectionalIterator::value_type}.
