...
#ifndef EXACT_TRIANGULATION_EUCLIDEAN_TRAITS_YZ_3_H
#define EXACT_TRIANGULATION_EUCLIDEAN_TRAITS_YZ_3_H
...
class Cartesian_tag;
template<class R, class Tag> class Exact_intersect_yz_2;
...
CGAL_END_NAMESPACE
#endif // EXACT_TRIANGULATION_EUCLIDEAN_TRAITS_YZ_3_H
