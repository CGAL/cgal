...
//
// file          : include/CGAL/Nef_3/Visualizor.h
// package       : Nef_3
...
//
// SNC_visualizor_OGL.h    visualization of SNCs and Sphere Maps in a OpenGLUT 
//                         viewer
// ============================================================================
...
template<typename SNC_explorer>
class Visualizor { 
  typedef typename SNC_explorer::SNC_structure             SNC_structure;
