...
//
// file          : include/CGAL/Nef_3/SNC_SM_base_decorator.h
// package       : Nef_3
...
//
// SNC_SM_base_decorator.h        exploration of sphere maps
// ============================================================================
#ifndef CGAL_SNC_SM_BASE_DECORATOR_H
#define CGAL_SNC_SM_BASE_DECORATOR_H
...
/*{\Manpage {SNC_SM_base_decorator}{Refs}
  {Topological sphere map decorator}{D}}*/

template <typename Refs_>
class SNC_SM_base_decorator 
{ typedef SNC_SM_base_decorator<Refs_> Self;
public:
...
/*{\Mcreation 3}*/
SNC_SM_base_decorator() : psm_(0) {}
SNC_SM_base_decorator(const Self& D) : psm_(D.psm_) {}
Self& operator=(const Self& D) { psm_=D.psm_; return *this; }

SNC_SM_base_decorator(Vertex_handle v) : psm_(v) {}
...
}; // SNC_SM_base_decorator


template <typename SM_>
void SNC_SM_base_decorator<SM_>::
...
template <typename SM_>
typename SNC_SM_base_decorator<SM_>::Size_type
SNC_SM_base_decorator<SM_>::
...
CGAL_END_NAMESPACE
#endif // CGAL_SNC_SM_BASE_DECORATOR_H
