...
A 3D Nef polyhedrono is a subset of the
3-dimensional space that is the result of forming complements and intersections
starting from a finite set \ccc{H} of
3-dimensional halfspaces. Nef polyhedra are closed under all binary set
operations, i.e. intersection, union, difference,
