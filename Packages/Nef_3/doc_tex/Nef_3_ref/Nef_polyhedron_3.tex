...
% | Package: Nef_3
% | 
\RCSdef{\RCSNefThreeRev}{$Revision$}
...
\ccc{template <} \=\ccc{class Nef_polyhedronTraits_3,}\\
                 ...
                 \>\ccc{class Nef_polyhedronMarks_3 = bool >}\\
...
The third parameter expects a model of the concept \ccc{Nef_polyhedronMarks_3}.
...
\ccGlue
\ccNestedType{Mark}{mark class selected for \ccc{Nef_polyhedronMarks_3}.}
...
\ccThree{Halffacet_const_iterator}{N.halffacets_begin();}{}
...
This example program creates two Nef polyhedra - one representing
the empty point set, one representing the whole 3D space. The complement
of the latter one is computeted and compared with the first one.
