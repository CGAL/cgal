...
\ccMethod{void convert_to_Polyhedron(Polyhedron& P) const;}{converts \ccVar\ into a Polyhedron. \ccc{Precondition: \ccVar\ .is_simple()}.}
\ccMethod{Nef_polyhedron_S2 get_sphere_map(Vertex_const_iterator v) const;}{returns the neighborhood of a vertex modeled by a \ccc{Nef_polyhedron_S2}.}
...
\ccMethod{Segment_3 segment(Halfedge_const_handle e) const;}{returns \ccc{Segment_3(point(source(e)),point(target(e)))}.}
