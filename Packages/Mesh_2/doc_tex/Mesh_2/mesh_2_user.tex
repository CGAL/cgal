...
components \new{including no seed points, meaning that seeds defines \emph{holes} is the domain.} Conversely, the seed points can
be used to mark the connected components which are \newnomargin{inside} the domain.
