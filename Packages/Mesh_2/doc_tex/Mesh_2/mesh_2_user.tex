...
that have to be respected.  Such a domain is defined by a \emph{planar
  straight line graph}, {\sc Pslg} for short, and a set of seed points.

A {\sc Pslg} is a plane embedded one dimensional simplicial complex, that
...
set. \\
The segments of the {\sc Pslg} describe the boundaries and the internal
constraints of the domain.

\subsection{Meshing Domain}
\label{sec:Mesh_2_meshin_domain}

The {\sc Pslg}, represented here by the constrained edges, divides the plane into several connected components.  The domain
