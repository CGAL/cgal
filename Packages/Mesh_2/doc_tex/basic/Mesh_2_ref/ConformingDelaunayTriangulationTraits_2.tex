...
\ccConstructor{ConformingDelaunayTriangulationTraits_2();}
{default constructor.}
\ccGlue
\ccConstructor{ConformingDelaunayTriangulationTraits_2(
   const ConformingDelaunayTriangulationTraits_2& traits2);}
{Copy constructor.}
\ccGlue
\ccMethod{ConformingDelaunayTriangulationTraits_2 operator=(
  ConformingDelaunayTriangulationTraits_2 traits2);}
{Assignment operator.}
...
\todo{Est-ce que j'ai besoin de faire une
  Conforming\_Delaunay\_triangulation\_traits\_2?}
