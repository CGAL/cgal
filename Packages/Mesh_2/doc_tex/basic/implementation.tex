...
\ccc{Conform_triangulation_2<Tr>} et \ccc{Mesh_2<Tr>}, qui dérive de
la première. \ccc{Conform_triangulation_2<Tr>} permet de conformer une
...
\begin{itemize}
\item \ccc{Conform_triangulation_2<Tr>} contient la liste (en fait,
...
\item \ccc{Mesh_2<Tr>} contient en plus une liste des mauvaises faces,
  ...
  \ccc{Conform_triangulation_2<Tr>} avec une \emph{policy class} qui
...
\ccc{Conform_triangulation_2<Tr>} sont paramétrées par une
...
\section{Pourquoi \ccc{Conform_triangulation_2<Tr>} est-elle une
  classe?}

Conformément à ce que l'on avait dit, j'ai créé en dehors de la classe
\ccc{Conform_triangulation_2<Tr>} deux fonctions globales \ccc{void
...
classe \ccc{Conform_triangulation_2<Tr>} on ne peut plus rien faire
