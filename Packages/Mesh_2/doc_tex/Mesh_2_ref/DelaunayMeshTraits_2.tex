...
\ccNestedType{Quality}{Copy constructible and comparable type.}
...
\ccConstructor{DelaunayMeshTraits_2();}{default constructor.}
\ccGlue
\ccConstructor{DelaunayMeshTraits_2(const DelaunayMeshTraits_2& traits2);}
{Copy constructor.}
\ccGlue
\ccMethod{DelaunayMeshTraits_2 operator=(DelaunayMeshTraits_2 traits2);}
{Assignment operator.}
...
\ccHasModels
\ccc{Delaunay_mesh_traits_2}\\
\ccc{Delaunay_mesh_size_traits_2}
