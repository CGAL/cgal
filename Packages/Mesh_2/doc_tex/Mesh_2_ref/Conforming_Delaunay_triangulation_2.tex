...
The template parameter \ccc{CDT}, from which this class derives, has to be a
...
\ccc{CDT}'s availlable operations, until we call one of the conforming
...
constraints, use \ccc{CGAL::Constrained_triangulation_plus_2<CDT>} as
template parameter.
