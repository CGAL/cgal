...
from \ccc{Conforming_Delaunay_triangulation_2<CDT>}. The template parameter \ccc{CDT} has to be a \cgal\ 
...
usual model of the geometric traits class of triangulations \ccc{CDT}.
...
A \ccRefName{} object acts like a \ccc{CDT} CDT, in which one can
insert points and constrained segments and every \ccc{CDT}'s availlable
...
refined, that's why the base face of the triangulation \ccc{CDT} has to
...
the CDT. Then the \ccRefName{} object acts again as a normal \ccc{CDT}
