...
degenerate\ccIndexSubitem[t]{degeneracies}{\ccFont Min_ellipse_2},
...
\emph{support set}\ccIndexSubitem[t]{support set}{\ccFont Min_ellipse_2},
...
\ccIndexSubitem[t]{support set}{\ccFont Min_ellipse_2}
...
\ccMemberFunction{ bool  is_degenerate( ) const;}{
        ...
        than~3.}
\ccIndexSubitem[t]{degeneracies}{\ccFont Min_ellipse_2}
...
\ccIndexSubitem[t]{validity check}{\ccFont Min_ellipse_2}
...
If randomization\ccIndexSubitem[t]{randomization}{\ccFont Min_ellipse_2} is
