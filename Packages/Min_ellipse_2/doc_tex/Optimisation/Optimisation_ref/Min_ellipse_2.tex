...
\ccc{CGAL_Optimisation_traits_2}
  (Section~\ref{sec:opt_traits_impl_2D_kernel}),
\linebreakByHand
\ccc{CGAL_Min_ellipse_2_adapterC2}
  (Section~\ref{sec:min_ellipse_2_traits_adapterC2}), 
\ccc{CGAL_Min_ellipse_2_adapterH2}
  (Section~\ref{sec:min_ellipse_2_traits_adapterH2}).
...
To illustrate the creation of \ccClassTemplateName, we give an example.
