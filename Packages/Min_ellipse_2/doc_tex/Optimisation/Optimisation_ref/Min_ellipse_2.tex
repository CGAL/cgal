...
\ccHidden
\ccConstructor{ Min_ellipse_2( const Point*   first,
                               const Point*   last,
                               bool           randomize = false,
                               Random&        random    = default_random,
                               const Traits&  traits    = Traits());}{
...
\ccHidden
\ccConstructor{ Min_ellipse_2( list<Point>::const_iterator  first,
...
\ccHidden
\ccConstructor{ Min_ellipse_2( istream_iterator<Point,ptrdiff_t>  first,
