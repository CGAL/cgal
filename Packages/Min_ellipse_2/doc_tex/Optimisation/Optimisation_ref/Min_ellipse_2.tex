...
% Subsec.: 2D Smallest Enclosing Ellipse
% -----------------------------------------------------------------------------
% file:   doc_tex/basic/Optimisation/Min_ellipse_2.tex
...
\ccHtmlNoClassToc
\begin{ccClassTemplate}{Min_ellipse_2<Traits>}
\ccSubsection{2D Smallest Enclosing Ellipse}
\label{sec:min_ellipse_2_spec}

\cgalSetMinEllipseLayout
...
\ccTexHtml{Section~\ref{sec:min_ellipse_2_traits_req}}{Section&nbsp;<A HREF="requirements_Min_ellipse_2.html"><IMG SRC="../gif/cc_ref_up_arrow.gif" ALT="reference arrow" WIDTH="10" HEIGHT="10"></A>}.
...
\ccSetThreeColumns{typedef Traits::Ellipse}{Ellipse;}{}
...
\ccSetTwoColumns{Min_ellipse_2<Traits>:: Support_point_iterator}{}
...
\ccUnchecked
\ccHidden
\ccConstructor{ Min_ellipse_2( const Min_ellipse_2<Traits>&);}{
        copy constructor.}

\ccHidden
\ccConstructor{ ~Min_ellipse_2( );}{
        destructor.}

\ccUnchecked
\ccHidden
\ccMemberFunction{ Min_ellipse_2<Traits>&
                   operator = ( const Min_ellipse_2<Traits>&);}{
        assignment operator.}
...
\ccFunction{ ostream& operator << (
                 ostream& os, const Min_ellipse_2<Traits>& min_ellipse);}{
...
in~\cite{gs-epsee-97,gs-seefe-97a}. The whole implementation is
described in~\cite{gs-seeeg-98}. If randomization is chosen, the
