...
The class template \ccc{Min_ellipse_2} is parameterized with a
...
parameterize \ccc{Min_ellipse_2}.  A traits class implementation
...
\ccc{Min_ellipse_2} must provide the following primitives.
