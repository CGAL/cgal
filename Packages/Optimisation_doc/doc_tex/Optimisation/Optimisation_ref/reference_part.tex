...
Smallest enclosing circle and ellipse (2D), smallest enclosing rectangle, parallelogram, and strip (2D), rectangular $p$-center (2D), smallest enclosing sphere and annulus (dD).
...
All furthest neigbors (2D), polytope distance (dD).
...
\ccRefIdfierPage{Min_ellipse_2_traits}
...
\ccRefIdfierPage{Min_quadrilateral_traits_2}

\smallskip

\ccRefIdfierPage{CGAL::rectangular_p_center_2}\\[1ex]
\ccRefIdfierPage{CGAL::Rectangular_p_center_default_traits_2<R>}\\[1ex]
\ccRefIdfierPage{Rectangular_p_center_traits_2}

\bigskip

\ccRefIdfierPage{CGAL::Min_sphere_d<Traits>}\\[1ex]
\ccRefIdfierPage{CGAL::Min_sphere_d_traits_2<R>}\\
\ccRefIdfierPage{CGAL::Min_sphere_d_traits_3<R>}\\
\ccRefIdfierPage{CGAL::Min_sphere_d_traits_d<R>}\\[1ex]
\ccRefIdfierPage{Min_sphere_d_traits}
...
\ccRefIdfierPage{CGAL::Extremal_polygon_perimeter_traits_2<R>}\\[1ex]
