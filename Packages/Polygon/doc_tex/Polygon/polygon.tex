...
\ccStyle{Polygon_traits_2<R>} is provided (see section \ref{sec:poly_default}),
...
\ccHeading{Predicates}
  ...
  \ccMethod{Oriented_side oriented_side(const Point_2& q) const;}
    { Returns \ccStyle{POSITIVE_SIDE}, \ccStyle{NEGATIVE_SIDE},
...
\ccSetThreeColumns{Oriented_side}{10cm}{}
...
Returns \ccStyle{NEGATIVE_SIDE},
\ccStyle{POSITIVE_SIDE}, or \ccStyle{ON_ORIENTED_BOUNDARY},
depending on where point \ccStyle{q} is.
...
formed by the points in the range \ccStyle{[first,last)}.
Returns \ccStyle{ON_BOUNDED_SIDE}, \ccStyle{ON_BOUNDARY}
...
{
  Returns \ccc{Direction_2<R>(v1) == Direction_2<R>(v2)}.
}
