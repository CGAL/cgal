...
% | Package: Polygon
% | 
\RCSdef{\RCSorientedsideRev}{$Revision$}
...
\begin{ccRefFunction}{oriented_side_2}  %% add template arg's if necessary
...
\ccInclude{oriented_side_2.h}

\ccGlobalFunction{void oriented_side_2();}
