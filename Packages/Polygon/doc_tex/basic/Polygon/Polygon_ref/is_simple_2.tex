...
\begin{ccRefFunction}{is_simple_2}  %% add template arg's if necessary
...
\ccInclude{is_simple_2.h}

\ccGlobalFunction{void is_simple_2();}
...
included using the 
\verb|\ccIncludeExampleCode{examples/Polygon/is_simple_2_prog.C}| 
