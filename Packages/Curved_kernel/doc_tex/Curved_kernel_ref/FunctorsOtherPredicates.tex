...
To test whether two curves overlap.

\ccCreationVariable{ov}
...
\ccc{Circular_kernel::Do_overlap_2;}
...
\begin{ccRefFunctionObjectConcept}{CircularKernel::InRange_2}
...
\ccc{Circular_kernel::In_range_2;}

\ccSeeAlso

\ccRefIdfierPage{CGAL::in_range}

\end{ccRefFunctionObjectConcept}

\begin{ccRefFunctionObjectConcept}{CircularKernel::IsVertical_2}

\ccCreationVariable{vert}
...
\ccc{Circular_kernel::Is_vertical_2;}
...
\ccc{Circular_kernel::Is_y_monotone_2;}
