...
$+,\ -,\ *,\ /,\ %,\ +=,\ -=,\ *=,\ %=\ /=,\ -$(unary), \ccc{div}, 
\ccc{gcd}, the comparison operations $<,\ <=,\ >,\ >=,\ ==,\ !=$ and
the stream operations are all available.

Of course, also all the other operations required by the number type
concept, like \ccc{to_double}, \ccc{is_finite}, etc., are defined for
\ccClassName.
