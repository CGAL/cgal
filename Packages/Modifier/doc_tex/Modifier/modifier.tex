...
\begin{ccTexOnly}
    \begin{center}
      \parbox{\textwidth}{%
          \includegraphics[width=\textwidth]{Modifier/idraw/modifier.ips}%
      }
    \end{center}
\end{ccTexOnly}
...
\begin{ccHtmlOnly}
    <CENTER>
    <A HREF="Modifier/modifier.gif">
        <img src="Modifier/modifier_small.gif" alt="Modifier Class Diagram"></A><BR>
    </CENTER>
\end{ccHtmlOnly}
\end{figure}
