...
\ccc{Points_on_segment_2} have to additional methods.
...
\ccc{Join_input_iterator} to generate composed objects from other
...
\ccTexHtml{Figure~\ref{figureSegmentGeneratorFan}}{Figure <A
  ...
  ALT="reference arrow" WIDTH="10" HEIGHT="10"></A>} for the example
output. It uses the \ccc{Points_on_segment_2} iterator,
\ccc{Join_input_iterator_2} and \ccc{Counting_iterator} to
