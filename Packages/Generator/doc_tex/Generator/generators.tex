...
For this hte function \ccc{perturb_points_2} is provided.
...
Section~\ref{sec:random_selection}. The function
\ccc{random_collinear_points_2()} adds collinearities to
a point set.
