...
\newcommand{\cgalwinlibmsvc}{\path'http://www.cgal.org/download/CGALWin/MS\_windows/Visual\_C++/CGALWin\_msvc\_native.zip'}
\newcommand{\cgalwinlibbcc}{\path'http://www.cgal.org/download/CGALWin/MS\_windows/Borland/CGALWin\_bcc\_native.zip'}
...
\section{The non-interactive mode (Unix/Cygwin)}\label{sec:non-interactive}
