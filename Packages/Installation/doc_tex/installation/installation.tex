...
If you want to use \leda, \gnu\ GMP or CLN with \cgal, you will have
to go to the \textit{leda menu} described in section
\ref{sec:leda-menu} resp.  to the \textit{gmp menu} described in
section \ref{sec:gmp-menu}.
...
This menu is to setup CLN (Class Library for Numbers) specific
options, if you plan to use CLN together with \cgal . In the {\tt
  auxiliary} directory you can find a CLN distribution, if you do not
already have it installed on your system. Note that in order to enable
