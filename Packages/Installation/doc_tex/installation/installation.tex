...
\begin{center}\index{compilers!supported}\index{supported compilers}
  ...
  \begin{tabular}{|l|l|} \hline
    ...
    & IRIX 6.5 / Solaris 2.6+ / Linux 2.x / 
      \mswin\ 95/98/NT4\footnotemark[12]\\\hline
    \egcs{1.1.2} (and later) \footnotemark[9]
    & IRIX 6.5 / Solaris 2.6+ / Linux 2.x / 
      \mswin\ 95/98/NT4\footnotemark[12]\\\hline
    \msvc{6.0} \footnotemark[10]           
    & \mswin\ 95/98/NT4\\\hline
    \bcc{5.5} \footnotemark[11]                          
    & \mswin\ 95/98/NT4\\\hline
  \end{tabular}
\end{center}
\footnotetext[7]{\mipsprourl}\stepcounter{footnote}
\footnotetext[8]{\kccurl}\stepcounter{footnote}
\footnotetext[9]{\gccurl}\stepcounter{footnote}
\footnotetext[10]{\msvcurl}\stepcounter{footnote}
\footnotetext[11]{\bccurl}\stepcounter{footnote}
\footnotetext[12]{with Cygwin}\stepcounter{footnote}
...
\index{files!\texttt{compiler\_config.h}} is defined, with the
correct settings of all flags. This file is generated automatically by
the \texttt{install\_cgal} script. For this the test programs in the
