...
come with \gmp\ distribution pass.  See \texttt{CGALROOT\bslsh
  auxiliary\bslsh wingmp\bslsh gmp-2.0.2\bslsh msvc\bslsh src} for
details.
...
\path'http://www.mpi-sb.mpg.de/LEDA/download/windows/'
