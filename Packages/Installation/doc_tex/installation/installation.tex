...
ISO 14882 standard for \CC\footnote{see e.g.
  \path~http://reality.sgi.com/austern/std-c++/faq-new.html\#PartB~ for
...
\begin{verbatim}
  ****************************************************************
  **            CGAL 2.0 Installation Compiler Menu             **
  **            -----------------------------------             **
  **                                                            **
  **   OS:                  sparc_SunOS-5.5                     **
  **   Compiler:            SUNPRO CC 4.2                       **
...
In case you have \cgal\ 1.0/1.1/1.2 installed on your system, you might
...
installation (e.g. {\tt /pub/local/CGAL-2.0}).
