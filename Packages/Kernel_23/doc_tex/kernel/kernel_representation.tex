...
and \ccc{Simple_cartesian<FieldNumberType>::RT} are mapped to number type \ccc{FieldNumberType}, too.
...
\ccc{CGAL/Cartesian.h}, \ccc{CGAL/Homogeneous.h}, and \ccc{CGAL/Simple_cartesian.h},
