...
kernel concept. For all kernel objects \ccc{Object}, the types
\ccc{CGAL::Object<Kernel>} and \ccc{Kernel::Object} are identical.
...
\section{Choosing a Kernel and Predefined Kernels}
...
\begin{itemize}
\item They are all Cartesian kernels.
\item They all support constructions of points from \texttt{double} Cartesian
      coordinates.
