\begin{ccRefFunction}{has_larger_signed_distance_to_plane}

\ccFunction{bool
has_larger_signed_distance_to_plane(const Plane_3<R>& h,
                                const Point_3<R>& p,
                                const Point_3<R>& q);}
...
\ccFunction{bool
has_larger_signed_distance_to_plane(const Point_3<R>& p,
                                const Point_3<R>& q,
                                const Point_3<R>& r,
                                const Point_3<R>& s,
                                const Point_3<R>& t);}
