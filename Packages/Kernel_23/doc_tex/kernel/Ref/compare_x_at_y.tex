...
\ccFunction{Comparison_result compare_x_at_y(const Point_2<R> &p,
                                             const Line_2<R> &h);}
...
\begin{ccTexOnly}
\begin{figure}[h]
\centerline{\epsfxsize=\textwidth\epsffile{compare_x_at_y.eps}}
...
\ccFunction{Comparison_result compare_x_at_y(const Line_2<R> &l1,
                                           const Line_2<R> &l2,
                                           const Line_2<R> &h);}
