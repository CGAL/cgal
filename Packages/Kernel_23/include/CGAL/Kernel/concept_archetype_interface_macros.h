...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_ARE_ORDERED_ALONG_LINE_2)
CGAL_Kernel_pred(Are_ordered_along_line_2,
		 are_ordered_along_line_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_ARE_ORDERED_ALONG_LINE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COLLINEAR_ARE_ORDERED_ALONG_LINE_2)
CGAL_Kernel_pred(Collinear_are_ordered_along_line_2,
		 collinear_are_ordered_along_line_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COLLINEAR_ARE_ORDERED_ALONG_LINE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COLLINEAR_ARE_STRICTLY_ORDERED_ALONG_LINE_3)
CGAL_Kernel_pred(Collinear_are_strictly_ordered_along_line_3,
		 collinear_are_strictly_ordered_along_line_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COLLINEAR_HAS_ON_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPARE_ANGLE_WITH_X_AXIS_2)
CGAL_Kernel_pred(Compare_angle_with_x_axis_2,
		 compare_angle_with_x_axis_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPARE_DISTANCE_2)
CGAL_Kernel_pred(Compare_distance_2,
		 compare_distance_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPARE_DISTANCE_3)
CGAL_Kernel_pred(Compare_distance_3,
		 compare_distance_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPARE_SLOPE_2)
CGAL_Kernel_pred(Compare_slope_2,
		 compare_slope_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPARE_X_AT_Y_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPUTE_SQUARED_DISTANCE_2)
CGAL_Kernel_cons(Compute_squared_distance_2,
		 compute_squared_distance_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPUTE_SQUARED_DISTANCE_3)
CGAL_Kernel_cons(Compute_squared_distance_3,
		 compute_squared_distance_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPUTE_SQUARED_LENGTH_2)
CGAL_Kernel_cons(Compute_squared_length_2,
		 compute_squared_length_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPUTE_SQUARED_LENGTH_3)
CGAL_Kernel_cons(Compute_squared_length_3,
		 compute_squared_length_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPUTE_SQUARED_RADIUS_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COMPUTE_VOLUME_3)
CGAL_Kernel_cons(Compute_volume_3,
		 compute_volume_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_BASE_VECTOR_3)
CGAL_Kernel_cons(Construct_base_vector_3,
		 construct_base_vector_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_BISECTOR_2)
CGAL_Kernel_cons(Construct_bisector_2,
		 construct_bisector_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_CENTER_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_CENTROID_3)
CGAL_Kernel_cons(Construct_centroid_3,
		 construct_centroid_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_CIRCLE_2)
CGAL_Kernel_cons(Construct_circle_2,
		 construct_circle_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_CIRCUMCENTER_2)
CGAL_Kernel_cons(Construct_circumcenter_2,
		 construct_circumcenter_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_CIRCUMCENTER_3)
CGAL_Kernel_cons(Construct_circumcenter_3,
		 construct_circumcenter_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_CROSS_PRODUCT_VECTOR_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_DIRECTION_3)
CGAL_Kernel_cons(Construct_direction_3,
		 construct_direction_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_ISO_CUBOID_3)
CGAL_Kernel_cons(Construct_iso_cuboid_3,
		 construct_iso_cuboid_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_ISO_RECTANGLE_2)
CGAL_Kernel_cons(Construct_iso_rectangle_2,
		 construct_iso_rectangle_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_LIFTED_POINT_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_MIDPOINT_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OBJECT_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_DIRECTION_2)
CGAL_Kernel_cons(Construct_opposite_direction_2,
		 construct_opposite_direction_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_DIRECION_3)
CGAL_Kernel_cons(Construct_opposite_direction_3,
		 construct_opposite_direction_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_LINE_2)
CGAL_Kernel_cons(Construct_opposite_line_2,
		 construct_opposite_line_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_LINE_3)
CGAL_Kernel_cons(Construct_opposite_line_3,
		 construct_opposite_line_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_PLANE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_SEGMENT_2)
CGAL_Kernel_cons(Construct_opposite_segment_2,
		 construct_opposite_segment_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_SEGMENT_3)
CGAL_Kernel_cons(Construct_opposite_segment_3,
		 construct_opposite_segment_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_SPHERE_3)
CGAL_Kernel_cons(Construct_opposite_sphere_3,
		 construct_opposite_sphere_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_TRIANGLE_2)
CGAL_Kernel_cons(Construct_opposite_triangle_2,
		 construct_opposite_triangle_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_OPPOSITE_VECTOR_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_ORTHOGONAL_VECTOR_3)
CGAL_Kernel_cons(Construct_orthogonal_vector_3,
		 construct_orthogonal_vector_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_PERPENDICULAR_DIRECTION_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_PERPENDICULAR_LINE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_PERPENDICULAR_VECTOR_2)
CGAL_Kernel_cons(Construct_perpendicular_vector_2,
		 construct_perpendicular_vector_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_PLANE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_POINT_ON_3)
CGAL_Kernel_cons(Construct_point_on_3,
		 construct_point_on_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_POINT_2)
CGAL_Kernel_cons(Construct_point_2,
		 construct_point_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_POINT_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_PROJECTED_XY_POINT_2)
CGAL_Kernel_cons(Construct_projected_xy_point_2,
		 construct_projected_xy_point_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_RAY_2)
CGAL_Kernel_cons(Construct_ray_2,
		 construct_ray_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_RAY_3)
CGAL_Kernel_cons(Construct_ray_3,
		 construct_ray_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_SCALED_VECTOR_2)
CGAL_Kernel_cons(Construct_scaled_vector_2,
		 construct_scaled_vector_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_SCALED_VECTOR_3)
CGAL_Kernel_cons(Construct_scaled_vector_3,
		 construct_scaled_vector_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_SEGMENT_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_SPHERE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_SUPPORTING_PLANE_3)
CGAL_Kernel_cons(Construct_supporting_plane_3,
		 construct_supporting_plane_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_TETRAHEDRON_3)
CGAL_Kernel_cons(Construct_tetrahedron_3,
		 construct_tetrahedron_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_TRANSLATED_POINT_2)
CGAL_Kernel_cons(Construct_translated_point_2,
		 construct_translated_point_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_TRANSLATED_POINT_3)
CGAL_Kernel_cons(Construct_translated_point_3,
		 construct_translated_point_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_TRIANGLE_2)
CGAL_Kernel_cons(Construct_triangle_2,
		 construct_triangle_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_CONSTRUCT_TRIANGLE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COPLANAR_ORIENTATION_3)
CGAL_Kernel_pred(Coplanar_orientation_3,
		 coplanar_orientation_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_COPLANAR_SIDE_OF_BOUNDED_CIRCLE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_DO_INTERSECT_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_HAS_ON_NEGATIVE_SIDE_3)
CGAL_Kernel_pred(Has_on_negative_side_3,
		 has_on_negative_side_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_HAS_ON_POSITIVE_SIDE_2)
CGAL_Kernel_pred(Has_on_positive_side_2,
		 has_on_positive_side_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_HAS_ON_POSITIVE_SIDE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_HAS_ON_UNBOUNDED_SIDE_3)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_LESS_DISTANCE_TO_POINT_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_LESS_ROTATE_CCW_2)
CGAL_Kernel_pred(Less_rotate_ccw_2,
		 less_rotate_ccw_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_LESS_SIGNED_DISTANCE_TO_LINE_2)
...
#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_SIDE_OF_BOUNDED_CIRCLE_2)
CGAL_Kernel_pred(Side_of_bounded_circle_2,
		 side_of_bounded_circle_2_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_SIDE_OF_BOUNDED_SPHERE_3)
CGAL_Kernel_pred(Side_of_bounded_sphere_3,
		 side_of_bounded_sphere_3_object)
#endif

#if !defined(CGAL_CA_LIMITED_INTERFACE) || defined(CGAL_CA_SIDE_OF_ORIENTED_CIRCLE_2)
