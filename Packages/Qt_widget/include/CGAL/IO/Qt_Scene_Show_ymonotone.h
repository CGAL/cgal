...
#ifndef CGAL_QT_SCENE_SHOW_YMONOTONE_H
#define CGAL_QT_SCENE_SHOW_YMONOTONE_H
...
template <class T>
class Qt_scene_show_ymonotone : public Qt_scene
{
    //Q_OBJECT
public:
  ...
  Qt_scene_show_ymonotone(T &p) : polygon(p)
  {};
