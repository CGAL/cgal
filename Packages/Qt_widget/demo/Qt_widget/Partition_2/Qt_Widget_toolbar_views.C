...
#include <CGAL/IO/Qt_Scene_Show_Mouse_coordinates.h>
#include <CGAL/IO/Qt_Scene_Show_polygon.h>
#include <CGAL/IO/Qt_Scene_Show_greene_approximation.h>
#include <CGAL/IO/Qt_Scene_Show_ymonotone.h>
#include <CGAL/IO/Qt_Scene_Show_optimal_convex_partition.h>
#include <CGAL/IO/Qt_Scene_Show_polygon_points.h>
...
namespace CGAL {
     ...
     nr_of_buttons(0)
  {
    ...
    showP = new Qt_scene_show_polygon<Polygon>(*p);
    showGA = new Qt_scene_show_greene_approx<Polygon>(*p);
    showYM = new Qt_scene_show_ymonotone<Polygon>(*p);
    showOC = new Qt_scene_show_optimal_convex<Polygon>(*p);
    showPP = new Qt_scene_show_polygon_points<Polygon>(*p);
