...
void Window::set_window(double xmin, double xmax,
			  double ymin, double ymax)
{
  widget->set_window(xmin, xmax, ymin, ymax);
}

void Window::new_instance()
{
...
void Window::get_new_object(CGAL::Object obj)
{
  Point p;
  Segment s;
  Line l;
...
void Window::insert_after_show_conflicts(QMouseEvent*)
{
  if(got_point)
  {
    got_point = FALSE;
...
void Window::generate_triangulation()
{
  tr1.clear();
  widget->lock();
  widget->set_window(-1.1, 1.1, -1.1, 1.1); // set the Visible Area to the Interval
...
void Window::save_triangulation()
{
  QString fileName = 
...
void Window::load_triangulation()
{
