...
# ADD CPP /nologo /W3 /GR /GX /O2 /I "$(CGALROOT)\stlport" /I "$(CGALROOT)\auxilary\wingmp\gmp-4.0.1" /I "$(CGALROOT)\include\cgal\config\msvc6" /I "$(CGALROOT)\include" /I "$(QTDIR)/include" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "CGAL_USE_GMP" /D "CGAL_USE_QT" /D "QT_DLL" /D "QT_THREAD_SUPPORT" /FD /Zm900 /c /Tp
