...
tool is already attached this gets detached first.}
...
deactivate a layer, that layer will keep the order in the list of layers. s it's
a pointer to an existing attached layer.}
...
In order that layers can draw on the drawing area of a widget, they have to access
