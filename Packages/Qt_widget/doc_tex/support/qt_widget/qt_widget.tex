...
A view can be attached to a \ccc{Qt_widget}. The widget calls the method \ccc{Qt_widget_view::draw_view()} of all attached views, in the order 
...
In the previous example we have seen how the \ccc{Qt_view_show_voronoi<T>}
