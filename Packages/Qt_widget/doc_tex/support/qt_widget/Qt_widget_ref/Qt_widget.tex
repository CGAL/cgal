...
{\bf af: Why was this in a comment?}}

\ccMethod{void do_paint();}{Refresh the widget calling 
\ccc{paintEvent(QPaintEvent *e)} for the \ccc{Qt_widget}.}
...
%VIEWS
%\ccHeading{Views}
\ccMethod{void add_view(Qt_widget_view* s);}{Add the view s in the list of 
views.The last added will be on top of the screen.}
\ccMethod{void remove_view(Qt_widget_view* s);}{Remove the view s from the list.}
\ccMethod{void redraw();}{Redraw the views situated in the list. Before 
...
\ccMethod{QPainter& painter();}{Returns the current painter. {\bf af: Should be \ccc{get_painter}.}}
\end{ccAdvanced}
