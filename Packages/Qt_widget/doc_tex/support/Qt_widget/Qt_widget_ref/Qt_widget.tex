...
\ccc{name}. The default geometers are given by the size of the window.}
...
with given coordinates. This method should be called after \ccc{resize()} from 
\ccStyle{QWidget}.}
...
\ccMethod{void zoom_in(double ratio);}{Multiply X and Y scaling factor by \ccc{ratio}.}

\ccMethod{void zoom_out(double ratio);}{Multiply X and Y scaling factor by \ccc{1/ratio}.}
...
\ccMethod{void back();}{}
\ccGlue
\ccMethod{void forth();}{This slots permits to walk into history.}
