...
public:
  ...
  typedef typename Vb::template TDS_rebind<Tds>::Rebound      Vertex_base;
  typedef typename Fb::template TDS_rebind<Tds>::Rebound      Face_base;
  
  // Je laisse ca provisoirement 
  // par la suite Vertex_base et Face_base devront satisfaire
  // le Concept TdsVertex  et TdsFace
