...
//   _test_cls_cons_Del_triangulation(CDt());
...
//   _test_cls_const_Del__triangulation(CDt1());
  ...
  typedef CGAL::Triangulation_data_structure_using_list_2<Vb2,CFb2>  Tds2;
  typedef CGAL::Constrained_Delaunay_triangulation_2<Gt2,Tds2>        CDt2;
