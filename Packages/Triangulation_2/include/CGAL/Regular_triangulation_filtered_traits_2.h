  ...
  : Converter
{
  ...
  typedef typename Regular_triangulation_euclidean_traits_2<Source_kernel>
                   ::Weighted_point_2  Source_wp;

  typedef typename Regular_triangulation_euclidean_traits_2<Target_kernel>
...
class Regular_triangulation_filtered_traits_2
  : public Regular_triangulation_euclidean_traits_2<K>
{
...
public:
  ...
  typedef Filtered_predicate<
            typename Exact_traits::Power_test_degenerated_2,
            typename Filtering_traits::Power_test_degenerated_2,
            Weighted_converter_2<C2E>,
            Weighted_converter_2<C2F> >  Power_test_degenerated_2;

  Power_test_2 power_test_2_object() const
  { return Power_test_2();}

  Power_test_degenerated_2 power_test_degenerated_2_object() const
