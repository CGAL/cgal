...
a  face stores \ccc{void *} pointers
...
{\it rebound} face, in which the actual 
\ccc{Triangulation_data_structure_2} is  plugged.
This type  \ccc{Other}  will be the real base
class used for the \ccc{Face}  of \ccc{Triangulation_data_structure_2}.}
...
\ccGlue
\ccMethod{int face_index(const Face_handle n) const;}
