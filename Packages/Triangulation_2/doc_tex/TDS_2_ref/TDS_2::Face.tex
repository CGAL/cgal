...
In degenerate cases,
when the \ccc{Triangulation_data_structure_2} stores a
simplicial complex of dimension $0$ and $1$,
faces are used to store the faces of maximal dimension of the complex 
...
\ccc{delete_face()}
have to be used to 
define new faces and delete non longer used ones.
