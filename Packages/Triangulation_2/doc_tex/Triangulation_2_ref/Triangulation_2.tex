...
\begin{figure}[h]
\begin{ccTexOnly}
\begin{center} \IpeScale{50} \Ipe{Triangulation_2_ref/infinite_vertex.ipe} \end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\input{Triangulation_2/insert1.ltex}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\input{Triangulation_2/insert2.ltex}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\input{Triangulation_2/insert3.ltex}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\input{Triangulation_2/remove.ltex}
\end{center}
\end{ccTexOnly}
\caption{Removal
...
\begin{figure}
\begin{ccTexOnly}
\begin{center}  \Ipe{Triangulation_2/walk.ipe} \end{center}
\end{ccTexOnly} 
