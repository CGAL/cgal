...
\ccTypes
\ccThree{typedef Traits::Triangle}{Triangulation_data_structure;}{}
...
list of a function, an appropriate iterator or circulator can be used
as well.
...
%and \ccc{Segment}.}
CGAL also provides  stram operators \ccc{ <<}  to draw triangulations
