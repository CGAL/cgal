...
\ccc{vertices_begin()} returns an
iterator pointing 
on the first vertex of the enclosing constraint,
\ccc{vertices_end()} returns an iterator
pointing past the last vertex on  the enclosing constraint, and 
\ccc{current()} returns an iterator pointing
on the first vertex of the subconstraint in the sequence of vertices
of the enclosing constraint.}
