...
{returns an iterator on the first element of a sequence of hidden vertices.}

\ccMethod{Hidden_vertices_iterator hidden_vertices_begin() const;}
{returns the past the end iterator of the sequence of hidden vertices.}

\ccMethod{All_vertices_iterator all_vertices_begin() const;}
{returns an iterator on the first element of a sequence of hidden and not hidden
finite vertices.}

\ccMethod{All_vertices_iterator all_vertices_begin() const;}
{returns the past the end iterator of the sequence of hidden and not hidden
finite vertices.}
