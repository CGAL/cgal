...
If he has to deal
with a large triangulations, the user is advised to use the 
encapsulating class
\ccc{Triangulation_hierarchy_2<Tr>}
with the template parameter instantiated with a \ccRefName\ .
The class \ccc{Triangulation_hierarchy_2<Tr>} offers the same 
