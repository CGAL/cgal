...
a few construction objects for those types  
and fonction objects  for 
...
\ccc{Segment_2}.Must provide \ccc{Segment_2 operator()(Point_2
p,Point_2 q)}, 
...
The following functions give access to the  constructor and predicate objects.
...
a ray from a point and a direction.}
