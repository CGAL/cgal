...
included using the 
\verb|\ccIncludeExampleCode{examples/Package/Regular_triangulation_traits_2_prog.C}| 
...
%% \ccIncludeExampleCode{examples/Package/Regular_triangulation_traits_2_prog.C}
