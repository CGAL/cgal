...
\section{Augmented Constrained Triangulations}

The class \ccc{Constrained_triangulation_plus_2<Tr,Itag>}
...
The class  \ccc{Constrained_triangulation_plus_2<Tr,Itag>}
 constructs a triangulated arrangement
...
In addition, the class \ccc{Constrained_triangulation_plus_2<Tr,Itag>} 
is equipped
...
The following code inputs a set of intersecting segments
form a file and builds the triangulated arrangement of these
segments.
