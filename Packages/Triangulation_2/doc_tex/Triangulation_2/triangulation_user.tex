...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=6cm]{Triangulation_2/tr1.ps} \hspace*{1cm} 
\includegraphics[width=6cm]{Triangulation_2/dt1.ps} 
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
<CENTER>
...
\begin{ccTexOnly}
\begin{center}
\includegraphics{Triangulation_2/infinite.eps} 
\end{center}
\end{ccTexOnly}
...
algorithms~ \cite{cgal:bdty-tcgal-00}.
...
\begin{ccTexOnly}
    \begin{center}
     \includegraphics[width=6cm]{Triangulation_2/rep_bis.eps} 
    \end{center}
\end{ccTexOnly} 
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=13cm]{Triangulation_2/threelevels.eps}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=13cm]{Triangulation_2/derivation_tree.eps} 
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center} \IpeScale{100} \Ipe{Triangulation_2/constraints.ipe} \end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=5cm]{Triangulation_2/poisson.ps}
\includegraphics[width=5cm]{Triangulation_2/del_poisson.ps}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=13cm]{Triangulation_2/threelevels2.eps}
\end{center}
\end{ccTexOnly}
