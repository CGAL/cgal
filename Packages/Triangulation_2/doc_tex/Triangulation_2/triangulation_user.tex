...
The additional types \ccc{Line} and
and \ccc{Ray} and the constructor objects
...
\ccMethod{ Construct_circumcenter_2}{
...
and a two types Power_test_2 and Power_test_degenerated_2
for the power tests.
