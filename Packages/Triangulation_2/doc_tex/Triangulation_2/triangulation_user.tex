...
\ccHeading{Predefined Geometric Traits Class}
...
\ccHeading{Requirements for the Base Face}
...
\ccHeading{Requirements for a weighted-point}
The weighted point type  
is required to provide access to the underlying  point and to its weight.


\ccHeading{Predefined Weighted Point}
...
\subsection{Definition}
The class \ccc{Triangulaton_hierarchy_2<Tr>}
...
\ccHeading{A predefined Vertex Base type}
\cgal provides the class \ccc{Triangulation_hierarchy_vertex_base_2<Traits>}
...
\ccc{Triangulation_vertex_base_2<Traits>}. It is templated,
as its base class, by a geometric traits class \ccc{Traits}
