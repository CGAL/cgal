...
figure~\ref{Ref_Fig_infinite_vertex}, note that
...
concept described on page~\ccRefPage{ConceptTriangulation_traits_2<Rep>}.
The second parameter expects a model of the
\ccc{Triangulation_data_structure} described on page~\ccRefPage{ConceptTriangulation_data_structure<Vb,Fb>}.
