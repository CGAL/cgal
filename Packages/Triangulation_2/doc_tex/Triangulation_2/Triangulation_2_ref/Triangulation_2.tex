...
\ccTypes
\ccThree{typedef Traits::Trianglperle sirius gemma procyon algorab zosma alcyone sargas taniae}{}{the triangulation data structure type.}
\ccThreeToTwo
...
%\ccIncludeExampleCode{../../../examples/Triangulation/triangulation_prog1.C}
\ccIncludeExampleCode{triangulation_prog1.C}
