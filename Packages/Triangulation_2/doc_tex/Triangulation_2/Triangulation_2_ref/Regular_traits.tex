...
\ccTypes
\ccNestedType{Bare_point}{Anothr name for the Point_2 type.}
\ccGlue    
\ccNestedType{Weighted_point}{Is required to derive from Point_2
and to be a model of the Weighted_point concept.}
\ccGlue
...
\ccNestedTypes{Power_test_2}{A predicate object type. Must provide
the operator 
...
\ccc{s}. \ccPrecondition{the bare_points corresponding to 
\ccc{p}, \ccc{q}, \ccc{r} are not collinear}.}
\ccGlue
\ccNestedTypes{Power_test_degenerated_2}{A predicate object type. Must provide
the operator 
\ccc{Oriented_side operator() ( Weighted_point p,
			     Weighted_point q,
			     Weighted_point r) }
...
\ccc{p}, \ccc{q}, \ccc{r}.
\ccPrecondition{the bare_points corresponding to 
