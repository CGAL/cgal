...
\item[--] join two vertices that are connected with an edge,\\
\item[--] split a vertex into two vertices that are joined by an edge (this
is the reverse of the above operation); see also
Figure~\ref{fig-tds-user-split-join}.
\end{itemize}
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=0.7\textwidth]{TDS_2_ref/join_split}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
<center>
...
returned.}\label{fig-tds-user-split-join}
\begin{ccHtmlOnly}
</font>
\end{ccHtmlOnly}
\end{figure}
