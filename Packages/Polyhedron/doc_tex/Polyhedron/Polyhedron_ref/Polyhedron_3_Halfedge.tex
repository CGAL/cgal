...
counterclockwise around the facet (hole) and traverses all halfedges
incident to this facet (hole). A similar invariant is that successive
assignments of the form \ccc{h = h->next()->opposite()} cycle
clockwise around the vertex and traverses all halfedges incident to
...
\ccc{Vertex}, \ccc{Facet}, \ccc{CGAL::Polyhedron_3}.
