...
\begin{ccTexOnly}
    ...
    \begin{flushright}~\hspace{1cm}
      \parbox{0.5\textwidth}{%
          \includegraphics[width=0.5\textwidth]{Polyhedron/fig/shark.ps}%
      }%
    \end{flushright}
\end{ccTexOnly}
...
\begin{ccTexOnly}
    ...
    \begin{center}
      \parbox{0.4\textwidth}{%
          \includegraphics[width=0.4\textwidth]{Polyhedron/fig/halfedge.ips}%
      }
    \end{center}
    \vspace{-5mm}
\end{ccTexOnly}
...
\begin{ccTexOnly}
    \begin{center}
      \parbox{\textwidth}{%
          \includegraphics[width=\textwidth]{Polyhedron/fig/make_cube.ips}%
      }
    \end{center}
\end{ccTexOnly}
...
\\
\ccInclude{CGAL/IO/Polyhedron_geomview_stream.h}
...
\begin{ccTexOnly}
    \begin{center}
      \parbox{\textwidth}{%
          \includegraphics[width=\textwidth]{Polyhedron/fig/subdiv.ps}%
      }
    \end{center}
\end{ccTexOnly}
