...
\ccc{the separating distance}), hits the domain boundary, reaches a 
...
This method introduces an intermediate point \ccc{p'} to have more precision in the computation (see~figure~\ref{runge_kutta_fig})
