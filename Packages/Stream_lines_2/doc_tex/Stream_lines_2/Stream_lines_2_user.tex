...
This method introduces an intermediate point \ccc{p'} to increase the
precision of the computation (see~Figure~\ref{runge_kutta_fig}).
...
starting at the farthest away from all previously placed
streamlines.\\
...
directions sampled within a domain, associated to an interpolation
...
iterative integration from the seed point. The computation is
