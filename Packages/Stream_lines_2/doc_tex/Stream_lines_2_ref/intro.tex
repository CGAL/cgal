...
The \ccc{Stream_lines_2} class of \cgal\ depends on two template
...
operations on them, and should be instantiated by a model of
...
construct the streamlines, and should be instantiated by a model of
\ccc{Integrator_2}.
