...
\ccc{Stream_lines_2<VectorField_2,Integrator_2>}.  This concept provides
...
\ccGlue
\ccNestedType{Vector_field_2}{The vector  type.}
\ccGlue

\ccCreation
\ccCreationVariable{integrator_2}  %% choose variable name
