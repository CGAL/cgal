...
This class provides a vector field specified by a set of sample points defined on a triangulated domain. All of the sample points are inserted in a \ccc{Delaunay triangulation}, and for each point \ccc{p} in the domain located in a face \ccc{f}, its vector value is interpolated from the vertices of the face \ccc{f}. 
