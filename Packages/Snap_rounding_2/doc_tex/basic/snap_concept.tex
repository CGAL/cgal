...
\ccNestedType{segment_direction_2}{Returns a floating-point approximation of the
slope of a segment as described in \cite{isr-2002}.
...
\ccGlue
\ccMethod{segment_direction_2 segment_direction_object();}{}
\ccGlue
\ccMethod{rotate_point_2 rotate_point_object();}{}
\ccGlue
\ccMethod{integer_grid_point_2 integer_grid_point_object();}{}
\ccGlue
\ccMethod{box_of_minkowski_sum_2 box_of_minkowski_sum_object();}{}
\ccGlue
