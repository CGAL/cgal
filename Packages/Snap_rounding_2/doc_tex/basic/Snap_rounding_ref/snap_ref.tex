...
\begin{ccAdvanced}
 ...
 with the parameter {\it number_of_kd_trees}. Typically, but not
 always, one kd-tree (the default) is sufficient.

\end{ccAdvanced}

\ccPrecond{{\it pixel_size} must have a positive value and {\it number_of_kd_trees} must be a positive integer.}
