...
The Snap Rounding traits-class we provide is templated by another traits.
This traits must provide an arbitrary-precision number type (\ccc{FT}),
\ccc{Point_2}, \ccc{Segment_2} and \ccc{Iso_rectangle_2}.
