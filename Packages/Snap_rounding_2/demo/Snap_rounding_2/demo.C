...
void display_bounding_box(Snap_rounding_2 &s,CGAL::Window_stream &W)
{
  return;// !!!!! check
}
...
void clear(Snap_rounding_2 &s,CGAL::Window_stream &W)
{
  s.clear();

  W.clear();

  display_bounding_box(s,W);
}

void redraw(Snap_rounding_2 &s,CGAL::Window_stream &W)
{
  W.clear();
