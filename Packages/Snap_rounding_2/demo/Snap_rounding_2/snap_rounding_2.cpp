...
public:
  MyWindow(int w, int h){
    ...
    *widget << CGAL::LineWidth(2) << CGAL::BackgroundColor (CGAL::BLACK);
    ...
    //layers
    ssl.show_output = true; ssl.show_input = true;
    ssl.show_hp = true;
    widget->attach(&ssl);
    prec = 1;
  };
...
public slots:
  ...
  void open(){
    ...
    QProgressDialog progress("Loading segments", "Abort loading", number_of_segments, this, "progress", true);
    progress.show();
