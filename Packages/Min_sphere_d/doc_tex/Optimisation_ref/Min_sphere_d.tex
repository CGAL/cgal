...
\textbf{Note:} This class is (almost) obsolete. The class
\ccc{Min_sphere_of_spheres_d} solves a more general problem
and is faster then \ccRefName\, even if used only for points
as input. Most importantly, \ccc{Min_sphere_of_spheres_d} has
...
\ccRefName\ over \ccc{Min_sphere_of_spheres_d} is that the
