...
#ifndef CGAL_SEGMENT_VORONOI_DIAGRAM_SIMPLE_STORAGE_SITE_H
#define CGAL_SEGMENT_VORONOI_DIAGRAM_SIMPLE_STORAGE_SITE_H
...
#endif // CGAL_SEGMENT_VORONOI_DIAGRAM_SIMPLE_STORAGE_SITE_H
