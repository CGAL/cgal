...
The concept \ccc{SegmentVoronoiDiagramDataStructure_2} refines the
concept \ccc{ApolloniusGraphDataStructure_2}
described in \ccRefPage{ApolloniusGraphDataStructure_2}. In addition
...
and $g$ are returned as a \ccc{CGAL::Quadruple} in that order.
...
\ccThree{Vertex_handle}{svdds.join_vertices(Face_handle v, int i)+}{}
%
...
\ccGlue
\ccMethod{Quadruple<Vertex_handle, Vertex_handle, Face_handle, Face_handle>
  ...
  faces \ccc{f1} and \ccc{f2}. The quaruple \ccc{(v1,v2,f,g)} is
  returned.}
