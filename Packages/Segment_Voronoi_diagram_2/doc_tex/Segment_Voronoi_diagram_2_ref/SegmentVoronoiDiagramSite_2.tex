...
\ccCreation
\ccThree{SegmentVoronoiDiagramSite_2+}{construct_site_2(Point_2 p)+}{}
...
\ccMethod{SegmentVoronoiDiagramSite_2
  construct_site_2(Point_2 p);}{Constructs a site from a point: the site
  represents the point \ccc{p}.}
%
\ccGlue
\ccMethod{SegmentVoronoiDiagramSite_2 construct_site_2(Point_2 p1,
