...
\begin{ccRefClass}
{Segment_Voronoi_diagram_filtered_traits_without_intersections_2<CK,CM,EK,EM,FK,FM>}
...
to achieve traits for the \ccc{Segment_Voronoi_diagram_2<Gt,DS>}
...
\ccc{Segment_Voronoi_diagram_traits_without_intersections_2<CK,CM>},
which means that they may be inexact.

This class has six template parameters. 
The first, third and fifth template parameters must be a models of the
\ccc{Kernel} concept. The second, fourth and sixth template parameters
