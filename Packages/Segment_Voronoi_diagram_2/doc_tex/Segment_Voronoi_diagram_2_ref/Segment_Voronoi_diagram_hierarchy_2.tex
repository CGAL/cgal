...
\ccc{Segment_Voronoi_diagram_2<Gt,SC,DS>} for the incremental
...
difference between the \ccc{Segment_Voronoi_diagram_2<Gt,SC,DS>} class
...
\ccc{Segment_Voronoi_diagram_2<Gt,SC,DS>} class. At every subsequent
...
meaning as in the \ccc{Segment_Voronoi_diagram_2<Gt,SC,DS>} class. The
...
\ccc{Segment_Voronoi_diagram_2<Gt,SC,DS>} class. The interface is
...
its base class \ccc{Segment_Voronoi_diagram_2<Gt,SC,DS>}.

\ccCreation
\ccCreationVariable{svdh}
%
%\ccThree{Segment_Voronoi_diagram_hierarchy_2<Gt,SC,DS>}
%{svdh(Gt gt=Gt());}{}
%\ccThreeToTwo
...
Segment_Voronoi_diagram_hierarchy_2<Gt,SC,DS>(Input_iterator
...
%
\ccGlue
\ccConstructor{Segment_Voronoi_diagram_hierarchy_2<Gt,SC,DS>
(Segment_Voronoi_diagram_hierarchy_2<Gt,SC,DS> other)}
...
not.}
%
\ccThree{Segment_Voronoi_diagram_hierarchy<Gt,SC,DS>++}{svdh = other;}{}
\ccThreeToTwo
\ccGlue
\ccMethod{Segment_Voronoi_diagram_hierarchy_2<Gt,SC,DS>
operator=(Segment_Voronoi_diagram_hierarchy_2<Gt,SC,DS>
...
\ccc{Segment_Voronoi_diagram_2<Gt,SC,DS>} class.}
%
\ccGlue
...
\ccThree{Vertex_handle}{svdh.nearest_neighbor(Point p)+}{}
%
...
\ccMethod{void swap(Segment_Voronoi_diagram_hierarchy_2<Gt,SC,DS>
other);}
