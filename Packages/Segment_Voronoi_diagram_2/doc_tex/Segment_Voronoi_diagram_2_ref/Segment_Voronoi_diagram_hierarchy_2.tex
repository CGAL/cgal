...
its base class \ccc{Segment_Voronoi_diagram_2<Gt,PC,DS>}.

\ccCreation
\ccCreationVariable{svdh}
%
%\ccThree{Segment_Voronoi_diagram_hierarchy_2<Gt,PC,DS>}
%{svdh(Gt gt=Gt());}{}
%\ccThreeToTwo
...
Segment_Voronoi_diagram_hierarchy_2<Gt,PC,DS>(Input_iterator
...
%
\ccGlue
\ccConstructor{Segment_Voronoi_diagram_hierarchy_2<Gt,PC,DS>
(Segment_Voronoi_diagram_hierarchy_2<Gt,PC,DS> other)}
...
not.}
%
\ccThree{Segment_Voronoi_diagram_hierarchy<Gt,PC,DS>++}{svdh = other;}{}
\ccThreeToTwo
\ccGlue
\ccMethod{Segment_Voronoi_diagram_hierarchy_2<Gt,PC,DS>
operator=(Segment_Voronoi_diagram_hierarchy_2<Gt,PC,DS>
...
\ccMethod{void swap(Segment_Voronoi_diagram_hierarchy_2<Gt,PC,DS>
other);}
