...
\ccThree{typedef typename std::list<typename Site_2::Point_2>::iterator}
{Point_handle+}{}
\ccThreeToTwo
\ccTypes
\ccNestedType{Site_2}{The site type.}
\ccGlue
\ccTypedef{typedef typename std::list<typename Site_2::Point_2>::iterator
Point_handle;}{The type for a handle to a point.}



\ccCreation
%\ccThree{SegmentVoronoiDiagramStorageSite_2}{construct_storage_site_2(Point_handle hp)+}{} 
\ccThree{SegmentVoronoiDiagramStorageSite_2}{construct}{}
...
\ccMethod{SegmentVoronoiDiagramStorageSite_2
...
%
\ccGlue
\ccMethod{SegmentVoronoiDiagramStorageSite_2 source_site();}
{Returns a storage site that represents the first endpoint of the
  represented segment.
  \ccPrecond{\ccc{ss.is_segment()} must be \ccc{true}.}}
%
\ccGlue
\ccMethod{SegmentVoronoiDiagramStorageSite_2 target_site();}
