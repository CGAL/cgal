...
requirements for the \ccc{Segment_Voronoi_diagram_2<Gt,PC,DS>} and
\ccc{Segment_Voronoi_diagram_hierarchy_2<Gt,STag,PC,DS>} classes. In
particular, it provides a type \ccc{Site_2}, which must be a model of
the concept \ccc{SegmentVoronoiDiagramSite_2}. It also provides
...
\ccNestedType{Intersections_tag}{Indicates or not whether the
  intersecting segments are to be supported.
  \ccPrecond{The tag must either be \ccc{CGAL::Tag_true} or
  \ccc{CGAL::Tag_false}.}}
...
%
\ccGlue
\ccNestedType{Are_same_points_2}{A predicate object type. Must provide
...
\ccNestedType{Oriented_side_2}{A predicate object type. Must provide
  ...
  that contains the point site \ccc{p}.
...
\ccGlue
\ccMethod{Are_same_points_2 are_same_points_2_object();}{}
\ccGlue
