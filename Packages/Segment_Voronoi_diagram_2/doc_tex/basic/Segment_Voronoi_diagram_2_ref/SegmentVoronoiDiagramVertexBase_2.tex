...
\ccc{SegmentVoronoiDiagramDataStructure_2} concept. A vertex stores an
...
%
\ccGlue
\ccNestedType{Point_handle}{A handle type for the points in the point
  container.
  \ccPrecond{This type must be identical to the type
    \ccc{Point_container::iterator}.}}
%
\ccGlue
\ccNestedType{Site_2}{A type for the site.
...
\ccNestedType{Storage_site_tag}{A type that indicates what kind of
  storage type to use.
  \ccPrecond{\ccc{Storage_site_tag} must either be
