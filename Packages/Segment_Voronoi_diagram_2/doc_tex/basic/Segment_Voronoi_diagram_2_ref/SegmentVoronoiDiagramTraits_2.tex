...
\ccNestedType{Arrangement_type}{An enumeration type that indicates the
  ...
  \ccc{INTERIOR_2}. A detailed description of the meaning of these
  values is shown the end of the reference manual for this concept.}
\ccGlue
...
\ccPrecond{\ccc{s1} and \ccc{s2} muts be points.}}
%
\ccGlue
