...
\ccc{Segment_Voronoi_diagram_2<SegmentVoronoiDiagramTraits_2,ApolloniusGraphDataStructure_2>}
...
\item the underlying {\bf data structure}. This is
  actually identical to the Apollonius graph data structure (discussed
  in Chapter \ref{sec:apollonius2-design}). The corresponding concept
  is that of \ccc{ApolloniusGraphDataStructure_2}. The class
...
the \ccc{Segment_Voronoi_diagram_2<K,MTag>} class, and
...
The
\ccc{Segment_Voronoi_diagram_hierarchy_2<SegmentVoronoiDiagramTraits_2,
  SSTag, ApolloniusGraphDataStructure_2>} class is the analogue
...
The class
\ccc{Segment_Voronoi_diagram_hierarchy_2<SegmentVoronoiDiagramTraits_2,
  SSTag, ApolloniusGraphDataStructure_2>}
