...
the class \ccc{Regular_triangulation_2}.

The triangulation needs a geometric traits class as argument.
The requirements of this class are described in the 
concepts \ccc{CGAL::AlphaShapeEuclideanTraits_2} and
\ccc{CGAL::WeightedAlphaShapeEuclideanTraits_2} for which
the classes \ccc{CGAL::Alpha_shape_euclidean_traits_2}
...
\ccc{AlphaShapeVertexBase_2} and \ccc{AlphaShapeFaceBase_2},
by default the classes \ccc{Alpha_shape_vertex_base_2<Gt, Tv} 
and \ccc{Alpha_shape_face_base_2<Tf>}.
