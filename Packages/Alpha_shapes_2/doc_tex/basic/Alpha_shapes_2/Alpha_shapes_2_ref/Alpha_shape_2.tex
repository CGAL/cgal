...
\ccNestedType{Alpha_shape_edges_iterator}{An iterator that allow to traverse 
the edges which belongs to the $\alpha$-shape for a fixed $\alpha$. The iterator
...
an arbitrary finite edge which belongs to the $\alpha$-shape for a fixed
