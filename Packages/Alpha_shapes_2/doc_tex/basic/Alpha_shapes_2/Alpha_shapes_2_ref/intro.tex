...
\ccRefConceptPage{AlphaShapeEuclideanTraits_2}\\
\ccRefConceptPage{WeightedAlphaShapeEuclideanTraits_2}\\
\ccRefConceptPage{AlphaShapeFaceBase_2}\\
\ccRefConceptPage{AlphaShapeVertexBase_2}\\


\subsection*{Classes}

\ccRefIdfierPage{CGAL::Alpha_shape_2<Dt>}\\
\ccRefIdfierPage{CGAL::Alpha_shape_euclidean_traits_2}\\
\ccRefIdfierPage{CGAL::Weighted_alpha_shape_euclidean_traits_2}\\
\ccRefIdfierPage{CGAL::Alpha_shape_vertex_base_2}\\
\ccRefIdfierPage{CGAL::Alpha_shape_face_base_2<Df>}\\
