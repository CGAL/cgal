...
\begin{ccRefClass}{Alpha_shape_vertex_base_2}
...
\ccConstructor{Alpha_shape_vertex_base_2();}{default constructor.}
\ccGlue
\ccConstructor{Alpha_shape_vertex_base_2(Point p);}{constructor setting
the point associated to.}
\ccGlue
\ccConstructor{Alpha_shape_vertex_base_2(Point p, void* f);} 
