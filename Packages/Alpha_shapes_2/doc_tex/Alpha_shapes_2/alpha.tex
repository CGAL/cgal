...
\chapter{Alpha-Shapes 2D} \label{I1_ChapterAlphashapes2D}
...
(cf. \ref{I1_SectClassicAS2D}) associated with the Delaunay triangulations
(cf. \ref{I1_Sect_Delaunay}), in the other hand, the {\em weighted alpha shapes}
(cf. \ref{I1_SectWeightedAS2D}) associated with the regular triangulations
...
\section{Requirements for the Underlying Triangulation\label{I1_SectDtClass2D}}
...
\subsection*{The Alpha-Shape Traits Class (\mbox{\it Gt})\label{I1_ASTraits2D}} 
...
Manual \ccRefPage{CGAL::Alpha_shape_traits_2}.
...
She requires to be templated by special \ccc{Alpha_shape_vertex_base_2} and
\ccc{Alpha_shape_face_base_2<Df>}, to store the alpha values associated. Thus, we need to
define the requirements of such \ccc{Alpha_shape_vertex_base_2} and
\ccc{Alpha_shape_face_base_2<Df>} classes.

\subsection{Requirements for the \protect \ccc{Vertex_base} Class of an
Alpha-Shape\label{I1_SectVertexAS2D}} 

The information about the alpha values associated  are accessible by the 
vertices of the alpha shape. Thus the nested \ccc{Alpha_shape_vertex_base_2}
...
\ccRefPage{CGAL::Alpha_shape_vertex_base_2}.  
...
faces of the alpha shape. Thus the nested \ccc{Alpha_shape_face_base_2<Df>}
type of an alpha shape offers additional functionalities to deal with these
methods.
...
\ccRefPage{CGAL::Alpha_shape_face_base_2<Df>}.

%----------------------------------------------------------------------

\section{Classic Version of Alpha-Shapes\label{I1_SectClassicAS2D}}
...
Of course, \cgal\ provides a default \ccc{Alpha_shape_traits_2} class in this
...
\section{Weighted Version of Alpha-Shapes\label{I1_SectWeightedAS2D}}
