...
\begin{ccRefConcept} {WeightedAlphaShapeTraits_2}

\ccCreationVariable{t}

\ccDefinition
The concept \ccRefName\ that satisfies the requirements of a
\ccc{AlphaShapeTraits_2} class must provide the following predicate and
...
point \ccc{test} to the smallest circle of the points \ccc{p0, p1}, using the
