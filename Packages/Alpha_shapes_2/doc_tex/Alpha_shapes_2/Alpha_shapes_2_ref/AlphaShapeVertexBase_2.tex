...
\begin{ccRefConcept}{AlphaShapeVertexBase_2}

\ccDefinition

This concpet extends the concpet of a triangulation vertex.
...
\ccConstructor{AlphaShapeVertexBase_2();}{default constructor.}
\ccGlue
\ccConstructor{AlphaShapeVertexBase_2(Point p);}{constructor setting
the point associated to.}
\ccGlue
\ccConstructor{AlphaShapeVertexBase_2(Point p, void* f);} 
