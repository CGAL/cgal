...
of the points \ccc{p0, p1}, as \ccc{Coord_type} associated with \emph{the metric used
by \ccc{Dt}}.} 
...
point \ccc{test} to the smallest circle of the points \ccc{p0, p1}, using \emph{the
