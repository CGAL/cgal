...
the vertices which belongs to the $\alpha$-shape for the current $\alpha$. The
...
the edges which belongs to the $\alpha$-shape for the current $\alpha$. The iterator
...
themselves. This allows the user to decide if this information gets cached or recomputed.
