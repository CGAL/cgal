...
\clearpage
\section{Reference pages for Alpha Shapes in 2D}
...
(cf. \ref{I1_SectClassicAS_2}) associated with the Delaunay triangulations
(cf. \ref{I1_Sect_Delaunay}), in the other hand, the {\em weighted alpha shapes}
(cf. \ref{I1_SectWeightedAS_2}) associated with the regular triangulations
