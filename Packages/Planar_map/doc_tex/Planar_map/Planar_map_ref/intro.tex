...
\ccIncludeExampleCode{Planar_map/triangle.txt}
...
\ccRefIdfierPage{CGAL::Pm_drawer<Planar_map>}\\
\ccRefIdfierPage{CGAL::draw_pm<Planar_map,Drawer,Window>(Planar_map pm, Drawer& drawer,Window& w);}
