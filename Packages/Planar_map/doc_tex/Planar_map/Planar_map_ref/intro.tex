...
of the same map it would be extremely faster to build the map only
once (incrementally or via a sweep line utility), save it and reload
...
\ccc{Planar_map_2<Dcel,Traits>} for best performance.
