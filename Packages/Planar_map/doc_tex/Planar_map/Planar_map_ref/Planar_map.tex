...
\ccMethod{bool read (istream &in);}{reading ccRefName\ from a given input stream.} 

\ccStyle{template <class Scanner>}
\ccMethod{bool read (istream &in, Scanner& scanner);}{reading \ccRefName\ from a given input stream when taking the scanner class as a parameter.}
