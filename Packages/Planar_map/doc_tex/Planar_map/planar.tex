...
\begin{figure}[h]
\begin{ccTexOnly}
\centerline{\includegraphics{Planar_map/insert_at.ps}}
\end{ccTexOnly}
...
\begin{ccTexOnly}
    \centerline{
      \includegraphics{Planar_map/pm_ray_shoot.ps}
    }
\end{ccTexOnly}
...
More details are give in sections 
  \ccc{Pm_trapezoid_dag_point_location<Planar_map>}\lcTex{
  (\ccRefPage{CGAL::Pm_trapezoid_dag_point_location<Planar_map>})}, 
