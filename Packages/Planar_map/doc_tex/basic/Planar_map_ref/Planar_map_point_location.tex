...
\ccMethod{virtual void insert(Halfedge_handle h,const X_curve_2& cv);}
...
\ccMethod{virtual void split_edge(const X_curve_2 &cv, Halfedge_handle e1,
   Halfedge_handle e2,const X_curve_2& cv1, const X_curve_2& cv2);}{updates the 
...
\ccMethod{virtual void merge_edge(const X_curve_2 &cv1, const X_curve_2 &cv2,
                        Halfedge_handle e,const X_curve_2& cv );}{updates 
