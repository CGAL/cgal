...
primitive operations used by the data structure \ccc{Planar_map_2<Dcel,Traits>}.
...
\ccNestedType{Has_left_category}{A boolean category that indicates
  whether the method \ccc{curves_compare_y_at_x_left()} is required or
  alternatively the methods \ccc{point_reflect_in_x_and_y()} and
...
as the \ccc{Traits} template parameter for
