% +------------------------------------------------------------------------+
% | Reference manual page: Pm_file_drawer.tex (Planar_map)
% +------------------------------------------------------------------------+
% | 
...
The user has to make sure that methods for writing Point_2 and X_monotone_curve_2 types of \ccc{Planar_map} are defined in the graphic stream he chooses to work with.
