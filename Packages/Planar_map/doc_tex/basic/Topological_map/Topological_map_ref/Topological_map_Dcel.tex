...
\ccc{Topological_map_DCEL::Vertex}\lcTex{ 
(\ccRefPage{Topological_map_DCEL::Vertex})},
\ccc{Topological_map_DCEL::Halfedge}\lcTex{
(\ccRefPage{Topological_map_DCEL::Halfedge})} and
\ccc{Topological_map_DCEL::Face}\lcTex{
(\ccRefPage{Topological_map_DCEL::Face})} respectively.)
...
\ccHasModels
     ...
     \ccc{Pm_dcel<V,H,F>}\lcTex{ (\ccRefPage{Pm_dcel<V,H,F>})}\\

\ccSeeAlso
     \ccc{Topological_map_DCEL::Vertex}\lcTex{ 
     (\ccRefPage{Topological_map_DCEL::Vertex})}\\
     \ccc{Topological_map_DCEL::Halfedge}\lcTex{
     (\ccRefPage{Topological_map_DCEL::Halfedge})}\\
     \ccc{Topological_map_DCEL::Face}\lcTex{
     (\ccRefPage{Topological_map_DCEL::Face})}
