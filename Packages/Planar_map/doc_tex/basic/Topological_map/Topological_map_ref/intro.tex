...
\ccc{Topological_map_DCEL}\lcTex{ (\ccRefPage{Topological_map_DCEL})}
...
\ccRefConceptPage{Topological_map_DCEL}\\
\ccRefConceptPage{Topological_map_DCEL::Vertex}\\
\ccRefConceptPage{Topological_map_DCEL::Halfedge}\\
\ccRefConceptPage{Topological_map_DCEL::Face}
