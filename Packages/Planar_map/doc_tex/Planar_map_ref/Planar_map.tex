...
\ccDefinition
    An object $pm$ of the class \ccClassTemplateName\ is the
    subdivision of the planar induced by a set of $x$-monotone curves,
    such that no curve intersects the interior of any other curve. The
    available traits and dcel classes are described bellow. \ccc{Self}
