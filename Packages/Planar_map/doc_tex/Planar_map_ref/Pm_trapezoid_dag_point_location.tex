% +------------------------------------------------------------------------+
% | Reference manual page: Pm_trapezoid_dag_point_location.tex (Planar_map)
% +------------------------------------------------------------------------+
% | 
...
\ccInclude{CGAL/Pm_trapezoid_dag_point_location.h}
...
\ccConstructor{Pm_trapezoid_dag_point_location<Planar_map>(bool preprocess = false);}
