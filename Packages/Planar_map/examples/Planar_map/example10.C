...
class Pm_my_dcel : public Pm_dcel<Pm_my_vertex<typename Traits::Point>,
...
// extend the drarwer for printing the color in addition. 
template <class PM>
...
public:
  ...
  Pm_my_file_writer(std::ostream& o, const PM& pm, bool verbose = false) : Pm_file_writer<PM>(o, pm, verbose){}
...
int main(int argc, char* argv[])
{
  ...
  for (Vertex_iterator v_iter = pm.vertices_begin(); v_iter != pm.vertices_end(); v_iter++)
