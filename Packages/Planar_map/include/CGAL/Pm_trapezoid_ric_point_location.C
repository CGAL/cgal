...
#ifndef CGAL_PM_TRAPEZOID_RIC_POINT_LOCATION_C
#define CGAL_PM_TRAPEZOID_RIC_POINT_LOCATION_C
...
typename Pm_trapezoid_ric_point_location<Planar_map>::Halfedge_const_handle
Pm_trapezoid_ric_point_location<Planar_map>::locate(const Point& p,
                                                    Locate_type& lt)
  const
{
...
template <class Planar_map>
typename Pm_trapezoid_ric_point_location<Planar_map>::Halfedge_handle
Pm_trapezoid_ric_point_location<Planar_map>::locate(const Point& p,
                                                    Locate_type& lt){
