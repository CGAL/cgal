...
class Spherical_cgm_pm_halfedge : public Cgm_arr_halfedge<X_monotone_curve_2> 
{
public:
  /*
   empty constructor
...
/*
 Extend the planar-map halfedge to hold information used by the spherical map
*/
class Spherical_cgm_pm_face: public Cgm_arr_face
{
public:
  /*
   empty constructor
...
class Spherical_cgm_pm_dcel: public Arr_dcel_base<
