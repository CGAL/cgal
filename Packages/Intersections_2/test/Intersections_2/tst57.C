...
void one_pair(ray_t const & ray, rect_t const & rect)
{
    ...
    point_t point;
/*
    CGAL_Ray_2_Iso_rectangle_2_pair<TestR> pair(&ray, &rect);
    switch (pair.intersection_type()) {
    case CGAL_Ray_2_Iso_rectangle_2_pair<TestR>::SEGMENT:
	...
	cout<<'\n';
	break;
    case CGAL_Ray_2_Iso_rectangle_2_pair<TestR>::POINT:
	cout<<"Point intersection.\n";
	pair.intersection(point);
	print(point);
	cout<<'\n';
	break;
    case CGAL_Ray_2_Iso_rectangle_2_pair<TestR>::NO:
