...
typedef CGAL::Surface_mesher::Surface_mesher_manifold<Del, Oracle, Criteria, SMREWBB> SMMWB;
...
int main(int argc, char **argv) {
  ...
  // Meshing criteria
  CGAL::Surface_mesher::Curvature_size_criterion<Del> c_s_crit (1000);
  CGAL::Surface_mesher::Uniform_size_criterion<Del> u_s_crit (5e-2);
  //CGAL::Surface_mesher::Uniform_size_criterion<Del> u_s_crit (10000);
  CGAL::Surface_mesher::Aspect_ratio_criterion<Del> a_r_crit (30);
  std::vector<Criterion*> crit_vect(3);
  crit_vect[0] = &c_s_crit;
  crit_vect[1] = &u_s_crit;
  crit_vect[2] = &a_r_crit;
