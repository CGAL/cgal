% +------------------------------------------------------------------------+
% | Reference manual page: Complex2InTriangulation3.tex
% +------------------------------------------------------------------------+
% | 02.12.2005   Author
% | Package: Package
% | 
...
\ccConstructor{Complex2InTriangulation3();}{default constructor.}
...
%% \ccIncludeExampleCode{Package/Complex2InTriangulation3.C}
