...
% cross references between manuals not currently possible and you surely
% don't want the ... page# format here in the ps version.
...
%    \ccRefConceptPage{Kernel::Orientation_2}.}
  ...
  \ccNestedType{FT}{model for FieldNumberType.}
  
  \ccNestedType{Point_2}{model for Kernel::Point\_2.}
  
  \ccNestedType{Compute_squared_distance_2}{model for
    Kernel::ComputeSquaredDistance\_2.}
  
  \ccNestedType{Less_xy_2}{model for Kernel::LessXY\_2.}
  
  \ccNestedType{Orientation_2}{model for Kernel::Orientation\_2.}
