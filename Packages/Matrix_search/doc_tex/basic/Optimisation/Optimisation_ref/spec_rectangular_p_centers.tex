...
\begin{ccRefFunction}{rectangular_p_center_2}
  ...
  \ccRefIdfierPage{\ccPureGlobalScope Rectangular_p_center_default_traits_2<R>}\\
  \ccRefIdfierPage{\ccPureGlobalScope sorted_matrix_search}
...
\begin{ccRefClass}{Rectangular_p_center_default_traits_2<R>}
  ...
  \ccSeeAlso
  \ccRefIdfierPage{\ccPureGlobalScope rectangular_p_center_2}
