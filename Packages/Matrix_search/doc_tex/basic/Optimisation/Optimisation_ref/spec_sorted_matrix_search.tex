...
\clearpage\begin{ccAdvanced}
  ...
  \ccHtmlNoClassToc\begin{ccHtmlClassFile}{sorted_matrix_search.html}
    {Function Declaration of \ccc{sorted_matrix_search}}
    \ccTexHtml{}{
      <H3>Sorted Matrix Search</H3>
      
      This section describes a function
      <i>sorted_matrix_search</I> to select the smallest entry in
    ...
    \ccc{sorted_matrix_search} to compute the upper bound for the
  ...
  \ccHtmlNoClassToc\ccHtmlNoClassIndex\begin{ccClass}{Sms_traits}
    ...
    adaptor \ccc{Sorted_matrix_search_traits_adaptor} to create
  ...
  \begin{ccClassTemplate}{Sorted_matrix_search_traits_adaptor<F,M>}
    ...
    \ccConstructor{Sorted_matrix_search_traits_adaptor<F,M>(
