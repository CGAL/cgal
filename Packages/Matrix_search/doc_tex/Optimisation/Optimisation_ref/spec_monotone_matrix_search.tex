...
\clearpage\begin{ccAdvanced}
  ...
  \begin{ccHtmlClassFile}{monotone_matrix_search.html}
    {Function Declaration of \ccc{monotone_matrix_search}}
    \ccTexHtml{}{
  ...
  \ccHtmlNoClassToc\ccHtmlNoClassIndex\begin{ccClass}{Mms_matrix}
    ...
    \item There is an adaptor \ccc{Dynamic_matrix} (see section
  ...
  \ccHtmlNoClassToc
  \begin{ccClassTemplate}{Dynamic_matrix<M>}
