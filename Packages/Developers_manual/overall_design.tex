...
\cgal\ currently provides three models for the \cgal\ kernel
...
the \ccAnchor{http://www.mpi-sb.mpg.de/GALIA/Members/Manual/doc_html/ref-manual3/contents.html}{Support Library Reference Manual} and contains packages
