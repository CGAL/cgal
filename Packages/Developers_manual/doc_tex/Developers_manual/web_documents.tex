...
\begin{itemize}
   ...
   \item \ccAnchor{http://www-sop.inria.fr/geometrica/CGAL/Members/Releases/}{Internal release page}
   \begin{ccTexOnly} 
      --- \path|http://www-sop.inria.fr/geometrica/CGAL/Members/Releases/|
   \end{ccTexOnly}

   \item \ccAnchor{http://www-sop.inria.fr/geometrica/CGAL/Members/testsuite/}{Test suite results}
   \begin{ccTexOnly}
