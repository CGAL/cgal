...
\ccChapterAuthor{Matthias B\"asken ({\tt baesken@infsn2.informatik.uni-halle.de})}
...
{test suite results} 
page 
\lcTex{(\path|http://www-sop.inria.fr/geometrica/CGAL/Members/testsuite/|)}.
