...
use without \ccc{std::} qualification. Whenever a platform does not
put names into namespace \ccc{std}, \cgal\ adds the names it needs to
namespace \ccc{std}. This is done by the configuration tools.
...
\ccIncludeExampleCode{Developers_manual/kl.C}
...
\ccIncludeExampleCode{Developers_manual/poi.C}
