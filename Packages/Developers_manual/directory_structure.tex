...
\index{version file@{\tt version} file}\ccIndexMainItem{\tt changes.txt}\ccIndexMainItem{\tt description.txt}
...
\begin{description}
  ...
  \item[{\tt doc\_tex}]\index{doc_tex directory@{\tt doc\_tex} directory}
       ...
       the documentation.
  \item[{\tt doc\_ps}]\index{doc_ps directory@{\tt doc\_ps} directory}
...
\ccAnchor{http://www.cs.uu.nl/CGAL/Members/Develop/updates/packages.html}{packages web page} only; they are not
  ...
  \item[\ccAnchor{example/maintainer}{{\tt maintainer}}]%
       \ccIndexSubitem{\tt maintainer}{file}
...
\begin{description}
 ...
 \item[\ccAnchor{example/doc_tex/basic/Package/Package_ref/main_tex}{{\tt Optimisation\_ref/main.tex}}]
...
run by the test suite.\ccIndexSubitem{test suite}{demos in}
