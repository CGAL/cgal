...
\epsffile{pictures/reference_counting.eps}
\end{center}
}
...
\lcTex{
\begin{center}
\leavevmode\epsfxsize=7cm\epsffile{pictures/handle_rep.eps}
\end{center}
}
...
\lcTex{
\begin{center}
\leavevmode\epsfxsize=13.5cm\epsffile{pictures/handle_allocate.eps}
\end{center}
}
