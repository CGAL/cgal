...
\ccIndexMainItem{reference counting} scheme for 
...
\epsffile{reference_counting.eps}
\end{center}
}
...
\lcRawHtml{
<CENTER>
<IMG BORDER=0 SRC="images/reference_counting.gif" ALT="Reference counted objects"><BR>
</CENTER>
}
\end{figure}
...
\lcTex{
\begin{center}
\leavevmode\epsfxsize=7cm\epsffile{handle_rep.eps}
\end{center}
}
\caption{UML class diagram for Handle \& Rep scheme.\label{fig:HandleRep}}
\lcRawHtml{
<CENTER>
<IMG BORDER=0 SRC="images/handle_rep.gif" ALT="Handle & Rep UML class diagram"><BR>
</CENTER>
}
\end{figure}
...
\lcTex{
\begin{center}
\leavevmode\epsfxsize=13.5cm\epsffile{handle_allocate.eps}
\end{center}
}
\caption{UML diagram for templated handles.\label{fig:HandleFor}}
\lcRawHtml{
<CENTER>
<IMG BORDER=0 SRC="images/handle_allocate.gif" ALT="Templated handles UML diagram"><BR>
</CENTER>
}
\end{figure}
...
parameter defined in \ccc{CGAL/memory.h}. But you can also choose your
own, for example
