...
\index{C standard library!and namespace std@and namespace \texttt{std}}
functions. 
...
\ccc{std::} qualification. Whenever a platform does not put names in namespace
\ccc{std}, \cgal\ adds the names it needs to namespace \ccc{std}. This
