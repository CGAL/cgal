...
% -----------------------------------------------------------------------------
\section{Categories of checks} 
\label{sec:checks_categories}
...
% -----------------------------------------------------------------------------
\section{Using checks}
\label{sec:checks_using}
...
To enable expensive and exactness checks, respecitively, the compile-time 
...
% -----------------------------------------------------------------------------
\section{Controlling checks at a finer granularity}
\label{sec:checks_controlling}
...
with all macro definitions.
This is done with the shell script.
...
Recommendations:
\begin{itemize}
   \item Make all checks arguments of the appropriate preprocessor
         macros (Sections~\ref{sec:checks_using} 
