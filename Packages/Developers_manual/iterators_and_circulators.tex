...
the \ccAnchor{http://www.cgal.org/Manual/doc_html/ref-manual3/contents.html}{\cgal\ Support Library Reference Manual}. 
...
and in the
\ccAnchor{http://www.cgal.org/Manual/doc_html/use_of_stl/contents.html}{Use of \stl\ and \stl\ Extensions in \cgal\ } manual (which also
...
%the \ccAnchor{http://www.cgal.org/Manual/doc_html/ref-manual3/contents}{\cgal\ Support Library Reference Manual}. 
%\ccIndexMainItemEnd{handles}
...
See the \ccAnchor{http://www.cgal.org/Manual/doc_html/ref-manual3/Circulator/Chapter_circulator.html}{Circulator documentation} in the
