...
\begin{itemize}
   \item \ccAnchor{http://www.cs.uu.nl/CGAL/Members/Develop/}{The CGAL Developers' pages}
   \begin{ccTexOnly}
   ...
   \item \ccAnchor{http://www.mpi-sb.mpg.de/GALIA/Members/Manual}{Current Manuals}
   \begin{ccTexOnly}
     --- \path|http://www.mpi-sb.mpg.de/GALIA/Members/Manual|
   \end{ccTexOnly}

   \item \ccAnchor{http://www.mpi-sb.mpg.de/GALIA/Members/Develop/locals.html}{Links to Local CGAL pages}
   \begin{ccTexOnly}
