...
operations from \ccc{PM_const_decorator}. \ccc{Explorer} additionally
...
\begin{ccTexOnly}
\begin{center}
\scalebox{0.5}{\includegraphics{Nef_2_ref/extsegs.eps}}
\end{center}
\end{ccTexOnly}
...
\ccInheritsFrom{Const\_decorator}        
...
\ccc{Explorer} is copy constructable and assignable. An object
