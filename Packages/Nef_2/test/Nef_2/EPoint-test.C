  ...
  CGAL_TEST_START;
{
  ...
  CGAL_TEST(D.construct_direction(D.NW(),D.NE())==ED(1,0));
  CGAL_TEST(D.construct_direction(D.NE(),D.NW())==ED(-1,0));
  CGAL_TEST(D.construct_direction(D.SW(),D.NE())==ED(1,1));
  CGAL_TEST(D.construct_direction(D.NW(),D.SE())==ED(1,-1));
  CGAL_TEST(D.construct_direction(D.NW(),D.SW())==ED(0,-1));
  CGAL_TEST(D.construct_direction(D.SW(),D.NW())==ED(0,1));

  CGAL_TEST(D.construct_direction(eps5,D.NE())==ED(1,1));
  CGAL_TEST(D.construct_direction(eps5,D.SW())==ED(-1,-1));
