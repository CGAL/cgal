...
#line 1428 "RPolynomial.lw"
  RP::NT seq[4] = { 0, 1, 2, 0 };
  RP p1, p2(NT(1)), p3(NT(1),NT(1)), p4(5,2), p5(-2,5), p6(4,1), 
     p7(3,0), p8(seq,seq+4 MSC_HACK_ARGINS);
  ...
  CGAL_TEST((p4*p5) == RP(prod,prod+3 MSC_HACK_ARGINS));
  CGAL_TEST((p2*p3) == p3);
  MSCCAST(r1)+p3;
  p3+MSCCAST(r1);
