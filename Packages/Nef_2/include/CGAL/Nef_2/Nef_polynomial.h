...
template <class NT> double to_double(const ::CGAL::Nef_polynomial<NT>& p) { 
  return CGAL::to_double(p.eval_at(CGAL::Nef_polynomial<NT>
                                       ::infi_maximal_value()));
}

inline
double to_double(const Nef_polynomial<int>& p) { 
  return CGAL::to_double(p.eval_at(CGAL::Nef_polynomial<int>
				       ::infi_maximal_value()));
}

inline
double to_double(const Nef_polynomial<double>& p) { 
  return CGAL::to_double(p.eval_at(CGAL::Nef_polynomial<double>
				       ::infi_maximal_value()));
}
