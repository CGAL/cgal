...
% Concept: Width_traits_3
% -----------------------------------------------------------------------------
% file  : doc_tex/basic/Optimisation/Optimisation_ref/Width_traits_3.tex
...
\begin{ccRefConcept}{Width_traits_3}
...
\ccSaveThreeColumns
\ccSetTwoColumns{Width_traits_3:: ChullTraits;}{}
...
\ccNestedType{ChullTraits}{The traits class for using the convex hull
  algorithm. This class is only used, if the width is computed from a set
  of points.}
...
\ccRefIdfierPage{CGAL::Width_default_traits_3<R>}
