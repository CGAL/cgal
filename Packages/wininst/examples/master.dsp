...
# ADD LINK32 cgal.lib gmp.lib user32.lib gdi32.lib comdlg32.lib shell32.lib advapi32.lib /nologo /subsystem:console /machine:I386 /libpath:"$(CGALROOT)/lib/msvc/visual/Release" /libpath:"$(CGALROOT)/auxiliary/wingmp/gmp-4.0.1/msvc"
...
# ADD LINK32 cgal.lib gmp.lib user32.lib gdi32.lib comdlg32.lib shell32.lib advapi32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(CGALROOT)/lib/msvc/visual/Debug" /libpath:"$(CGALROOT)/auxiliary/wingmp/gmp-4.0.1/msvc"
