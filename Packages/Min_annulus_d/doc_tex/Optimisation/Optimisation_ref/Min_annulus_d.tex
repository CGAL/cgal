...
The template parameter \ccc{Traits} is a model for \ccc{Min_annulus_d_traits}.

We provide the models \ccc{Min_annulus_d_traits_2},
\ccc{Min_annulus_d_traits_3}, and \ccc{Min_annulus_d_traits_d} using the
...
\ccRefIdfierPage{\ccPureGlobalScope Min_sphere_d<Traits>}\\[1ex]
...
might take up to linear time.  The clear operation and the check for
validity each take linear time.
