...
// release_date  :
//
// file          : include/CGAL/Triangulation_handles.h
// revision      : $Revision$
...
#ifndef CGAL_TRIANGULATION_HANDLES_H
#define CGAL_TRIANGULATION_HANDLES_H
...
class CGAL_Triangulation_vertex_handle
  :public CGAL_Pointer<CGAL_Triangulation_vertex<Gt,Tds> > 
{
public:
  typedef CGAL_Pointer<CGAL_Triangulation_vertex<Gt,Tds> > Pointer;
  ...
  inline 
  CGAL_Triangulation_vertex_handle()
    : Pointer(NULL)
  {}

  inline  
  CGAL_Triangulation_vertex_handle(const Vertex* v)
    : Pointer((Vertex*)v)
    {}

  inline  
  CGAL_Triangulation_vertex_handle(const Vertex_iterator & vit)
    : Pointer(&(*vit))
    {}
...
class CGAL_Triangulation_cell_handle
  :public CGAL_Pointer<CGAL_Triangulation_cell<Gt,Tds> > 
{
public:
  typedef CGAL_Pointer<CGAL_Triangulation_cell<Gt,Tds> > Pointer;
  ...
  inline 
  CGAL_Triangulation_cell_handle()
    : Pointer(NULL)
  {}

  inline  
  CGAL_Triangulation_cell_handle(const Cell* c)
    : Pointer((Cell*)c)
  {}

  inline  
  CGAL_Triangulation_cell_handle(const Cell_iterator & cit)
    : Pointer(&(*cit))
  {}
  
  inline  
  CGAL_Triangulation_cell_handle(const Cell_circulator & ccir)
    : Pointer(&(*ccir))
  {}
...
#endif CGAL_TRIANGULATION_HANDLES_H
