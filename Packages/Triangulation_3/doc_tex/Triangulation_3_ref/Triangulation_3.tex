...
\ccNestedType{All_cells_iterator}{iterator over cells}
\ccGlue
\ccNestedType{All_facets_iterator}{iterator over facets}
\ccGlue
\ccNestedType{All_edges_iterator}{iterator over edges}
\ccGlue
\ccNestedType{All_vertices_iterator}{iterator over vertices}
