...
\ccThree{Verte____}{tds.insert_in_facet()}{}
...
\ccMethod{Vertex_handle insert_in_cell(Vertex_handle v, Cell_handle c);} 
...
\ccMethod{Vertex_handle insert_in_facet(Vertex_handle v, const Facet & f);} 
...
\ccMethod{Vertex_handle insert_in_facet(Vertex_handle v, Cell_handle c, int i);} 
...
\ccMethod{Vertex_handle insert_in_edge(Vertex_handle v, Edge e);} 
...
\ccMethod{Vertex_handle insert_in_edge(Vertex_handle v, Cell_handle c, int i, int j);} 
...
\ccMethod{Vertex_handle insert_increase_dimension(
			Vertex_handle v, 
...
\ccMethod{void remove_degree_dplus1(Vertex_handle v, Cell_handle f = NULL);}
