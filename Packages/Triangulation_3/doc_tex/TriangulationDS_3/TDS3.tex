...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{TriangulationDS_3/repres.eps}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{TriangulationDS_3/topo-simplex4.eps}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{TriangulationDS_3/topo-simplex3.eps}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{TriangulationDS_3/topo-simplex2.eps}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{TriangulationDS_3/comborient.eps} 
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=14cm]{TriangulationDS_3/design_tds.eps}
\end{center}
\end{ccTexOnly}
