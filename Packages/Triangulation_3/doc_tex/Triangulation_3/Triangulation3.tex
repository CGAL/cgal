...
\ccPrecond{\ccVar.\ccc{dimension()} $=3$ and \ccc{c} is incident to
\ccc{e}.}}
...
\ccPrecond{\ccVar.\ccc{dimension()} $\geq 2$ and \ccc{f} is incident to
\ccc{e}.}\\ 
\textit{not yet implemented}}
\ccGlue
...
\ccVar.\ccc{dimension()} $<3$ then the returned set is empty. \\
...
\ccVar.\ccc{number_of_vertices()} $<1$ then the set is empty.
...
\ccc{Triangulation_vertex_3<Traits,Tds>} } 
...
\protect\ccc{Delaunay_triangulation_3<Traits,Tds>} }  
...
segment with endpoints \ccc{p} and \ccc{q}.
	...
	\subsection{The Class \protect \ccc{Triangulation_geom_traits_3<R>}}
...
\ccc{Regular_triangulation_euclidean_traits_3<R,Weight>} }
...
\ccMethod{Weight weight() const;}{}
		...
		\subsubsection{The class \protect\ccc{Weighted\_point<Point,Weight>}}
