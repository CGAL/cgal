...
\ccRefConceptPage{Weighted_pt}

\subsection*{Classes}

\subsubsection*{Main classes}

\ccRefIdfierPage{CGAL::Triangulation_3<TriangulationTraits_3,Tds_3>}

\ccRefIdfierPage{CGAL::Delaunay_triangulation_3<DelaunayTriangulationTraits_3,Tds_3>}\\
\ccRefIdfierPage{CGAL::Triangulation_hierarchy_3<Tr>}\\
\ccRefIdfierPage{CGAL::Regular_triangulation_3<RegularTriangulationTraits_3,Tds_3>}
...
\ccRefIdfierPage{CGAL::Triangulation_3<TriangulationTraits_3,Tds_3>::Vertex}\\
\ccRefIdfierPage{CGAL::Triangulation_3<TriangulationTraits_3,Tds_3>::Cell}
