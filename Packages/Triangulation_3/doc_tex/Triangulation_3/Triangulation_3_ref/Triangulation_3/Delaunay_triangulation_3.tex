...
\begin{ccRefClass}{Delaunay_triangulation_3<DelaunayTriangulationTraits_3,Tds_3>}  %% add template arg's if necessary
...
\ccInheritsFrom{\ccc{Triangulation_3<DelaunayTriangulationTraits_3,Tds_3>}}

\ccTypes

Inherits the types of \ccc{Triangulation_3<DelaunayTriangulationTraits_3,Tds_3>}.
...
\ccConstructor{Delaunay_triangulation_3<DelaunayTriangulationTraits_3,Tds_3>()}
...
\ccConstructor{Delaunay_triangulation_3<DelaunayTriangulationTraits_3,Tds_3>
(const Delaunay_triangulation_3<DelaunayTriangulationTraits_3,Tds_3> & dt1)}
{Copy constructor.}
