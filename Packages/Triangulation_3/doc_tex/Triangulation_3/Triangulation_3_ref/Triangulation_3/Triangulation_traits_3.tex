...
\ccNestedType{Less_distance_to_point_3}{Predicate object.
Must provide a constructor taking a \ccc{Point p} as argument, as well as an
\ccc{bool operator()(Point q, Point r)} returning true iff \ccc{q} is closer
to \ccc{p} than \ccc{r} is.}
