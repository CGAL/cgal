...
\begin{ccRefClass}{Triangulation_3<Triangulation_traits_3,Tds_3>}  %% add template arg's if necessary
...
\ccThree{typedef Triangulation_traits_3::Tetrahedron Tetrahedron;}
{Tetrahedron}{}
\ccThreeToTwo

\ccTypedef{typedef Tds_3 Triangulation_data_structure;}{}
\ccGlue
\ccTypedef{typedef Triangulation_traits_3 Geom_traits;}{}

\ccTypedef{typedef Triangulation_traits_3::Point_3 Point;}{}
\ccGlue
\ccTypedef{typedef Triangulation_traits_3::Segment_3 Segment;}{}
\ccGlue
\ccTypedef{typedef Triangulation_traits_3::Triangle_3 Triangle;}{}
\ccGlue
\ccTypedef{typedef Triangulation_traits_3::Tetrahedron_3 Tetrahedron;}{}
...
\ccThree{Triangulation_3<Triangulation_traits_3,Tds_3>}{Facet }{}

\ccConstructor{Triangulation_3<Triangulation_traits_3,Tds_3>
(const Triangulation_traits_3 & traits );}
{Introduces a triangulation \ccVar\ having only one vertex which is the
infinite vertex.} 

\ccConstructor{Triangulation_3<Triangulation_traits_3,Tds_3>(const
Triangulation_3<Triangulation_traits_3,Tds_3> & tr);} 
...
\ccMethod{Triangulation_3<Triangulation_traits_3,Tds_3>
	operator=(const Triangulation_3<Triangulation_traits_3,Tds_3> & tr);}
...
\ccMethod{void copy_triangulation
		(const Triangulation_3<Triangulation_traits_3,Tds_3> & tr);}
{The triangulation is duplicated.}

The previous two methods are equivalent.

\ccMethod{void swap(Triangulation_3<Triangulation_traits_3,Tds_3> & tr);}
...
\ccMethod{const Triangulation_traits_3 & geom_traits() const;}
{Returns a const reference to the geometric traits object.}
\ccGlue
\ccMethod{const Tds_3 & tds() const;}
...
\ccc{Triangulation_cell_3<Triangulation_traits_3,Tds_3>}. 
...
\ccMethod{void incident_cells(Vertex_handle v, 
		set<Cell_handle, less<Cell_handle> > & cells,
...
\ccMethod{void incident_vertices(Vertex_handle v, 
		set<Vertex_handle, less<Vertex_handle> > & vertices,
		Cell_handle c = NULL ) const;}
...
\ccc{is_valid} method of the \ccc{Tds_3} cell class. Also checks the
...
(istream& is, Triangulation_3<Triangulation_traits_3, Tds_3> &t);}
...
(ostream& os, const Triangulation_3<Triangulation_traits_3, Tds_3> &t);}
