% +------------------------------------------------------------------------+
% | Reference manual page: Triangulation_vb_3.tex
% +------------------------------------------------------------------------+
...
\begin{ccRefConcept}{Triangulation_vb_3}
...
\ccConstructor{Triangulation_vb_3();}
{Default constructor}
\ccGlue
\ccConstructor{Triangulation_vb_3(const Point & p);}
...
\ccGlue
\ccConstructor{Triangulation_vb_3(void* c);}
...
(istream& is, Triangulation_vb_3 & v);}
