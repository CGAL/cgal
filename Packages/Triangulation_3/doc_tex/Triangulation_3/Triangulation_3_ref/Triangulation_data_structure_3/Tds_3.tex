...
\begin{ccRefConcept}{Tds_3<Vb,Fb>}
...
data structure class (see Section~\ref{TDS3-sec-concept} of
...
\ccThree{Tds_3<Vb,Fb>}{tds.set_number_of_vertices()}{}

\ccConstructor{Tds_3<Vb,Fb>();}
{A default constructor.}

\ccConstructor{Tds_3<Vb,Fb>(const Tds_3 & tds1);}
{Copy constructor. All the vertices and cells are duplicated.}

\ccMethod{Tds_3<Vb,Fb> operator = (const Tds_3 & tds1);}
