...
\ccChapterAuthor{Andreas Fabri, Sylvain Pion, Monique Teillaud}

\begin{ccTexOnly}
%\vspace*{-1cm}
\begin{center}
\includegraphics[width=6cm]{Triangulation_3/grid.eps} \hspace*{2cm} 
\includegraphics[width=6cm]{Triangulation_3/sphere.eps} 
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{Triangulation_3/orient.eps} 
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{Triangulation_3/ortho.eps} 
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center} 
\includegraphics{Triangulation_3/derivation.eps} 
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=13cm]{Triangulation_3/concept_hierarchy.eps}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\includegraphics[width=13cm]{Triangulation_3/design.eps}
\end{center}
\end{ccTexOnly}
...
degenerate cases quite easily \cite{dt-pvr3d-03}. Andreas Fabri
...
\cite{bdpty-tc-02}: he implemented the Delaunay hierarchy
\cite{d-dh-02} in 2.3, he improved the memory footprint in 2.4 and
3.0, he also performed work on arithmetic filters \cite{dp-eegpd-03}
