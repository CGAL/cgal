...
\ccNestedType{Finite_cell_iterator}{iterator over finite cells}
\ccGlue
\ccNestedType{Finite_facet_iterator}{iterator over finite facets}
\ccGlue
\ccNestedType{Finite_edge_iterator}{iterator over finite edges}
\ccGlue
\ccNestedType{Finite_vertex_iterator}{iterator over finite vertices}
...
\ccMethod{Finite_vertex_iterator finite_vertices_begin() const;}
...
\ccGlue
\ccMethod{Finite_vertex_iterator finite_vertices_end() const;}
...
\ccMethod{Finite_edge_iterator finite_edges_begin() const;}
...
\ccGlue
\ccMethod{Finite_edge_iterator finite_edges_end() const;}
{Past-the-end iterator}
\ccGlue
...
\ccMethod{Finite_facet_iterator finite_facets_begin() const;}
...
\ccGlue
\ccMethod{Finite_facet_iterator finite_facets_end() const;}
{Past-the-end iterator}
\ccGlue
...
\ccMethod{Finite_cell_iterator finite_cells_begin() const;}
...
\ccGlue
\ccMethod{Finite_cell_iterator finite_cells_end() const;}
{Past-the-end iterator}
\ccGlue
