...
\begin{ccRefClass}{Triangulation_vertex_base_3<TriangulationTraits_3, TriangulationDSVertexBase_3>}  %% add template arg's if necessary
...
\ccc{CGAL::Triangulation_cell_base_3<TriangulationTraits_3,TriangulationDSCellBase_3>}.
