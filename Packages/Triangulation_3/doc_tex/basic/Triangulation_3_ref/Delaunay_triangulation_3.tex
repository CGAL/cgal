...
{Removes the vertex \ccc{v} from the triangulation.\footnote{In {\sc Cgal} 3.0
we have implemented a new algorithm for retriagulating the hole after the removal.
