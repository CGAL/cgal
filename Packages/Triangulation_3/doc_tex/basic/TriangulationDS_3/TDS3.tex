...
to a cell, and a cell has four pointers to vertices and four pointers to cells.
These pointers are of type \ccc{void*}.
...
cell has four pointers to vertices. These pointers are \emph{handles}.
The triangulation data structure provides
