...
\ccThree{TriangulationDataStructure_3;}{tds.set_number}{}
\ccThreeToTwo
...
\ccThree{Vertex_handle_}{tds.insert_in_facet()xxxxx}{}
...
{Calls \ccc{delete_vertex} over an iterator range.}
...
\ccc{CGAL::Triangulation_data_structure_3<TriangulationDSVertexBase_3,TriangulationDSCellBase_3>}.
