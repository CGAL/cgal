...
\begin{ccRefClass}[Triangulation_3<TriangulationTraits_3,Tds_3>::]{Cell}  %% add template arg's if necessary
...
\ccc{Triangulation_3<TriangulationTraits_3,Tds_3>::Vertex} class.
...
\ccConstructor{Triangulation_cell_3<TriangulationTraits_3,Tds_3>();}
...
\ccc{CGAL::Triangulation_3<TriangulationTraits_3,Tds_3>::Vertex}.
