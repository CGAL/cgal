...
From now on, we will thus consider the triangulation data structure as
...
\ccThree{Tds_3<Triangulation_vb_3,Triangulation_cb_3>();}{tds.set_number_of_vertices()}{}

\ccConstructor{Tds_3<Triangulation_vb_3,Triangulation_cb_3>();}
{A default constructor.}

\ccConstructor{Tds_3<Triangulation_vb_3,Triangulation_cb_3>(const Tds_3 & tds1);}
{Copy constructor. All the vertices and cells are duplicated.}

\ccMethod{Tds_3<Triangulation_vb_3,Triangulation_cb_3> operator = (const Tds_3 & tds1);}
{Assignment. All the vertices and cells are duplicated.}

The previous two methods are equivalent.

\ccThree{Tds_3<Tvb,Tcb>}{tds.set_number_of_vertices()}{}

\ccMethod{void swap(Tds_3 & tds1);} 
...
\ccMethod{Vertex* copy_tds(const Tds_3 & tds1, Vertex* v = NULL);}
...
\ccc{Delaunay_triangulation_3<Triangulation_traits_3,Tds_3>}, the triangulation
...
\ccc{CGAL::Triangulation_data_structure_3<Triangulation_vb_3,Triangulation_cb_3>}.
