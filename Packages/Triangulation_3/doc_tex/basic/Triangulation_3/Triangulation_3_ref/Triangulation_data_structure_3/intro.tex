...
\ccRefIdfierPage{CGAL::Triangulation_data_structure_3<Vb,Cb>}

This class is a model for the concept of the 3D-triangulation data structure
\ccc{Tds_3<Vb,Cb>} and provides the optional
