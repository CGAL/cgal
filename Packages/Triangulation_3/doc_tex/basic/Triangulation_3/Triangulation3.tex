...
\ccTypedef{typedef Traits::Point Point;}{Point}
\ccGlue
\ccTypedef{typedef Traits::Segment Segment;}{Segment}
\ccGlue
\ccTypedef{typedef Traits::Triangle Triangle;}{Triangle}
\ccGlue
\ccTypedef{typedef Traits::Tetrahedron Tetrahedron;}{Tetrahedron}
...
\ccTypedef{typedef typename Traits::Point Point;}{point type}
\ccGlue
\ccTypedef{typedef typename Tds::Vertex Vtds;}{vertex of the triangulation data structure}
\ccGlue
