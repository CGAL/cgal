...
\ccRefPage{TriangulationTraits_3}} and the homogeneous and Cartesian
...
The kernels provided by CGAL~: \ccc{Cartesian<R>}, \ccc{Homogeneous<R>},
\ccc{Simple_cartesian<R>}, \ccc{Simple_homogeneous<R>}, can all be used as
models for the geometric traits parameter.
...
structure is \ccc{Triangulation_data_structure_3<TriangulationVertexBase_3,
TriangulationCellBase_3>}\lcTex{ 
...
needs not be specified by the user. 
