...
(The homogeneous kernel is used in the additional test with other
implementations described in Section~\ref{sec:other_implementations}.)
...
@macro <Min_sphere_d test: typedefs> += @begin
    ...
    // comparing (needs LEDA)
      ...
      typedef  CGAL::@2_traits_@1<R_3>    Traits_3;
      typedef  CGAL::Min_sphere_d<Traits_1>              Min_sphere_d;
      typedef  CGAL::@2<Traits_3>        O_Min_sphere_d;
    #endif
@end
