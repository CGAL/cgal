...
//
// file          : test/Min_sphere_d_new/test_Min_sphere_d_3.C
...
//
// implementation: test program for smallest enclosing sphere (3D traits class)
// ============================================================================
...
// comparing (needs LEDA)
  ...
  typedef  CGAL::Optimisation_d_traits_3<R_3>  Traits_3;
