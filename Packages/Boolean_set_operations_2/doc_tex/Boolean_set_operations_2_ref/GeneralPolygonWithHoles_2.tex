...
contained inside the outer boundary, and the outer boundary and the outer 
boundary of the holes must be pairwise disjoint, except perhaps at the 
vertices.}
...
\ccc{CGAL::Gps_segment_traits_2<Kernel,Container,ArrSegmentTraits>::Polygon_with_holes_2}\\
