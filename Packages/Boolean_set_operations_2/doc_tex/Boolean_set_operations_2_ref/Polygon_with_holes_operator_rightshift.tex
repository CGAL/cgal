...
polygon with holes from the input stream \ccc{in}. If the stream \ccc{in} 
does not contain a permissible polygon with hols, a general polygon, or a 
general polygon with holes, the \ccc{ios::badbit} of the input stream 
\ccc{in} is set and $P$ remains unchanged.
