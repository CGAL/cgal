...
\ccc{CGAL::do_intersect}
  {\lcRawHtml{<A HREF="Function_do_intersect.html">(go there)</A>}
   \lcTex{\dotfill page~\pageref{ref_bso_do_intersect}}}\\
\ccc{CGAL::intersection}
  {\lcRawHtml{<A HREF="Function_intersection.html">(go there)</A>}
   \lcTex{\dotfill page~\pageref{ref_bso_intersection}}}\\
\ccc{CGAL::join}
  {\lcRawHtml{<A HREF="Function_join.html">(go there)</A>}
   \lcTex{\dotfill page~\pageref{ref_bso_join}}}\\
\ccc{CGAL::difference}
  {\lcRawHtml{<A HREF="Function_difference.html">(go there)</A>}
   \lcTex{\dotfill page~\pageref{ref_bso_difference}}}\\
\ccc{CGAL::symmetric_difference}
  {\lcRawHtml{<A HREF="Function_symmetric_difference.html">(go there)</A>}
