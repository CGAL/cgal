...
polygons \ccc{pgn}, inserts the resulting polygons with
...
OutputIterator complement(const Polygon_2<Kernel, Container> & pgn,
                          OutputIterator oi);}
\ccGlue
\ccGlobalFunction{template <class Traits, class OutputIterator>
OutputIterator complement(const General_polygon_2<Traits> & pgn,
                          OutputIterator oi);}
\ccGlue
\ccGlobalFunction{template <class Traits, class OutputIterator>
