...
\ccNestedType{General_polygon_2}{represents a general polygon.}
\ccGlue
\ccNestedType{General_polygon_with_holes_2}{represents a general polygon
  with holes.}
...
\ccThree{Construct_general_polygon_2}{}{\hspace*{\ccwComment}}
\ccThreeToTwo
...
\ccMethod{Construct_general_polygon_2 construct_general_polygon_2_object();}
...
\ccPredicates
% ===========
\ccMethod{bool is_simple(General_polygon_2 & pgn);}
