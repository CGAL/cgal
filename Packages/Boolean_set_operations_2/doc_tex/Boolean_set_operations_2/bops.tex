...
\ccc{GeneralPolygonWithHoles_2}. A model of this concept represents a
set that may be bounded or unbounded. In case of a bounded set, its
{\em outer boundary} is represented as a simple (but not necessarily
strictly simple) polygon, whose vertices are oriented in a
counterclockwise order around the interior of the set. In addition,
the set may contain {\em holes}, where each hole is represented as a
strictly simple polygon, whose vertices are oriented in a clockwise
...
with vertices of the boundary.

The point set represented by a polygons with holes is considered to be
