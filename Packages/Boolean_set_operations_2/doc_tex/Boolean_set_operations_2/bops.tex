...
\ccIncludeExampleCode{../examples/Boolean_set_operations_2/example1.C}
...
\ccIncludeExampleCode{../examples/Boolean_set_operations_2/example2.C}
...
\ccIncludeExampleCode{../examples/Boolean_set_operations_2/example3.C}
...
access to the outer boundary, which is of \ccc{Polygon_2} type,
