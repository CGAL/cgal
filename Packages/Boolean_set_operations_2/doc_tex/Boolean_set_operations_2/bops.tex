...
\lcHtml{\label{fig:non_strictly_simple_polygon}}
\begin{ccHtmlOnly}
  <p><center>
...
other, a type of a simple polygon, namely \ccc{Polygon_2}, and a type of 
...
\ccc{Polygon_2}. The outer boundary could be empty, in which case the 
polygon is unbounded, and the number of holes could be zero. An unbounded
