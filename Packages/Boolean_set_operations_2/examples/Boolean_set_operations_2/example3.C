//! \file examples/Boolean_set_operations_2/example3.C
...
typedef CGAL::Gps_segment_traits_2                      Traits;
typedef CGAL::General_polygon_set_2<Traits>             Polygon_set;

int main(int argc, char * argv[])
{
  Polygon p1, p2, rect;
  p1.push_back(Point(0,1)); p1.push_back(Point(2,0));
  p1.push_back(Point(1,1)); p1.push_back(Point(2,2));
  p2.push_back(Point(3,1)); p2.push_back(Point(1,2));
  p2.push_back(Point(2,1)); p2.push_back(Point(1,0));
  p2.push_back(Point(0,0)); p2.push_back(Point(3,0));
  p2.push_back(Point(3,2)); p2.push_back(Point(0,2));
