...
\end{ccTexOnly}
\begin{ccTexOnly}
\caption{The {\em Vertex\_conflict\_2} predicate. The (unshaded) black
  circles define the tritangent gray circle. We want to determine if
  ...
  (unshaded) black circles. Left: the predicate returns {\em
  NEGATIVE}. Right: the predicate returns {\em
  POSITIVE}.\label{fig-ag2vertexconflict}}
\end{ccTexOnly}
\begin{ccHtmlOnly}
\caption{The {\em Vertex\_conflict\_2} predicate. The red circles define
  ...
  Left: the predicate returns {\em NEGATIVE}. Right: the predicate
  returns {\em POSITIVE}.\label{fig-ag2vertexconflict}}
\end{ccHtmlOnly}
\begin{ccHtmlOnly}
<center>
...
\end{ccTexOnly}
\begin{ccTexOnly}
\caption{The {\em Finite\_edge\_interior\_conflict\_2} predicate. The
...
class is nothing but the equivalent of the \ccc{Triangulation_hierarchy_2}
