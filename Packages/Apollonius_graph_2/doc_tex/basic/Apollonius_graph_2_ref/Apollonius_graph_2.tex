...
\ccThree{typedef typename Gt::Weighted_point}{Weighted_point+}{}
%
...
\ccGlue
\ccTypedef{typedef typename Gt::Bare_point Point;}{A type for the bare
point defined in the geometric traits.}
\ccGlue
\ccTypedef{typedef typename Gt::Weighted_point  Weighted_point;}
{A type for the weighted point defined in the geometric traits.}
\ccGlue
\ccTypedef{typedef typename Gt::Weight          Weight;}
...
\ccThree{typedef pair<Face_handle, int>}{}{the apollonius graph,
...
\ccc{Unidirectional Iterator}. The value type
\ccc{Input_iterator} must be \ccc{Gt::Weighted_point}.}}
%
...
After the assignement, \ccVar\ and \ccc{other} refer to different
Apollonius graphs~: if \ccc{other} is modified, \ccVar\ is not.}
...
The Apollonius graph also provides circulators that allows to visit 
...
\ccGlue
\ccMethod{Vertex_circulator incident_vertices(t.infinite_vertex()) ;} {}
\ccGlue
...
\ccHeading{Insertion}
\ccThree{Vertex_handle }{ag.insert(Weighted_point p)x}{}
%
...
\ccGlue
\begin{ccAdvanced}
\ccMethod{Vertex_handle insert(Weighted_point p, Vertex_handle
...
\ccThree{Vertex_handle }{ag.nearest_neighbor(Point p)+}{}
%
...
\ccThree{CGAL::Object}{ag.dual(Finite_edges_iterator ei)+}{}
%
\ccMethod{Point  dual(const Face_handle& f) const;}{Returns the
Apollonius vertex corresponding to the face handle \ccc{f}.
\ccPrecond{\ccc{f} must be a finite face.}}
\ccGlue
\ccMethod{CGAL::Object dual(Edge e);}{Returns the dual of
the edge \ccc{e}. The return type of this method can be one of the
...
\ccGlue
\ccMethod{CGAL::Object dual(const Edge_circulator& ec) const;}
{Returns the dual of the edge to which the edge circulator \ccc{ec}
points to. The return type of this method can be one of the
following~: \ccc{Gt::Line_2}, \ccc{Gt::Hyperbola_2}, \ccc{Gt::Ray_2},
\ccc{Gt::Hyperbola_ray_2}, \ccc{Gt::Segment_2},
\ccc{Gt::Hyperbola_segment_2}.
\ccPrecond{The edge corresponding to \ccc{ec} must be a finite edge.}}
\ccGlue
\ccMethod{CGAL::Object dual(const Finite_edges_iterator& ei) const;}
{Returns the dual of the edge to which the finite edge iterator
\ccc{ei} points to. The return type of this method can be one of the
following~: \ccc{Gt::Line_2}, \ccc{Gt::Hyperbola_2}, \ccc{Gt::Ray_2},
\ccc{Gt::Hyperbola_ray_2}, \ccc{Gt::Segment_2},
\ccc{Gt::Hyperbola_segment_2}.}
...
\ccc{Stream& operator<<(Stream&, Weighted_point)}.}
\ccGlue
\ccMethod{template < class Stream >
...
\ccGlue
\ccMethod{template < class Stream >
Stream& draw_hidden_weighted_points(Stream& str);}{Draws all
...
\ccGlue
\ccMethod{template < class Stream >
Stream& draw_hidden_weighted_point_centers(Stream& str);}{Draws
...
method does nothing.
\ccPrecond The following operator must be defined~:\\
\ccc{Stream& operator<<(Stream&, Point)}.}
\ccGlue
\ccMethod{template < class Stream >
Stream& draw_non_hidden_weighted_points(Stream& str);}{Draws all
non-hidden weighted points to the stream \ccc{str}.
\ccPrecond The following operator must be defined~:\\
\ccc{Stream& operator<<(Stream&, Weighted_point)}.}
\ccGlue
\ccMethod{template < class Stream >
Stream& draw_non_hidden_weighted_point_centers(Stream& str);}
{Draws the centers of all non-hidden weighted points to the stream
\ccc{str}.
\ccPrecond The following operator must be defined~:\\
\ccc{Stream& operator<<(Stream&, Point)}.}
\ccGlue
...
\begin{ccAdvanced}
\ccMethod{template < class Stream > 
Stream& draw_dual_weighted_points(Stream& str);}{Draws the
