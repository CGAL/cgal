...
\ccThree{typedef Data_structure::Finite_vertices_iterator}
{Finite_vertices_iterator+}{}
\ccGlue
\ccTypedef{typedef Data_structure::All_vertices_iterator
  All_vertices_iterator;}
{A type for an iterator over all vertices.}
\ccGlue
\ccTypedef{typedef Data_structure::Finite_vertices_iterator
  Finite_vertices_iterator;}
{A type for an iterator over finite vertices.}
\ccGlue
\ccTypedef{typedef Data_structure::All_faces_iterator
  All_faces_iterator;}
{A type for an iterator over all faces.}
\ccGlue
\ccTypedef{typedef Data_structure::Finite_faces_iterator
  Finite_faces_iterator;}
{A type for an iterator over finite faces.}
\ccGlue
\ccTypedef{typedef Data_structure::All_edges_iterator
  All_edges_iterator;}
{A type for an iterator over all edges.}
\ccGlue
\ccTypedef{typedef Data_structure::Finite_edges_iterator
...
\ccAccessFunctions
% MK:: in the following copy text from TDS
\ccThree{Vertex_handle}{ag.number_of_hidden_vertices()+}{}
%
