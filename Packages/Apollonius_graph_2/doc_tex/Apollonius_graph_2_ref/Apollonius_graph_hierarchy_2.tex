...
\ccc{Apollonius_graph_2<Gt,Agds>} class. At every
...
in the \ccc{Apollonius_graph_2<Gt,Agds>}. The second
...
an estimate for the nearest neighbor of the center of \ccc{s}. If
