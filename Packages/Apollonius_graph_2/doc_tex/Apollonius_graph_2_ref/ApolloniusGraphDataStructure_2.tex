...
vertex in the data structure. We only describe what are the additional 
...
vertex and the two faces adjacent to it. The copies of the edges the
star of \ccc{v} are collapsed.}
