...
it provides a type \ccc{Weighted_point}. It also provides
...
%
\ccNestedType{Bare_point}{A type for a non-weighted point.}
\ccGlue
\ccNestedType{Weighted_point}{A type for a weighted point.}
\ccGlue
\ccNestedType{Site}{Another name for the \ccc{Weighted_point} type.}
\ccGlue
...
%operator()(const Weighted_point& p, const Line_2& l, const Bare_point& 
%p1, const Bare_point& p2)} which constructs the a parabolic segment
...
%provide \ccc{operator()(const Weighted_point& p1, const
%Weighted_point& p2)} which constructs a hyperbola equidistant from the 
...
%Weighted_point& p1, const Weighted_point& p2, )} which constructs a hyperbola equidistant from the 
%weighted points \ccc{p1} and \ccc{p2}.}
\ccGlue
...
\ccc{Bare_point operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3)}, which constructs a
...
Must provide \ccc{Weighted_point operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3)}, which constructs an
weighted point whose center $c$ if equidistant from \ccc{p1}, \ccc{p2} and
\ccc{p3}, and its its weight is equal to the (signed) distance of $c$
...
operator()(Weighted_point p1, Weighted_point p2)}, which constructs
...
Must provide \ccc{CGAL::Object operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3)}
...
Must provide \ccc{CGAL::Object operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3, Weighted_point p4)}.
...
bisector. Must provide \ccc{Ray_2 operator()(Weighted_point p1,
Weighted_point p2, Weight_point p3)}, which constructs the
...
Must also provide \ccc{Parabola_segment_2 operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3)}, which constructs the parabolic
...
Must finally provide \ccc{Segment_2 operator()(Weighted_point p1,
Weighted_point p2)}, which constructs the (straight) segment defined
...
provide \ccc{Comparison_result operator()(Weighted_point p,
Weighted_point q)}, which compares the $x$-coordinates of
\ccc{p} and \ccc{q}.}
%
\ccGlue
\ccNestedType{Compare_y_2}{A predicate object type. Must
provide \ccc{Comparison_result operator()(Weighted_point p,
Weighted_point q)}, which compares the $y$-coordinates of
\ccc{p} and \ccc{q}.}
%
\ccGlue
\ccNestedType{Compare_weight_2}{A predicate object type. Must
provide \ccc{Comparison_result operator()(Weighted_point p,
Weighted_point q)}, which compares the weights of \ccc{p} 
and \ccc{q}.}
%
\ccGlue
\ccNestedType{Orientation_2}{A predicate object type. Must
provide \ccc{Orientation operator()(Weighted_point p,
Weighted_point q, Weighted_point r)}, which performs the
usual orientation test for the centers of the three weighted points
\ccc{p}, \ccc{q} and \ccc{r}.}
%
\ccGlue
\ccNestedType{Is_trivial_2}{A predicate object type. Must
provide \ccc{bool operator()(Weighted_point p,
Weighted_point q)}, which returns \ccc{true} if the circle
...
Must provide \ccc{Oriented_side operator()(Weighted_point p1,
Weighted_point p2, Bare_point q)}, which returns
...
Must provide \ccc{Sign operator()(Weighted_point p1, Weighted_point
p2, Weighted_point p3, Weighted_point q)}, which
...
\ccc{p3} must exist.}\\
Must also provide \ccc{Sign operator()(Weighted_point p1,
Weighted_point p2, Weighted_point q)}, which
...
type. Must provide \ccc{bool operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3, Weighted_point p4,
Weighted_point q, bool b)}. The weighted points \ccc{p1}, \ccc{p2},
...
%
Must also provide \ccc{bool operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3, Weighted_point q, bool b)}. The
...
\ccc{p3} must exist.}
%
Must finally provide \ccc{bool operator()(Weighted_point p1,
Weighted_point p2, Weighted_point q, bool b)}. The
...
object type. Must provide \ccc{bool operator()(Weighted_point p1,
Weighted_point p2, Weighted_point p3, Weighted_point q, bool b)}. The
...
Must provide \ccc{bool operator()(Weighted_point p1, Weighted_point
p2, Weighted_point p3, Weighted_point p4)}. It returns \ccc{true} if
...
\ccGlue
\ccMethod{Is_trivial_2 is_trivial_2_object();}{}
\ccGlue
