...
\ccc{Apollonius_graph_data_structure_2<Vb,Fb>} are models of the
...
\ccRefConceptPage{ApolloniusGraphFaceBase_2} \\
...
\ccRefIdfierPage{CGAL::Apollonius_graph_data_structure_2<Vb,Fb>}\\
