...
possible values for \ccc{Method_tag}, namely
\ccc{CGAL::Sqrt_fields_tag} and \ccc{CGAL::Ring_tag}. The first one
...
The template parameter must a model of \ccc{CGAL::Kernel}.
