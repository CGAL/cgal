...
In all cases, you have access to a global counter of failures
\ccc{Interval_nt_advanced::number_of_failures}, which is incremented
for each unsafe comparison.
