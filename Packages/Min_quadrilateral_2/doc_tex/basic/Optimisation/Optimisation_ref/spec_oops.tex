...
\begin{ccRefFunction}{min_rectangle_2}
  ...
  \ccSeeAlso
  \ccRefIdfierPage{\ccPureGlobalScope min_parallelogram_2}\\
  \ccRefIdfierPage{\ccPureGlobalScope min_strip_2}\\
  \ccRefIdfierPage{Min_quadrilateral_traits_2}\\
  \ccRefIdfierPage{\ccPureGlobalScope Min_quadrilateral_default_traits_2<R>}
...
\begin{ccRefFunction}{min_parallelogram_2}
  ...
  \ccSeeAlso
  \ccRefIdfierPage{\ccPureGlobalScope min_rectangle_2}\\
  \ccRefIdfierPage{\ccPureGlobalScope min_strip_2}\\
  \ccRefIdfierPage{Min_quadrilateral_traits_2}\\
  \ccRefIdfierPage{\ccPureGlobalScope Min_quadrilateral_default_traits_2<R>}
...
\begin{ccRefConcept}{Min_quadrilateral_traits_2}
  ...
  \ccNestedType{Parallelogram_2}{class used for representing
    parallelograms.}
  
  \ccNestedType{Strip_2}{class used for representing strips, that is
    the closed region bounded by two parallel lines.}
