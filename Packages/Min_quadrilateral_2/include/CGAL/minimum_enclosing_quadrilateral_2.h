...
#if ! (CGAL_MINIMUM_ENCLOSING_QUADRILATERAL_2_H)
...
//   in that order.
{
  ...
  // make sure that we have to distinct points, such that it
...
} // minimum_enclosing_rectangle_2( f, l, o , t)
template < class ForwardIterator, class OutputIterator, class Traits >
OutputIterator
...
} // minimum_enclosing_parallelogram_2(f, l, o , t)
template < class ForwardIterator, class OutputIterator, class Traits >
OutputIterator
                               ...
                               OutputIterator o)
{
  ...
  return minimum_enclosing_rectangle_2(f, l, o, t);
} // minimum_enclosing_rectangle_2(f, l, o)
template < class ForwardIterator, class OutputIterator >
inline
OutputIterator
minimum_enclosing_parallelogram_2( ForwardIterator f,
                               ...
                               OutputIterator o)
{
  ...
  typedef typename VT::R R;
  Minimum_enclosing_quadrilateral_default_traits_2< R > t;
  return minimum_enclosing_parallelogram_2(f, l, o, t);
} // minimum_enclosing_parallelogram_2(f, l, o)
template < class ForwardIterator, class OutputIterator >
inline
OutputIterator
minimum_enclosing_strip_2( ForwardIterator f,
