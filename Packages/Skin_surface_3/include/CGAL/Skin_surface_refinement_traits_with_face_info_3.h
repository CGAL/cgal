...
#ifndef SKIN_SURFACE_REFINEMENT_TRAITS_WITH_FACE_INFO_H
#define SKIN_SURFACE_REFINEMENT_TRAITS_WITH_FACE_INFO_H
...
public:
  ...
  Skin_surface_refinement_traits_with_face_info_3(
  ...
  Polyhedron_point to_surface_along_transversal_segment(
    ...
    Triang_cell_handle ch = vh->halfedge()->facet()->triang_ch;
...
#endif // SKIN_SURFACE_REFINEMENT_TRAITS_WITH_FACE_INFO_H
