...
#ifndef CGAL_MEAN_VALUE_COORDINATES_PARAMETIZER_3_H
#define CGAL_MEAN_VALUE_COORDINATES_PARAMETIZER_3_H
...
/// implements Floater's Mean Value Coordinates parameterization.
...
/// Mean_value_coordinates_parametizer_3:
...
protected:
                            ...
                            Vertex_around_vertex_const_circulator neighbor_vertex_Vj)
    {
        ...
        // Compute angle of (Vj,Vi,Vk) corner (ie angle of Vi corner)
        ...
        // Compute angle of (Vl,Vi,Vj) corner (ie angle of Vi corner)
...
#endif //CGAL_MEAN_VALUE_COORDINATES_PARAMETIZER_3_H
