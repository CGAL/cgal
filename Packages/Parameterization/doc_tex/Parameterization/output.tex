...
\ccc{Triangulation_data_structure_2}, thus
...
in a \ccc{Polyhedron_3} mesh with a \ccc{Parameterization_polyhedron_adaptor_3} adaptor.
Note that \ccc{Parameterization_polyhedron_adaptor_3} stores (u,v) pairs in halfedges (inner and border).
...
See the complete code in \ccc{Taucs_parameterization.C} example.