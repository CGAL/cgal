...
\item must provide BorderParametizer\_3 and SparseLinearAlgebraTraits\_d template parameters that make sense.\item must implement compute\_wij() to compute wij = (i,j) coefficient of matrix A for j neighbor vertex of i.\item may implement a optimized version of is\_one\_to\_one\_mapping().\end{itemize}
