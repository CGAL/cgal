...
This class parameterizes the border of a 3D surface onto a square on an uniform manner: points are equally spaced.

%END-AUTO(\ccDefinition)

\ccInclude{CGAL/Square_border_uniform_parametizer_3.h}
...
%% \ccIncludeExampleCode{Parameterization/Square_border_uniform_parametizer_3.C}
