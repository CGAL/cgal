...
% |
\RCSdef{\RCSDiscreteconformalmapparameterizerRev}{$Revision$}
...
The class Discrete\_conformal\_map\_parameterizer\_3 implements the Discrete Conformal Map (DCM) parameterization \cite{cgal:fh-survey-05}. This algorithm is also called {\em Discrete Conformal Parameterization (DCP)}, {\em Discrete Harmonic Map} or {\em Fixed Conformal Parameterization} by other authors.
