...
virtually {\em cuts} the mesh before parameterizing it.
Mesh\_adaptor\_feature\_extractor is used to compute the genus and extract the mesh's borders.

\ccIncludeExampleCode{Parameterization/Mesh_cutting_parameterization.C}
