...
% |
\RCSdef{\RCSBarycentricmappingparameterizerRev}{$Revision$}
...
The class Barycentric\_mapping\_parameterizer\_3 implements Tutte Barycentric Mapping algorithm \cite{cgal:fh-survey-05}. This algorithm is also called {\em Tutte Uniform Weights} by other authors.
