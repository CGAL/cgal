...
% |
\RCSdef{\RCSSquareborderarclengthparameterizerRev}{$Revision$}
...
with the border mapped onto a square.

\ccIncludeExampleCode{Parameterization/Square_border_parameterization.C}
