...
Base class of strategies that parameterize the border of a 3D surface onto a square. Square\_border\_parametizer\_3 is a pure virtual class, thus cannot be instanciated. Anyway, it implements most of the algorithm. Subclasses just have to implement compute\_edge\_length() to compute a segment's length.
