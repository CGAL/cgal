...
MeshAdaptor\_3 defines the minimum types, data and methods that a mesh must implement to allow surface parameterization. Among other things, this concept defines the accessor to the (u,v) values computed by parameterizations methods.
