...
public:
  ...
  typedef typename Base_traits::Compare_xy_2            Compare_xy_2;
  typedef typename Base_traits::Construct_min_vertex_2  Construct_min_vertex_2;
  typedef typename Base_traits::Construct_max_vertex_2  Construct_max_vertex_2;
  typedef typename Base_traits::Is_vertical_2           Is_vertical_2;
  typedef typename Base_traits::Compare_y_at_x_2        Compare_y_at_x_2;
  typedef typename Base_traits::Compare_y_at_x_right_2  Compare_y_at_x_right_2;
  //typedef typename Base_traits::Compare_y_at_x_left_2 Compare_y_at_x_left_2;
  typedef typename Base_traits::Equal_2                 Equal_2;
