...
/*! \file
 * The linear piece-wiese (polyline) traits-class for the arrangement package.
 */
...
public:
  ...
  public:
    ...
    bool operator()(const X_monotone_curve_2 & cv) const
    {
      ...
      return(cv._size() == 1 && seg_traits.is_vertical_object()(cv[0]));
    }
  };
                   ...
                   const Point_2 & p) const
  {
    ...
    else
    {
      ...
      seg_traits.curve_split(cv[i], cvi_1, cvi_2, p);
...
public:
  ...
  {
    return (_size() == 0) ? const_iterator(NULL, -1, true) :
  ...
  {
    return (_size() == 0) ? const_iterator(NULL, -1, false) :
...
private:
   ...
   */
  inline unsigned int _size() const
  {
