...
of constant complexity, and defines a search structure on top of these
cells, such that each query can be answered in $O(\log n)$ time, where
$n$ is the complexity of the arrangement.
...
that do not go through many changes), and when the number of issued queries
is relatively large.
