...
\ccRefConceptPage{ArrWithHistoryInputFormatter}\\
\ccRefConceptPage{ArrWithHistoryOutputFormatter}
~\\
...
\ccRefIdfierPage{CGAL::Arr_merged_curve_data_traits_2<Traits,Data,Merge>}\\
~\\
...
\ccRefIdfierPage{CGAL::insert_x_monotone_curve}\\
\ccRefIdfierPage{CGAL::insert_x_monotone_curves}\\
...
\ccRefIdfierPage{CGAL::insert_curve (Arrangement_with_history_2)}\\
\ccRefIdfierPage{CGAL::insert_curves (Arrangement_with_history_2)}\\
\ccRefIdfierPage{CGAL::remove_curve (Arrangement_with_history_2)}\\
\ccRefIdfierPage{CGAL::overlay (Arrangement_with_history_2)}\\
\ccRefIdfierPage{CGAL::read (Arrangement_with_history_2)}\\
\ccRefIdfierPage{CGAL::write (Arrangement_with_history_2)}\\
