...
\ccTypedef{typedef Face::Isolated_vertices_iterator Isolated_vertices_iterator;}{}
...
\ccMethod{Isolated_vertices_iterator iterator();}
...
%===========
  ...
  \ccMethod{void set_iterator (Isolated_vertices_iterator it);}
