...
\ccNestedType{Curve_iterator}{a bidirectional iterator over the
       ...
       \ccc{Curve_extended_2} (see below).}

\ccNestedType{Origin_curve_iterator}
    {an iterator for the curves that originate a given arrangement edge.
     Its value type is \ccc{Curve_handle}.}
\ccGlue
\ccNestedType{Origin_curve_const_iterator}
...
\ccMethod{Size number_of_origin_curves (Halfedge_handle e) const;}
    {returns the number of input curves that originate the edge \ccc{e}.}

\ccMethod{Origin_curve_iterator origin_curves_begin (Halfedge_handle e);}
    {returns the begin-iterator of the curves originating the edge \ccc{e}.}
\ccGlue
\ccMethod{Origin_curve_iterator origin_curves_end (Halfedge_handle e);}
...
The \ccc{Curve\_extended\_2} nested class extends the \ccc{Curve_2} type
...
\ccNestedType{iterator}{an iterator for the edges induced by the curve.
                        Its value type is \ccc{Halfedge_handle}.}
\ccGlue
\ccNestedType{const_iterator}{a \ccc{const} iterator for the edges induced by
                              the curve.
