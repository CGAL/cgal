...
\ccIsModel
    \ccc{ArrWithHistoryInputFormatter} \\
    \ccc{ArrWithHistoryOutputFormatter}

\ccSeeAlso
    \ccc{read}\lcTex{
     (\ccRefPage{CGAL::read (Arrangement_with_history_2)})} \\
    \ccc{write}\lcTex{
     (\ccRefPage{CGAL::write (Arrangement_with_history_2)})}
