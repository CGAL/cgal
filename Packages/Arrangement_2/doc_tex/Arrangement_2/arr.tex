...
\ccc{insert_non_intersecting()} function, as all other functions
...
The \ccc{insert_non_intersecting()} function is very
...
\ccc{insert_vertex(arr, p, pl)} inserts a vertex into \ccc{arr} that
...
$x$-monotone) curves of type \ccc{Curve_2} --- exactly as their
counterpart incremental version.
