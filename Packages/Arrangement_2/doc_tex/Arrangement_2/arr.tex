...
concidered as {\em marked}, and the intersection of the two
marked faces is denoted as $f_0$.}
\label{arr_fig:ex_22}
\end{figure}
...
by the shape $f_0$ in Figure~\ref{arr_fig:ex_22}:
...
and the consolidated curve set. Needless to say, users can employ an 
overlay-traits class to maintain any type of auxiliary data kept with 
the \dcel\ features (see Section~\ref{arr_sec:overlay}).
