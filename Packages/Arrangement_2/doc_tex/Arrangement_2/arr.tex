...
Using \ccc{Cartesian<Gmpq>} as the kernel type is generally a good choice;
...
\ccc{Cartesian<Gmpq>} kernel is several times slower in comparison to
a \ccc{Simple_cartesian<Gmpq>} kernel. However, in the latter case the
...
\begin{ccTexOnly}
  \begin{center}
  \begin{tabular}{cc}
    \includegraphics{Arrangement_2/fig/fan_grids} &
    \includegraphics{Arrangement_2/fig/Europe} \\
  {\small (a)} & {\small (b)} \\
  \end{tabular}
  \end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
%  <p><center>
%    <img src="./fig/predef_kernels.gif" border=0 alt="insert">
%  </center>
\end{ccHtmlOnly}
...
disjoint line segments, defined in the input file \ccc{Europe.dat}.}
...
\ccIncludeExampleCode{../examples/Arrangement_2/ex_predefined_kernel.C}
...
\ccIncludeExampleCode{../examples/Arrangement_2/ex_predefined_kernel_non_intersecting.C}
...
which correspond to dilated polygon edges, and circular arc, which are
originated by dilated polygon vertices. Using the arrangement of the
...
traits class, whose coordiates are typically algerbraic numbers of degree 2,
...
\ccIncludeExampleCode{../examples/Arrangement_2/ex_circular_arcs.C}
