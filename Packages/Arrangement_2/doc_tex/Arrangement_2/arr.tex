...
from the traits class --- see Section~\ref{arr_sec:traits} for the
details. However, most built-in traits classes that come with the
\cgal\ public release support these extra operations.
...
\ccc{example5.C} and \ccc{example6.C}. The arrangement vertices
are drawn in light dots, while the query points $q_1, \ldots, q_6$
are marked with crosses.}
\label{arr_fig:ex_5}
%\begin{ccHtmlOnly}
%<P>
%<center>
%  <img src="ex_5.gif"  border=0 alt="The segment arrangement constructed in \ccc{example5.C} and \ccc{example6.C}.">
%</center>
%\end{ccHtmlOnly}
\end{figure}
