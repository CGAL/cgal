...
and to maintain them. An arrangement is defined by the \dcel\ class,
which represents the {\em topological structure} of the planar
subdivision, and a geometric {\em traits} class that determines the
family of planar curves that form the arrangement. It supplies a
...
separate between topological and geometric aspects of the planar
...
planar subdivision, are rather specialized, as they require the
a-priori knowledge on the location of the inserted curve. Indeed, for
most purposes it is more convenient to construct an arrangement using
the global insertion-functions. You may skip to
Section~\ref{arr_sec:gl_funcs}, and return to this subsection at a
later point in time.
...
arrangement and does not contain any vertex of the arrangement. In
...
e.g.,~\cite[Chapeter~3]{ptvf-nrcpp-02}.
