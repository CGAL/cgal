...
\begin{ccTexOnly}
  \begin{center}
    \input{Arrangement_2/fig/arr_segs.pstex_t}
  \end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\ccc{Arr_segment_traits_2} traits class to handle segments only. It
...
can be obtained by the \ccc{curve()} method of the nested
\ccc{Halfedge} class.
...
\begin{center}
  \begin{tabular}{ccc}
    \input{Arrangement_2/fig/insert_in_face.pstex_t} &
    \input{Arrangement_2/fig/insert_from_vertex.pstex_t} &
    \input{Arrangement_2/fig/insert_at_vertices.pstex_t}\\
...
\begin{ccTexOnly}
  \begin{center}
  \input{Arrangement_2/fig/ex_1.pstex_t}
  \end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_2.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{center}
  \begin{tabular}{ccc}
    \input{Arrangement_2/fig/ex_3a.pstex_t} &
    \input{Arrangement_2/fig/ex_3b.pstex_t} &
    \input{Arrangement_2/fig/ex_3c.pstex_t} \\
  {\small (a)} & {\small (b)} & {\small (c)}\\
  \end{tabular}
\end{center}
\end{ccTexOnly}
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_4.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_5.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The global function \ccc{insert_non_intersecting_curve(arr, c, pl)}
inserts the $x$-monotone curve \ccc{c} into the arrangement \ccc{arr},
with the precondition that the interior of \ccc{arr} is disjoint from
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The global function \ccc{insert_non_intersecting_curve(arr, c)} is also
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The global function \ccc{insert_x_monotone_curve(arr, c, pl)} performs
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The global function \ccc{insert_curve()} requires that the traits class
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_8.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\ccc{insert_non_intersecting_curves(arr, begin, end)},
\ccc{insert_x_monotone_curves(arr, begin, end)} and
\ccc{insert_curves(arr, begin, end)} that insert a range of curves,
given by the input iterators \ccc{[begin, end)} into an arrangement
\ccc{arr}. The different functions accept a set of pairwise
...
necessarily $x$-monotone) curves of type \ccc{Curve_2} --- exactly as their
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_10.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\ccc{ArrangementLandmarkTraits_2}. A model of this concept must
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
If the traits class models the \ccc{ArrangementXMonotoneTraits_2}
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The refined concept \ccc{ArrangementTraits_2} refines the
...
only when using the global \ccc{insert_curve()} and
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_12.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\ccc{example12.C}. Disks mark vertices associated with
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_13.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_14.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_16.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
base-traits class, and in particular inherits it \ccc{Point_2} type.
In addition:
\begin{itemize}
...
\ccc{BaseTraits::X_monotone_curve_2} are identical (e.g., in case
...
object using the \ccc{Convert} functor, which is automatically associated
...
\ccc{BaseTraits::Curve_2} a single \ccc{Data} field, and the basic
\ccc{BaseTraits::X_monotone_curve_2} with a {\em set} of data objects.
The \ccc{Data} type is assumed to support the equality operator, such that
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_17.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
constructed in \ccc{example17.C}. Disks correspond to
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_18.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_19.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
a default parameter for the \ccc{Arrangement_2} template. The default
...
\dcel\ class, its nested \ccc{Face} type is extended by the access function
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_20.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
traits class. Let us assume that \ccc{arr_a} is of type
\ccc{Arrangement_2<Traits,Dcel_A>}, \ccc{arr_b} is of type
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_22.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
As we have just mentioned, a \ccc{Curve_handle} object \ccc{ch} serves as
a pointer to a curve stored in an arrangement-with-history instance \ccc{arr}.
Using this handle, it is possible to obtain the number of arrangement edges
this curve induces by calling \ccc{arr.number_of_induced_edges(ch)}.
The functions \ccc{arr.induced_edges_begin(ch)} and
...
an arrangement with history. The global \ccc{insert_non_intersecting_curve()}
...
and only the global \ccc{insert_curve()} and \ccc{insert_curves()} functions
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_24.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\begin{ccTexOnly}
\begin{center}
\input{Arrangement_2/fig/ex_25.pstex_t}
\end{center}
\end{ccTexOnly}
\begin{ccHtmlOnly}
  <p><center>
...
\ccIncludeExampleCode{../examples/Arrangement_2/example26.C}
...
\ccIncludeExampleCode{../examples/Arrangement_2/example27.C}
...
\ccIncludeExampleCode{../examples/Arrangement_2/example28.C}
...
adapt \ccc{Arrangement_2} into a BGL graph thus enabling us to use the 
BGL algorithms. (For more information, see \boost\ documentation on 
www.boost.org).

\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The class \ccc{Arr_face_graph_adaptor} is the adaptor class of 
\ccc{Arrangement_2} into a BGL graph that implements the Graph, Incidence Graph 
and Vertex List Graph \boost\ concepts. The PlanarMap template parameter in 
\ccc{Arr_face_graph_adaptor<PlanarMap>} is the type of the planar map to adapt. 
It defines various types and methods to be used by \boost\ algorithms. 
\ccc{Arr_face_graph_adaptor} considers the \ccc{Arrangement_2} faces as 
...
Use the \ccc{make_arr_face_graph_adaptor()} function.

\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The next example shows how to use the \ccc{Arr_face_graph_adaptor} to use 
\boost\ algorithms. In this example we construct an \ccc{Arrangement_2} and 
run breadth first search on the faces. The \ccc{breadth_first_search} 
...
Section~\ref{arr_sec:ex_dcel}), and use the \ccc{Object_color_map} to create 
the color map.
