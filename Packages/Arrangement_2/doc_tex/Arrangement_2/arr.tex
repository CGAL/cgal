...
necessarily $x$-monotone.\footnote{A continuous planar curve $C$ is
{\em $x$-monotone} if every vertical line intersects it at
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
In Section~\ref{arr_sec:arr_class} we explain how to construct
...
all the mapping of the existing arrangement edges and vertices.

The global function \ccc{insert_non_intersecting(arr, c, pl)}
performs this exact operation: It inserts the $x$-monotone curve
...
arrangement, we consider the size of the arrangement $n$.
...
In example below we aggregately construct an arrangement of a set
${\mathcal S}_1$ containing five line segments. Then, insert a single
