...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
The free function \ccc{insert_non_intersecting_curve(arr, c)} is also
...
the pair functions is called by methods of the \ccc{Arrangement_2} class. 
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
All examples till this point use the default \ccc{Arr_default_dcel<Traits>}. 
...
\begin{ccHtmlOnly}<p>\end{ccHtmlOnly}
When an \ccc{Arrangement_2} object is injected by this
...
% \ccIncludeExampleCode{../examples/Arrangement_2/example29.C}
