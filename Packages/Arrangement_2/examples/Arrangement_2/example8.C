...
int main ()
{
  ...
  insert_non_intersecting (arr, lm_pl, s1);
  insert_non_intersecting (arr, lm_pl, s2);
  insert_non_intersecting (arr, lm_pl, s3);
  insert_non_intersecting (arr, lm_pl, s4);
  
  // Test the insertion function (iis2 and iis3 cause some overlaps).
  Segment_2       iis1 (Point_2(0.0, -3.0), Point_2(5.0, 2.0));
  
  insert (arr, lm_pl, iis1);
