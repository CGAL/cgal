...
\ccNestedType{Sphere}{is a typedef to to \ccc{Traits::Sphere}.}

\ccNestedType{FT}{is a typedef to to \ccc{Traits::FT}.}
...
arithmetic model, so they count the overall number of operations on
...
be used for approximate computation.  (For exact number types
