...
\RCSdef{\Nef_polyhedronRefRev}{$Revision$}
...
%% \ccChapterRelease{\Nef_polyhedronRefRev. \ \Nef_polyhedronRefDate}\\
...
\ccRefIdfierPage{CGAL::Nef_polyhedron_S2<Traits>::SFace_cycle_iterator} 
