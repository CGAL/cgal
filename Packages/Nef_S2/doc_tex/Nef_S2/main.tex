...
\chapter{Nef Polyhedra embedded on $S_2$}
\label{chapterNef_S2}
...
\begin{ccTexOnly}
    ...
    \begin{flushright}
      \parbox{0.3\textwidth}{%
          \includegraphics[width=0.3\textwidth]{Nef_S2/fig/sphere_map.ps}%
      }%
    \end{flushright}
\end{ccTexOnly}
...
\begin{ccTexOnly}
    ...
    \begin{center}
      \parbox{0.4\textwidth}{%
          \includegraphics[width=0.4\textwidth]{Nef_S2/fig/shalfloop.eps}%
      }
    \end{center}
    \vspace{-5mm}
\end{ccTexOnly}
...
\begin{ccHtmlOnly}
    <CENTER>
    <A HREF="./shalfloop.jpg">
        <img src="./shalfloop.jpg" alt="SHalfloop Diagram"></A><P>
    </CENTER>
\end{ccHtmlOnly}
...
This example shows the different types of constructors: $N1$ is the complete
...
stream. The usage is shown in the following example:
