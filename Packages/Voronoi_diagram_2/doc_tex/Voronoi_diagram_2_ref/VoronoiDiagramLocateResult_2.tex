...
\begin{ccRefClass}{Voronoi_diagram_2<DG,VT,AP>::Locate_result}

%% \ccHtmlCrossLink{}     %% add further rules for cross referencing links
%% \ccHtmlIndexC[concept]{} %% add further index entries
\ccDefinition

The class \ccc{Voronoi_diagram_2<DG,VT,AP>::Locate_result} is the result
...
\ccTypes
\ccTwo{Voronoi_diagram_2<DG,VT,AP>::Locate_result::Halfedge_handle+}{}
%
