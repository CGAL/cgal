...
The concept \ccc{VoronoiTraits_2} defines the functors required for
accessing geometric information in the Delaunay graph that is needed by the
\ccc{Voronoi_diagram_2<DG,VT,AP>} class.
...
\ccc{CGAL::Segment_Delaunay_graph_Voronoi_traits_2<SDG2>}
