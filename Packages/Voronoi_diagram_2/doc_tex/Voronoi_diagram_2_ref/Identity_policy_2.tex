...
template parameter must be a model of the \ccc{VoronoiTraits_2} concept.
...
\ccc{VT::Site_2}. The site inserter functor provided by this policy
uses the afore-mentioned \ccStyle{insert} method.
