...
\ccConstructor{Voronoi_diagram_2(Adaptation_traits
  tr = Adaptation_traits(), Adaptation_policy ap = Adaptation_policy());}
{Creates a Voronoi diagram using \ccc{tr} as adaptation traits and
  \ccc{ap} as adaptation policy.}
%
\ccConstructor{Voronoi_diagram_2(Delaunay_graph dg, bool swap_dg = false,
  Adaptation_traits tr = Adaptation_traits(), Adaptation_policy ap =
  Adaptation_policy());}
{Creates a Voronoi diagram from the Delaunay graph \ccc{dg} and using
  \ccc{tr} as adaptation traits and \ccc{ap} as adaptation policy. The 
...
{Creates a Voronoi diagram using as sites the sites in the iterator
  range \ccStyle{[first, beyond)}, \ccc{tr} as adaptation traits and
