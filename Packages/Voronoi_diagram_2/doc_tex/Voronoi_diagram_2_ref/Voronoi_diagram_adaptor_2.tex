...
\ccThree{typedef Voronoi_traits::Point_2}{Voronoi_traits+}{}
\ccThreeToTwo
\ccTwo{Voronoi_diagram_adaptor_2<DG,VT>::Locate_type+}{}
%
...
%\ccGlue
\ccNestedType{Locate_type}{The return type of the point location
  queries. In must be a model of the \ccc{VoronoiDiagramLocateType_2}
  concept.}
%
%
...
\ccThree{Halfedge_handle}{vda.number_of_halfedges()+}{}
%
...
\ccThree{Unbounded_halfedges_iterator}{vda.unbounded_halfedges_begin()+}{}
...
\end{ccTexOnly}
\ccHeading{Queries}
\ccThree{Locate_type}{vda.locate(Point_2 p)+}{}
\ccMethod{Locate_type locate(Point_2 p);}{Performs point location for
