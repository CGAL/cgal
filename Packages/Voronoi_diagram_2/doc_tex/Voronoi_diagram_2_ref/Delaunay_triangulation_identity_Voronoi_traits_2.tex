...
\begin{ccRefClass}{Delaunay_triangulation_identity_Voronoi_traits_2<DT2>}
...
%
This model of the Voronoi traits for 2D Delaunay triangulations provides
...
\ccc{CGAL::Delaunay_triangulation_Voronoi_traits_2<DT2>} and
\ccc{CGAL::Delaunay_triangulation_caching_Voronoi_traits_2<DT2>} classes
(which actually do some work). This traits class is suitable for
users who want to view 2D Delaunay triangulations as Voronoi diagrams,
