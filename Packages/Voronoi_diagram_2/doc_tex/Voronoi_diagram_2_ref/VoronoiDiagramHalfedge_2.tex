...
\begin{ccRefClass}{Voronoi_diagram_2<DG,VT,AP>::Halfedge}

\ccDefinition
The class \ccRefName\ is the Voronoi halfedge class provided by the
...
\ccTypes
%
\ccTwo{Voronoi_diagram_2<DG,VT,AP>::Halfedge::Ccb_halfedge_circulator+}{}
...
\ccMethod{bool is_valid();}{Returns \ccStyle{true} if the following
  conditions are met: the dual edge of the halfedge is not a rejected
  edge with respect to the chosen adaptation policy;
  the twin edge of its twin edge is itself; its adjacent face does not
