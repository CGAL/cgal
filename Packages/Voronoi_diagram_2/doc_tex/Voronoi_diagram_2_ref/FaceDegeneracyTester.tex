...
\ccThree{bool}{Dual_graph dg, fdt(Finite_vertices_iterator fvit)+}{}
\ccThreeToTwo
\ccMemberFunction{bool operator()(Dual_graph dg, Vertex_handle v);}
...
%
\ccGlue
\ccMemberFunction{bool operator()(Dual_graph dg, Vertex_circulator vc);}
{returns \ccStyle{true}, if the dual Voronoi face of \ccc{*vc} (that
  belongs to the dual Delaunay graph \ccc{dg}) is
  degenerate, i.e., it has zero area.}
%
\ccGlue
\ccMemberFunction{bool operator()(Dual_graph dg, All_vertices_iterator avit);}
