...
\ccThree{typedef Delaunay_graph::Geom_traits::Point_2}{Vertex_handle+}{}
\ccThreeToTwo
\ccGlue
\ccTypedef{typedef Delaunay_graph::Geom_traits::Point_2 Point_2;}{}
...
\ccc{CGAL::Apollonius_graph_caching_Voronoi_traits_2<AG2>::Nearest_site_2}\\
\ccc{CGAL::Apollonius_graph_identity_Voronoi_traits_2<AG2>::Nearest_site_2}\\
\ccc{CGAL::Delaunay_triangulation_Voronoi_traits_2<DT2>::Nearest_site_2}\\
\ccc{CGAL::Delaunay_triangulation_caching_Voronoi_traits_2<DT2>::Nearest_site_2}\\
\ccc{CGAL::Delaunay_triangulation_identity_Voronoi_traits_2<DT2>::Nearest_site_2}\\
\ccc{CGAL::Regular_triangulation_Voronoi_traits_2<RT2>::Nearest_site_2}\\
\ccc{CGAL::Regular_triangulation_caching_Voronoi_traits_2<RT2>::Nearest_site_2}\\
\ccc{CGAL::Regular_triangulation_identity_Voronoi_traits_2<RT2>::Nearest_site_2}\\
\ccc{CGAL::Segment_Voronoi_diagram_Voronoi_traits_2<SVD2>::Nearest_site_2}\\
\ccc{CGAL::Segment_Voronoi_diagram_caching_Voronoi_traits_2<SVD2>::Nearest_site_2}\\
\ccc{CGAL::Segment_Voronoi_diagram_identity_Voronoi_traits_2<SVD2>::Nearest_site_2}
