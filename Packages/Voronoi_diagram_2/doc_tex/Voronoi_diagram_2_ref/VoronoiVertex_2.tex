...
\ccc{VoronoiVertex_2::Delaunay_graph::Geom_traits::Point_2}.
...
\ccTypes
\ccTwo{VoronoiVertex_2::Delaunay_graph+}{}
%
...
%\ccGlue
\ccThree{typedef typename Delaunay_graph::Geom_traits::Point_2}{Point_2+}{}
\ccTypedef{typedef typename Delaunay_graph::Geom_traits::Point_2 Point_2;}
{A type for a point.}
% The Voronoi vertex should be convertible to this type.}
...
\ccHasModels
\ccc{CGAL::Apollonius_graph_Voronoi_traits_2<AG2>::Voronoi_vertex_2}\\
\ccc{CGAL::Delaunay_triangulation_Voronoi_traits_2<DT2>::Voronoi_vertex_2}\\
\ccc{CGAL::Regular_triangulation_Voronoi_traits_2<RT2>::Voronoi_vertex_2}\\
\ccc{CGAL::Segment_Voronoi_diagram_Voronoi_traits_2<SVD2>::Voronoi_vertex_2}\\
