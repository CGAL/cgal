...
The \ccc{CGAL::Point\_set\_2} class depends on three template parameters T1, T2 and T3.
T2 and T3 are used as template parameters for the \ccc{CGAL::Delaunay\_triangulation\_2}
class \ccc{CGAL::Point\_set\_2} is inherited from. T2 and T3 are models for the
geometric traits and for the triangulation data structure that the Delaunay triangulation
expects.
T1 is a model of geometric traits for the \ccc{CGAL::Point\_set\_2} class.
