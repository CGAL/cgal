...
\begin{ccRefFunction}{sibson_gradient_fitting}  %% add template arg's if necessary
\ccIndexMainItemBegin{sibson_gradient_fitting}

\ccDefinition
  
The function \ccRefName\ approximates the gradient of a function at a
point \ccc{p} given natural neighbor coordinates of \ccc{p} and its
...
\ccFunction{template < class Dt, class OutputIterator, class Functor,
  ...
  dt, OutputIterator out, Functor f, const Traits& traits);} {estimates
