...
%\subsubsection{General interpolation schemes}
...
\ccc{linear_interpolation} and \ccc{quadratic_interpolation}.\medskip
...
This package implements Sibson's and Farin's interpolation functions
