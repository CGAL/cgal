...
int ellipsoid_function (double, double, double);  // (c=(0,0,0), r=1)
int torus_function (double, double, double);  // (c=(0,0,0), r=2)
int chair_function (double, double, double);  // (c=(0,0,0), r=6)
int tanglecube_function (double, double, double);  // (c=(0,0,0), r=4)
int octic_function (double, double, double);  // (c=(0,0,0), r=2)
int heart_function (double, double, double);  // (c=(0,0,0), r=2)
int klein_function (double, double, double);  // (c=(0,0,0), r=4)
int ring_function (double, double, double);  // (c=(0,0,0), r=?)
int false_knot_function (double, double, double);  // (c=(0,0,0), r=1)
...
int torus_function (double x, double y, double z) {
  double x2=x*x, y2=y*y, z2=z*z;
  double x4=x2*x2, y4=y2*y2, z4=z2*z2;

  double value = x4  + y4  + z4  + 2 *x2*  y2  + 2*
...
int chair_function (double x, double y, double z) {
  double x2=x*x, y2=y*y, z2=z*z;
  double x4=x2*x2, y4=y2*y2, z4=z2*z2;

  double value = x4-1.2*x2*y2+3.6*x2*z2-7.50*x2+y4+3.6*y2*z2-7.50*y2+.2*z4-7.50*z2+64.0625-16.0*z*y2+16.0*x2*z;
...
int tanglecube_function (double x, double y, double z) {
  double x2=x*x, y2=y*y, z2=z*z;
  double x4=x2*x2, y4=y2*y2, z4=z2*z2;

  double value = x4 - 5*x2 + y4 - 5*y2 + z4 - 5*z2 + 11.8;
...
int heart_function (double x, double y, double z) {  // radius = 2

  double value = (2*x*x+y*y+z*z-1)*(2*x*x+y*y+z*z-1)*(2*x*x+y*y+z*z-1) - (0.1*x*x+y*y)*z*z*z;
...
int klein_function (double x, double y, double z) {  // radius = 4

  double value = (x*x+y*y+z*z+2*y-1)*((x*x+y*y+z*z-2*y-1)*(x*x+y*y+z*z-2*y-1)-8*z*z)+16*x*z*(x*x+y*y+z*z-2*y-1);
...
int ring_function (double x, double y, double z) {  // radius = ?
  double e=0.1;
...
int false_knot_function (double x, double y, double z) {  // radius = 1
  double d=1.2, e=0.1;
...
int knot1_function (double a, double b, double c) {  // radius = 4
  double e=0.1;
...
/*
int knot1_function (double x, double y, double z) {  // radius = 4
  double e=0.1;
...
int knot1_surf1_function (double x, double y, double z) {  // radius = 4
  double c1, c2, c3, c4, den;
  den=1+x*x+y*y+z*z;
  c1=2*x/den;
  c2=2*y/den;
...
int knot1_surf2_function (double x, double y, double z) {  // radius = 4
  double c1, c2, c3, c4, den;
  den=1+x*x+y*y+z*z;
  c1=2*x/den;
  c2=2*y/den;
...
int knot2_function (double a, double b, double c) {  // radius = 4
  double e=0.025;
...
int knot3_function (double a, double b, double c) {  // radius = 4
  double e=0.025;
...
void init_functions()
{
  ...
  functions["implicit"] = &implicit_function;
  functions["klein"] = &klein_function;
  functions["knot1"] = &knot1_function;
  functions["knot1_surf1"] = &knot1_surf1_function;
  functions["knot1_surf2"] = &knot1_surf2_function;
  functions["knot2"] = &knot2_function;
  functions["knot3"] = &knot3_function;
  functions["octic"] = &octic_function;
  functions["peanut"] = &peanut_function;
