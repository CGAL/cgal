...
degenerate\ccIndexSubitem[t]{degeneracies}{\ccc{Polytope_distance_d}},
...
$pd(S_P,S_Q)=pd(P,Q)$ are called \emph{pair of support
  sets}\ccIndexSubitem[t]{support set}{\ccc{Polytope_distance_d}}, the
...
\ccIndexSubitem[t]{support set}{\ccc{Polytope_distance_d}}
%
...
\ccIndexSubitem[t]{degeneracies}{\ccc{Polytope_distance_d}}
...
\ccIndexSubitem[t]{validity check}{\ccc{Polytope_distance_d}}
...
objective function\ccIndexSubitem[t]{quadratic program}
{\ccc{Polytope_distance_d}}. The solution is obtained using our exact solver for
