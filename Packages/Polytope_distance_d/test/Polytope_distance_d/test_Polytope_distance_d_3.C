...
main( int argc, char* argv[])
{
    ...
    // --------------
        ...
        // generate point set
        std::vector<R_1::Point_3>  p_points_1, q_points_1;
        p_points_1.reserve( 50);
        q_points_1.reserve( 50);
        {
            int  i;
            for ( i = 0; i < 50; ++i) {
                p_points_1.push_back( R_1::Point_3(
                    CGAL::default_random( 0x100000),
                    CGAL::default_random( 0x100000),
                    CGAL::default_random( 0x100000)));
            }
            for ( i = 0; i < 50; ++i) {
                q_points_1.push_back( R_1::Point_3(
                    -CGAL::default_random( 0x100000),
                    -CGAL::default_random( 0x100000),
                    -CGAL::default_random( 0x100000)));
            }
    ...
    // --------------
        ...
        // generate point set
        std::vector<R_2::Point_3>  p_points_2, q_points_2;
        p_points_2.reserve( 50);
        q_points_2.reserve( 50);
        {
            int  i;
            for ( i = 0; i < 50; ++i) {
                p_points_2.push_back( R_2::Point_3(
                    CGAL::default_random( 0x100000),
                    CGAL::default_random( 0x100000),
                    CGAL::default_random( 0x100000)));
            }
            for ( i = 0; i < 50; ++i) {
                q_points_2.push_back( R_2::Point_3(
                    -CGAL::default_random( 0x100000),
                    -CGAL::default_random( 0x100000),
                    -CGAL::default_random( 0x100000)));
            }
