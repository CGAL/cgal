...
The class \ccc{CGAL::Alpha_shape_3<Dt>} represents the family of
...
the classes \ccc{CGAL::Alpha_shape_euclidean_traits_3}
and \ccc{CGAL::Weighted_alpha_shape_euclidean_traits_3} are models.
...
and \ccc{CGAL::Alpha_shape_Cell_base_3<Tf>}.
...
For the geometric traits class we can use the \ccc{CGAL::Alpha_shape_traits_3}
...
namely \ccc{CGAL::Alpha_shape_vertex_base_3<Gt, Dv>} and \ccc{CGAL::Alpha_shape_cell_base_3<Gt,Df>}.
As default vertex and cell type they use \ccc{CGAL::Triangulation_vertex_base_3<Gt>}
and  \ccc{CGAL::Triangulation_cell_base_3<Gt>} respectively. 
...
A weighted alpha shape\ccIndexMainItem[f]{Weighted Alpha Shapes 3}, needs a regular triangulation as
underlying triangulation \ccc{Dt}, and it needs a particular
cell class, namely \ccc{CGAL::Regular_triangulation_cell_base_3<Gt>}.
