...
\ccRefIdfierPage{CGAL::Alpha_shape_euclidean_traits_3<K>}\\
\ccRefIdfierPage{CGAL::Weighted_alpha_shape_euclidean_traits_3<K>}\\
\ccRefIdfierPage{CGAL::Alpha_shape_vertex_base_3<AlphaShapeTraits_3>}\\
\ccRefIdfierPage{CGAL::Alpha_shape_cell_base_3<AlphaShapeTraits_3, 
