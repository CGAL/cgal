...
circle of the points \ccc{p0, p1, p2, p3} or the squared radius of the
smallest circle of the points \ccc{p0, p1, p2} or the squared radius of smallest circle
of the points \ccc{p0, p1}, as \ccc{Coord_type} associated with the metric used
by \ccc{Dt}.} 

\ccHeading{Predicate by function object}

\ccMethod{Side_of_bounded_circle_3 side_of_bounded_circle_3_object();}
{Returns an object, which has to be able to compute the relative position of
point \ccc{test} to the smallest circle of the points \ccc{p0, p1, p2} or 
to the smallest circle of the points \ccc{p0, p1}, using the
same metric as \ccc{Dt}.}
