...
% | Package: Package
% | 
\RCSdef{\RCSGeomviewRev}{$Revision$}
...
\ccInclude{IO/Geomview_stream.h}
...
%included using the 
%\verb|\ccIncludeExampleCode{examples/Package/Geomview_prog.C}| 
...
%%% \ccIncludeExampleCode{examples/Package/Geomview_prog.C}
