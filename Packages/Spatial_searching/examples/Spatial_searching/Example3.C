...
#include <CGAL/Nearest_neighbour_Minkowski_norm.h>
...
typedef CGAL::Nearest_neighbour_Minkowski_norm<Traits,
...
NNN_Iterator;
  ...
  Traits tr(bucket_size, CGAL::Split_rule_enumeration::MIDPOINT_OF_MAX_SPREAD, 2.0, true);
