...
\ccc{CGAL::Weighted_Minkowski_distance<Point>} implementing 
...
\item
The class \ccc{CGAL::General_standard_search<TreeTraits, Distance, QueryItem, Tree>} 
...
\item
The class \ccc{CGAL::General_priority_search<TreeTraits, Distance, QueryItem, Tree>} implementing the priority search 
...
\item
The class \ccc{CGAL::Orthogonal_standard_search<TreeTraits, Distance, Tree>} implementing the standard search strategy for 
...
\item
The class \ccc{Orthogonal_priority_search<TreeTraits, Distance, Query_Item, Tree>} implementing the priority search strategy for general 
distances
...
$k$-$d$ trees have been implemented by the class \ccc{CGAL::Kdtree_d<TreeTraits>} (see Section \ref{KDT_section}), 
...
except for the definition of \ccc{Kdtree_d<Traits>::Box} 
