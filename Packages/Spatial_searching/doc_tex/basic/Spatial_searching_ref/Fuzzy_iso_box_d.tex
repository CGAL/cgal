...
\begin{ccRefClass}{Fuzzy_iso_box_d<Point,IsoBox_d>}  %% add template arg's if necessary
...
\ccConstructor{Fuzzy_iso_box_d(Point p,Point q, NT epsilon=NT(0));}{Constructs a fuzzy iso box
