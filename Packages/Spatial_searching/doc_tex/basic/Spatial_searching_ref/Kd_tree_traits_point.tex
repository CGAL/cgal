...
\begin{ccRefClass}{Kd_tree_traits_point<Point,Splitter>}  %% add template arg's if necessary
...
example \ccc{CGAL::Sliding_midpoint<Point,Container,Separator>}.
Splitter has default argument \ccc{CGAL::Sliding_midpoint<Point>}.
...
(int bucket_size=100, NT aspect_ratio=NT(3), bool use_extended_nodes=true);}
