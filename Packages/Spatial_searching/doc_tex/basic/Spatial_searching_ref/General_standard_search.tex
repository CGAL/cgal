...
\begin{ccRefClass}{General_standard_search<Traits, Query_item, Distance>}  %% add template arg's if necessary
...
\ccConstructor{General_standard_search(Tree& tree, Query_item& q, Distance& d, int k, NT Eps,
