...
\begin{ccRefClass}{Weighted_Minkowski_distance<PointTraits>}  %% add template arg's if necessary
...
\ccConstructor{template <class InputIterator>
               Weighted_Minkowski_distance(NT power, int dim, InputIterator wb, InputIterator we);}
