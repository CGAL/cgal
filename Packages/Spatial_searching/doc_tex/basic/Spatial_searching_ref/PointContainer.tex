...
void split(PointContainer& C, SpatialSeparator sep, bool sliding=false);}
{Given an empty container \ccc{C} with the same dimension as \ccc{c}, splits \ccc{c} into
\ccc{c} and \ccc{C} using the separator \ccc{sep}. If sliding is \ccc{true}, after splitting 
each container contains at least one point. Container \ccc{c} should contain at least two points.}
