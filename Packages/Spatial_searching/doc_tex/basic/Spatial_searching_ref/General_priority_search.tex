...
\begin{ccRefClass}{General_priority_search<TreeTraits,Distance,QueryItem,Tree>}  %% add template arg's if necessary
...
\ccc{CGAL::Orthogonal_priority_search<TreeTraits,Distance,Tree>}.
