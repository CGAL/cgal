...
void split(Point_container<PointTraits> &c2, SpatialSeparator sep, bool sliding=false);}
...
\ccMethod{void swap(Point_container<SpatialPoint> &c2);}
...
\ccFunction{ template<class PointTraits>
