...
\begin{ccRefClass}{Orthogonal_standard_search<Traits, Query_item, Distance>}  %% add template arg's if necessary
...
\ccInclude{CGAL/Orthogoanl_standard_search.h}
...
\ccConstructor{Orthogonal_standard_search(Tree& tree, Query_item& q, Distance& d, int k, NT Eps,
