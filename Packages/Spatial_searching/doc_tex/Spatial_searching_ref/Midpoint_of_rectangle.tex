...
\begin{ccRefFunctionObjectClass}{Midpoint_of_rectangle<SpatialPoint,PointContainer,Separator>}  %% add template arg's if necessary
...
\ccTypedef{PoitContainer Container;}{Point container.}
