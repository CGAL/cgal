...
\begin{ccRefClass}{Fuzzy_sphere_d<Point>}  %% add template arg's if necessary
...
\ccConstructor{Fuzzy_sphere_d(Point center, NT radius, NT epsilon=NT(0));}{Constructs a fuzzy sphere
