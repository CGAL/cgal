...
\begin{ccRefClass}{Kd_tree_node<PointTraits,Splitter,UseExtendedNode>}  %% add template arg's if necessary
...
\ccTypedef{Kd_tree<PointTraits,Splitter,UseExtendedNode>::Point_iterator Point_iterator;}{Iterator over points.} 
\ccTypedef{Kd_tree<PointTraits,Splitter,UseExtendedNode>::Node_handle Node_handle;}{Node handle.}
