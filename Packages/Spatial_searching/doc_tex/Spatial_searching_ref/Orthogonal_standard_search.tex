...
\begin{ccRefClass}{Orthogonal_standard_search<TreeTraits, OrthogonalDistance, SpatialTree>}  %% add template arg's if necessary
...
\ccConstructor{Orthogonal_standard_search(Tree tree, QueryItem q, OrthogonalDistance d=OrthogonalDistance(), int k=1, NT Eps=NT(0.0),
...
\ccc{CGAL::General_standard_search<TreeTraits, GeneralDistance, QueryItem, Tree>}.
