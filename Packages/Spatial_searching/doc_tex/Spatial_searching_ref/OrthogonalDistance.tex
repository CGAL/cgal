...
\ccMethod{NT distance(SpatialPoint q, SpatialPoint r);}{Returns the transformed distance between \ccc{q} and \ccc{r}.}

\ccMethod{NT min_distance_to_rectangle(SpatialPoint q, Kd_tree_rectangle<NT> r;);}
{Returns the transformed distance between \ccc{q} and
the point on the boundary of \ccc{r} closest to \ccc{q}.}

\ccMethod{NT max_distance_to_rectangle(SpatialPoint q, Kd_tree_rectangle<NT> r;);}
{Returns the transformed distance between \ccc{q} and
