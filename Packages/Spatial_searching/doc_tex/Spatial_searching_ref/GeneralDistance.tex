...
\ccMethod{NT distance(QueryItem q, SpatialPoint r);}{Returns the transformed distance between \ccc{q} and \ccc{r}.}
...
\ccc{CGAL::Manhattan_distance_rectangle_point<Query_item, SpatialPoint>}\\
