...
\begin{ccRefClass}{Orthogonal_priority_search<Traits,QueryItem,Distance>}  %% add template arg's if necessary
...
\ccConstructor{Orthogonal_priority_search(Tree& tree, QueryItem& q, Distance& d, int k, NT Eps);}
