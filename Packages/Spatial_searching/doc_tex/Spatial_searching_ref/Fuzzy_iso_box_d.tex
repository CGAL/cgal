...
\ccTypedef{Traits::Construct_iso_box_d Construct_iso_box_d;}{Function object with an operator 
that takes two \ccc{Point_d} and returns the smallest \ccc{Iso_box_d} vontaing the points.}
...
\ccMethod{bool contains(Point_d p);}{test whether $b$ contains $p$.}
...
\ccMethod{bool outer_range_is_contained_by(const Kd_tree_rectangle<FT>& rectangle);}
