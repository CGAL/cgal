...
\ccTypedef{Traits::Iso_box_d Iso_box_d;}{Iso box type.}
...
\ccMethod{FT transformed distance(Iso_box_d b, Point_d p);}{Returns the transformed 
...
\ccMethod{FT min_distance_to_rectangle(Iso_box_d b, Kd_tree_rectangle<Traits> r);}
{Returns the minimal distance between a point from \ccc{b} and a point from
\ccc{r}.}

\ccMethod{FT max_distance_to_rectangle(Iso_box_d b, Kd_tree_rectangle<Traits> r);}
