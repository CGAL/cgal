...
void split_container(Point_container<PointTraits> &C, SpatialSeparator sep, bool sliding=false);}
...
{\bf Non-Member functions related to \ccc{Point_container<PointTraits>}}
...
PointTraits, SpatialSeparator, PointContainer.
\end{ccAdvanced}
\end{ccRefClass}
