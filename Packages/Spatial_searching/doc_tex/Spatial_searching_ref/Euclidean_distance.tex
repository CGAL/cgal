...
\ccTypedef{Traits::Point_d Query_item;}{Query item type.}
...
\ccMethod{FT distance(Point_d q, Point_d p);}{Returns the squared Euclidean distance between \ccc{q} and \ccc{p}.}
