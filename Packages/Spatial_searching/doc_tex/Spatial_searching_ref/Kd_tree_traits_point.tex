...
a template class for the construction of a binary search tree by the class \ccc{Binary_Search_Tree}.
The parameters \ccc{selected_split_rule}, \ccc{aspect_ratio}, \ccc{bucket_size}, and \ccc{use_extended_nodes}  
define the way in which the binary search tree is constructed.
