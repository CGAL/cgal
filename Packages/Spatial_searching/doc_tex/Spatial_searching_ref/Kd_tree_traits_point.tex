...
for example \ccc{CGAL::Sliding_midpoint<SpatialPoint, PointContainer, SpatialSeparator>}.
The second template argument has default value \ccc{CGAL::Sliding_midpoint<SpatialPoint>}.
