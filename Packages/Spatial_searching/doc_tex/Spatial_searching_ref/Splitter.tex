...
\ccNestedType{\ccHtmlNoLinksFrom{Separator};}{\ccHtmlNoLinksFrom{Separator}.} 
...
\ccMethod{
void operator()(\ccHtmlNoLinksFrom{Separator}& s, PointContainer& c0, PointContainer& c1, NT Aspect_ratio=NT(3));} 
