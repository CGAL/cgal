...
\ccc{CGAL::Fair<Point,Container,Separator>}, \\
\ccc{CGAL::Median_of_rectangle<Point,Container,Separator>}, \\
\ccc{CGAL::Median_of_max_spread<Point,Container,Separator>}, \\
\ccc{CGAL::Midpoint_of_rectangle<Point,Container,Separator>}, \\
\ccc{CGAL::Midpoint_of_max_spread<Point,Container,Separator>}, \\
\ccc{CGAL::Sliding_fair<Point,Container,Separator>}, \\
\ccc{CGAL::Sliding_midpoint<Point,Container,Separator>.}
