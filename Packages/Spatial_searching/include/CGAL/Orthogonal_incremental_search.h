...
//
// file          : include/CGAL/Orthogonal_incremental_search.h
// package       : ASPAS (3.12)
...
#ifndef  ORTHOGONAL_INCREMENTAL_SEARCH
#define  ORTHOGONAL_INCREMENTAL_SEARCH
#include <cstring>
#include <list>
#include <queue>
#include <memory>
...
class Orthogonal_incremental_search {
...
class iterator;
    ...
    // constructor
    Orthogonal_incremental_search(Tree& tree,  
...
void swap (typename Orthogonal_incremental_search<Traits, 
				Query_item, Distance>::iterator& x,
        typename Orthogonal_incremental_search<Traits, 
...
#endif  // ORTHOGONAL_INCREMENTAL_SEARCH_H
