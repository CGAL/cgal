...
//
// release       : 
// release_date  : 2001, July 09
//
// file          : include/CGAL/IO/PS_Stream.h
// package       : PS_Stream (1.7)
// maintainer    : Sylvain Pion <Sylvain.Pion@sophia.inria.fr>
// revision      : $Revision$
// revision_date : $Date$
// revision      : 2002/02/08 Hans Tangelder adapted PS_Manipulator class  
// author(s)     : 
...
//  Hans 8 Feb 2002 friend PS_Stream& operator<< CGAL_NULL_TMPL_ARGS (PS_Stream& ,
//  Hans 8 Feb 2002                                  const PS_Manipulator<T> &);
public:
  PS_Manipulator(PS_Stream& (PS_Stream::*f)(T),T v):
    _PS_func(f), param(v) {}
// protected:  Hans 8 Feb 2002
