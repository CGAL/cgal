...
template <class Tree_traits, class Search_traits, class Distance>
void swap (typename Nearest_neighbour_general_distance<Tree_traits, 
				Search_traits, Distance>::iterator& x,
        typename Nearest_neighbour_general_distance<Tree_traits, 
				Search_traits, Distance>::iterator& y) {
        typename Nearest_neighbour_general_distance<Tree_traits, 
		Search_traits, Distance>::iterator::Iterator_implementation
