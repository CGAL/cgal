...
//
// file          : include/CGAL/Orthogonal_k_neighbors_search.h
// package       : ASPAS (3.12)
...
#ifndef  ORTHOGONAL_K_NEIGHBORS_SEARCH_H
#define  ORTHOGONAL_K_NEIGHBORS_SEARCH_H
#include <cstring>
#include <list>
#include <queue>
#include <memory>
...
class Orthogonal_k_neighbors_search {
...
Distance* distance_instance;
    ...
    // constructor
    Orthogonal_k_neighbors_search(Tree& tree, const Query_item& q,  
    ...
    // Print statistics of the k_neighbors search process.
    std::ostream& statistics (std::ostream& s) {
    	s << "K_Neighbors search statistics:" << std::endl;
...
#endif  // ORTHOGONAL_K_NEIGHBORS_SEARCH
