 ...
 *            Iddo Hanniel
 * included to ASPAS as Kdtree_example1.C
 * modifying #include <CGAL/kdtree_d.h> to <CGAL/Kd_tree_d_new.h>
 * demonstrating backward compability with old kd tree package by
 * adding a representation class R (commented out) to user defined
 * point or alternatively applying partial specialitation for Kernel_traits 
\*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*/
