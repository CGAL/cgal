...
\ccTexHtml{Section~\ref{sec:min_circle_2_traits_req}}{Section&nbsp;<A HREF="requirements_Min_circle_2.html"><IMG SRC="../cc_ref_up_arrow.gif" ALT="reference arrow" WIDTH="10" HEIGHT="10"></A>}.
...
\ccUnchecked
\ccHidden
\ccConstructor{ CGAL_Min_circle_2( const CGAL_Min_circle_2<Traits>&);}{
        copy constructor.}
...
\ccMemberFunction{ CGAL_Min_circle_2<Traits>&
                   operator = ( const CGAL_Min_circle_2<Traits>&);}{
        assignment operator.}
...
\ccFunction{ ostream& operator << ( ostream& os,
                                    const CGAL_Min_circle_2<Traits>&
                                        min_circle);}{
...
\ccFunction{ CGAL_Window_stream&
             operator << ( CGAL_Window_stream& ws,
                           const CGAL_Min_circle_2<Traits>& min_circle);}{
...
\linebreakByHand
\ccc{CGAL_Min_circle_2_adapterH2}
