...
% Concept: Min_circle_2_traits
% -----------------------------------------------------------------------------
% file  : doc_tex/basic/Optimisation/Optimisation_ref/Min_circle_2_traits.tex
...
\begin{ccRefConcept}{Min_circle_2_traits}
...
\ccConstructor{ Min_circle_2_traits( );}{}
\ccConstructor{ Min_circle_2_traits( const Min_circle_2_traits&);}{}
...
\ccMemberFunction{ \ccPureGlobalScope Orientation
...
\ccRefIdfierPage{\ccPureGlobalScope Min_circle_2_traits_2<R>}

% -----------------------------------------------------------------------------
\ccSeeAlso

\ccRefIdfierPage{\ccPureGlobalScope Min_circle_2<Traits>}
...
\ccMemberFunction{ \ccPureGlobalScope Bounded_side
...
\ccFunction{ CGAL::Window_stream&
             operator << ( \ccPureGlobalScope Window_stream& ws,
                           const Circle& circle);}{
