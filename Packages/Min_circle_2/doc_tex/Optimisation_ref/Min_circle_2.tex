...
degenerate\ccIndexSubitem[t]{degeneracies}{\ccFont Min_circle_2},
...
\emph{support set}\ccIndexSubitem[t]{support set}{\ccFont Min_circle_2},
...
a given support~set\ccIndexSubitem[t]{support set}{\ccFont Min_circle_2}
$S$ of $P$.
...
\ccIndexSubitem[t]{support set}{\ccFont Min_circle_2}
...
\ccIndexSubitem[t]{degeneracies}{\ccFont Min_circle_2}
...
\ccIndexSubitem[t]{validity check}{\ccFont Min_circle_2}
...
If randomization\ccIndexSubitem[t]{randomization}{\ccFont Min_circle_2} is
