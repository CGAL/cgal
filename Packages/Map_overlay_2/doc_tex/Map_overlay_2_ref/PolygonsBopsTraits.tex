...
\ccTypes
  ...
  \ccNestedType{X_monotone_curve_2}{same as \ccc{SweepLineTraits_2::X_monotone_curve_2}.}
  \ccNestedType{Curve_2}{same as \ccc{SweepLineTraits_2::X_monotone_curve_2}.}
...
\ccMethod{
   Point_2 calc_hitting_point(const X_monotone_curve_2& cv,const Point_2& p);}{
