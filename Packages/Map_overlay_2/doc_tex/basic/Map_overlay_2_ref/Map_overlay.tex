...
\ccc{MapOverlayDcel_2<Traits,Vertex_base,Halfedge_base,Face_base>}\lcTex{ 
   (\ccRefPage{CGAL::MapOverlayDcel_2<Traits,Vertex_base,Halfedge_base,Face_base>})}
\ccc{Map_overlay_incremental<Subdivision,Notifier>}\lcTex{ 
   (\ccRefPage{CGAL::Map_overlay_incremental<Subdivision,Notifier>})}
\ccc{Map_overlay_sweep_line<Subdivision,Notifier>}\lcTex{ 
   (\ccRefPage{CGAL::Map_overlay_sweep_line<Subdivision,Notifier>})}
