...
files. The macro \verb+\ccIncludeVerbatim{+{\em filename\/}\verb+}+
...
The revision control system \Dindex{RCS} manages variables like the
...
\begin{ccHtmlOnly}
<CENTER>
   <IMG SRC="./horizontal_struct.gif" ALT="Horizontal layout with two examples: A function that fits well in three columns and a constructor formatted in two columns and three lines.">
</CENTER>
\end{ccHtmlOnly}
\end{figure}
...
\begin{ccHtmlOnly}
<CENTER>
  <IMG SRC="./vertical_struct.gif" ALT="Vertical layout with two examples: A function that fits well in three columns, and a function formatted in three lines.">
</CENTER>
\end{ccHtmlOnly}
\end{figure}
...
\begin{tabbing}
  M \= \verb+foo\ccptyParameter bar+M \= foo\ccUnderscore barMMM 
    \= \verb+foo\ccAmpersand bar+M \= \kill
