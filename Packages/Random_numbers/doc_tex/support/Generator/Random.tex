...
\ccSetThreeColumns{double}{\ccVar.get_seed( Seed& seed)}{}
...
\ccMemberFunction{ void get_seed( Seed& seed) const;}{
        stores the current internal seed in \ccc{seed}.}

\ccMemberFunction{ void set_seed( Seed const& seed);}{
        sets the internal seed to \ccc{seed}.}
