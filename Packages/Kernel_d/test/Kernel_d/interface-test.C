...
{ 
  ...
  { 
    ...
    CGAL_IO_TEST(p1,p4); // IO operations
    ...
    Point::Homogeneous_iterator hit; 
    Point::Cartesian_iterator cit; int i;
  ...
  { 
    ...
    CGAL_TEST(a3.homogeneous(1)==RT(4));
    CGAL_TEST(a3.cartesian(1)==FT(2));
    CGAL_TEST(a3[0]==FT(3));
    CGAL_TEST(a3.direction()==Direction(3,2,1));

    Vector::Homogeneous_iterator hit; 
    Vector::Cartesian_iterator cit; int i;
    ...
    CGAL_TEST(FT(2,3)*a4==Vector(2,0,3));
    
    CGAL_TEST(a3/2==Vector(3,2,1,2));
    CGAL_TEST(a3/FT(2,3)==Vector(9,6,3,2));
  ...
  { 
    ...
    Direction::Delta_iterator it; int i;
  ...
  { 
    ...
    Hyperplane::Coefficient_iterator it; int i;
