...
Direction_d<R>(int d, InputIterator first, InputIterator last)}{
  ...
  elements and the value type of \ccc{InputIterator} is \ccc{RT}.}

\ccConstructor{Direction_d<R>(Base_direction, int d, int i)}{
  returns a variable \ccc{dir} of type \ccc{Direction_d<R>} initialized  
...
\ccMethod{bool  is_degenerate() ;}{
  returns true iff \ccc{dir.vector()} is the zero vector.}
...
We provide all operations of the lower dimensional interface \ccc{dx()},
\ccc{dy()}, \ccc{dz()}. 
