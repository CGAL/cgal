...
\ccFunction{bool weak_equality(const Line_d<R>& l1, const Line_d<R>& l2) ;}{Test for equality as unoriented lines. 
}

\ccFunction{bool parallel(const Line_d<R>& l1, const Line_d<R>& l2) ;}{returns true if \ccc{l1} and \ccc{l2} are parallel as unoriented lines
and false otherwise.  
}
