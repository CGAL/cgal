...
object \ccStyle{obj} of the class \ccc{Object} can represent an
arbitrary class. The only operations it provides is to make copies and
...
\ccc{assign} to use the functionality of the encapsulated class.
