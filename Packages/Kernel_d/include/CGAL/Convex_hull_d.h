...
// ============================================================================
//---------------------------------------------------------------------
// file generated by notangle from Conve_hull_d.lw
...
protected:
  ...
  Vector_d           quasi_center_;    // sum of the vertices of the origin simplex
...
public:
  ...
  /*{\Mop returns the facet opposite to the $i$-th vertex of $f$ (|Facet_handle()|
  if there is no such facet). \precond $0 \leq i < |dcur|$ and |dcur > 1|. }*/
    ...
    switch (location) {
      ...
      case 1:
        { num_of_vertices++; 
          ...
          for (it = visible_simplices.begin(); it != visible_simplices.end(); ++it) {
            Simplex_handle S = *it; 
