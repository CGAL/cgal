//---------------------------------------------------------------------
// file generated by notangle from PointHd.lw
...
PointHd(int a, int b, int c = 1) : Base( Tuple((RT)a,(RT)b,(RT)c) )
{ CGAL_assertion_msg((c != 0),"PointHd::construction: c == 0.");
  if (c < 0) invert_rep();
}

PointHd(const RT& a, const RT& b, const RT& c = 1)
/*{\Mcreate introduces a variable |\Mvar| of type |\Mname| in 
$2$-dimensional space.}*/ 
  : Base( Tuple(a,b,c) )
{ CGAL_assertion_msg((c!=0),"PointHd::construction: c == 0.");
...
PointHd(int a, int b, int c, int d) : 
  Base( Tuple((RT)a,(RT)b,(RT)c,(RT)d) )
{ CGAL_assertion_msg((d!=0),"PointHd::construction: d == 0.");
  if (d < 0) invert_rep();
}

PointHd(const RT& a, const RT& b, const RT& c, const RT& d) 
/*{\Mcreate introduces a variable |\Mvar| of type |\Mname| in 
$3$-dimensional space.}*/
  : Base( Tuple(a,b,c,d) )
{ CGAL_assertion_msg((d!=0),"PointHd::construction: d == 0.");
...
/*{\Mimplementation 
Points are implemented by arrays of |RT| as an item type.  All
operations like creation, initialization, tests, point - vector
arithmetic, input and output on a point $p$ take time
$O(|p.dimension()|)$. |dimension()|, coordinate access and conversions
take constant time.  The space requirement for points is
$O(|p.dimension()|)$.}*/
