...
$x_{d-1}$ are Cartesian point coordinates.  The sign of the left hand
side of this expression determines the position of a point $x$ with
respect to the hyperplane (on the hyperplane, on the negative side, or
...
typedef typename Tuple::const_iterator Coefficient_iterator;
...
exist.  The value type of |RandomAccessIterator| is
|PointHd<RT,LA>|. }*/
...
Coefficient_iterator coefficients_begin() const { return ptr->begin(); }
/*{\Mop returns an iterator pointing to the first coefficient.}*/

Coefficient_iterator coefficients_end() const { return ptr->end(); }
...
/*{\Mop return true iff point |p| lies on the hyperplane |\Mvar|. }*/
{ return (oriented_side(p) == ON_ORIENTED_BOUNDARY); }

bool has_on_boundary(const PointHd<RT,LA>& p) const 
/*{\Mop return true iff point |p| lies on the boundary of 
hyperplane |\Mvar|. }*/
{ return (oriented_side(p) == ON_ORIENTED_BOUNDARY); }

bool has_on_positive_side(const PointHd<RT,LA>& p) const 
/*{\Mop return true iff point |p| lies on the positive side of 
hyperplane |\Mvar|. }*/
{ return (oriented_side(p) == ON_POSITIVE_SIDE); }

bool has_on_negative_side(const PointHd<RT,LA>& p) const 
/*{\Mop return true iff point |p| lies on the negative side of 
hyperplane |\Mvar|. }*/
...
$O(|h.dimension()|)$. |dimension()| and coordinate access take
