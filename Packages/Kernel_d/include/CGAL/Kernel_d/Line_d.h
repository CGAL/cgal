//---------------------------------------------------------------------
// file generated by notangle from Line_d.lw
...
/*{\Mcreate introduces a variable |\Mvar| of type |\Mname| and 
initializes it to the line through |r.point(1)| and |s.point(2)|. }*/
...
/*{\Mop returns an arbitrary point on l.  It holds |point(i) ==
