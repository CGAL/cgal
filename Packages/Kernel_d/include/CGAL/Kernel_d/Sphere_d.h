//---------------------------------------------------------------------
// file generated by notangle from Sphere_d.lw
...
/*{\Mop return an iterator pointing to the first defining point.}*/

point_iterator points_end() const { return ptr->P.end(); }
/*{\Mop return an iterator pointing beyond the last defining point.}*/
...
/*{\Mop returns the squared radius of circle. }*/
...
/*{\Mop   eturns |ON_BOUNDED_SIDE|, |ON_BOUNDARY|, or
...
/*{\Mop returns the circle with the same center and squared
  radius as circle but with opposite orientation.}*/
