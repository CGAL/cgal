//---------------------------------------------------------------------
// file generated by notangle from DirectionHd.lw
...
typedef typename Tuple::const_iterator Delta_iterator;
...
DirectionHd(const RT& a, const RT& b) : Base( Tuple(a,b,1) ) {}
...
DirectionHd(const RT& a, const RT& b, const RT& c) : 
  Base( Tuple(a,b,c,1) ) {}
/*{\Mcreate introduces a variable |\Mvar| of type |\Mname| in 
            $3$-dimensional space. }*/
...
Delta_iterator deltas_begin() const { return ptr->begin(); }
/*{\Mop  returns an iterator pointing to the first delta of |\Mvar|. }*/
Delta_iterator deltas_end() const { return ptr->last(); }
