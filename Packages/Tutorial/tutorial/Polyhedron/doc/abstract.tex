...
\begin{figure}[t]
    \centering{\includegraphics[width=0.45\textwidth]{figs/gargoyle_raster}}
...
\begin{figure}[t]
    \centering{\includegraphics[width=0.45\textwidth]{figs/gargoyle_vec}}
...
% \begin{figure}[t]
% % I try to make these figures larger so that the distinction
% % between vector and raster output becomes more visible.
% \hfill\includegraphics[width=5.0cm]{figs/gargoyle_vec}\\~

% \noindent\vspace*{-20mm}\includegraphics[width=50mm]{figs/gargoyle_raster}
% %    \centering{\includegraphics[width=3.0cm]{figs/gargoyle_raster}
% %               \includegraphics[width=3.0cm]{figs/gargoyle_vec}}
