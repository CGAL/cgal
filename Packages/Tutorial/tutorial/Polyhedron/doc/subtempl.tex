...
The smoothing points of a refined polyhedron is generated 
...
of the halfedges. The \CodeFmt{face\_point\_rule} for 
...
the facet handle, the \CodeFmt{face\_point\_rule} is called to 
...
smoothing points generated by the geometry policy, i.e.\ the \CodeFmt{point\_rule()}.
...
from the \poly\ . The only geometry requirement is the \CodeFmt{Point} type 
