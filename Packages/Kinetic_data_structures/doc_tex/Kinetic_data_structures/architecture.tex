...
such a table, \ccc{CGAL::KDS::Notifying_table<Object>}.
...
More specifically, the \ccc{NotifyingTable} allows multiple kinetic
...
particular instance of the \ccc{NotifyingTable} model will contain
...
\ccc{Simulator} they \ccc{NotifyingTable} models are explicitly shared
...
the \ccc{NotifyingTable} model can be extended to handle many such
...
\ccc{NotifyingTable} can check that the trajectories are
