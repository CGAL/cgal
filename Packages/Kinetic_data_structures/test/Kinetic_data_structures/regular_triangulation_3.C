...
#include <CGAL/KDS/Regular_triangulation_event_log_visitor_3.h>
#include <algorithm>
#include <iterator>

int main(int, char *[]){

  typedef CGAL::KDS::Regular_triangulation_exact_simulation_traits_3 Simulation_traits;
  typedef CGAL::KDS::Regular_triangulation_event_log_visitor_3 Visitor;
  typedef CGAL::KDS::Regular_triangulation_3<Simulation_traits, Visitor> KDel;
