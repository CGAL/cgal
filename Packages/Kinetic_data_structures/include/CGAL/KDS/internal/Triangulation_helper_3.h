#ifndef CGAL_KDS_TRIANGULATION_HELPER_H
#define CGAL_KDS_TRIANGULATION_HELPER_H
...
public:
  ...
  bool has_degree_3(const Edge &e) const {
    return CGAL::KDS::internal::has_degree_3(*this, e);
  };
  ...
  bool has_degree_4(const Vertex_handle vh) const {
    return CGAL::KDS::internal::has_degree_4(*this, vh);
  }
  ...
  Vertex_handle other_vertex(const Facet &f, const Edge &e) const {
    return CGAL::KDS::internal::other_vertex(*this, f, e);
 }
  ...
  void set_label(const Edge &e, Edge_label l) const {
    CGAL::KDS::internal::set_edge_label(*this, e, l);
  }
  ...
  Edge edge_in_cell(const Edge &e, const Cell_handle c) const {
    return CGAL::KDS::internal::edge_in_cell(e, c);
  }
protected:
