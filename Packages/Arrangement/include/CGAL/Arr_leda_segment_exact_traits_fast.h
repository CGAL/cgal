...
//
// file          : include/CGAL/Arr_leda_segment_exact_traits_fast.h
...
class Arr_leda_segment_exact_traits_fast
  : public Pm_segment_traits_fast_2<leda_rat_kernel_traits>
{
public:
  Arr_leda_segment_exact_traits_fast() {}
