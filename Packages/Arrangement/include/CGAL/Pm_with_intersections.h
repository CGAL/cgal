...
protected:
  ...
  {
    //return ((traits->curve_is_in_x_range(cv2, traits->curve_source(cv1)) && 
    //         traits->curve_is_in_y_range(cv1, traits->curve_source(cv2))) ||
    //        (traits->curve_is_in_x_range(cv2, traits->curve_target(cv1)) && 
    //         traits->curve_is_in_y_range(cv1, traits->curve_source(cv2))) ||
    //        (traits->curve_is_in_x_range(cv2, traits->curve_source(cv1)) && 
    //         traits->curve_is_in_y_range(cv1, traits->curve_target(cv2))) ||
    //        (traits->curve_is_in_x_range(cv2, traits->curve_target(cv1)) && 
    //         traits->curve_is_in_y_range(cv1, traits->curve_target(cv2))));
