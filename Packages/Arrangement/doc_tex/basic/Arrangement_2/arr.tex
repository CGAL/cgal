...
created from any container of points, where the $i$th and $(i+1)$st points 
in the container represent the endpoints of the $i$th segment of the polyline.
...
The \ccc{Arr_conic_traits_2<Kernel>} class can be used for constructing
...
however using \ccc{Traits} classes as the \ccc{Polyline Traits} will force 
