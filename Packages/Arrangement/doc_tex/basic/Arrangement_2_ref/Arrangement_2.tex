...
\ccCreation
    ...
    %\ccConstructor{Arrangement_2<Dcel,Traits,Base_node>( list<Traits::X_monotone_curve_2> &l );}
    ...
    %\ccConstructor{Arrangement_2<Dcel,Traits,Base_node>( InputIterator begin, 
     ...
     %           \ccPrecond{the container contains \ccStyle{Traits::X_monotone_curve_2} objects.}       
     %           }
...
\ccOperations
    ...
    \ccMethod{void clear();}
     ...
     \ccMethod{Curve_iterator insert(const Curve_2& cv);}{inserts the curve
       ...
       \ccc{Traits::curve_make_x_monotone}
    ...
    \ccMethod{Curve_iterator insert_from_vertex( const X_monotone_curve_2 & cv,
...
\end{ccAdvanced}    
    ...
    %\ccMethod{void insert( list<Traits::X_monotone_curve_2> &l );} {insert the
    ...
    %               \ccStyle{Traits::X_monotone_curve_2} objects.}}

%\comment{iddo: maybe add the function:} 
%\ccMethod{insert_super_curve(list<Traits::X_monotone_curve_2> &l );}{}
%\comment{iddo: which will insert the X_monotone_curve_2s with prev/next to the super-curve from which they originated.}
