...
\ccTypes
  ...
  \ccNestedType{X_monotone_curve_2}{same as \ccc{PlanarMapTraits_2::X_monotone_curve_2}.}
...
\ccMethod{void curve_make_x_monotone(const Curve_2& cv, list<X_monotone_curve_2>& l);}{
...
\ccMethod{X_monotone_curve_2 curve_reflect_in_x_and_y(const X_monotone_curve_2& cv);}{returns the \ccc{X_monotone_curve_2}
...
right of \ccc{pt} is an \ccc{X_monotone_curve_2} (i.e., there is an overlapping subcurve
...
\ccMethod{bool curves_overlap(const X_monotone_curve_2& cv1, const X_monotone_curve_2& cv2);}
