...
\begin{figure}
\begin{ccTexOnly}
{\centerline {\includegraphics{Arrangement_2/arr_hier}}}
\end{ccTexOnly}
...
define their own hierarchy by passing their own
\ccHtmlNoLinksFrom{intersection} sequence.
...
their points of \ccHtmlNoLinksFrom{intersection} with other points before they
are inserted into the map. Furthermore, overlapping curves are
supported. If two curves overlap the traits \ccHtmlNoLinksFrom{intersection}
function returns the two endpoints of the common part. Circulators of the
...
\begin{figure}[h]
\begin{ccTexOnly}
{\centerline {\includegraphics{Arrangement_2/arr_circ}}}
\end{ccTexOnly}
...
vertices may be original endpoints of the input curves, \
ccHtmlNoLinksFrom{intersection} points of two (or more) curves or points where
the tangent to the curve is a vertical line.

\begin{figure}[h]
\begin{ccTexOnly}
{\centerline {\includegraphics{Arrangement_2/arr_conics}}}
\end{ccTexOnly}
