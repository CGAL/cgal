...
printed depends on the the output operator imlemented for it.
...
\section{Arrangements of Circular Arcs and/or Line Segments}

\ccInclude{CGAL/Arr_circle_real_traits.h}\\
...
\ccInclude{CGAL/Arr_leda_polyline_traits.h}
...
The default hierarchy strucutre can be extended to include more levels
