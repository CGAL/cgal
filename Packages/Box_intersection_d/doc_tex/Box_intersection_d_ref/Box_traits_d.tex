...
\begin{ccRefClass}[Box_intersection_d::]{Box_traits_d<Box>}
...
type of \ccc{Box}; there is one if \ccc{Box} is a class type and there are
two if \ccc{Box} is a pointer type, one for a mutable and one for a const
pointer, respectively.

\begin{itemize}
  \item
    \ccc{Box}: either a class type \ccc{B}, a pointer \ccc{B*}, or a
