...
\ccc{Polyhedron_3::Point} is deinfed.

\ccHeading{Requirements}
\begin{enumerate}
   \item \ccc{Polyhedron_3::Point} is equivalent to \ccc{Traits::Point_3}.
  ...
  \item \ccc{Polyhedron_3} must define the following types:
        ...
        \end{itemize}
        The vertex type of \ccc{Polyhedron_3} must be 
        \ccc{CGAL::Polyhedron_3<Traits>::Vertex};
        the facet type must be \ccc{CGAL::Polyhedron_3<Triats>::Facet}.
\end{enumerate}
