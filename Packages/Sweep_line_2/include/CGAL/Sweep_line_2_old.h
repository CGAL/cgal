...
//
// file          : include/CGAL/Sweep_line_2_old.h
// package       : arr (1.87)
...
public:
  ...
  Sweep_line_2_old() : Base() {}
  Sweep_line_2_old(Traits *traits_) : Base(traits_) {} 
...
template <class CurveInputIterator, class SweepLineTraits_2>
inline bool
Sweep_line_2_old<CurveInputIterator, SweepLineTraits_2>::
