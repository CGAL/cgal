...
curves in a plane, the \ccStyle{Sweep_2} class provides the following 
...
The \ccStyle{Sweep_2} implementation supports not only line segments 
but also 
...
\section{Example using \ccStyle{Sweep_2}}
\label{ssec:example1_sweep}
The following example demonstrates the usage of the 
\ccc {Sweep_2} algorithm to find all subcurves created by 
