...
the endpoints of all curves and their \ccHtmlNoLinksFrom{intersection} points.
The initial set of 
...
\begin{itemize}
\item calculate the \ccHtmlNoLinksFrom{intersection} points between the curves
  of $C$. 
\item calculate the interior-disjoint curves induced by $C$.
\item calculate the \ccHtmlNoLinksFrom{intersection} points and return a list
  of curves participating at each \ccHtmlNoLinksFrom{intersection} point.
\item answer the query whether an \ccHtmlNoLinksFrom{intersection} point between
