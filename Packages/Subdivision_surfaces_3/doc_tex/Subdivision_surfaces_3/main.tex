...
%% \begin{ccHtmlOnly}
%%     <CENTER>
%%         <img src="./fig/QTSub.gif" alt="QT subdivision on a rook model"><P>
%%     </CENTER>
%% \end{ccHtmlOnly}
...
\ccc{CGAL::Subdivision_surfaces_3::PQQ} is the refinement 
...
the geometry policies and reuse the \ccc{PQQ} refinement host.
Considering the popularity of Catmull-Clark subdivision,
\ccc{Subdivision_surfaces_3} supports \ccc{CGAL::CatmullClark_stencil},
...
concept, and \ccc{step} specifies the refinement depth.
...
Note \ccc{DQQ_stencil} and \ccc{Sqrt3_stencil} do not support
meshes with global boundaries. Also, \ccc{PTQ_stencil} and
\ccc{Sqrt3_stencil} are subset of \ccc{PQQ_stencil}, and are not
