...
% +------------------------------------------------------------------------+
The subdivision algorithm is an easy to use yet powerful way to 
...
surfaces. It is hence especially popular for the character 
...
While many subdivision schemes are developed and new schemes 
...
aims to be easy to use and powerful to extend.
...
Catmull-Clark ...etc) subdivision, Section \ref{subsecFirstSub} 
...
\begin{ccTexOnly}
  \begin{center}
    ...
    Four refinement patterns are demonstrated on a valence-n submesh.
...
The input mesh of the refinement is called \emph{control mesh}.
...
% +-------------------------------------------------------------+
\subsection{Your First CGAL::Subdivision}
\label{subsecFirstSub}
...
\ccc{CatmullClark_subdivision(P,d);} 
...
This example shows how to apply \emph{the} subdivision algorithm 
...
you just want a unique surface which looks really bad. In either case,
...
\ccc{Subdivision_surfaces_3} also supportx three other refinements that 
...
of \ccc{Subdivision_surfaces_3}. This is explained in next section.
...
of the Catmull-Clark policy class is in the Section~\ref{subsecCC}.
