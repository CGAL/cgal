...
\end{ccExampleCode}
\ccc{Subdivision_surfaces_3} specifies the namespace of our
...
with \ccc{Subdivision_surfaces_3}.
...
and associated operations being defined, \ccc{Subdivision_surfaces_3} 
