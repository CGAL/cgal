...
\ccc{Subdivision_surfaces_3} supports \ccc{CGAL::CatmullClark_stencil_3},
...
\ccc{CGAL::CatmullClark_stencil_3}.
...
Note \ccc{DQQ_stencil_3} and \ccc{Sqrt3_stencil_3} do not support
meshes with global boundaries. Also, \ccc{PTQ_stencil_3} and
