...
\begin{ccTexOnly}
    ...
    \begin{picture}(0,0)(0.0,0.0)
      \put (78,25){% textwidth = 156mm
          \includegraphics[width=0.095\textwidth]{\FIGDIR/rook_mesh.eps}
          \includegraphics[width=0.095\textwidth]{\FIGDIR/rook_qt1.eps}
          \includegraphics[width=0.095\textwidth]{\FIGDIR/rook_qt2.eps}
          \includegraphics[width=0.095\textwidth]{\FIGDIR/rook_surf1.eps}
          \includegraphics[width=0.095\textwidth]{\FIGDIR/rook_surf2.eps}
      }
...
% +------------------------------------------------------------------------+
Subdivision algorithms (see e.g.~\cite{cgal:warren-subdivision-02})
...
\SUB3\ provides a set of refinement patterns (the \emph{refinement hosts})
...
\SUB3\ provides \ccc{CGAL::CatmullClark_stencil} realizing the 
...
\SUB3\ provides four refinement hosts of primal 
...
of \CC\ subdivision. \ccc{Point} is an alias to \ccc{Point_3}
in \ccc{_Poly}.
...
% +------------------------------------------------------------------------+
\CC , Loop, \DS\ and \SQRT3\ subdivisions are directly supported 
by \SUB3. 
