...
defined in the typename \ccc{Polyhedron} and in 
the typename \ccc{Polyhedron::Vertex}. The refinement hosts use
...
% +------------------------------------------------------------------------+
One of the goal of \ccc{Subdivision_surfaces_3} is 
