...
and take a cue from the policy-based design \cite{cgal:shiue-sesub-05}.
...
%The refined mesh is shown below the initial mesh.
\begin{ccTexOnly}
  \begin{center}
    \parbox{0.6\textwidth}{%
...
(e.g.~\ccc{Halfedge_handle}) of 
the source mesh, and the target vertex as the reference of 
the \ccc{Point}. The function collects the neighbors
...
of \ccc{PQQ_stencil}), which defines a superset of PTQ stencils.
