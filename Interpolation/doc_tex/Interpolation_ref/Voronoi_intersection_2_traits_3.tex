...
\begin{ccRefClass}{Voronoi_intersection_2_traits_3<K>}
 ...
 \ccTypedef{typedef K::Compare_distance_3          Compare_distance_2;}{}
  ...
  {An instance of this function object class computes the square 
    ...
    If the number type \ccc{FT} does not support the square root 
...
{The plane associated to the traits class contains \ccc{point} and has as normal vector \ccc{normal}.}
