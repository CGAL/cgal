...
{
  const std::filesystem::path fname1 = (argc>1) ? argv[1] : CGAL::data_file_path("points_3/hippo1.ply");
  const std::filesystem::path fname2 = (argc>2) ? argv[2] : CGAL::data_file_path("points_3/hippo2.ply");
