...
Function \ccRefIdfierPage{CGAL::jet_smooth_point_set} smoothes the input point set by projecting each point onto a smooth parametric surface patch (so-called jet surface) fitted over its $k$ nearest neighbors.\\
