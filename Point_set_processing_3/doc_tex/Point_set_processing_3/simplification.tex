...
Function \ccc{CGAL::random_simplify_point_set()} randomly deletes a user-specified fraction of points from the input point set. This algorithm is fast. The following example reads an input point set and randomly deletes 75\% of the points.
