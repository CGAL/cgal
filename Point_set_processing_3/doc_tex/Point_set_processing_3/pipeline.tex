...
\begin{center}
    ...
    % Image
    \begin{ccTexOnly}
        \includegraphics[width=0.7\textwidth]{Point_set_processing_3/merge_simplification} % omit .eps suffix
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
...
\begin{center}
    \label{Point_set_processing_3-fig-APSS}
    % Image
    \begin{ccTexOnly}
        \includegraphics[width=0.5\textwidth]{Point_set_processing_3/APSS} % omit .eps suffix
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
