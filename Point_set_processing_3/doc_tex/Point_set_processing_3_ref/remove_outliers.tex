...
\begin{description}
\item \ccc{first}: iterator over the first input point. \item \ccc{beyond}: past-the-end iterator over input points. \item \ccc{point_pmap}: property map ForwardIterator -$>$ \ccc{Point_3} \item \ccc{k}: number of neighbors. \item \ccc{removed_percentage}: percentage of points to remove. \item \ccc{kernel}: geometric traits. \end{description}
}
\ccGlue
