...
\ccFunction{bool write_xyz_point_set(const char * pFilename, InputIterator first, InputIterator beyond);}
{
...
\begin{description}
\item \ccc{pFilename}: output file \item \ccc{first}: first input point \item \ccc{beyond}: past-the-end input point \end{description}
}
\ccGlue
\ccFunction{bool write_xyz_point_set(const char * pFilename, InputIterator first, InputIterator beyond, bool write_normals);}
{
