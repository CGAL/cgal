...
\ccc{CGAL::write_off_point_set()} saves points (positions + optionally normals) to a .off file (ASCII).

The \ccc{CGAL::write_off_point_set()} function exists in two flavors:
...
\ccFunction{template<typename InputIterator> bool write_off_point_set(std::ostream& stream, InputIterator first, InputIterator beyond);}
{
...
\ccGlue
\ccFunction{template<typename InputIterator> bool write_off_point_set(std::ostream& stream, InputIterator first, InputIterator beyond, bool write_normals);}
{
...
if(!CGAL::write_off_point_set(filename,
