...
\ccFunction{bool write_off_point_set(const char * pFilename, InputIterator first, InputIterator beyond);}
{
...
\ccGlue
\ccFunction{bool write_off_point_set(const char * pFilename, InputIterator first, InputIterator beyond, bool write_normals);}
{
