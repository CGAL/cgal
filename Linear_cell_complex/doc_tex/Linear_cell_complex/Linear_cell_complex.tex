...
read \ccRef[the combinatorial maps chapter]{Pkg:CombinatorialMaps}
...
\begin{figure}
  ...
  \begin{ccHtmlOnly}
    ...
    \caption{UML diagram of the main classes of the package. Gray
      ...
      \ccRef[combinatorial map package]{Pkg:CombinatorialMaps}.}
...
As explained in the 
\ccRef[combinatorial map user manual]{Pkg:CombinatorialMaps},
...
explained in package \ccRef[combinatorial map]{Pkg:CombinatorialMaps}). 
Intuitively, the
