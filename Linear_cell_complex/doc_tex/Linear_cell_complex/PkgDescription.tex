...
\begin{ccPkgDescription}{Linear Cell Complex\label{Pkg:LinearCellComplex}}
  ...
  \ccPkgSummary{This package  implements linear cell complexes,
    objects in \emph{d}-dimension with linear geometry. The combinatorial
    part of objects is described by a 
    \ccRef[combinatorial map]{Pkg:CombinatorialMaps}, representing all the 
    ...
    associating a \ccc{Point} to each vertex of the map.
    
    Taking a 2D combinatorial map, and using 3D points, gives a
    linear cell complex equivalent to a \ccc{Polyhedron_3}.}
%
