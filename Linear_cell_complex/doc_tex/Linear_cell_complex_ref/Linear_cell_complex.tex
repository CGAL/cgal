...
% +------------------------------------------------------------------------+
\begin{ccRefClass}{Linear_cell_complex<d,d2,Traits_,CMItems,Alloc_>}
...
\ccInheritsFrom
\ccRefIdfierPage{CGAL::Combinatorial_map<d,CMItems,Alloc_>}
...
\begin{ccAdvanced}
  ...
  \ccc{Linear_cell_complex<d,d2,Traits_,CMItems,Alloc_,CMap>} allowing
...
% +-----------------------------------+
\ccTypes
\ccThree{typedef Linear_cell_complex<d,d2,Traits_,CMItems,Alloc_>}{}{}
\ccTypedef{typedef Linear_cell_complex<d,d2,Traits_,CMItems,Alloc_> Self;}{}
\ccGlue
