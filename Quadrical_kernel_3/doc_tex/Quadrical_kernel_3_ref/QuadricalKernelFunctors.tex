...
\ccMemberFunction{QuadricalKernel_3::Quadric_3
  operator()(QuadricalKernel_3::Algebraic_kernel::Polynomial_3 polynomial);}
...
\ccMemberFunction{QuadricalKernel_3::Curve_3
  operator()(QuadricalKernel_3::Quadric_3 q1, QuadricalKernel_3::Quadric_3 q2);}
...
template< class OutputIterator >
OutputIterator
  operator()(QuadricalKernel_3::Curve_3 curve, OutputIterator oi);}
...
template< class OutputIterator >
OutputIterator
  operator()(QuadricalKernel_3::Curve_3 curve, QuadricalKernel_3::Quadric_3 q,
OutputIterator oi);}
{decomposes a curve into maximal objects of type 
