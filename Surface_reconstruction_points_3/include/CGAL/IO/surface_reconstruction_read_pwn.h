...
#ifndef CGAL_SURFACE_RECONSTRUCTION_READ_PWN_H
#define CGAL_SURFACE_RECONSTRUCTION_READ_PWN_H
...
bool surface_reconstruction_read_pwn(const char* pFilename, OutputIterator output)
{
...
#endif // CGAL_SURFACE_RECONSTRUCTION_READ_PWN_H
