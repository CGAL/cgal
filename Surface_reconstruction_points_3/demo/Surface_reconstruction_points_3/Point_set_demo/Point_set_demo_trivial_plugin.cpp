...
class Point_set_demo_trivial_plugin : 
  public QObject,
...
}; // end Point_set_demo_trivial_plugin

void Point_set_demo_trivial_plugin::init(QMainWindow* mainWindow, Scene_interface* scene_interface)
{
  scene = scene_interface;
...
QList<QAction*> Point_set_demo_trivial_plugin::actions() const {
  return QList<QAction*>() << actionBbox;
}

void Point_set_demo_trivial_plugin::bbox()
{
...
void Point_set_demo_trivial_plugin::enableAction() {
  actionBbox->setEnabled(true);
}

Q_EXPORT_PLUGIN2(Point_set_demo_trivial_plugin, Point_set_demo_trivial_plugin);

#include "Point_set_demo_trivial_plugin.moc"
