...
}; // end Point_set_demo_convex_hull_plugin


void Point_set_demo_convex_hull_plugin::on_actionConvexHull_triggered()
{
...
Q_EXPORT_PLUGIN2(Point_set_demo_convex_hull_plugin, Point_set_demo_convex_hull_plugin);

#include "Point_set_demo_convex_hull_plugin.moc"
