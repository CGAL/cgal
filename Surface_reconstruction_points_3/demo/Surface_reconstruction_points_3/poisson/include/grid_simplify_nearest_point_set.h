...
#ifndef CGAL_GRID_SIMPLIFY_NEAREST_POINT_SET_H
#define CGAL_GRID_SIMPLIFY_NEAREST_POINT_SET_H
          ...
          double epsilon)           ///< tolerance value when comparing 3D points
{
    ...
    return grid_simplify_nearest_point_set(first,beyond,output,k,epsilon,Kernel());
}


CGAL_END_NAMESPACE

#endif // CGAL_GRID_SIMPLIFY_NEAREST_POINT_SET_H
