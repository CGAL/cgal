...
\ccFunction{template<class InputIterator> Poisson_reconstruction_function(InputIterator first, InputIterator beyond);}
{
...
\ccCommentHeading{Parameters}
\begin{description}
\item \ccc{first}: Iterator over first point. \item \ccc{beyond}: Past-the-end iterator. \end{description}
}
