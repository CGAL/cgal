...
\includegraphics[width=0.8\textwidth]{Surface_reconstruction_points_3/sampling}     \end{ccTexOnly}
    \begin{ccHtmlOnly}
        <img width="80%" border=0 src="./sampling.png"><P>
    \end{ccHtmlOnly}
    \begin{figure}[h]
...
\includegraphics[width=0.8\textwidth]{Surface_reconstruction_points_3/holes_bad} 
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
        <img width="80%" border=0 src="./holes_bad.png"><P>
    \end{ccHtmlOnly}
    \begin{figure}[h]
...
\includegraphics[width=0.8\textwidth]{Surface_reconstruction_points_3/flipped_normals}
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
        <img width="80%" border=0 src="./flipped_normals.png"><P>
    \end{ccHtmlOnly}
    \begin{figure}[h]
...
\includegraphics[width=0.8\textwidth]{Surface_reconstruction_points_3/noise}
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
        <img width="80%" border=0 src="./noise.png"><P>
    \end{ccHtmlOnly}
    \begin{figure}[h]
...
\includegraphics[width=0.8\textwidth]{Surface_reconstruction_points_3/sharp_features}
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
        <img width="80%" border=0 src="./sharp_features.png"><P>
    \end{ccHtmlOnly}
    \begin{figure}[h]
