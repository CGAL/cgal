...
\ccc{Point_set_processing_3} package provides outlier removal, simplification, smoothing,
...
See \ccc{Point_set_processing_3} documentation to read point sets from file and preprocess them.
