...
The optional parameter \ccc{two_passes} controls if the Delaunay refinement is done for the input points, or an approximation of the surface obtained from a first pass of the algorithm on a sample of the points.
