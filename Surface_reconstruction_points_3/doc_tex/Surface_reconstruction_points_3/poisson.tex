...
\ccCommentHeading{Parameters}
\begin{description}
\item \ccc{first}: iterator over the first input point. \item \ccc{beyond}: past-the-end iterator over input points. \item \ccc{point_pmap}: property map InputIterator -$>$ \ccc{Point_3}. \item \ccc{normal_pmap}: property map InputIterator -$>$ \ccc{Vector_3}. \end{description}
}
