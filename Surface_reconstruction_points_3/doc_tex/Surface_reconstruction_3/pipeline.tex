...
% \begin{center}
%     \label{Surface_reconstruction_points_3-fig-outlier_removal}
%     % Image
%     \begin{ccTexOnly}
%         \includegraphics[width=0.9\textwidth]{Surface_reconstruction_points_3/outlier_removal} % omit .eps suffix
%     \end{ccTexOnly}
%     \begin{ccHtmlOnly}
...
\begin{center}
    \label{Surface_reconstruction_points_3-fig-merge_simplification}
    % Image
    \begin{ccTexOnly}
        \includegraphics[width=0.7\textwidth]{Surface_reconstruction_points_3/merge_simplification} % omit .eps suffix
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
        <img width="100%" border=0 src="../Surface_reconstruction_points_3/merge_simplification.jpg"><P>
    \end{ccHtmlOnly}
    % Title
    \begin{figure}[h]
...
\ccIncludeExampleCode{Surface_reconstruction_points_3/random_simplification_example.cpp}
...
% \begin{center}
%     \label{Surface_reconstruction_points_3-fig-jet_smoothing}
%     % Image
%     \begin{ccTexOnly}
%         \includegraphics[width=1.0\textwidth]{Surface_reconstruction_points_3/jet_smoothing} % omit .eps suffix
%     \end{ccTexOnly}
%     \begin{ccHtmlOnly}
...
\ccIncludeExampleCode{Surface_reconstruction_points_3/jet_smoothing_example.cpp}
...
% \begin{center}
%     \label{Surface_reconstruction_points_3-fig-pca_normal_estimation}
%     % Image
%     \begin{ccTexOnly}
%         \includegraphics[width=0.9\textwidth]{Surface_reconstruction_points_3/pca_normal_estimation} % omit .eps suffix
%     \end{ccTexOnly}
%     \begin{ccHtmlOnly}
...
\begin{center}
    \label{Surface_reconstruction_points_3-fig-mst_normal_orientation}
    % Image
    \begin{ccTexOnly}
        \includegraphics[width=0.9\textwidth]{Surface_reconstruction_points_3/mst_normal_orientation} % omit .eps suffix
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
