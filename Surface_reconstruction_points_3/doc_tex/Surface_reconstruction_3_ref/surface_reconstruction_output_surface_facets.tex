...
\ccFunction{template<class SurfaceMeshComplex_2InTriangulation_3, typename OutputIterator> void surface_reconstruction_output_surface_facets(const SurfaceMeshComplex_2InTriangulation_3& c2t3, OutputIterator output);}
{
Get reconstructed surface out of a \ccc{SurfaceMeshComplex_2InTriangulation_3} object.
\ccCommentHeading{Template Parameters}
\begin{description}
\item \ccc{SurfaceMeshComplex_2InTriangulation_3}: model of the \ccc{SurfaceMeshComplex_2InTriangulation_3} concept. \item \ccc{OutputIterator}: \ccc{value_type} must be \ccc{Triangle_3}.\end{description}
\ccCommentHeading{Returns} true on success.
\ccCommentHeading{Parameters}
\begin{description}
\item \ccc{c2t3}: Input surface. \item \ccc{output}: Output triangles soup. \end{description}
}
\ccGlue
