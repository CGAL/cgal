...
\ccGlue
\ccConstructor{Reconstruction_vertex_base_3(const Point_with_normal& p);}
{
}
\ccGlue
\ccConstructor{Reconstruction_vertex_base_3(const Point_with_normal& p, Cell_handle c);}
{
}
\ccGlue
