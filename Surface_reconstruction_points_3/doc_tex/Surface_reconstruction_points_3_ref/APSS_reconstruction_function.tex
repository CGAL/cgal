...
\ccc{APSS_reconstruction_function} computes a signed distance field that defines a Point Set Surface (PSS) based on moving least squares (MLS) fitting of algebraic spheres.
...
\ccGlue
\ccMethod{BBox bounding_box() const;}
{
}
\ccGlue
