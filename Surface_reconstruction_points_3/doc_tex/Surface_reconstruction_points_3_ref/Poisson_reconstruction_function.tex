...
\begin{center}
    \label{Surface_reconstruction_points_3-fig-poisson}
    % Image
    \begin{ccTexOnly}
        \includegraphics[width=0.7\textwidth]{Surface_reconstruction_points_3/poisson} % omit .eps suffix
    \end{ccTexOnly}
    \begin{ccHtmlOnly}
        <img width="70%" border=0 src="../Surface_reconstruction_points_3/poisson.jpg"><P>
    \end{ccHtmlOnly}
    % Title
    \begin{figure}[h]
