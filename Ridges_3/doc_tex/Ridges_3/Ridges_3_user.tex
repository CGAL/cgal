...
\item
a min ridge point if the {\em extremality coefficient} $b_3=\langle
...
\section{Approximation of ridges on Triangular Meshes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{ridge-mesh}
...
A regular triangle has 0 or 2 edges crossed by a max (resp. min) ridge
...
\section{Approximation of Umbilics on Triangular Meshes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{umbilic-mesh}
...
The main class is
\ccc{Ridge_approximation<TriangularPolyhedralSurface,Vertex2FTPropertyMap,Vertex2VectorPropertyMap>}.
...
%%%%%%%%%%%%%%%%%%%%%
The main class is
\ccc{Umbilic_approximation<TriangularPolyhedralSurface,Vertex2FTPropertyMap,Vertex2VectorPropertyMap>}.
Its construction requires the mesh and the property maps defining the
...
\ccc{compute} has a parameter to define the size of the neighborhood
of the umbilic.
