...
\ccc{RED_HYPERBOLIC_RIDGE}, see figure \ref{ellipsoid-ridges}.
...
\ccc{BLUE_CREST_RIDGE} and \ccc{RED_CREST_RIDGE}, see figure \ref{david-crest}.
...
specify a ridge interrogation type, that is an entry in the following
