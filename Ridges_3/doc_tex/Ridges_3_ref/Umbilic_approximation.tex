...
\begin{ccRefClass}{Umbilic_approximation<TriangularPolyhedralSurface,Vertex2FTPropertyMap,Vertex2VectorPropertyMap>} 
...
\ccc{TriangularPolyhedralSurface} provides the surface. Parameters
...
\ccConstructor{Umbilic_approximation(const TriangularPolyhedralSurface& P, 
