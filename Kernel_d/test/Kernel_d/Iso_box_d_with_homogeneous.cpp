...
int main() {
  ...
  Point pp2(dim,p2,p2+dim,1.0);
  Point qq2(dim,q2,q2+dim,1.0);
  ...
  Point pp4(dim,p4,p4+dim,1.0);
  Point qq4(dim,q4,q4+dim,1.0);
  Box b4(pp4,qq4);
  ...
  p5[dim]=1.0;
  q5[dim]=1.0;
  Point pp5(dim+1,p5,p5+dim+1,1.0);
  Point qq5(dim+1,q5,q5+dim+1,1.0);
  Box b5(pp5,qq5);
