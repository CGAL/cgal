...
public:
  ...
  { typedef std::optional< boost::variant< Point_d, Line_d > > type; };

  template <typename F>
  struct result<F(Segment_d, Line_d)>
  { typedef std::optional< boost::variant< Point_d, Segment_d > > type; };
  template <typename F>
  ...
  { typedef std::optional< boost::variant< Point_d, Ray_d > > type; };
  ...
  { typedef std::optional< boost::variant< Point_d, Segment_d, Ray_d > > type; };
