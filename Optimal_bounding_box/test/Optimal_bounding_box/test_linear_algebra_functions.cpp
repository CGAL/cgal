...
{
  CGAL::Eigen_dense_matrix<double> A(3, 3);
  /*
  ...
  CGAL::Eigen_dense_matrix<double> Q;
...
void test_fitness_function()
{
  ...
  CGAL::Eigen_dense_matrix<double> rotation(3, 3);
  /*
...
{
  //Matrix3d Sc(3, 3);
  CGAL::Eigen_dense_matrix<double> Sc(3, 3);
  /*
  ...
  CGAL::Eigen_dense_matrix<double> S_worst(3, 3);
  /*
  ...
  CGAL::Eigen_dense_matrix<double> Sr = CGAL::Optimal_bounding_box::reflection(Sc, S_worst);
  double epsilon = 1e-5;
  ...
  CGAL::Eigen_dense_matrix<double> Se = CGAL::Optimal_bounding_box::expansion(Sc, S_worst, Sr);
  ...
  CGAL::Eigen_dense_matrix<double> S_a(3, 3);
  /*
  ...
  CGAL::Eigen_dense_matrix<double> S_b(3, 3);
  /*
  ...
  CGAL::Eigen_dense_matrix<double> S_c = CGAL::Optimal_bounding_box::mean(S_a, S_b);
...
void test_centroid()
{
  ...
  CGAL::Eigen_dense_matrix<double> S_c(3, 3);
  /*
  ...
  CGAL::Eigen_dense_matrix<double> S_centroid = CGAL::Optimal_bounding_box::centroid(S_a, S_b, S_c);
  double epsilon = 1e-5;
...
void test_eigen_matrix_interface()
{
  ...
  A.set_coef(2, 1, 0.8);
  A.set_coef(2, 2, 0.9);
  CGAL::Eigen_dense_matrix<double> B = A.transpose();

  CGAL::Eigen_dense_matrix<double> S = 0.5 * A;

  CGAL::Eigen_dense_matrix<double> C(3,3);
  ...
  CGAL::Eigen_dense_matrix<double> Q(3,3);
  ...
  CGAL::Eigen_dense_matrix<double> D(3,3);
  ...
  CGAL::Eigen_dense_matrix<double> E(3,3);
  ...
  CGAL::Eigen_dense_matrix<double> Sr = CGAL::Optimal_bounding_box::reflection(D, E);
  CGAL_assertion(assert_doubles(Sr(0,0), -0.13359, epsilon));
  CGAL_assertion(assert_doubles(Sr(0,1), -0.95986, epsilon));
  CGAL_assertion(assert_doubles(Sr(0,2), -0.24664, epsilon));
  CGAL_assertion(assert_doubles(Sr(1,0), -0.60307, epsilon));
