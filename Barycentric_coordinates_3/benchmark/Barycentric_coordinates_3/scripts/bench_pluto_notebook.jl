...
# ╔═╡ 5352becc-fc1c-11eb-22d7-c352547689d4
using Plots

# ╔═╡ 0034844b-5e15-4db9-ac8b-fdb77df19125
using DelimitedFiles

# ╔═╡ d206a52d-b2ab-49ae-96d8-3305888031c5
samples = readdlm("/home/antonio/Documentos/points.txt", ' ', Float64, '\n')

# ╔═╡ c27a3346-13b8-4130-87a4-a923652124e4
interior = scatter(samples[:, 1], samples[:, 2], samples[:, 3], markeralpha = 0.1, ms=1.1, color=RGB(1, 0, 0), title="Bench", label="samples")

# ╔═╡ 58e01dd7-c7f4-4315-b673-0ec232b02cef
...
# ╔═╡ b128fd0d-14e7-45a3-80e3-a76db50dfc7c
...
# ╔═╡ 832b2e15-7767-4c80-9444-bbc5dfe59ee6
...
# ╔═╡ 87f2ae26-3511-47fc-bb35-4c961a57d9ae
...
# ╔═╡ 7b3f610a-c4f9-40ff-a904-a3ad7ae81ce1
