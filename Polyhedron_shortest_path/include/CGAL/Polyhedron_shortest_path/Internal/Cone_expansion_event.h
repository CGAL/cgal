...
#ifndef CGAL_POLYHEDRON_SHORTEST_PATH_INTERNAL_CONE_EXPANSION_EVENT_H
#define CGAL_POLYHEDRON_SHORTEST_PATH_INTERNAL_CONE_EXPANSION_EVENT_H
...
#endif // CGAL_POLYHEDRON_SHORTEST_PATH_INTERNAL_CONE_EXPANSION_EVENT_H
