...
void _test_solve(AK ak)
{
  ...
  CGAL_test_assert(res1.size() == 1);
  CGAL_test_assert(res1[0].second == 2u);
  CGAL_test_assert(res1[0].first == Root_for_circles_2_2(10, 5));

  std::vector< std::pair<Root_for_circles_2_2, size_t> > res2;
  theSolve(theConstruct_2_2(-5, 5, 25),
	   theConstruct_2_2(0, 5, 100),
	   std::back_inserter(res2));
  CGAL_test_assert(res2.size() == 1);
  CGAL_test_assert(res2[0].second == 2u);
  CGAL_test_assert(res2[0].first == Root_for_circles_2_2(-10, 5));
  ...
  CGAL_test_assert(res3.size() == 1);
  CGAL_test_assert(res3[0].second == 2u);
  CGAL_test_assert(res3[0].first == Root_for_circles_2_2(0, 10));
 
  std::vector< std::pair<Root_for_circles_2_2, size_t> > res4;
  theSolve(theConstruct_2_2(0, -5, 25),
	   theConstruct_2_2(0, 0, 100),
	   std::back_inserter(res4));
  CGAL_test_assert(res4.size() == 1);
  CGAL_test_assert(res4[0].second == 2u);
  CGAL_test_assert(res4[0].first == Root_for_circles_2_2(0, -10));
 
  std::vector< std::pair<Root_for_circles_2_2, size_t> > res5;
  theSolve(theConstruct_2_2(-5, 5, 25),
	   theConstruct_2_2(0, 0, 25),
	   std::back_inserter(res5));
  CGAL_test_assert(res5.size() == 2);
  CGAL_test_assert(res5[0].second == 1u);
  CGAL_test_assert(res5[0].first == Root_for_circles_2_2(-5, 0));
  CGAL_test_assert(res5[1].second == 1u);
  CGAL_test_assert(res5[1].first == Root_for_circles_2_2(0, 5));
  ...
  CGAL_test_assert(res6.size() == 2);
  CGAL_test_assert(res6[0].second == 1u);
  CGAL_test_assert(res6[0].first == Root_for_circles_2_2(-10, 5));
  CGAL_test_assert(res6[1].second == 1u);
  CGAL_test_assert(res6[1].first == Root_for_circles_2_2(10, 5));
  ...
  CGAL_test_assert(res7.size() == 2);
  CGAL_test_assert(res7[0].second == 1u);
  CGAL_test_assert(res7[0].first == Root_for_circles_2_2(5, -5));
  CGAL_test_assert(res7[1].second == 1u);
  CGAL_test_assert(res7[1].first == Root_for_circles_2_2(5, 15));
  ...
  CGAL_test_assert(res8.size() == 1);
  CGAL_test_assert(res8[0].second == 2u);
  CGAL_test_assert(res8[0].first == Root_for_circles_2_2(-5, 5));
  ...
  CGAL_test_assert(res9.size() == 1);
  CGAL_test_assert(res9[0].second == 2u);
  CGAL_test_assert(res9[0].first == Root_for_circles_2_2(15, 5));
  ...
  CGAL_test_assert(res10.size() == 1);
  CGAL_test_assert(res10[0].second == 2u);
  CGAL_test_assert(res10[0].first == Root_for_circles_2_2(5, 15));
  ...
  CGAL_test_assert(res11.size() == 1);
  CGAL_test_assert(res11[0].second == 2u);
  CGAL_test_assert(res11[0].first == Root_for_circles_2_2(5, -5));
  ...
  CGAL_test_assert(res12.size() == 1);
  CGAL_test_assert(res12[0].second == 1u);
  CGAL_test_assert(res12[0].first == Root_for_circles_2_2(0, 5));
  
  std::vector< std::pair<Root_for_circles_2_2, size_t> > res13;
  theSolve(theConstruct_1_2(0, 1, -5),
	   theConstruct_1_2(1, -1, 5),
	   std::back_inserter(res13));
  CGAL_test_assert(res13.size() == 1);
  CGAL_test_assert(res13[0].second == 1u);
  CGAL_test_assert(res13[0].first == Root_for_circles_2_2(0, 5));

  std::vector< std::pair<Root_for_circles_2_2, size_t> > res14;
  theSolve(theConstruct_1_2(1, -1, 5),
	   theConstruct_1_2(0, 1, -5),
	   std::back_inserter(res14));
  CGAL_test_assert(res14.size() == 1);
  CGAL_test_assert(res14[0].second == 1u);
  CGAL_test_assert(res14[0].first == Root_for_circles_2_2(0, 5));

  std::vector< std::pair<Root_for_circles_2_2, size_t> > res15;
  theSolve(theConstruct_1_2(1, 0, 0),
	   theConstruct_1_2(1, -1, 5),
	   std::back_inserter(res15));
  CGAL_test_assert(res15.size() == 1);
  CGAL_test_assert(res15[0].second == 1u);
  CGAL_test_assert(res15[0].first == Root_for_circles_2_2(0, 5));

  std::vector< std::pair<Root_for_circles_2_2, size_t> > res16;
  theSolve(theConstruct_1_2(1, -1, 5),
	   theConstruct_1_2(1, 0, 0),
	   std::back_inserter(res16));
  CGAL_test_assert(res16.size() == 1);
  CGAL_test_assert(res16[0].second == 1u);
  CGAL_test_assert(res16[0].first == Root_for_circles_2_2(0, 5));

  std::vector< std::pair<Root_for_circles_2_2, size_t> > res17;
  theSolve(theConstruct_1_2(0, 1, -5),
	   theConstruct_1_2(1, 0, 0),
	   std::back_inserter(res17));
  CGAL_test_assert(res17.size() == 1);
  CGAL_test_assert(res17[0].second == 1u);
  CGAL_test_assert(res17[0].first == Root_for_circles_2_2(0, 5));

  std::vector< std::pair<Root_for_circles_2_2, size_t> > res18;
  theSolve(theConstruct_1_2(1, 0, 0),
	   theConstruct_1_2(0, 1, -5),
	   std::back_inserter(res18));
  CGAL_test_assert(res18.size() == 1);
  CGAL_test_assert(res18[0].second == 1u);
  CGAL_test_assert(res18[0].first == Root_for_circles_2_2(0, 5));

  std::vector< std::pair<Root_for_circles_2_2, size_t> > res19;
  theSolve(theConstruct_1_2(1, 0, 0),
	   theConstruct_1_2(1, 0, 0),
	   std::back_inserter(res19));
  CGAL_test_assert(res19.size() == 0);

   std::vector< std::pair<Root_for_circles_2_2, size_t> > res20;
  theSolve(theConstruct_1_2(1, 0, 0),
	   theConstruct_1_2(1, 0, 5),
	   std::back_inserter(res20));
  CGAL_test_assert(res20.size() == 0);
  ...
  for(std::size_t i = 0; i < 500; i++){
    ...
    for (std::size_t j = 0 ; j < res.size() ; j++){
      CGAL_test_assert(res[j].second == 1u);
      CGAL_test_assert(theSigh_at(theConstruct_1_2(a1, b1, c1),
			res[j].first) == CGAL::ZERO);
      CGAL_test_assert(theSigh_at(theConstruct_1_2(a2, b2, c2),
			res[j].first) == CGAL::ZERO);
    }
    for (std::size_t j = 0 ; j < res2.size() ; j++){
      if(res2.size() == 1) CGAL_test_assert(res2[j].second == 2u);
      if(res2.size() == 2) CGAL_test_assert(res2[j].second == 1u);
      CGAL_test_assert(theSigh_at(theConstruct_2_2(a3, b3, r_sq),
			res2[j].first) == CGAL::ZERO);
      CGAL_test_assert(theSigh_at(theConstruct_1_2(a2, b2, c2),
			res2[j].first) == CGAL::ZERO);
    }
    for (std::size_t j = 0 ; j < res3.size() ; j++){
      if(res3.size() == 1) CGAL_test_assert(res3[j].second == 2u);
      if(res3.size() == 2) CGAL_test_assert(res3[j].second == 1u);
      CGAL_test_assert(theSigh_at(theConstruct_2_2(a3, b3, r_sq),
...
void _test_sign_at(AK ak)
{
  ...
  CGAL_test_assert(theSigh_at(theConstruct_2_2(5, 5, 100),
  ...
  CGAL_test_assert(theSigh_at(theConstruct_1_2(1, 0, -5),
		    Root_for_circles_2_2(5,-6)) == CGAL::ZERO);
  CGAL_test_assert(theSigh_at(theConstruct_1_2(1, 0, -5),
		    Root_for_circles_2_2(6,-6)) != CGAL::ZERO);
  CGAL_test_assert(theSigh_at(theConstruct_1_2(0, 1, -5),
		    Root_for_circles_2_2(5,-6)) != CGAL::ZERO);
  CGAL_test_assert(theSigh_at(theConstruct_1_2(0, 1, -5),
		    Root_for_circles_2_2(5, 5)) == CGAL::ZERO);
...
void _test_critical_points(AK ak)
{
  ...
  for(int i = 0; i < 20; i++){
    ...
    CGAL_test_assert(theX_critical_points(theConstruct_2_2(x,y,r*r),true)
	   == Root_for_circles_2_2(x - r, y));
    CGAL_test_assert(theX_critical_points(theConstruct_2_2(x,y,r*r),false)
	   == Root_for_circles_2_2(x + r, y));
    CGAL_test_assert(theY_critical_points(theConstruct_2_2(x,y,r*r),true)
	   == Root_for_circles_2_2(x, y - r));
    CGAL_test_assert(theY_critical_points(theConstruct_2_2(x,y,r*r),false)
	   == Root_for_circles_2_2(x, y + r));
  }
