...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Segment_Delaunay_graph_Linf_2/include/CGAL/Segment_Delaunay_graph_Linf_storage_site_2.h $
// $Id: Segment_Delaunay_graph_Linf_storage_site_2.h 56668 2010-06-09 08:45:58Z sloriot $
// 
//
...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_STORAGE_SITE_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_STORAGE_SITE_H
...
class Segment_Delaunay_graph_Linf_storage_site_2 
{
  friend class
...
protected:
  ...
  typedef Segment_Delaunay_graph_Linf_storage_site_2<Storage_traits>  Self;
...
public:
  // DEFAULT CONSTRUCTOR
  //--------------------
  Segment_Delaunay_graph_Linf_storage_site_2() : type_(0) {}

  // COPY CONSTRUCTOR
  //-----------------
  Segment_Delaunay_graph_Linf_storage_site_2(const Self& other) {
    copy_from(other);
  }
...
#endif // CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_STORAGE_SITE_H
