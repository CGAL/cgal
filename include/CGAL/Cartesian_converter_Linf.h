#ifndef CGAL_CARTESIAN_CONVERTER_LINF_H
#define CGAL_CARTESIAN_CONVERTER_LINF_H
...
//#include <CGAL/Polygonal_chain_Linf_2.h>
...
class Cartesian_converter_Linf : public Enum_converter
{
...
public:
    ...
    {
      std::cout << "debug: convert object at "
                << &obj << std::endl;
...
#include <CGAL/Kernel/interface_macros.h>
	...
	return make_object(res);
      ...
      std::cout << "debug: convert polychain at "
                << &obj << std::endl;

/*
      if (const K1_Polygonal_chain_Linf * ptr =
            object_cast<K1_Polygonal_chain_Linf>(&obj)) {
        K1_Polygonal_chain_Linf_const_iterator it;
        K2_Polygonal_chain_Linf res();
        for(it = (*ptr).begin(); it != (*ptr).end(); ++it){
           res.push_back(operator()(*it));
        }
        return make_object(res);
      } 
*/

      CGAL_error_msg("Cartesian_converter_Linf is unable to determine what is wrapped in the Object");
      return Object();
...
class Cartesian_converter_Linf <K, K, C>
{
public:
...
#endif // CGAL_CARTESIAN_CONVERTER_LINF_H
