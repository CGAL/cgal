...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Segment_Delaunay_graph_Linf_2/include/CGAL/Segment_Delaunay_graph_Linf_face_base_2.h $
// $Id: Segment_Delaunay_graph_Linf_face_base_2.h 56667 2010-06-09 07:37:13Z sloriot $
// 
//
...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_FACE_BASE_2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_FACE_BASE_2_H
...
class Segment_Delaunay_graph_Linf_face_base_2 
  : public Fb
{
private:
...
public:
  ...
  struct Rebind_TDS {
    ...
    typedef Segment_Delaunay_graph_Linf_face_base_2<Gt, Fb2>    Other;
  };
