...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Segment_Delaunay_graph_Linf_2/include/CGAL/Segment_Delaunay_graph_Linf_2/Kernel_wrapper_2.h $
...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_KERNEL_WRAPPER_2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_KERNEL_WRAPPER_2_H
...
#include <CGAL/Segment_Delaunay_graph_Linf_simple_site_2.h>
...
namespace Internal {
  ...
  struct SDG_Which_site<K,Tag_true>
  {
    ...
    typedef CGAL::Segment_Delaunay_graph_Linf_site_2<K> Site_2;
  ...
  struct SDG_Which_site<K,Tag_false>
  {
    ...
    typedef CGAL::Segment_Delaunay_graph_Linf_simple_site_2<K> Site_2;
...
#endif // CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_KERNEL_WRAPPER_2_H
