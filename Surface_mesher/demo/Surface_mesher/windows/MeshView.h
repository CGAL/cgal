...
public:
	...
	afx_msg void OnPointsetView();
	afx_msg void OnRenderDelaunayedges();
	afx_msg void OnRenderVoronoiedges();
	afx_msg void OnRenderVoronoisites();
	afx_msg void OnUpdatePointsetView(CCmdUI *pCmdUI);
	afx_msg void OnUpdateRenderDelaunayedges(CCmdUI *pCmdUI);
	afx_msg void OnUpdateRenderVoronoiedges(CCmdUI *pCmdUI);
	afx_msg void OnUpdateRenderVoronoisites(CCmdUI *pCmdUI);
};
