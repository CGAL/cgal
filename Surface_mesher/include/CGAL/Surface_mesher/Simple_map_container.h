...
#ifndef CGAL_MESH_3_SIMPLE_MAP_CONTAINER_H
#define CGAL_MESH_3_SIMPLE_MAP_CONTAINER_H
...
namespace CGAL {
  ...
  namespace Mesh_3 {
    ...
    public:
      ...
      void add_element(const Element& e, const Info& i)
      {
...
#endif // CGAL_MESH_3_SIMPLE_MAP_CONTAINER_H
