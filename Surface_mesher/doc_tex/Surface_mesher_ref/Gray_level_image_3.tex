...
\emph{CGAL\_ImageIO}. An executable that uses \ccRefName\ must be linked with
the \emph{CGAL\_ImageIO} library. This library is shipped with \cgal{} and
will be linked automatically by any makefile created by the script
\ccc{cgal_create_makefile}.

The library \emph{CGAL\_ImageIO} and therefore \ccRefName\ support
