...
The surface is described through a traits  that mainly can tell wether a
...
the \ccc{SurfaceMeshTrait_3} concept are provided. They allow to mesh
...
\ccRefIdfierPage{CGAL::Grey_level_image_3<Traits,Func>}
...
\ccRefIdfierPage{CGAL::make_surface_mesh<C2T3,Surface,Criteria,Tag>}
