...
\ccc{Criteria} of the \ccc{make_surface_mesh<C2T3,Surface,Criteria,Tag>}.
...
\ccNestedType{Facet}{The type of facets. Must be the same as \ccc{Facet} is
the triangulation embedded in the
\ccc{SurfaceMeshComplex_2InTriangulation_3} passed as first argument of
...
\ccMethod{bool is_bad (const Facet& f, Quality& q);}{Must assign the quality
  of the facet \ccc{f} to~\ccc{q}, and return \ccc{true} is \ccc{f} does
...
% TODO: Mariette needs to review this file.
