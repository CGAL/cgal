...
\ccc{Criteria} of the surface mesher function
\ccc{make_surface_mesh<SurfaceMeshC2T3,Surface,Criteria,Tag>}.
...
is a multi-component variable.  Each component corresponds to
