...
to agregate both  the triangulation and the \ccc{Complex_2_in_triangulation_3}.
If implemented with a map of facets, \ccRefName\ 
can then be view as an additionnal data structure
...
%included using the 
%\verb|\ccIncludeExampleCode{examples/Package/Complex_2_in_triangulation_3_prog.C}| 
...
%% \ccIncludeExampleCode{examples/Package/Complex_2_in_triangulation_3_prog.C}
