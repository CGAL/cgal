...
namespace     Feature {
  ...
  */
    ...
    class Coverage_angular : public CGAL::Classification::Feature_base
    {
...
#ifdef CGAL_LINKED_WITH_EMBREE
        Coverage_angular(const PointRange& input, PointMap point_map, const Mesh& wrap, float tnear = 0.f, int n_rays = 25) : point_map(point_map)
        {
