...
#ifndef CGAL_STRAIGHT_SKELETON_3_INTERNAL_ALGORITHM_VERTEX_EVENT_H
#define CGAL_STRAIGHT_SKELETON_3_INTERNAL_ALGORITHM_VERTEX_EVENT_H
  ...
  : public Abstract_event<GeomTraits>
{
  ...
  using Vertex_event_sptr = std::shared_ptr<Vertex_event<GeomTraits> >;
...
public:
  Vertex_event()
    : Base(Base::VERTEX_EVENT)
  { }

  virtual ~Vertex_event()
  { }

  static Vertex_event_sptr create()
  {
...
#endif /* CGAL_STRAIGHT_SKELETON_3_INTERNAL_ALGORITHM_VERTEX_EVENT_H */
