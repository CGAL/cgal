...
*/ 
typedef unspecified_type Cell_badness;
...
/*!
Returns the `Cell_badness` value of the cell `c`, which lives in the triangulation `tr`.
The type `Tr` must be identical to the triangulation type used by the mesh generation function.
*/
Cell_badness operator()(const Tr& tr, Cell_handle c);
