...
public:
  ...
  */
  ...
  `std::optional< boost::variant< T... > > operator()(Segment_3 s, Plane_3 p)`

  `std::optional< boost::variant< T... > > operator()(Ray_3 r, Iso_cuboid i)`

  `std::optional< boost::variant< T... > > operator()(Segment_3 s, Iso_cuboid i)`
