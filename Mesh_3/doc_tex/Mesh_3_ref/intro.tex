...
\ccChapterAuthor{Laurent Rineau, St\'ephane Tayeb, Mariette Yvinec}
...
%\ccRefConceptPage{MeshTriangulation_3} \\
%\ccRefConceptPage{MeshWSEVertexBase_3} \\
\ccRefConceptPage{MeshDomain_3} \\
%\ccRefConceptPage{MeshWSETraits_3} \\
...
\subsection*{Classes}
\ccRefIdfierPage{CGAL::Mesh_complex_3_in_triangulation_3<Tr>} \\
...
\ccRefIdfierPage{CGAL::Triangle_accessor_3<Polyhedron_3<K>,K>} \\
...
\subsection*{CGAL::parameter Functions}
