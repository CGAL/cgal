     ...
     K k = K())
{
  ...
  FT min_quotient = 
    dihedral_angle_aux_compute_quotient(p0, p1, p2, p3, k);

  min_quotient = 
    std::min(min_quotient,
       dihedral_angle_aux_compute_quotient(p0, p2, p1, p3, k));
  min_quotient = 
    std::min(min_quotient,
       dihedral_angle_aux_compute_quotient(p0, p3, p1, p2, k));
  min_quotient = 
    std::min(min_quotient,
       dihedral_angle_aux_compute_quotient(p1, p2, p0, p3, k));
  min_quotient = 
    std::min(min_quotient,
       dihedral_angle_aux_compute_quotient(p1, p3, p0, p2, k));
  min_quotient = 
    std::min(min_quotient,
       dihedral_angle_aux_compute_quotient(p2, p3, p0, p1, k));
