...
The concept `GMapDart` defines a <I>d</I>-dimensional dart for generalized maps. A dart mainly stores handles to the darts linked with itself by \f$ \alpha_i\f$, \f$ \forall\f$<I>i</I>, 0\f$ \leq\f$<I>i</I>\f$ \leq\f$<I>d</I>. Moreover, it stores also handles to each non void attribute associated with itself.
