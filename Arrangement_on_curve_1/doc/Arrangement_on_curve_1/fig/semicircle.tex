...
\begin{tikzpicture}[scale=0.5]
    ...
    \draw[edge] (-5,0) arc[start angle=180, end angle=143.13, radius=5]
        node[midway, above left, color=black] {\textcolor{blue}{$e_0$}};

    \draw[edge] (-4,3) arc[start angle=143.13, end angle=126.87, radius=5]
        node[midway, above left, color=black] {\textcolor{blue}{$e_1$}};

    \draw[edge] (-3,4) arc[start angle=126.87, end angle=90, radius=5]
        node[midway, above left, color=black] {\textcolor{blue}{$e_2$}};

    \draw[edge] (0,5) arc[start angle=90, end angle=53.13, radius=5]
        node[midway, above right, color=black] {\textcolor{blue}{$e_3$}};

    \draw[edge] (3,4) arc[start angle=53.13, end angle=36.87, radius=5]
        node[midway, above right, color=black] {\textcolor{blue}{$e_4$}};

    \draw[edge] (4,3) arc[start angle=36.87, end angle=0, radius=5]
        node[midway, above right, color=black] {\textcolor{blue}{$e_5$}};

    % Define the points with coordinates and labels
    % Coordinates:
    % v_0 = (-5,0), v_1 = (-4,3), v_2 = (-3,4), v_3 = (0,5), v_4 = (3,4), v_5 = (4,3), v_6 = (5,0)

    \node[point, label=below:{\textcolor{red}{$v_0$}}] (v0) at (-5,0) {};
    \node[point, label=above left:{\textcolor{red}{$v_1$}}] (v1) at (-4,3) {};
    \node[point, label=above left:{\textcolor{red}{$v_2$}}] (v2) at (-3,4) {};
    \node[point, label=above:{\textcolor{red}{$v_3$}}] (v3) at (0,5) {};
    \node[point, label=above right:{\textcolor{red}{$v_4$}}] (v4) at (3,4) {};
    \node[point, label=above right:{\textcolor{red}{$v_5$}}] (v5) at (4,3) {};
    \node[point, label=below:{\textcolor{red}{$v_6$}}] (v6) at (5,0) {};
