...
template <typename Gt, typename NamedParameters>
struct Point_set_processing_3_np_helper<::Point_set_3<Gt>, NamedParameters>
    : public Point_set_processing_3_np_helper<typename ::Point_set_3<Gt>::Base, NamedParameters>
{};
