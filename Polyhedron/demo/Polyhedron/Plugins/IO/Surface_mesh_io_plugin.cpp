...
public:
   ...
   CGAL::Three::Scene_item* load(QFileInfo fileinfo) {
     ...
     if(!in) {
      CGAL::Three::Three::messages()->error(QString("Cannot open file %1").arg((const char*)fileinfo.filePath().toUtf8()));
       return NULL;
     }
...
//         CGAL::Three::Three::messages()->error(QString("Cannot open file %1").arg((const char*)fileinfo.filePath().toUtf8()));
       ...
       //CGAL::Three::Three::messages()->information("The facets don't seem to be oriented. Loading a Soup of polygons instead."
