...
namespace SurfaceReconstruction
{
                    ...
                    unsigned int samples = 300, unsigned int iterations = 4)
  {
    ...
    reconstruct.reconstruct_surface(boost::make_transform_iterator(points.begin(), Point_set_make_point(points)),
                        ...
                        double radius_ratio_bound = 5., double beta = 0.52)
  {
    ...
    Triangulation_3 dt( boost::make_transform_iterator(points.begin(), Point_set_make_pair_point_index(points)),
...
(const Polyhedron_demo_surface_reconstruction_plugin_dialog& dialog)
{
  ...
  if(pts_item)
      ...
      if (!(dialog.interpolate()))
	{
	  ...
	  std::copy (boost::make_transform_iterator(points->begin(), SurfaceReconstruction::Point_set_make_point(*points)),
