#ifndef SCENE_EDIT_PATH_ITEM_H
#define SCENE_EDIT_PATH_ITEM_H

#include <CGAL/Three/Scene_item_rendering_helper.h>
#include <CGAL/Three/Scene_transparent_interface.h>
#include <CGAL/Simple_cartesian.h>
#include "create_sphere.h"
#include "Scene_edit_path_item_config.h"
struct Scene_edit_path_item_priv;
class SCENE_EDIT_PATH_ITEM_EXPORT Scene_edit_path_item:
    ...
    public CGAL::Three::Scene_transparent_interface
{
  ...
  public:
    ...
    Scene_edit_path_item* clone() const {
      return nullptr;
    }
...
protected:
    friend struct Scene_edit_path_item_priv;
    Scene_edit_path_item_priv* d;
};
#endif // SCENE_EDIT_PATH_ITEM_H
