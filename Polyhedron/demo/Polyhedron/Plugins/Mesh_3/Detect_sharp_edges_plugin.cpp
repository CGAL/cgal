                                                                 ...
                                                                 double angle)
{
  ...
  typedef boost::property_map<Polyhedron,boost::face_patch_id_t>::type PatchID;
  Q_FOREACH(Poly_tuple tuple, polyhedrons)
  {
    ...
    CGAL::Mesh_3::Detect_features_in_polyhedra<Polyhedron, PatchID> detect_features(get(boost::face_patch_id_t(),*pMesh));
    // Get sharp features
