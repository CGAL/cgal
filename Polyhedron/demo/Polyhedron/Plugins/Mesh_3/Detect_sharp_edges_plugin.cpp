                                                                 ...
                                                                 double angle)
{
  ...
  typedef boost::property_map<Polyhedron,CGAL::face_patch_id_t>::type PatchID;
  Q_FOREACH(Poly_tuple tuple, polyhedrons)
  {
    ...
    CGAL::Mesh_3::Detect_features_in_polyhedra<Polyhedron, PatchID> detect_features(get(CGAL::face_patch_id_t(),*pMesh));
    // Get sharp features
