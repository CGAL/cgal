...
#ifndef CGAL_GPA_CURVE_INTERVAL_ARCNO_CACHE_H
#define CGAL_GPA_CURVE_INTERVAL_ARCNO_CACHE_H

/*! \file GPA_2/Curve_interval_arcno_cache.h
...
struct Curve_interval_arcno_cache {
    ...
    Curve_interval_arcno_cache(GPA_2 *gpa) :
        _m_gpa(gpa), _m_last_curve_id(-1) {
...
#endif // CGAL_GPA_CURVE_INTERVAL_ARCNO_CACHE_H
