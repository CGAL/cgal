...
\begin{ccRefClass}{Min_sphere_annulus_d_traits_d<K,ET,NT>}
\ccIndexTraitsClassBegin{Min_sphere_annulus_d_traits_d}{%
...
\ccInclude{CGAL/Min_sphere_annulus_d_traits_d.h}
...
\ccSaveThreeColumns
\ccSetTwoColumns{Min_sphere_annulus_d_traits_d<K,ET,NT>:: Rep_tag}{}
...
\ccConstructor{ Min_sphere_annulus_d_traits_d( );}{default constructor.}
\ccConstructor{ Min_sphere_annulus_d_traits_d(
                  const Min_sphere_annulus_d_traits_d<K,ET,NT>&);}{copy constructor.}
...
\ccRefIdfierPage{CGAL::Min_sphere_annulus_d_traits_3<K,ET,NT>}\\[1ex]
\ccRefConceptPage{MinSphereAnnulusDTraits}
