...
An object of the class `Ellipse` is an ellipse in two-dimensional
...
/*!
sets `ellipse` to the ellipse containing exactly \f$ \{\mbox{\ccc{p}}\}\f$.
*/
...
\note Only needed, if the corresponding predicate of `Min_ellipse_2` is used.
*/
CGAL::Bounded_side
