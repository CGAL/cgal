...
struct DefaultColorFunctorV2
{
  ...
  static CGAL::Color run(const V2&,
                         const typename V2::Face_iterator fh)
  {
...
public:
  ...
  SimpleVoronoiDiagram2ViewerQt(QWidget* parent, const V2& av2,
    ...
    //First draw: vertices; half-edges; faces; multi-color; no inverse normal
          ...
          const ColorFunctor& fcolor)
{
  ...
  if (!cgal_test_suite)
  {
    ...
    SimpleVoronoiDiagram2ViewerQt<V2, ColorFunctor> mainwindow(app.activeWindow(),
                                                              av2,
                                                              title,
                                                              nofill,
                                                              fcolor);
...
template<class V2>
void draw(const V2& av2, const char* title)
