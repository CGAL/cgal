...
#ifndef CGAL_LINEAR_LEAST_SQUARES_FITTING_CIRCLES_H
#define CGAL_LINEAR_LEAST_SQUARES_FITTING_CIRCLES_H
                               ...
                               const typename K::Circle_2*) // used for indirection
{
  ...
  Matrix covariance = Matrix(2,true,PI); //DEFINE PI PROPERLY
