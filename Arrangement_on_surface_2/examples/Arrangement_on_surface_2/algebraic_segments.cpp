...
int main() {
    ...
    // Construct x^4+y^3-1
    std::vector<std::pair<CGAL::Exponent_vector,Integer> > coeffs0;
    coeffs0.push_back(std::make_pair(CGAL::Exponent_vector(4,0),1));
    coeffs0.push_back(std::make_pair(CGAL::Exponent_vector(0,3),1));
    coeffs0.push_back(std::make_pair(CGAL::Exponent_vector(0,0),-1));
    Polynomial_2 f0 = construct_polynomial(coeffs0.begin(),coeffs0.end());
    Curve_2 cv0 = construct_curve(f0);
    ...
    for(unsigned int i = 0; i < static_cast<int>(pre_segs.size()); i++ ) {
    ...
    coeffs1.push_back(std::make_pair(CGAL::Exponent_vector(2,0),2));
    coeffs1.push_back(std::make_pair(CGAL::Exponent_vector(0,2),5));
    coeffs1.push_back(std::make_pair(CGAL::Exponent_vector(0,0),-7));
    ...
    coeffs2.push_back(std::make_pair(CGAL::Exponent_vector(0,3),-1));
    ...
    coeffs3.push_back(std::make_pair(CGAL::Exponent_vector(0,0),1));
    ...
    coeffs4.push_back(std::make_pair(CGAL::Exponent_vector(1,0),1));
    ...
    isolated_points.push_back
        (CGAL::make_object(construct_point(Algebraic_real_1(-2),cv3,0)));
    isolated_points.push_back
        (CGAL::make_object(construct_point(Algebraic_real_1(-2),cv3,1)));
