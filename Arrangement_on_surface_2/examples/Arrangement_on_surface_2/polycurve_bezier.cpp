...
int main (int argc, char *argv[])
{
  ...
  Polycurve_bezier_traits_2::Construct_x_monotone_curve_2 construct_x_mono_polycurve =
  ...
  for (k = 0; k < n_curves; k++)
  {
    ...
    Bezier_x_curve_2 x_seg = CGAL::object_cast<Bezier_x_curve_2>( (obj_vector[0]) );
    x_curves.push_back(x_seg);
  }

  X_mono_polycurve polycurve = construct_x_mono_polycurve(x_curves.begin(), x_curves.end());
