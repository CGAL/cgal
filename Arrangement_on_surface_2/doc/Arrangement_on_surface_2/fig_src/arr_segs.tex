...
\psscalebox{1}{\arrset{1}\LARGE%
  ...
  \ncline[linewidth=0.5pt,offset=3pt,nodesepB=6pt]{->}{f}{1}\Aput[1pt]{\LARGE $e_{\mathrm{prev}}$}
  \ncline[linewidth=0.5pt,linecolor=blue]{f}{g}
  \ncline[linewidth=0.5pt,linecolor=blue]{g}{2}
  \ncline[linewidth=0.5pt,linecolor=blue]{g}{2}
  \ncline[linewidth=0.5pt,offset=3pt,nodesepB=4pt]{->}{2}{g}\Aput[1pt]{\LARGE $e_{\mathrm{next}}$}
  ...
  \ncline[linewidth=0.5pt,offset=3pt,nodesepA=6pt]{->}{1}{2}\Aput[1pt]{\LARGE $e$}
  \ncline[linewidth=0.5pt,offset=3pt]{->}{2}{1}\Aput[1pt]{\LARGE $e'$}
  %
  \rput(2,10){\LARGE $f_0$}
  \rput(3,4){\LARGE $f_1$}
  \rput(8.5,9.5){\LARGE $f_2$}
  \rput(5,7){\LARGE $f_3$}
  \rput(4.5,5.6){\LARGE $f_4$}
  %
  \arru[90](2,6){1}
  \arru[90](5,9){2}
  %
