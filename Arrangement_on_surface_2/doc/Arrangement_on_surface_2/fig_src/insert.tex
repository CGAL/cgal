...
\psscalebox{1}{\arrset{1}\LARGE
  \begin{tabular}{ccc}
    ...
    \arrMinorVertex(3,3){1}\uput[135]{0}(3,3){\LARGE $v_1$}
    \arrMinorVertex(6,4){2}\uput[-45]{0}(6,4){\LARGE $v_2$}
    ...
    \ncline[linewidth=0.5pt,linecolor=blue]{a}{b}
    \ncline[linewidth=0.5pt,linecolor=blue]{b}{c}
    \ncline[linewidth=0.5pt,linecolor=blue]{c}{d}\Aput[1pt]{\LARGE $h_1$}
    ...
    \ncline[linewidth=0.5pt,linecolor=blue]{b}{d}\Aput[1pt]{\LARGE $h_2$}
    \psframe[linewidth=0.5pt](0.5,0)(10,7)
    \endpspicture
  \end{tabular}
}
