...
planar subdivision induced by a set of input curves \f$ \calC\f$. 
...
\f$ C \in \calC\f$ - or may represent an overlap among several curves 
in \f$ \calC\f$. 
...
representing \f$ \calC\f$, and by maintaining a cross-mapping between these 
