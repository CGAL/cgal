...
public:
   ...
   */
  Arr_counting_traits_2(Shared_decorated_traits_2 traits);
  ...
  /// \name Types and functors coming from DecoratedTraits_2
  /// @{
...
template <typename OutStream, typename DecoratedTraits_2>
