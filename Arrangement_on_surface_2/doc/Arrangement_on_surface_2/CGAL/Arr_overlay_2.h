...
<span class="textsc">Dcel</span> (encapsulated in the various topology-traits classes) classes.
...
<UL>
<LI>The overlay-traits object `ovl_tr` must model the `OverlayTraits`
