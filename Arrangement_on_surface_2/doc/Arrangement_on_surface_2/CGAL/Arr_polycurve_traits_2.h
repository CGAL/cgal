...
namespace CGAL {
  ...
  */
  ...
  public:
    ...
    /*!
     */
    typedef GeometryTraits::Curve_2                   Segment_2;
    typedef GeometryTraits::X_monotone_curve_2        X_monotone_segment_2;
    /// @}
    ...
    /*!
      ...
      Note that the composing segments, depending on the `GeometryTraits`,
    ...
    */
    ...
    /*!  The `Curve_2` type nested in the `Arr_polycurve_traits_2`
      ...
      are `GeometryTraits::Curve_2` and `GeometryTraits::Point_2`
    ...
    */
    ...
    public:
      ...
      */
      typename GeometryTraits::X_monotone_curve_2
