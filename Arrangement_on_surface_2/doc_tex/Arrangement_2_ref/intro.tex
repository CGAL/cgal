\RCSdef{\ArrangementRefRev}{$Id$}
\RCSdefDate{\ArrangementRefDate}{$Date$}
\ccRefChapter{2D Arrangements\label{chapterArrangement_2_ref}}
\ccChapterRelease{\ArrangementRefRev. \ \ArrangementRefDate}
...
\ccRefIdfierPage{CGAL::Boundary_type}\\
\ccRefIdfierPage{CGAL::Curve_end}
...
\ccRefIdfierPage{CGAL::Arr_postscript_file_stream}\\
~\\
