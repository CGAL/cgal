...
\ccNestedType{category}{boost::readable_property_map_tag}
\ccGlue
\ccNestedType{value_type}{unsigned int}
\ccGlue
\ccNestedType{reference}{unsigned int}
\ccGlue
\ccNestedType{key_type}{Vertex_handle}
