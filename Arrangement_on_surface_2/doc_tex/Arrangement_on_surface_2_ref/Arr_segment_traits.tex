...
\ccStyle{Exact_predicates_exact_constructions_kernel}, ensures the exact and
...
\ccStyle{Exact_predicates_exact_constructions_kernel} type is a shortcut for a
kernel that uses an exact number type, that is, \ccStyle{Gmpq} (More
precisely, \ccStyle{Lazy_exact_nt<Gmpq>}), when \ccStyle{Gmpq} is available.
