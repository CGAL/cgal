...
\ccc{Compare_y_near_boundary_2}, while the nadling of curves that
...
rational arcs. 
The template argument must be a model of the concept \ccc{AlgebraicKernel_d_1}. 
...
\ccc{Arr_rational_function_traits_2<AlgebraicKernel_d_1>} is a model of the
\ccc{ArrangementTraits_2} concept as well as the \ccc{ArrangementDirectionalXMonotoneTraits_2}
