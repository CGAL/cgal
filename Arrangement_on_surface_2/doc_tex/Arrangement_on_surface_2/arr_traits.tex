...
concept. Continuous portions of rational functions are represented
by the nested type \ccc{X_monotone_curve_2}, which is different than
\ccc{Curve_2}. Constructors for both types are provided by the
traits. A \ccc{Curve_2} may be split up into several
