...
%we use the term ``segment'' for a closed continuous subset of an algebraic curve
...
%of a segment. An weakly $x$-monotone segment is therefore a segment that is
...
The \ccc{Arr_algebraic_curve_traits<Coefficient>} class template 
