...
\ccc{Left_side_category}, \ccc{Right_side_category},
\ccc{Bottom_side_category}, and \ccc{Top_side_category}. Each such
type must be convertible to the type \ccc{Arr_oblivious_side_tag} for
...
of the \ccc{ArrangementTraits_2} concept. It handles bounded and
