...
\item
 The \ccc{Vertex} class provides three-valued predicates
  ...
  approaches $-\infty$ and \ccc{ARR_RIGHT_BOUNDARY} if the
  $x$-coordinate approaches $\infty$. The latter returns
  \ccc{ARR_BOTTOM_BOUNDARY} if the $y$-coordinate of the point
  approaches $-\infty$ and \ccc{ARR_TOP_BOUNDARY} if the
  $y$-coordinate approaches $\infty$. The Boolean predicate
