...
set(CACHING_POLYLINE_GEOM_TRAITS 3)
set(NON_CACHING_POLYLINE_GEOM_TRAITS 4)
set(POLYCURVE_CONIC_GEOM_TRAITS 5)
set(POLYCURVE_CIRCULAR_ARC_GEOM_TRAITS 6)
set(POLYCURVE_BEZIER_GEOM_TRAITS 7)
set(LINEAR_GEOM_TRAITS 8)
set(CORE_CONIC_GEOM_TRAITS 9)
set(LINE_ARC_GEOM_TRAITS 10)
set(CIRCULAR_ARC_GEOM_TRAITS 11)
set(CIRCULAR_LINE_ARC_GEOM_TRAITS 12)
set(CIRCLE_SEGMENT_GEOM_TRAITS 13)
set(BEZIER_GEOM_TRAITS 14)
set(GEODESIC_ARC_ON_SPHERE_GEOM_TRAITS 15)
set(RATIONAL_ARC_GEOM_TRAITS 16)
set(ALGEBRAIC_GEOM_TRAITS 17)
set(FLAT_TORUS_GEOM_TRAITS 18)
...
#---------------------------------------------------------------------#
function(test_caching_polyline_traits)
  set(nt ${CGAL_GMPQ_NT})
  set(kernel ${CARTESIAN_KERNEL})
  set(geom_traits ${CACHING_POLYLINE_GEOM_TRAITS})
  set(flags "-DTEST_NT=${nt} -DTEST_KERNEL=${kernel} -DTEST_GEOM_TRAITS=${geom_traits}")

  compile_test_with_flags(test_traits test_caching_polylines "${flags}")
