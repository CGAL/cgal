...
#define CACHING_POLYLINE_GEOM_TRAITS       3
#define NON_CACHING_POLYLINE_GEOM_TRAITS   4
#define POLYCURVE_CONIC_GEOM_TRAITS        5
#define POLYCURVE_CIRCULAR_ARC_GEOM_TRAITS 6
#define POLYCURVE_BEZIER_GEOM_TRAITS       7
#define LINEAR_GEOM_TRAITS                 8
#define CORE_CONIC_GEOM_TRAITS             9
#define LINE_ARC_GEOM_TRAITS               10
#define CIRCULAR_ARC_GEOM_TRAITS           11
#define CIRCULAR_LINE_ARC_GEOM_TRAITS      12
#define CIRCLE_SEGMENT_GEOM_TRAITS         13
#define BEZIER_GEOM_TRAITS                 14
#define GEODESIC_ARC_ON_SPHERE_GEOM_TRAITS 15
#define RATIONAL_ARC_GEOM_TRAITS           16
#define ALGEBRAIC_GEOM_TRAITS              17
#define FLAT_TORUS_GEOM_TRAITS             18
