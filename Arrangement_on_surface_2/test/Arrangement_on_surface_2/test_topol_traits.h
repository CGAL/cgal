#ifndef CGAL_TEST_TOPOL_TRAITS_H
#define CGAL_TEST_TOPOL_TRAITS_H
...
// ============================================================================
#if TEST_TOPOL_TRAITS == PLANAR_BOUNDED_TOPOL_TRAITS
typedef CGAL::Arr_bounded_planar_topology_traits_2<Geom_traits> Topol_traits;
#define TOPOL_TRAITS_TYPE "Bounded Planar"

#elif TEST_TOPOL_TRAITS == PLANAR_UNBOUNDED_TOPOL_TRAITS
typedef CGAL::Arr_unb_planar_topology_traits_2<Geom_traits>     Topol_traits;
