...
class Traits_adaptor_test : public Traits_base_test<Traits_T> {
private:
...
public:
  ...
  /*! Constructor */
  Traits_adaptor_test(const Traits& traits);
 ...
 */
template <typename Traits_T>
Traits_adaptor_test<Traits_T>::Traits_adaptor_test(const Traits_T& traits) :
  Traits_base_test<Traits_T>(traits)
{
  typedef Traits_T Traits;
 ...
 */
template <typename Traits_T>
Traits_adaptor_test<Traits_T>::~Traits_adaptor_test() {}

template <typename Traits_T>
bool Traits_adaptor_test<Traits_T>::
ta_compare_y_at_x_left_wrapper(std::istringstream & str_stream)
{
  typedef typename Traits_T::Has_left_category          Has_left_category;
...
{
  typedef typename Traits_T::Has_merge_category          Has_merge_category;
...
template <typename Traits_T>
bool Traits_adaptor_test<Traits_T>::ta_merge_wrapper
