...
public:
  ...
  typedef typename Geometry_traits_2::Has_do_intersect_category
...
private:
  ...
  // Data members:
  const Geometry_traits_2* m_geometry_traits;  // The base segment-traits class.
  bool m_own_traits;
...
public:
  ...
  Arr_polycurve_traits_2() :
    m_geometry_traits(new Geometry_traits_2()), m_own_traits(true) {}
   ...
   */
  Arr_polycurve_traits_2(const Geometry_traits_2* geom_traits) :
   ...
   */
  const Geometry_traits_2* geometry_traits_2() const
  ...
  public:
    /*! Constructor. */
    Compare_x_2(const Polycurve_traits_2& traits) : m_poly_traits(traits) {}
  ...
  public:
    /*! Constructor. */
    Compare_xy_2(const Polycurve_traits_2& traits) : m_poly_traits(traits) {}
  ...
  public:
    /* Constructor. */
    Number_of_points_2(const Polycurve_traits_2& traits) :
  ...
  public:
    /* Constructor. */
    Construct_min_vertex_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Construct_max_vertex_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Is_vertical_2(const Polycurve_traits_2& traits) : m_poly_traits(traits) {}
  ...
  private:
                                 ...
                                 Arr_not_all_sides_oblivious_tag) const
    {
      ...
      typename Geometry_traits_2::Construct_max_vertex_2 max_vertex =
  ...
  public:
    /*! Constructor. */
    Compare_y_at_x_left_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Compare_y_at_x_right_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Equal_2(const Polycurve_traits_2& poly_tr) : m_poly_traits(poly_tr) {}
                    ...
                    const X_monotone_curve_2& cv2) const
    {
      ...
      typename Geometry_traits_2::Construct_max_vertex_2 max_vertex =
        geom_traits->construct_max_vertex_2_object();
      typename Geometry_traits_2::Compare_endpoints_xy_2 comp_endpt =
  ...
  public:
    /*! Constructor. */
    Compare_endpoints_xy_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits) {}
  ...
  public:
    /*! Constructor */
    Construct_opposite_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits) {}
                          ...
                          Arr_not_all_sides_oblivious_tag) const
    {
      ...
      CGAL_precondition_code
        (
         ...
         // A segment should not be pushed if the polycurve is directed to
         ...
         CGAL_precondition_msg(((dir != SMALLER) ||
                               ...
                               "Can not push back any segment further." );
      ...
      CGAL_precondition_code
        (
         ...
         CGAL_precondition_msg((((min_x_seg == ARR_INTERIOR) &&
                               ...
                               "or more segments present in the polycurve.");

         // Something like Ray should not be pushed front if there
         // is already one or more segments present in polycurve.
         CGAL_precondition_msg((((dir == SMALLER) &&
                                 (max_x_seg == ARR_INTERIOR) &&
                                 (max_y_seg == ARR_INTERIOR)) ||
                                ((dir == LARGER) &&
                                 ...
                                 (min_y_seg == ARR_INTERIOR)) ||
                                (num_seg == 0)),
                               "Segment reaching the boundary at the "
  ...
  public:
               ...
               OutputIterator oi) const
    {
      ...
      typename Geometry_traits_2::Construct_max_vertex_2 max_vertex =
        geom_traits->construct_max_vertex_2_object();
      typename Geometry_traits_2::Intersect_2 intersect =
        ...
        if (!right_coincides && !left_coincides) {
          ...
          for (size_t i = 0; i < int_seg.size(); ++i) {
            ...
            if (p_ptr != NULL) {
              ...
              // segment should be inserted into oi.
              // The max_vertex of the current segment (if intersecting)
  ...
  class Merge_2 {
  protected:
    typedef Arr_polycurve_traits_2<Geometry_traits_2>     Geometry_traits;
    /*! The traits (in case it has state) */
  ...
  typedef typename Geometry_traits_2::Approximate_2    Approximate_2;
  ...
  public:
    ...
    Curve_2 operator()(const Point_2& p, const Point_2& q) const
    {
      CGAL_precondition_msg(!m_poly_traits.
                            geometry_traits_2()->equal_2_object()(p,q),
  ...
  public:
    ...
    X_monotone_curve_2 operator()(const X_monotone_segment_2& seg) const
    {
      ...
      if (m_poly_traits.geometry_traits_2()->
        ...
        return X_monotone_segment_2(m_poly_traits.geometry_traits_2()->
                                    construct_opposite_2_object()(seg));
#endif
                                        ...
                                        boost::false_type) const
    {
      CGAL_precondition_msg
        (
         begin != end,
         "Input range of segments has to contain at least one segment"
         );
  ...
  public:
    /*! Constructor. */
    Parameter_space_in_x_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Parameter_space_in_y_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Compare_x_on_boundary_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  protected:
    ...
    /*! \brief returns a trimmed version of the polyline with src and tgt as
     * end points.
     */
  public:
    /*! Constructor. */
    Trim_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
                                  ...
                                  const Point_2& tgt)const
    {
      ...
      Point_2 source_max_vertex =
        geom_traits->construct_max_vertex_2_object()(xcv[source_segment_number]);
      Point_2 source_min_vertex =
        geom_traits->construct_min_vertex_2_object()(xcv[source_segment_number]);
      Point_2 target_min_vertex =
        geom_traits->construct_min_vertex_2_object()(xcv[target_segment_number]);
      Point_2 target_max_vertex =
        geom_traits->construct_max_vertex_2_object()(xcv[target_segment_number]);
          ...
          ! geom_traits->equal_2_object()(source, source_max_vertex) )
      {
        if (source_segment_number != target_segment_number )
          trimmed_segments.push_back(trim(xcv[source_segment_number],
      ...
      return X_monotone_curve_2(trimmed_segments.begin(),
                                trimmed_segments.end());
    }
  };
  ...
  public:
    Compare_x_at_limit_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
                                  ...
                                  const Arr_curve_end ce) const
    {
      ...
      // I think this is because of the way the segments are stored in the
      // curve_vector.
    ...
    {
      const Geometry_traits_2* geom_traits = m_poly_traits.geometry_traits_2();
      typename Geometry_traits_2::Compare_x_at_limit_2 compare_x_at_limit =
  ...
  public:
    Compare_x_near_limit_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Compare_y_on_boundary_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Compare_y_near_boundary_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
  ...
  public:
    /*! Constructor. */
    Is_on_y_identification_2(const Polycurve_traits_2& traits) :
      m_poly_traits(traits)
    {}
    ...
    bool operator()(const X_monotone_curve_2& xcv) const
    {
      ...
      typename X_monotone_curve_2::Segment_const_iterator it;
      for (it = xcv.begin_segments(); it != xcv.end_segments(); ++it)
        if (! geom_traits->is_on_y_identification_2_object()(*it))
          return false;
      return true;
    }
  };
...
private:
  ...
  public:
    // Constructor
    Compare_points(const Polycurve_traits_2& traits, Comparer compare,
                   const Point_2& p) :
      m_poly_traits(traits),
      m_point(p),
      m_compare(compare)
                          ...
                          const Point_2& q, const bool& to_right) const
  {
    ...
    typename Geometry_traits_2::Is_vertical_2 is_vert =
    ...
    if ((!is_vert(cv[0]) && (comp_x(get_min_v(cv[i]), q) == EQUAL)) ||
      ...
      if (to_right) return i;
        ...
        if (direction == SMALLER) {
          ...
          if (i == cv.number_of_segments()-1) return INVALID_INDEX;
          else return i+1;
        }
      }
    }
