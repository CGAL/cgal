...
#ifndef CGAL_ARR_TORUS_CONSTRUCTION_SL_VISITOR_H
#define CGAL_ARR_TORUS_CONSTRUCTION_SL_VISITOR_H

/*!
 * Definition of the Arr_torus_construction_sl_visitor class-template.
 */
...
/*! \class Arr_torus_construction_sl_visitor
...
public:
  ...
  /*! Constructor. */
  Arr_torus_construction_sl_visitor (Arrangement_2 *arr) :
    m_helper (arr),
    m_arr (arr),
  ...
  /*! Destructor. */
  virtual ~Arr_torus_construction_sl_visitor()
  {}
...
//
template <class Hlpr> 
void Arr_torus_construction_sl_visitor<Hlpr>::before_sweep ()
{
...
//
template <class Hlpr> 
void Arr_torus_construction_sl_visitor<Hlpr>::before_handle_event (Event* event)
{
...
//
template <class Hlpr> 
bool Arr_torus_construction_sl_visitor<Hlpr>::after_handle_event
...
//
template <class Hlpr> 
void Arr_torus_construction_sl_visitor<Hlpr>::add_subcurve
...
//
template <class Hlpr>
typename Arr_torus_construction_sl_visitor<Hlpr>::Halfedge_handle
Arr_torus_construction_sl_visitor<Hlpr>::insert_in_face_interior
...
template <class Hlpr>
typename Arr_torus_construction_sl_visitor<Hlpr>::Halfedge_handle
Arr_torus_construction_sl_visitor<Hlpr>::insert_at_vertices
    (const X_monotone_curve_2& cv,
     Halfedge_handle prev1,
     Halfedge_handle prev2,
     Subcurve* sc,
...
template <class Hlpr>
typename Arr_torus_construction_sl_visitor<Hlpr>::Halfedge_handle
Arr_torus_construction_sl_visitor<Hlpr>::insert_from_right_vertex
    (const X_monotone_curve_2& cv,
     Halfedge_handle prev,
     Subcurve* sc)
{
...
template <class Hlpr>
typename Arr_torus_construction_sl_visitor<Hlpr>::Halfedge_handle
Arr_torus_construction_sl_visitor<Hlpr>::insert_from_left_vertex
    (const X_monotone_curve_2& cv,
     Halfedge_handle prev,
     Subcurve* sc)
{
...
//
template <class Hlpr>
typename Arr_torus_construction_sl_visitor<Hlpr>::Vertex_handle
Arr_torus_construction_sl_visitor<Hlpr>::insert_isolated_vertex
    (const Point_2& pt,
     Status_line_iterator /* iter */)
{
...
//
template <class Hlpr>
void Arr_torus_construction_sl_visitor<Hlpr>::relocate_in_new_face
    (Halfedge_handle he)
{
...
//
template <class Hlpr>
void Arr_torus_construction_sl_visitor<Hlpr>::_map_new_halfedge
