...
public:
  ...
  (
   (boost::mpl::or_<
    ...
    std::is_same< Left_side_category, Arr_identified_side_tag > >)
  );
  BOOST_MPL_ASSERT
  (
   (boost::mpl::or_<
    std::is_same< Bottom_side_category, Arr_oblivious_side_tag >,
    std::is_same< Bottom_side_category, Arr_contracted_side_tag > >)
  );
  BOOST_MPL_ASSERT
  (
   (boost::mpl::or_<
    std::is_same< Top_side_category, Arr_oblivious_side_tag >,
    std::is_same< Top_side_category, Arr_contracted_side_tag > >)
  );
  BOOST_MPL_ASSERT
  (
   (boost::mpl::or_<
    std::is_same< Right_side_category, Arr_oblivious_side_tag >,
    std::is_same< Right_side_category, Arr_identified_side_tag > >)
  );
  //@}
