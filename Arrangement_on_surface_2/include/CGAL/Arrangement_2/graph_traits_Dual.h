...
// This file has no include guards as it is meant to be included by
// another header file defining the macro CGAL_ARGT_CLASS

#include <CGAL/license/Arrangement_on_surface_2.h>

#ifndef CGAL_ARGT_CLASS
  #error CGAL_ARGT_CLASS is not defined
#endif
...
class Dual< CGAL_ARGT_CLASS<T1,T2> >
{
public:
  
  typedef typename CGAL_ARGT_CLASS<T1,T2>::Geometry_traits_2 Geometry_traits_2;
  typedef typename CGAL_ARGT_CLASS<T1,T2>::Topology_traits Topology_traits;
  typedef CGAL_ARGT_CLASS<T1,T2> Arrangement_on_surface_2;
 ...
 */
template <class T1, class T2>
class graph_traits<CGAL::Dual< CGAL_ARGT_CLASS<T1,T2> > >
{
public:
...
template <class T1, class T2>
typename 
boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::degree_size_type
out_degree(typename 
           boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::
                                                           vertex_descriptor v,
           const CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> >& darr)
{
...
template <class T1, class T2>
typename
boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::vertex_descriptor
source(typename
       boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::
                                                           edge_descriptor e,
       const CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> >& /* darr */)
...
template <class T1, class T2>
typename
boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::vertices_size_type
num_vertices(const CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> >& darr)
{
...
std::pair<typename
          ...
          boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::
                                                               vertex_iterator>
vertices (const CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> >& darr)
{
...
template <class T1, class T2>
typename
boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::edges_size_type
num_edges(const CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> >& darr)
{
...
std::pair<typename
          ...
          boost::graph_traits<CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> > >::
                                                               edge_iterator>
edges (const CGAL::Dual<CGAL_ARGT_CLASS<T1,T2> >& darr)
{
