...
#include "AlgebraicCurveParserNew.h"

AlgebraicCurveParserNew::AlgebraicCurveParserNew(std::string &expression) : expression(expression) {};

bool AlgebraicCurveParserNew::validateExpression(const std::string &expression) {
...
Terms AlgebraicCurveParserNew::extractTerms() {
...
bool AlgebraicCurveParserNew::parseTerm(Iterator first, Iterator last, AlgebraicCurveTerm &term) {
