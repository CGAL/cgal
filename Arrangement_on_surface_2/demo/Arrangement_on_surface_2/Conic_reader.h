...
public:
	...
	/*!
      \param filename a character pointer to the file being referenced.
      \param curves_out An OutputIterator for the curves being formed.
      \param bbox a Bbox_2 object for the bounding box area of the curve
