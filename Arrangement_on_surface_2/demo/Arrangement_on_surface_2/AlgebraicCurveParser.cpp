...
TermsArray AlgebraicCurveParser::extractTerms() {
...
AlgebraicTerm AlgebraicCurveParser::extractCoefficientAndExponent(std::string &subExpression) {
...
int AlgebraicCurveParser::extractCoefficient(std::string &subExpression) {
