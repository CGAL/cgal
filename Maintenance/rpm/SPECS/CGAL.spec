...
%define CGAL_DIR %{_libdir}/CGAL-3.2.1-I
%else
%define tarball_name CGAL-%{cgal_version}
%define CGAL_DIR %{_libdir}/CGAL-3.2.1
...
%if %{build_doc}
Source1: CGAL-3.2.1-doc_pdf.tar.gz
Source2: CGAL-3.2.1-doc_html.tar.gz
%endif
...
%changelog
* Tue May 23 2006 Sylvain Pion <Sylvain.Pion@sophia.inria.fr> - 3.2.1-0.1
- Update to CGAL-3.2.1-0.1.
