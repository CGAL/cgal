...
`Delaunay_triangulation<DelaunayTriangulationTraits, TriangulationDataStructure>`. It brings the geometric ingredients to 
the definition of a Delaunay complex, while the combinatorial 
ingredients are 
brought by the second template parameter, `TriangulationDataStructure`. 

\refines ::TriangulationTraits. 

CONVERRORHasModels: `CGAL::Cartesian_d<FT, Dim, LA>`, 
CONVERRORHasModels: `CGAL::Simple_cartesian_d<FT, Dim, LA>`, 
CONVERRORHasModels: `CGAL::New_kernel_d` (recommended when available) 
