...
`TriangulationDSVertex` (the third template parameter) 

\models ::TriangulationVertex 
CONVERRORIsModel: Additionally, the class `Triangulation_vertex` also provides the following type, 
...
also read. 
\relates Triangulation_vertex 
*/ 
istream & operator>>(istream & is, Triangulation_vertex & v); 
...
\relates Triangulation_vertex 
*/ 
ostream & operator<<(ostream & os, const Triangulation_vertex & v); 
