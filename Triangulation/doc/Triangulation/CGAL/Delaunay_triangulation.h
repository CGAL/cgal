...
`Triangulation<DelaunayTriangulationTraits, TriangulationDataStructure>::Maximal_dimension` for an explanation of 
the use of the parameter `dim`. The complex stores a copy of the geometric 
traits `gt`. 
*/ 
Delaunay_triangulation(const int dim, const Geom_traits gt = 
Geom_traits()); 
...
value of `lt`:<UL> <DT><B>`OUTSIDE_AFFINE_HULL`</B><DD> Point 
