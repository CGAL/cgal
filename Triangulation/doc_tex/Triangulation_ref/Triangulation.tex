...
\note{je comprends pas bien toute ces preconditions, je les vire,
...
\ccGlobalScope\ccc{POSITIVE} is returned. \ccPrecond Full cell \ccc{c} must be
finite.
...
point \ccc{query} into the triangulation and returns a handle to the
...
The point \ccc{query} is inserted in the triangulation according to the value
