...
and predicates needed by Delaunay complexes. \ccc{DTTraits} must be a model of
...
%\ccTypedef{typedef DTTraits Geom_traits;}%
%{The model for the \ccc{DelaunayComplexTraits} concept.}
%\ccTypedef{typedef DTTraits::Point_d Point;}%
...
\ccMethod{Full_cell_handle remove(Vertex_handle);}{Remove the vertex \ccc{v}
...
= Full_cell_handle());}{Inserts point \ccc{p} in the Delaunay triangulation. Returns a
...
as a starting point for the gathering. 
