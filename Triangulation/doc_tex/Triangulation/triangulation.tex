...
\begin{ccAdvanced}
Thus, to the user in need of a custom vertex or simplex class, we recommend
...
\paragraph{Barycentric subdivision}
...
which is not documented, but easy to implement.
