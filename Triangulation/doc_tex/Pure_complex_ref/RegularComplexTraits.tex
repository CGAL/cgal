...
oriented, then the positive side of sphere \ccc{S} geometrically corresponds
to the unbounded side of \ccc{S} and the negative side corresponds to the
bounded side of \ccc{S}. If the simplex is negatively oriented, the
