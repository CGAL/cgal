...
The chapter teaser shows the process of Catmull-Clark 
...
% +-------------------------------------------------------------+
\section{First Example: Catmull-Clark Subdivision}
\label{secFirstSub}
...
% +-------------------------------------------------------------+
\section{Know How: Catmull-Clark Subdivision}
\label{secCC}
...
They are respectively used by Catmull-Clark, Loop, Doo-Sabin and $\sqrt{3}$ 
subdivision. 
...
are designed to work on the polyhedron with \ccc{CGAL::Point_3} 
as the vertex position. If you application uses a polyhedron 
with a specialized geometry kernel, you need to specialize 
the refinement host with the geometry mask based on the kernel.
...
required to converge to a smoothed surface. This is the requirement
