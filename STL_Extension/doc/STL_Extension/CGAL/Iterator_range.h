...
namespace CGAL {
  ...
  /*!
    ...
    The class is essentially a clone of <A href="https://www.boost.org/doc/libs/latest/libs/range/doc/html/range/reference/utilities/iterator_range.html">`boost::iterator_range`</A>,
