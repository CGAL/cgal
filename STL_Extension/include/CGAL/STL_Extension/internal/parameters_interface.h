...
CGAL_add_named_parameter(use_poisson_disk_sampling_euclidean_t, use_poisson_disk_sampling_euclidean, use_poisson_disk_sampling_euclidean)
CGAL_add_named_parameter(use_poisson_disk_sampling_geodesic_t, use_poisson_disk_sampling_geodesic, use_poisson_disk_sampling_geodesic)
CGAL_add_named_parameter(number_of_darts_t, number_of_darts, number_of_darts)
CGAL_add_named_parameter(sampling_radius_t, sampling_radius, sampling_radius)
