...
CGAL_add_named_parameter(compatibility_check_t, compatibility_check, compatibility_check)
CGAL_add_named_parameter(compatibility_check_builder_t, compatibility_check_builder, compatibility_check_builder)
