...
CGAL_add_named_parameter(exude_options_param_t, exude_options_param, exude_options)
CGAL_add_named_parameter(perturb_options_param_t, perturb_options_param, perturb_options)
CGAL_add_named_parameter(odt_options_param_t, odt_options_param, odt_options)
CGAL_add_named_parameter(lloyd_options_param_t, lloyd_options_param, lloyd_options)
CGAL_add_named_parameter(reset_options_param_t, reset_options_param, reset_options)
CGAL_add_named_parameter(mesh_param_t, mesh_param, mesh_options)
...
CGAL_add_named_parameter_with_compatibility(facet_sizing_field_param_t, facet_sizing_field_param, facet_sizing_field)
CGAL_add_named_parameter_with_compatibility(facet_distance_param_t, facet_distance_param, facet_distance)
...
CGAL_add_named_parameter_with_compatibility(cell_sizing_field_param_t, cell_sizing_field_param, cell_sizing_field)
CGAL_add_named_parameter_with_compatibility(sizing_field_param_t, sizing_field_param, sizing_field)
