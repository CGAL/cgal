...
// List of named parameters used in the package `Ball_merge_surface_reconstruction`
CGAL_add_named_parameter(delta_t, delta, delta)
CGAL_add_named_parameter(eta_t, eta, eta)
