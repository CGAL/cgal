...
template <class SimulationTraits,
          class Cell_base = CGAL::Regular_triangulation_cell_base_3<
            typename SimulationTraits::Instantaneous_kernel> >
class Regular_triangulation_cell_base_3
    : public Delaunay_triangulation_cell_base_3<SimulationTraits, Cell_base>
{
private:
...
public:
  ...
  Regular_triangulation_cell_base_3(Vertex_handle v0, Vertex_handle v1,
    ...
    : Cell_base(v0, v1, v2, v3)
  { }

  Regular_triangulation_cell_base_3(Vertex_handle v0, Vertex_handle v1,
                                    Vertex_handle v2, Vertex_handle v3,
                                    Cell_handle f0, Cell_handle f1,
                                    Cell_handle f2, Cell_handle f3)
    : Cell_base(v0,v1,v2, v3, f0,f1,f2, f3)
  { }
...
#endif // CGAL_KINETIC_KINETIC_REGULAR_CELL_BASE_3_H
