...
public:
  ...
  virtual CGAL::Comparison_result compare_concurrent(typename P::Key a, typename P::Key b) const{return CGAL::EQUAL;}
...
protected:
  ...
  bool leq_ub(const Priority &t) const {
    ...
    else return (CGAL::compare(t, Priority(ub_)) != CGAL::LARGER);
  }
