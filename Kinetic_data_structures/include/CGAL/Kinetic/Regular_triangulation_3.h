...
protected:
  ...
  struct Base_traits: public TraitsT
  {
    ...
    typedef typename TraitsT::Kinetic_kernel::Power_side_of_power_sphere_3 Side_of_oriented_sphere_3;
    ...
    Side_of_oriented_sphere_3 side_of_oriented_sphere_3_object() const
    {
      ...
      return TraitsT::kinetic_kernel_object().power_side_of_power_sphere_3_object();
    }
