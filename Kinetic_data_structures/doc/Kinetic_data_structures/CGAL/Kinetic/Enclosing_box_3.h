...
The class `Kinetic::Enclosing_box_3` keeps the points in the simulation inside of a 
...
`Kinetic::Enclosing_box_3` bounces the points at the nearest easily representable 
time before the point would leave the box. 

*/
template< typename Traits >
class Enclosing_box_3 {
public:
