...
\ccc{Kinetic::RegularTriangulationVisitor_3}. You can extend this class if you only
want to implement a few methods from \ccc{Kinetic::RegularTriangulationVisitor_3}.
