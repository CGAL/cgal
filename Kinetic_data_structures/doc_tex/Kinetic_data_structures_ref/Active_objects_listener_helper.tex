...
\begin{ccRefClass}{KDS::Active_objects_listener_helper<ActiveObjectsTable, KDS>}  %% add template arg's if necessary
...
\ccInclude{CGAL/KDS/Active_objects_listener_helper.h}


\ccSeeAlso

\ccc{CGAL::KDS::Active_objects_vector},
\ccc{ActiveObjectsTable}.
