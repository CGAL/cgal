...
The class \ccc{Kinetic::Qt_Delaunay_triangulation_2} displays a kinetic
...
\ccc{Triangulation::Face} must inherit from \ccc{Kinetic::Delaunay_triangulation_face_base_2<Traits>}.
...
\ccc{Kinetic::Delaunay_triangulation_recent_edges_visitor_2},
