...
\ccNestedType{Simulator}{A model of Kinetic::Simulator which will be
used by all the kinetic data structures.}

%\ccNestedType{Active_objects_table}{A model of Kinetic::ActiveObjectsTable which can be used to store moving points of an appropriate dimension. This is really optional and not needed if no kinetic data structures use points.}
