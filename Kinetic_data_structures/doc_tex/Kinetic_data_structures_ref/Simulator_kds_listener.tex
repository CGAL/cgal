...
\begin{ccRefClass}{Kinetic::Simulator_kds_listener<Simulator_listener, KDS>}  %% add template arg's if necessary
...
See the \ccc{Kinetic::Simple_kds_base} source code for a simple
