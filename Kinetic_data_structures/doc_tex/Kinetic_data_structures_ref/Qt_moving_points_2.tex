...
\begin{ccRefClass}{Kinetic::Qt_moving_points_2<Traits, QtWidget2>}  %% add template arg's if necessary
...
\ccConstructor{Qt_moving_points_2(QtGui::Pointer, ActiveObjectsTable::Pointer);}{default constructor.}


\ccSeeAlso

\ccc{Kinetic::Qt_moving_points_3}.
