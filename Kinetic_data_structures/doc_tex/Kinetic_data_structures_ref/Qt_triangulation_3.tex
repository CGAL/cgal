...
\begin{ccRefClass}{KDS::Qt_triangulation_3<KineticDelaunay_3, QtWidget_3, Qt_moving_points_3>}  %% add template arg's if necessary
...
\ccc{CGAL::KDS::Qt_triangulation_2<KineticDelaunay_2, QtWidget_2,
...
\ccInclude{CGAL/KDS/IO/Qt_triangulation_3.h}
