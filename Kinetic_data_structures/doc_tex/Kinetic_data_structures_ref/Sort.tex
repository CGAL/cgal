...
\begin{ccRefClass}{Kinetic::Sort<Traits, SortVisitor>}  %% add template arg's if necessary
...
The \ccc{SortVisitor} can be used to monitor what is happening.
...
\ccc{Kinetic::Ref_counted},
\ccc{Kinetic::Delaunay_triangulation_2}.
\ccc{Kinetic::Simple_kds_base}.
