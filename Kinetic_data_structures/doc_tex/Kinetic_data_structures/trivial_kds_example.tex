...
future use. It gets a handle to to the \ccc{Kinetic::ActiveObjectsTable} by
calling the
...
of changes to the point set.  The \ccc{Kinetic::SimulationTraits} method
...
instance of a model of the \ccc{Kinetic::InstantaneousKernel} from the
...
method where \ccc{Kinetic::Event} is a proxy object which instructs the sort
