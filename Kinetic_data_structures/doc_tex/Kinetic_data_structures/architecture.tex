...
\ccc{Kinetic::Cartesian_kinetic_kernel<FunctionKernel>}, which
...
two models, the
\ccc{Kinetic::Cartesian_instantaneous_kernel<ActiveObjectsTable,
Kernel>} and
\ccc{Kinetic::Regular_triangulation_instantaneous_traits<ActiveObjectsTable,
Kernel>}.
...
Note that the \ccc{Kinetic::Simulator<FunctionKernel, EventQueue>}
...
counted pointer, \ccc{Kinetic::Simulator<FunctionKernel,
...
such a table, \ccc{Kinetic::Active_objects_vector<Object>}.
...
(\ccc{Kinetic::Qt_widget_2<Simulator>}) and Coin (\texttt{http://www.coin3d.org})
(\ccc{Kinetic::QT_widget_3<Simulator>}) libraries,
