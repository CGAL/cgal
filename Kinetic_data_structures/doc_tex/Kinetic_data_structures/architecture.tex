...
\ccc{InstantaneousKernel}.  The Kinetic::FunctionKernel concept is
...
basic usage of the Kinetic::Simulator. First, the \ccc{Simulator}
...
In the model of the Kinetic::Simulator concept that we provide, any
...
\ccc{Gmpq}) which is close to the current time and such
