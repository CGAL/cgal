...
package is structured: the \ccc{Kinetic::Simulator}, the
Kinetic::Kernel, the \ccc{Kinetic::ActiveObjectsTable} and the
\ccc{Kinetic::InstantaneousKernel}.  The \ccc{Kinetic::FunctionKernel} concept is
