...
See the example
\ccReferToExampleCode{examples/Kinetic_framework/defining_a_simulation_traits.cpp} to see how
...
\ccReferToExampleCode{examples/Kinetic_framework/trivial_kds.cpp} and a slightly more
complicated one is:
