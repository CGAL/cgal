...
\ccMethod{void set_interval(Time t_cur, Time t_end);}{Set the current time to $t_{cur}$ and the end time to $t_{end}$. The event queue must be empty. Use this method if you want to reset or extend the simulation.}
