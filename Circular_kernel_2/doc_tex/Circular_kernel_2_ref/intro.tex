\ccRefChapter{2D Circular Kernel}
...
\ccRefIdfierPage{CGAL::Arr_circular_arc_traits<CircularKernel>}\\
\ccRefIdfierPage{CGAL::Arr_line_arc_traits<CircularKernel>}\\
\ccRefIdfierPage{CGAL::Arr_circular_line_arc_traits<CircularKernel>}
