...
*/ 
typedef Hidden_type Line_arc_2; 

/*! 
Model of `CircularKernel::CircularArc_2`. 
*/ 
typedef Hidden_type Circular_arc_2; 

/*! 
Model of `CircularKernel::CircularArcPoint_2`. 
*/ 
typedef Hidden_type Circular_arc_point_2; 
...
*/ 
typedef Hidden_type Compare_y_to_right_2; 
...
*/ 
typedef Hidden_type Do_overlap_2; 
...
*/ 
typedef Hidden_type In_x_range_2; 
...
*/ 
typedef Hidden_type Is_x_monotone_2; 
...
*/ 
typedef Hidden_type Construct_circular_arc_point_2; 

/*! 
Model of `CircularKernel::ConstructLineArc_2`. 
*/ 
typedef Hidden_type Construct_line_arc_2; 

/*! 
Model of `CircularKernel::ConstructCircularArc_2`. 
*/ 
typedef Hidden_type Construct_circular_arc_2; 

/*! 
Model of `CircularKernel::ComputeCircularX_2` 
*/ 
typedef Hidden_type Compute_circular_x_2; 

/*! 
Model of `CircularKernel::ComputeCircularY_2` 
*/ 
typedef Hidden_type Compute_circular_y_2; 

/*! 
Model of `CircularKernel::ConstructCircularMinVertex_2`. 
*/ 
typedef Hidden_type Construct_circular_min_vertex_2; 

/*! 
Model of `CircularKernel::ConstructCircularMaxVertex_2`. 
*/ 
typedef Hidden_type Construct_circular_max_vertex_2; 

/*! 
Model of `CircularKernel::ConstructCircularSourceVertex_2`. 
*/ 
typedef Hidden_type Construct_circular_source_vertex_2; 

/*! 
Model of `CircularKernel::ConstructCircularTargetVertex_2`. 
*/ 
typedef Hidden_type Construct_circular_target_vertex_2; 
...
*/ 
typedef Hidden_type Make_xy_monotone_2; 
