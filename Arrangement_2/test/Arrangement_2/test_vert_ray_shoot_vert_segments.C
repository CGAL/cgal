...
int main ()
{
  ...
  vertical_ray_shooting_query (naive_pl, true, q1);
  vertical_ray_shooting_query (walk_pl, true, q1);

  vertical_ray_shooting_query (naive_pl, false, q1);
  vertical_ray_shooting_query (walk_pl, false, q1);

  Point_2          q2 (0, 1);

  vertical_ray_shooting_query (naive_pl, true, q2);
  vertical_ray_shooting_query (walk_pl, true, q2);

  vertical_ray_shooting_query (naive_pl, false, q2);
  vertical_ray_shooting_query (walk_pl, false, q2);
  
  Point_2          q3 (0, 3);

  vertical_ray_shooting_query (naive_pl, true, q3);
  vertical_ray_shooting_query (walk_pl, true, q3);

  vertical_ray_shooting_query (naive_pl, false, q3);
