...
\ccc{ex_point_location.cpp}, \ccc{ex_vertical_ray_shooting.cpp}, and
\ccc{ex_batched_point_location.cpp}. The
...
\ccIncludeExampleCode{../examples/Arrangement_2/ex_point_location.cpp}
...
\ccc{ex_point_location.cpp} (see Figure~\ref{arr_fig:ex_5}):

\ccIncludeExampleCode{../examples/Arrangement_2/ex_vertical_ray_shooting.cpp}
...
\ccc{ex_point_location.cpp} (see Section~\ref{arr_ssec:pl}):

\ccIncludeExampleCode{../examples/Arrangement_2/ex_batched_point_location.cpp}
