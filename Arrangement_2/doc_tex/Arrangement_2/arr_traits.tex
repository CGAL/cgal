...
\ccc{ex_conics.C}.\label{arr_fig:ex_14}}
\end{figure}
...
constructed in \ccc{ex_rational_functions.C}.\label{arr_fig:ex_16}}
\end{figure}
...
constructed in
\ccc{ex_unbounded_rational_functions.C}.\label{arr_fig:ex_unb_rat}}
\end{figure}
...
constructed in \ccc{ex_generic_curve_data.C}.\label{arr_fig:ex_18}}
\end{figure}
...
The third example we give in this section is based on \ccc{ex_dual_lines.C}
