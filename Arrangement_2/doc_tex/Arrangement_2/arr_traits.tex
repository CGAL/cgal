...
\ccIncludeExampleCode{Arrangement_2/ex_predefined_kernel.cpp}
...
\ccIncludeExampleCode{Arrangement_2/ex_predefined_kernel_non_intersecting.cpp}
...
\ccc{ex_polylines.cpp}. Disks mark vertices associated with
...
\ccIncludeExampleCode{Arrangement_2/ex_polylines.cpp}
...
\ccc{ex_circles.cpp}. Each circle is split into two $x$-monotone
...
\ccIncludeExampleCode{Arrangement_2/ex_circles.cpp}
...
\ccIncludeExampleCode{Arrangement_2/ex_circular_arcs.cpp}
...
\ccc{ex_conics.cpp}.\label{arr_fig:ex_14}}
\end{figure}
...
\ccIncludeExampleCode{Arrangement_2/ex_conics.cpp}
...
\ccIncludeExampleCode{Arrangement_2/ex_conic_multiplicities.cpp}
...
constructed in \ccc{ex_rational_functions.cpp}.\label{arr_fig:ex_16}}
\end{figure}
...
\ccIncludeExampleCode{Arrangement_2/ex_rational_functions.cpp}
...
constructed in
\ccc{ex_unbounded_rational_functions.cpp}.\label{arr_fig:ex_unb_rat}}
\end{figure}
...
\ccIncludeExampleCode{Arrangement_2/ex_unbounded_rational_functions.cpp}
...
of objects of the \ccc{RatKernel::Point_2} type). The template parameters
are the same ones used by the \ccc{Arr_conic_traits_2} class template, and
here it is also recommended to use the \ccc{CORE_algebraic_number_traits}
class, with Cartesian kernels instantiated
with the \ccc{Rational} and \ccc{Algebraic} number-types defined by this
class.
...
constructed in \ccc{ex_Bezier_curves.cpp}.\label{arr_fig:ex_bez}}
\end{figure}
...
\ccIncludeExampleCode{Arrangement_2/ex_Bezier_curves.cpp}
...
constructed in \ccc{ex_consolidated_curve_data.cpp}. Disks correspond to
...
\ccIncludeExampleCode{Arrangement_2/ex_consolidated_curve_data.cpp}
...
constructed in \ccc{ex_generic_curve_data.cpp}.\label{arr_fig:ex_18}}
\end{figure}
...
\ccIncludeExampleCode{Arrangement_2/ex_generic_curve_data.cpp}

The third example we give in this section is based on \ccc{ex_dual_lines.cpp}
...
\ccIncludeExampleCode{Arrangement_2/ex_dual_with_data.cpp}
