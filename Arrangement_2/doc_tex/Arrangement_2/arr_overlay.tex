...
in \ccc{ex_overlay.cpp} and \ccc{ex_face_extension_overlay.cpp}.
In \ccc{ex_face_extension_overlay.cpp} the two bounded faces are
...
\ccIncludeExampleCode{../examples/Arrangement_2/ex_overlay.cpp}
...
\ccIncludeExampleCode{../examples/Arrangement_2/ex_face_extension_overlay.cpp}
...
\ccIncludeExampleCode{../examples/Arrangement_2/ex_overlay_unbounded.cpp}
