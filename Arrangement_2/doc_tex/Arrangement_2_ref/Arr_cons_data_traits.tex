...
Each \ccc{Curve_2} object is associated with a single data field
of type \ccc{Data}, and each \ccc{X_monotone_curve_2} object is associated
...
\ccTypedef{typedef Traits Base_traits_2;}
