...
\ccThreeToTwo
\ccNestedType{Intersect_2}{models the concept \ccc{Intersect_2}.}
\ccGlue
\ccNestedType{Split_2}{models the concept \ccc{Split_2}.}
...
\ccNestedType{Are_mergeable_2}{models the concept \ccc{AreMergeable_2}.}
\ccGlue
\ccNestedType{Merge_2}{models the concept \ccc{Merge_2}.}
...
% ==================
\ccRefPageBegin
\begin{ccRefConcept}{Intersect_2}
\ccRefines{Functor}
...
\ccMethod{void split(ArrTraits::X_monotone_curve_2 xc,
		     ...
		     ArrTraits::X_monotone_curve_2& xc2);}{%
  accepts an input curve \ccc{c} and a split point \ccc{p} in its
...
% =====================
\ccRefPageBegin
\begin{ccRefConcept}{AreMergeable_2}
\ccRefines{Functor}
...
\ccMethod{bool are_mergeable(ArrTraits::X_monotone_curve_2 xc1,
                             ArrTraits::X_monotone_curve_2 xc2);}{%
  accepts two $x$-monotone curves \ccc{c1} and \ccc{c2} that share
...
\ccMethod{void merge(ArrTraits::X_monotone_curve_2 xc1,
  ...
  accepts two {\sl mergeable} $x$-monotone curves \ccc{xc1} 
  and \ccc{xc2} (see above), and sets \ccc{xc} to be the merged curve.}%
\ccTagDefaults
\end{ccRefConcept}
\ccRefPageEnd
