...
\ccNestedType{Has_infinite_category}
...
\ccNestedType{Compare_x_2}
  ...
  \ccc{Has_infinite_category} tag is defined as \ccc{Tag_true}), then
  the type models the concept \ccc{ArrTraits::UnboundedCompareX_2}.}
\ccGlue
\ccNestedType{Compare_xy_2}{models the concept \ccc{ArrTraits::CompareXy_2}.}
\ccGlue
\ccNestedType{Infinite_in_x_2}
  {models the concept \ccc{ArrTraits::InfiniteInX_2}.
  Required only if the traits class supports unbounded curves
  (the \ccc{Has_infinite_category} tag is defined as \ccc{Tag_true}).}
\ccGlue
\ccNestedType{Infinite_in_y_2}
  {models the concept \ccc{ArrTraits::InfiniteInY_2}.
  Required only if the traits class supports unbounded curves
  (the \ccc{Has_infinite_category} tag is defined as \ccc{Tag_true}).}
\ccGlue
...
\ccNestedType{Compare_y_at_x_2}
  ...
  If the traits class supports unbounded curves (i.e., the
  \ccc{Has_infinite_category} tag is defined as \ccc{Tag_true}), then
  the type models the concept \ccc{ArrTraits::UnboundedCompareYAtX_2}.}
\ccGlue
...
\ccc{CGAL::Arr_Bezier_traits_2<RatKernel,AlgKernel,NtTraits>}\\
...
% ==========================
\ccRefPageBegin
\begin{ccRefConcept}{ArrTraits::UnboundedCompareX_2}
...
\ccHasModels\ccc{ArrangementBasicTraits_2::Infinite_in_x_2}

\ccCreationVariable{fo}
\ccMethod{Infinity_type operator()(ArrTraits::X_monotone_curve_2 xc,
                                   Curve_end ce);}
  ...
  \ccc{FINITE} if it has a finite $x$-coordinate.}
\end{ccRefConcept}
\ccRefPageEnd
...
\ccHasModels\ccc{ArrangementBasicTraits_2::Infinite_in_y_2}
...
\ccMethod{Infinity_type operator()(ArrTraits::X_monotone_curve_2 xc,
  ...
  \ccc{FINITE} if it has a finite $y$-coordinate.}
\end{ccRefConcept}
\ccRefPageEnd
...
\ccHasModels\ccc{ArrangementBasicTraits_2::onstruct_min_vertex_2}
