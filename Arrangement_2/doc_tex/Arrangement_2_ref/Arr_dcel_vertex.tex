...
\ccMethod{Infinity_type infinite_in_x () const;}
    {return whether the vertex has an infinite $x$-coordinate.}

\ccMethod{Infinity_type infinite_in_y () const;}
...
\ccMethod{void set_at_infinity (Infinity_type inf_x, Infinity_type inf_y);}
    {sets \ccVar{} as a vertex at infinity.
     \ccPrecond{Either \ccc{inf_x} or \ccc{inf_y} is not \ccc{FINITE}.}}
