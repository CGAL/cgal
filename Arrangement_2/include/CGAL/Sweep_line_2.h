  ...
  { 
    ...
    if(! this->m_currentEvent->has_left_curves())
    {
      ...
      */
      ...
      Status_line_iterator temp = this->m_status_line_insert_hint;
                              ...
                              
{
  ...
  Status_line_iterator sliter = leftCurve->get_hint(); 
                ...
                bool overlap_exist)
{
    ...
    else
    {
                                                 ...
                                                 MIN_END) == NO_BOUNDARY)
     {
       ...
       if (this->m_traits->compare_xy_2_object() (event->point(), 
                                                  begin_overlap) != EQUAL)
       {
