...
\ccConstructor{Fuzzy_iso_box(Point_d p, Point_d q, FT epsilon=FT(0),Traits t=Traits());}{Constructs a fuzzy iso box
...
\ccConstructor{Fuzzy_iso_box(Traits::Base::Point_d p, Traits::Base::Point_d q, FT epsilon=FT(0), Traits t=Traits());}
{Constructs a fuzzy iso box specified by the minimal iso box containing \ccc{p} and \ccc{q} and fuzziness value \ccc{epsilon}. 
\ccPrecond{ \ccc{p} must be lexicographically smaller than \ccc{q}.}}
