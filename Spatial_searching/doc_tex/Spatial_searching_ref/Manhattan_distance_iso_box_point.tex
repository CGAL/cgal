...
\ccMethod{FT min_distance_to_rectangle(Query_item b, Kd_tree_rectangle<Traits> r);}
{Returns the minimal distance between a point from \ccc{b} and a point from
\ccc{r}.}

\ccMethod{FT max_distance_to_rectangle(Query_item b, Kd_tree_rectangle<Traits> r);}
