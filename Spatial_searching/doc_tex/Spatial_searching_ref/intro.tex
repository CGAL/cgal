...
\ccRefIdfierPage{CGAL::Search_traits_adapter<Key,PointPropertyMap,Base_traits>}
...
\ccRefIdfierPage{CGAL::Distance_for_point_adapter<Key,PointPropertyMap,Base_distance>}
