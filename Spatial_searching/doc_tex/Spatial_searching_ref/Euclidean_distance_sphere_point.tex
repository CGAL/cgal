...
\ccMethod{NT min_distance_to_rectangle(Query_item s, Kd_tree_rectangle<Traits> r);}
{Returns the minimal distance between a point from the sphere \ccc{s} and a point from
\ccc{r}.}

\ccMethod{NT max_distance_to_rectangle(Query_item s, Kd_tree_rectangle<Traits> r);}
