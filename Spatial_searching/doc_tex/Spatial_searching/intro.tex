...
The following three example programs illustrate how to use the classes \ccc{Search_traits_adapter<Key,PointPropertyMap,BaseTraits>} and
\ccc{Distance_adapter<Key,PointPropertyMap,Base_distance>} to store in the kd-tree objects of an arbitrary key type. Points are
...
\subsubsection{Using an Integer as Key Type}
...
This example programs uses a \boost\ \ccAnchor{http://www.boost.org/doc/libs/release/libs/property_map/doc/LvaluePropertyMap.html}{LvaluePropertyMap}.
