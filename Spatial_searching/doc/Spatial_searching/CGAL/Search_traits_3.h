...
Point type. 
*/ 
Kernel::Point_3 Point_d; 

/*! 
Iso box type. 
*/ 
Kernel::Iso_cuboid_3 Iso_box_d; 

/*! 
Sphere type. 
*/ 
Kernel::Sphere_3 Sphere_d; 

/*! 
An iterator over the Cartesian 
coordinates. 
*/ 
Kernel::Cartesian_const_iterator_3 Cartesian_const_iterator_d; 
