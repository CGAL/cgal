...
\cgal. Number types must fulfill certain syntacitical and semantic
requirements, such that they can be successfully used in \cgal\ code.
In genreal they are expected to be a model of an algebraic structure 
concepts and in case they model a subring of the real numbers they are 
also a model of \ccc{RealEmebeddable}. For an overview of the algebraic 
structure concepts see section \ref{caf_ref::algebraic_structure_hierarchy} 
...
\ccc{<CGAL/float.h>}, \ccc{<CGAL/double.h>} and \ccc{<CGAL/long_double.h>}.}}{}
...
\section{Number Types Provided by {\sc Core}}
\label{CORE}

\newcommand{\core}{{\sc Core}}

In prinziple \core~\cite{klpy-clp-99} provides the same set of number types as \leda. 
...
a varibale precision floating-point type. It is also possbible to interprete it as an
...
To use \core\ with \cgal, just install \cgal\ with \core\ support, 
and include at least one of {\tt CGAL/CORE\_BigInt.h}, {\tt CGAL/CORE\_BigRat.h},
{\tt CGAL/CORE\_BigFloat.h}, {\tt CGAL/CORE\_Expr.h}. 
...
reflect their interoperatibility. 
...
TODO: move this part to chaper: kernel 
