...
the \ccc{mpz_class} and \ccc{mpq_class} types from \gmp.  The \ccc{Root_of_2}
...
The class \ccc{Sqrt_extension} was then contributed by Michael Hemmer and Ron Wein.
...
In 2008-2010, Bernd G\"artner added the \ccc{Gmpzf} class, while Luis
Pe\~naranda and Sylvain Lazard contributed the \ccc{Mpfi} and \ccc{Mpfr}
classes.
