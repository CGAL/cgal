...
This number type helps in doing filtering of predicates.
 ...
 \ccc{CGAL::Root_of_2} is a number  type that allows to represents algebraic numbers of
degree up to~2 over a \ccc{RingNumberType}.

A debugging helper \ccc{Number_type_checker<NT1,NT2,Comparator>} is also provided
...
\ccc{CGAL/CORE_Expr.h}.  {\sc Core} version 1.7 or later is required.
