...
IF (QT4_QMAKE_FOUND)
  ...
  IF (NOT QT_MKSPECS_DIR)
    ...
    SET(QT_MKSPECS_DIR ${qt_mkspecs_dir} CACHE PATH "The location of the Qt mkspecs" FORCE )
  ...
  IF( QT_QTCORE_INCLUDE_DIR AND NOT QT_INCLUDE_DIR)
    ...
    ELSE (QT_USE_FRAMEWORKS)
      ...
      SET( QT_INCLUDE_DIR ${qt4_include_dir} CACHE PATH "" FORCE )
...
if ( QT_QTGUI_INCLUDE_DIR )
  set ( QT_QTGUI_INCLUDE_DIR ${QT_QTOPENGL_INCLUDE_DIR}/QtGui )
endif()
...
if ( QT_QTOPENGL_INCLUDE_DIR )
  set ( QT_QTOPENGL_INCLUDE_DIR ${QT_QTOPENGL_INCLUDE_DIR}/QtOpenGL )
endif()
...
if ( QT_QTXML_INCLUDE_DIR )
  set ( QT_QTXML_INCLUDE_DIR ${QT_QTXML_INCLUDE_DIR}/QtXml )
endif()
