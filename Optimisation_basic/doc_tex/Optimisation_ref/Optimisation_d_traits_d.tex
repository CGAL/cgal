...
% -----------------------------------------------------------------------------
% file   : doc_tex/basic/Optimisation/..._ref/OptimisationDTraits_d.tex
...
\begin{ccRefClass}{Optimisation_d_traits_d<K,ET,NT>}
...
\ccSaveThreeColumns
\ccSetTwoColumns{Optimisation_d_traits_d<K,ET,NT>:: Rep_tag}{}
...
\ccConstructor{ Optimisation_d_traits_d(
                  const Optimisation_d_traits_d<K,ET,NT>&);}{copy constructor.}
...
\ccRefIdfierPage{CGAL::Optimisation_d_traits_3<K,ET,NT>}\\[1ex]
\ccRefConceptPage{OptimisationDTraits}
