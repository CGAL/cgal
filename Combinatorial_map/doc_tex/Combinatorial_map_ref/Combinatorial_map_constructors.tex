...
{Creates an isolated edge (two darts linked by $\beta_2$) and adds it in \ccc{cm}.
...
{Creates a combinatorial polygon of length \ccc{alg} (\ccc{alg} darts 
  linked by $\beta_1$), and adds it in \ccc{cm}. 
...
{Creates a combinatorial tetrahedron (four combinatorial triangles linked 
  together by $\beta_2$), and adds it in \ccc{cm}. 
