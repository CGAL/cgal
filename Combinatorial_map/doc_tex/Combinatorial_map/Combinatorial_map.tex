...
\begin{ccExampleCode}
  ...
  { 
    ...
    res = 0; 
    // Iterate over all the darts of the facet incident to dh1.  
    for (CMap_3::Dart_of_orbit_range<1>::const_iterator
         it(cm.darts_of_orbit<1>(dh1).begin()),
         itend(cm.darts_of_orbit<1>(dh1).end()); it!=itend; ++it) 
       ++res;
  
    std::cout<<"Number of darts of the facet containing dh1: "
             <<res<<std::endl; 
}
\end{ccExampleCode}
...
Number of darts of the facet containing d1: 3
\end{verbatim}
