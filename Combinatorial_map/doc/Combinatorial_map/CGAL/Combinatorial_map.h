...
The complexity of `is_without_boundary(unsigned int i)` is in <I>O</I>(\f$ | \f$ <I>D</I> \f$ | \f$), <I>D</I> being the set of darts of the combinatorial map, and the complexity of `is_without_boundary()` is in <I>O</I>(\f$ | \f$ <I>D</I> \f$ | \f$ \f$ \times\f$ <I>d</I>).

The complexity of `unmark_all` and `free_mark` is in <I>O</I>(1) if all the darts of the combinatorial map have the same mark, and in <I>O</I>(\f$ | \f$ <I>D</I> \f$ | \f$) otherwise.
