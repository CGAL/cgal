...
/*!
Equals to \link CGAL::Tag_true `Tag_true`\endlink to enable the storage of a
`Dart_handle` of the associated cell, \link CGAL::Tag_false `Tag_false`\endlink otherwise.
*/
...
copy constructor \link Info `Info(info)`\endlink.
Defined only if \link Info `Info`\endlink is different from `void`.
*/
...
`NULL` if \link Supports_cell_dart `Supports_cell_dart`\endlink is equal to
\link CGAL::Tag_false `Tag_false`\endlink.
*/
Dart_handle dart();
...
if \link Supports_cell_dart `Supports_cell_dart`\endlink is equal to
\link CGAL::Tag_true `Tag_true`\endlink.
