...
The function \link BasicMap::is_sewable `is_sewable`(dh1,dh2)\endlink returns true iff `*dh1` can be <I>i</I>-sewn with `*dh2` by keeping the combinatorial map valid.
...
The function \link BasicMap::sew `sew(dh1,dh2)`\endlink <I>i</I>-sew darts `*dh1` and `*dh2`, by keeping the combinatorial map valid.
...
The function \link BasicMap::unsew `unsew(dh)`\endlink <I>i</I>-unsew darts `*dh` and \f$ \beta_i\f$`(*dh)`, by keeping the combinatorial map valid.
...
\pre 0 \f$ \leq\f$ <I>i</I> \f$ \leq\f$ \link BasicMap::dimension `dimension`\endlink,
  ...
  and `*dh`\f$ \in\f$ \link BasicMap::darts `darts()`\endlink.
*/
...
\pre 0 \f$ \leq\f$ <I>i</I> \f$ \leq\f$ \link BasicMap::dimension `dimension`\endlink,
     `*dh`\f$ \in\f$ \link BasicMap::darts `darts()`\endlink, and `*dh` is not <I>i</I>-free.
*/
