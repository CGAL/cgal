...
It contains at most \link CombinatorialMap::dimension `dimension`\endlink`+1` types
...
<\f$\link CombinatorialMap::dimension `dimension`\endlink`+1`, \f$ \forall\f$<I>i</I>: <I>k</I>\f$
\leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink,
...
typedef unspecified_type Attributes;
  ...
  /*!
    ...
    \link CombinatorialMap::Dart_handle `Dart_handle`\endlink, and
    \link CellAttribute::Dart_const_handle `Attribute_type<i>::type::Dart_const_handle`\endlink is equal to
    \link CombinatorialMap::Dart_const_handle `Dart_const_handle`\endlink.
    \pre 0\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink and
...
This type is a model of `Range` concept, its iterator type is bidirectional and its value type is
  \link CombinatorialMap::Dart `Dart`\endlink.
*/
...
Cells are considered in <I>dim</I> dimension, with 0\f$ \leq\f$<I>i</I>\f$ \leq\f$<I>dim+1</I> and
 0\f$ \leq\f$<I>dim</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink. If <I>i==dim+1</I>,
...
0\f$ \leq\f$<I>dim</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink. If <I>i</I>==<I>dim+1</I>,
...
0\f$ \leq\f$<I>dim</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink.
...
- \f$ \forall\f$<I>i</I>, 2\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink: `d` is <i>i</i>-free, or \f$ \beta_i(\beta_i(d))=d\f$;
- \f$ \forall\f$<I>i</I>, <I>j</I>, 0\f$ \leq\f$<I>i</I>\f$ <\f$<I>i</I>+2\f$ \leq\f$<I>j</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink such that <I>j</I>\f$ \geq\f$ 3: \f$ \beta_j(\beta_i(d))=\varnothing\f$ or ; \f$ \beta_j(\beta_i(\beta_j(\beta_i(d))))=d\f$;
- \f$ \forall\f$<I>i</I>, 0\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink
...
\pre 1\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink.
*/
...
0\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink,
...
\pre 0\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink, and <I>i</I>-attributes are non `void`.
*/
...
\pre 0\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink, <I>i</I>-attributes are non `void` and `ah`!=NULL.
*/
template<unsigned int i>
...
\pre \link CombinatorialMap::attribute `attribute<i>`\endlink`(adart)!=NULL`.
*/
template<unsigned int i>
...
\pre `*dh`\f$ \in\f$`darts()` and `Beta...` is a sequence of integers \f$ i_1\f$,\f$ \ldots\f$,\f$ i_k\f$,
    such that 0\f$ \leq\f$\f$ i_1\f$\f$ <\f$\f$ i_2\f$\f$ <\f$\f$ \ldots\f$\f$ <\f$\f$ i_k\f$\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink,
     and (\f$ i_1\f$\f$ \neq\f$ 0 or \f$ i_2\f$\f$ \neq\f$ 1).
*/
...
`*ah`\f$ \in\f$\link CombinatorialMap::attributes() `attributes<i>()`\endlink.
*/
...
\pre `*dh`\f$ \in\f$`darts()`, 0\f$ \leq\f$<I>i</I>\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink,
<I>i</I>-attributes are non void, and `*ah`\f$ \in\f$\link CombinatorialMap::attributes() `attributes<i>()`\endlink.
*/
...
\f$ \forall i \f$, 0 \f$ \leq \f$ i \f$ \leq \f$ \link CombinatorialMap::dimension `dimension`\endlink such that the i-attributes are non void, \f$ \forall \f$ d \f$ \in\f$`darts()`:
...
NULL, functor \link CellAttribute::On_merge `Attribute_type<i>::type::On_merge`\endlink
is called on
...
the functor \link CellAttribute::On_split `Attribute_type<i>::type::On_split`\endlink
is called on the
...
\pre 0\f$ \leq\f$<I>m</I>\f$ <\f$\link CombinatorialMap::NB_MARKS `NB_MARKS`\endlink.
*/
bool is_reserved(size_type m) const;

/*!
Returns true iff `*dh` is marked for `m`.
\pre \link CombinatorialMap::is_reserved `is_reserved(m)`\endlink and `*dh`\f$ \in\f$`darts()`.
*/
...
become marked.
\pre \link CombinatorialMap::is_reserved `is_reserved(m)`\endlink.
*/
...
\pre \link CombinatorialMap::dimension `dimension`\endlink \f$ \geq\f$ 1 and
   `*dh`\f$ \in\f$\link CombinatorialMap::darts `darts()`\endlink.

See example in \cgalFigureRef{fig_cmap_insert_vertex}.

If \link CombinatorialMap::are_attributes_automatically_managed `are_attributes_automatically_managed()`\endlink`==true`, if 1-attributes are non `void`, \link CellAttribute::On_split `Attribute_type<1>::type::On_split`\endlink(<I>a</I>,<I>a'</I>) is called, with <I>a</I> the original 1-attribute associated with <I>dh</I> and <I>a'</I> the new 1-attribute created during the operation. If set, the dynamic onsplit function of 1-attributes is also called on <I>a</I> and <I>a'</I>.
...
\pre \link CombinatorialMap::dimension `dimension`\endlink \f$ \geq\f$ 2 and `*dh`\f$ \in\f$\link CombinatorialMap::darts `darts()`\endlink.

See example in \cgalFigureRef{fig_cmap_triangulation}.

If \link CombinatorialMap::are_attributes_automatically_managed `are_attributes_automatically_managed()`\endlink`==true`, if 2-attributes are non `void`, \link CellAttribute::On_split `Attribute_type<2>::type::On_split`\endlink(<I>a</I>,<I>a'</I>) is called, with <I>a</I> the original 2-attribute associated with `dh` and <I>a'</I> each new 2-attribute created during the operation. If set, the dynamic onsplit function of 2-attributes is also called on <I>a</I> and <I>a'</I>.
...
\pre \link CombinatorialMap::dimension `dimension`\endlink \f$ \geq\f$ 2, `*dh1`\f$ \in\f$\link CombinatorialMap::darts `darts()`\endlink, and `*dh2`\f$ \in\f$\link CombinatorialMap::darts `darts()`\endlink.
...
\pre \link CombinatorialMap::dimension `dimension`\endlink \f$ \geq\f$ 3.
...
An <I>i</I>-cell can be removed if `i`==\link CombinatorialMap::dimension `dimension`\endlink or if `i`==\link CombinatorialMap::dimension `dimension`\endlink-1 or if `i`\f$ <\f$\link CombinatorialMap::dimension `dimension`\endlink-1 and the <I>i</I>-cell containing `dh` is incident to at most two (<I>i+1</I>)-cells.
\pre 0\f$ \leq\f$`i`\f$ \leq\f$\link CombinatorialMap::dimension `dimension`\endlink and `*dh`\f$ \in\f$\link CombinatorialMap::darts `darts()`\endlink.
...
If \link CombinatorialMap::are_attributes_automatically_managed `are_attributes_automatically_managed()`\endlink`==true`, if `i`\f$ <\f$\link CombinatorialMap::dimension `dimension`\endlink, and <I>i+1</I>-attributes are non `void`, and if there are two distinct (<I>i+1</I>)-cells around dart `dh`, \link CellAttribute::On_merge `Attribute_type<i+1>::type::On_merge`\endlink(<I>a1</I>,<I>a2</I>) is called, with <I>a1</I> the (<I>i+1</I>)-attribute associated to `dh`, and <I>a2</I> the (<I>i+1</I>)-attribute associated to \f$ \beta_{i+1}\f$(<I>dh</I>). If set, the dynamic onmerge function of <I>i+1</I>-attributes is also called on <I>a1</I> and <I>a2</I>.

If \link CombinatorialMap::are_attributes_automatically_managed `are_attributes_automatically_managed()`\endlink`==true`, if a <I>j</I>-cell is disconnected in two <I>j</I>-cells during the operation, and if <I>j</I>-attributes are non void, \link CellAttribute::On_split `Attribute_type<j>::type::On_split`\endlink(<I>a</I>,<I>a'</I>) is called with <I>a</I> the original <I>j</I>-attribute and <I>a'</I> the new <I>j</I>-attribute created due to the disconnection. If set, the dynamic onsplit function of <i>j</i>-attributes is also called on <I>a</I> and <I>a'</I>.
