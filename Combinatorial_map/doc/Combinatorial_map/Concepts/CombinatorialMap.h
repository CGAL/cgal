...
The function \link GenericMap::is_valid `is_valid`\endlink returns true iff the combinatorial map is valid.
...
The function \link GenericMap::is_sewable `is_sewable`(dh1,dh2)\endlink returns true iff `*dh1` can be <I>i</I>-sewn with `*dh2` by keeping the combinatorial map valid.
...
The function \link GenericMap::sew `sew(dh1,dh2)`\endlink <I>i</I>-sew darts `*dh1` and `*dh2`, by keeping the combinatorial map valid.
...
The function \link GenericMap::unsew `unsew(dh)`\endlink <I>i</I>-unsew darts `*dh` and \f$ \beta_i\f$`(*dh)`, by keeping the combinatorial map valid.
