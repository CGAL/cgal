...
#include "simplify_2_toolbar_layers.h"
#include "simplify_2_layers.h"
...
Layers_toolbar::Layers_toolbar(CGAL::Qt_widget *w, QMainWindow *mw,
			       Cgal_Polygon *p, int& percentage) : QToolBar(mw, "LT"),
     nr_of_buttons(0)
  {
    showP = new Qt_layer_show_polygon<Cgal_Polygon>(*p);
    showGA = new Qt_layer_show_greene_approx<Cgal_Polygon>(*p, percentage);
...
#include "simplify_2_toolbar_layers.moc"
