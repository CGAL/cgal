% +------------------------------------------------------------------------+
% | Reference manual page: Periodic_2_triangulation_hierarchy_2.tex
% +------------------------------------------------------------------------+
...
The class \ccc{Periodic_2_triangulation_hierarchy_2} implements a
triangulation augmented with a data structure which allows fast point
location queries. 

\ccInclude{CGAL/Periodic_2_triangulation_hierarchy_2.h}
...
periodic triangulation classes.  \textit{In the current
  implementation, only \ccc{Periodic_2_Delaunay_triangulation_2} is
  supported for \ccc{PTr}.} 

\ccc{PTr::Vertex} has to be a model of the concept
\ccc{Periodic_2TriangulationHierarchyVertexBase_2}.\\
...
\ccSeeAlso
\ccc{CGAL::Periodic_2_triangulation_hierarchy_vertex_base_2}\\
\ccc{CGAL::Periodic_2_Delaunay_triangulation_2}
