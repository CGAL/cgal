...
\deprecated The functionality of this class has been generalized to
other packages than 2D convex hulls.  The more general class
`Projection_traits_xy_3` can be found in the 2D and 3D Linear
Geometric Kernel.  Note that the deprecated class was templated by a
point class, whereas the new class is templated by a geometric kernel.

The class `Convex_hull_projective_xy_traits_2` serves as a traits class for all the two-dimensional 
...
}; /* end Convex_hull_projective_xy_traits_2 */
} /* end namespace CGAL */
