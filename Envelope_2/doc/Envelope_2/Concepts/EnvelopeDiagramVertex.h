 ...
 * over this point. It is incident to two edges, one lying to its left and the
 * other to its right.
 *
 ...
 */
Edge_const_descriptor left() const;

/*! returns the edge lying to `v`'s right.
 */
Edge_const_descriptor right() const;
 ...
 */
void set_left(Edge_const_descriptor e);

/*! sets the edge lying to the right of `v` to be `e`.
 */
void set_right(Edge_const_descriptor e);
