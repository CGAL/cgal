  ...
  std::size_t faces_idx_begin)
{
  ...
  auto fill_edge = [&](std::size_t i){
    ...
    copy_constraint_status<SM>(tm.edge(h), new_edge, edge_cst_map_in, edge_cst_map_out);
    copy_constraint_status<SM>(tm.edge(h), new_edge, edge_mark_map_in, edge_mark_map_out);
  ...
  UserVisitor& user_visitor)
{
                   ...
                   i = patches_to_append.find_next(i))
  {
    ...
    append_patch<ConcurrencyTag, reverse_patch_orientation>(tm, output, patch,
                                                            ...
                                                            edge_cst_map_in, edge_mark_map_in,
