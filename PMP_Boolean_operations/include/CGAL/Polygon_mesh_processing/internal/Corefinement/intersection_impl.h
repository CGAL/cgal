...
// member functions
  ...
  // template<typename AABBTraits, typename TriangleMesh>
  // class Listing_Edge_Face_Intersection_traits
  // {
  ...
  // public:
  //   Listing_Edge_Face_Intersection_traits(Output_iterator out_it,
  //                                         const TriangleMesh &tm1,
  //                                         const TriangleMesh &tm2,
  //                                         const VertexPointMap &vpm1,
  //                                         const VertexPointMap &vpm2,
  //                                         const AABBTraits& traits)
  //     : m_out_it(out_it), m_tm1(tm1), m_tm2(tm2), m_vpm1(vpm1), m_vpm2(vpm2), m_traits(traits) {}

  //   constexpr bool go_further() const { return true; }

  //   void intersection(const Primitive& f1, const Primitive& f2)
  //   {
  //     for( halfedge_descriptor h: halfedges_around_face(f1, tm1) ){
  //       face_descriptor opposite = face(opposite(h, tm1), tm1);
  //       if(!is_border(opposite, tm1) && f1 > opposite) // To avoid consider an edge twice
  //         continue;
  //       callback1(halfedge(f2, tm2), h);
  //     }

  //     for( halfedge_descriptor h: halfedges_around_face(f2, tm2) ){
  //       face_descriptor opposite = face(opposite(h, tm2), tm2);
  //       if(!is_border(opposite, tm2) && f2 > opposite) // To avoid consider an edge twice
  //         continue;
  //       callback2(halfedge(f1, tm1), h);
  //       callback2(halfedge(f1, tm1), h);
  //     }
  //   }
  ...
  //   {
  //     return m_traits.do_intersect_object()(primitive, node.bbox());
  //   }
  ...
  //   const VertexPointMap &m_vpm1,
  //   const VertexPointMap &m_vpm2,
