...
The class \ccc{CGAL::Alpha_shape_3<Dt,ExactAlphaComparisonTag>} represents the whole
...
For the class \ccc{CGAL::Alpha_shape_3<Dt,ExactAlphaComparisonTag>}, the requirements of
...
The class \ccc{CGAL::Alpha_shape_3<Dt,ExactAlphaComparisonTag>} represents the whole family
...
In addition note that the class \ccc{CGAL::Alpha_shape_3<Dt,ExactAlphaComparisonTag>}
...
the regular triangulation requires 0.09s, then the class \ccc{CGAL::Fixed_alpha_shape_3<Dt>}
required 0.05s while the class \ccc{CGAL::Alpha_shape_3<Dt,ExactAlphaComparisonTag>} requires 0.35s
if \ccc{ExactAlphaComparisonTag} is \ccc{CGAL::Tag_false} (and 0.70s with \ccc{CGAL::Tag_true}).
Using \ccc{CGAL::Exact_predicates_exact_constructions_kernel}, building
the regular triangulation requires 0.19s and then the class \ccc{CGAL::Alpha_shape_3<Dt,ExactAlphaComparisonTag>} 
requires 0.90s.
...
\ccc{ExactAlphaComparisonTag} is set to \ccc{CGAL::Tag_true}.
\ccIncludeExampleCode{Alpha_shapes_3/ex_alpha_shapes_exact_alpha.cpp}
