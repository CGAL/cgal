...
the squared radius of  the smallest  circumsphere of 2 points \ccc{p0, p1},
and to return \ccc{NT(0)} for the squared radius of  the smallest  circumsphere
of a single point \ccc{p0}.} 
...
\ccc{CGAL::Alpha_shape_euclidean_traits_3<K>}
