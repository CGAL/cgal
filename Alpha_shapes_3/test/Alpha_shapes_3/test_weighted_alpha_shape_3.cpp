...
typedef CGAL::Filtered_weighted_alpha_shape_euclidean_traits_3<K> EF_Gt;
typedef EF_Gt::Weighted_point                               EF_Weighted_point;
...
typedef CGAL::Regular_triangulation_3<EF_Gt,EF_Tds>        EF_Triangulation_3;
