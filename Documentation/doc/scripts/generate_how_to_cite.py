...
def main():
    ...
    with open(build_dir + "/how_to_cite_cgal.bib.in", "w", encoding="utf-8") as f:
        f.write(result_bib)

    result_txt += RESULT_TXT_FOOTER
    with open(build_dir + "/how_to_cite_cgal.txt.in", "w", encoding="utf-8") as f:
        f.write(result_txt)

    with open(build_dir + "/how_to_cite.html.in", "w", encoding="utf-8") as f:
