#!/bin/bash
if [ "$1" == '--help' ]; then
  echo "Usage: $0 <doxygen 1.9.6> <doxygen 1.17.0> [publish_dir]"
  echo "Compares the output of doxygen 1.17.0 and doxygen master to the one from doxygen 1.9.6, of this CGAL version, "
...
DOXYGEN_1=$($PATH_TO_1_9_6 --version)
DOXYGEN_2=$($PATH_TO_1_17_0 --version)
...
echo "comparing versions 1.9.6 and 1.17.0"
bash -$- test_doxygen_versions.sh $PATH_TO_1_9_6 $PATH_TO_1_17_0 $PWD/doc_1_9_6 $PWD/doc_1_17_0  $PUBLISH_DIR
if [ ! -d $PWD/doc_1_17_0/doc_log ]; then
  echo "NO DOC LOGS."
  exit 1
fi
mv diff.txt diff1.txt

echo "comparing versions 1.9.6 and master"
if [ "$DO_COMPARE" = "TRUE" ]; then
  bash -$- test_doxygen_versions.sh $PATH_TO_1_9_6 $PATH_TO_MASTER $PWD/doc_1_9_6 $PWD/doc_master $PUBLISH_DIR
fi
if [ $? -ne 0 ] || [ "$DO_COMPARE" = "FALSE" ]; then
  DO_COMPARE=FALSE
...
if [ "$DO_COMPARE" = "TRUE" ]; then
  python3 ${PWD}/testsuite.py --output-dir1 $PWD/doc_1_9_6/doc_output/ --output-dir2 $PWD/doc_1_17_0/doc_output/ --doc-log-dir1 $PWD/doc_1_9_6/doc_log/ \
    --doc-log-dir2 $PWD/doc_1_17_0/doc_log/ --doc-log-dir-master $PWD/doc_master/doc_log/ \
  ...
  echo "NO MASTER"
  python3 ${PWD}/testsuite.py --output-dir1 $PWD/doc_1_9_6/doc_output/ --output-dir2 $PWD/doc_1_17_0/doc_output/ --doc-log-dir1 $PWD/doc_1_9_6/doc_log/ \
    --doc-log-dir2 $PWD/doc_1_17_0/doc_log/ --doc-log-dir-master $PWD/doc_master/ \
...
#clean-up
rm -rf ./doc_1_9_6 ./doc_1_17_0 ./doc_master #./doxygen_master
