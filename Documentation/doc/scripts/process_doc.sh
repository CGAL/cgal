#!/bin/bash
if [ "$1" == '--help' ]; then
  echo "Usage: $0 <doxygen 1.9.1> <doxygen 1.9.1> [publish_dir]"
  echo "Compares the output of doxygen 1.8.13 and doxygen master to the one from doxygen 1.9.1, of this CGAL version, "
...
DOXYGEN_2=$($PATH_TO_1_9_1 --version)
...
echo "comparing versions 1_8.13 and 1.9.1"
bash -$- test_doxygen_versions.sh $PATH_TO_1_8_13 $PATH_TO_1_9_1 $PWD/doc_1_8_13 $PWD/doc_1_9_1 $PUBLISH_DIR
mv diff.txt diff1.txt

echo "comparing versions 1_8.13 and master"
...
if [ "$DO_COMPARE" = "TRUE" ]; then
  python ${PWD}/testsuite.py --output-dir1 $PWD/doc_1_8_13/doc_output/ --output-dir2 $PWD/doc_1_9_1/doc_output/ --doc-log-dir1 $PWD/doc_1_8_13/doc_log/ \
    --doc-log-dir2 $PWD/doc_1_9_1/doc_log/ --doc-log-dir-master $PWD/doc_master/doc_log/ \
  ...
  echo "NO MASTER"
  python ${PWD}/testsuite.py --output-dir1 $PWD/doc_1_8_13/doc_output/ --output-dir2 $PWD/doc_1_9_1/doc_output/ --doc-log-dir1 $PWD/doc_1_8_13/doc_log/ \
    --doc-log-dir2 $PWD/doc_1_9_1/doc_log/ --doc-log-dir-master $PWD/doc_master/ \
...
#clean-up
rm -rf ./doc_1_8_13 ./doc_1_9_1 ./doc_master ./doxygen_master
