...
// ----------------------------------
    ...
    Halfedge_handle
    get_vertex_halfedge( Vertex_handle  ,CGAL::Tag_false) const {
        return Halfedge_handle();
    }
    Halfedge_handle
    get_vertex_halfedge( Vertex_handle v,CGAL::Tag_true) const {
        return v->halfedge();
    }

    Vertex_handle get_vertex( Halfedge_handle  , CGAL::Tag_false) const {
        return Vertex_handle();
    }
    Vertex_handle get_vertex( Halfedge_handle h, CGAL::Tag_true)  const {
        return h->vertex();
    }

    Halfedge_handle get_prev( Halfedge_handle  , CGAL::Tag_false) const {
        return Halfedge_handle();
    }
    Halfedge_handle get_prev( Halfedge_handle h, CGAL::Tag_true)  const {
        return h->HBase::prev();
    }

    Halfedge_handle find_prev( Halfedge_handle h, CGAL::Tag_true) const {
        return h->HBase::prev();
    }
    Halfedge_handle find_prev( Halfedge_handle h, CGAL::Tag_false) const {
        Halfedge_handle g = h;
        while ( g->next() != h)
            g = g->next();
        return g;
    ...
    Face_handle get_face( Halfedge_handle  , CGAL::Tag_false) const {
        return Face_handle();
    }
    Face_handle get_face( Halfedge_handle h, CGAL::Tag_true)  const {
        return h->face();
    }

    Halfedge_handle get_face_halfedge( Face_handle  ,
                                       CGAL::Tag_false) const {
        return Halfedge_handle();
    }
...
// ----------------------------------
    ...
    Halfedge_const_handle
    get_vertex_halfedge( Vertex_const_handle  ,CGAL::Tag_false) const {
        return Halfedge_const_handle();
    }
    Halfedge_const_handle
    get_vertex_halfedge( Vertex_const_handle v,CGAL::Tag_true) const {
        return v->halfedge();
    }

    Vertex_const_handle
    get_vertex( Halfedge_const_handle  , CGAL::Tag_false) const {
        return Vertex_const_handle();
    }
    Vertex_const_handle
    get_vertex( Halfedge_const_handle h, CGAL::Tag_true)  const {
        return h->vertex();
    }

    Halfedge_const_handle
    get_prev( Halfedge_const_handle  , CGAL::Tag_false) const {
        return Halfedge_const_handle();
    }
    Halfedge_const_handle
    get_prev( Halfedge_const_handle h, CGAL::Tag_true)  const {
        return h->HBase::prev();
    }

    Halfedge_const_handle
    find_prev( Halfedge_const_handle h, CGAL::Tag_true) const {
        return h->HBase::prev();
    }
    Halfedge_const_handle
    find_prev( Halfedge_const_handle h, CGAL::Tag_false) const {
    ...
    Halfedge_const_handle
    find_prev_around_vertex( Halfedge_const_handle h, CGAL::Tag_true) const {
        return h->HBase::prev();
    }
    Halfedge_const_handle
    find_prev_around_vertex( Halfedge_const_handle h, CGAL::Tag_false) const {
    ...
    Face_const_handle
    get_face( Halfedge_const_handle  , CGAL::Tag_false) const {
        return Face_const_handle();
    }
    Face_const_handle
    get_face( Halfedge_const_handle h, CGAL::Tag_true)  const {
        return h->face();
    }

    Halfedge_const_handle
    get_face_halfedge( Face_const_handle  , CGAL::Tag_false) const {
        return Halfedge_const_handle();
    }
    Halfedge_const_handle
    get_face_halfedge( Face_const_handle f, CGAL::Tag_true) const {
        return f->halfedge();
    }
...
// ----------------------------------
    ...
    void set_vertex( Halfedge_handle,
                     Vertex_handle,
                     CGAL::Tag_false) const {}
    void set_vertex( Halfedge_handle h,
                     Vertex_handle v,
                     CGAL::Tag_true)  const {
        h->HBase::set_vertex(v);
    }

    void set_prev( Halfedge_handle,
                   Halfedge_handle,
                   CGAL::Tag_false) const {}
    ...
    void set_face( Halfedge_handle,
                   Face_handle,
                   CGAL::Tag_false) const {}
    void set_face( Halfedge_handle h,
                   Face_handle f,
                   CGAL::Tag_true)  const {
        h->HBase::set_face(f);
    }
