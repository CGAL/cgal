...
\ccc{Face_const_handle}, \ccc{Face_const_iterator}.
...
\ccMethod{Vertex_const_iterator   vertices_end();}
{past-the-end iterator for vertices.}
\ccMethod{Halfedge_const_iterator halfedges_begin();}
{ iterator over halfedges of the map. }
\ccMethod{Halfedge_const_iterator halfedges_end();}
{ past-the-end iterator for halfedges. }
\ccMethod{Face_const_iterator     faces_begin();}
{ iterator over faces of the map. }
\ccMethod{Face_const_iterator     faces_end();}
{ past-the-end iterator for faces}

\ccHidden
\ccMethod{Point_const_iterator points_begin();}
{ ??? }
\ccHidden
\ccMethod{Point_const_iterator points_end();}
{ ??? }
