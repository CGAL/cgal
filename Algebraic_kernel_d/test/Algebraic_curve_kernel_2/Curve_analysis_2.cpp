...
template<typename Arithmetic_kernel> void test_routine() {
    ...
    {
        AcX_DSTREAM("P[1(0,P[1(0,2)(1,2)])(1,P[0(0,-3)])]" << std::endl);
    ...
    {
        AcX_DSTREAM("P[3(0,P[2(0,-2)(2,2)])(1,P[1(1,-1)])(3,P[1(1,-6)])]" << std::endl);
    ...
    {
        AcX_DSTREAM("P[10(1,P[9(4,18)(9,18)])(2,P[9(4,-9)(9,-9)])(3,P[7(2,-12)(7,-12)])(4,P[7(2,6)(3,-18)(7,6)])(5,P[5(3,9)(5,36)])(6,P[5(1,12)(5,-18)])(7,P[3(1,-6)(3,-42)])(8,P[3(3,21)])(9,P[1(1,12)])(10,P[1(1,-6)])]" << std::endl);
        ...
        assert(event.lower_boundary(0) > Rational(-169,100));
        assert(event.upper_boundary(0) < Rational(-168,100));
        assert(! event.is_event(0));
        event.refine_to(3,eps);
        assert(event.lower_boundary(3) > Rational(122,100));
        assert(event.upper_boundary(3) < Rational(123,100));
        assert(! event.is_event(0));
        ...
        event.refine_to(0,eps);
        assert(event.lower_boundary(0) > Rational(-101,100));
        assert(event.upper_boundary(0) < Rational(-99,100));
        assert(! event.is_event(0));
        event.refine_to(1,eps);
        assert(event.lower_boundary(1) > Rational(-1,100));
        assert(event.upper_boundary(1) < Rational(1,100));
        ...
        assert(event.lower_boundary(2) > Rational(199,100));
        assert(event.upper_boundary(2) < Rational(201,100));
        assert(! event.is_event(0));
    
        event=curve.status_line_at_exact_x(Algebraic_real(Poly_int1(-3,0,1),0,2));
        assert(event.number_of_events()==6);
        event.refine_to(1,eps);
        assert(event.lower_boundary(1) > Rational(-213,100));
        assert(event.upper_boundary(1) < Rational(-212,100));
        assert(! event.is_event(0));
        event.refine_to(3,eps);
        assert(event.lower_boundary(3) > Rational(199,100));
        assert(event.upper_boundary(3) < Rational(201,100));
        assert(! event.is_event(0));
    ...
    }
    {
        ...
        AcX_DSTREAM("P[2(0,P[2(1,3)(2,6)])(1,P[2(0,-3)(1,-11)(2,1)])(2,P[1(0,5)(1,-1)])]" << std::endl);
#if !CGAL_ACK_USE_EXACUS
    ...
    { // More tests...just analyse some curves and compute their segments
        ...
        Curve_analysis_2 curve(f);
        AcX_DSTREAM("P[8(0,P[8(0,24)(1,-8)(2,-162)(3,204)(4,106)(5,-340)(6,240)(7,-72)(8,8)])(1,P[6(0,-60)(1,8)(2,304)(3,-400)(4,148)(5,8)(6,-8)])(2,P[6(0,18)(1,80)(2,-165)(3,-132)(4,367)(5,-212)(6,38)])(3,P[4(0,-30)(1,-136)(2,264)(3,-72)(4,-26)])(4,P[4(0,-15)(1,36)(2,89)(3,-144)(4,49)])(5,P[2(0,30)(1,-24)(2,-6)])(6,P[2(0,-6)(1,-28)(2,22)])(8,P[0(0,3)])]" << std::endl);
        ...
        curve=Curve_analysis_2(f);
        AcX_DSTREAM("P[5(0,P[8(0,40)(1,-40)(2,-20)(3,20)(5,-8)(6,8)(7,4)(8,-4)])(1,P[8(0,-100)(1,100)(2,50)(3,-50)(5,20)(6,-20)(7,-10)(8,10)])(2,P[8(0,60)(1,-60)(2,-30)(3,30)(5,-12)(6,12)(7,6)(8,-6)])(3,P[8(0,-20)(1,20)(2,10)(3,-10)(5,4)(6,-4)(7,-2)(8,2)])(4,P[8(0,50)(1,-50)(2,-25)(3,25)(5,-10)(6,10)(7,5)(8,-5)])(5,P[8(0,-30)(1,30)(2,15)(3,-15)(5,6)(6,-6)(7,-3)(8,3)])]" << std::endl);
        ...
        curve=Curve_analysis_2(f);
        AcX_DSTREAM("P[8(0,P[10(5,80)(6,104)(7,44)(8,10)(9,4)(10,1)])(1,P[8(4,-80)(5,-36)(6,54)(7,32)(8,3)])(2,P[8(2,-80)(3,-104)(4,-72)(5,-66)(6,-8)(7,5)(8,1)])(3,P[7(1,80)(2,36)(3,-94)(4,-60)(5,-19)(6,-5)(7,-1)])(4,P[5(1,28)(2,56)(3,-10)(4,-30)(5,-6)])(5,P[5(0,40)(1,28)(2,16)(3,7)(4,-3)(5,-1)])(6,P[3(0,14)(1,24)(2,5)(3,1)])(7,P[2(0,-2)(1,4)(2,1)])(8,P[0(0,-1)])]" << std::endl);
        ...
        curve=Curve_analysis_2(f);
        AcX_DSTREAM("P[4(0,P[1(0,-10)(1,6)])(1,P[2(0,4)(1,8)(2,-6)])(2,P[2(0,-5)(1,-6)(2,5)])(3,P[3(0,2)(1,6)(2,1)(3,-3)])(4,P[3(1,-2)(2,-1)(3,1)])]" << std::endl);
