...
void test_real_root_isolator() {
    ...
    {  // (x^2-2)*(x^2+2)*(x-1)
        ...
        NT c = CGAL::INTERN_POLYNOMIAL::ipower(NT(10),12);
        ...
        NT z(0);
        NT a = CGAL::INTERN_POLYNOMIAL::ipower(NT(10),24); // a = 10^{24}
       
        Polynomial P(z,NT(4),CGAL::INTERN_POLYNOMIAL::ipower(a,2),z,z,2*a,z,z,NT(1)); 
        ...
        NT z(0);
        NT a = CGAL::INTERN_POLYNOMIAL::ipower(NT(10),20); // a = 10^{20}
