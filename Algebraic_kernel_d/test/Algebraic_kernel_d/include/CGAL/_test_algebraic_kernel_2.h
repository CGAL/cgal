...
void test_algebraic_kernel_2(const AlgebraicKernel_2& ak_2) {
  ...
  typedef CGAL::cpp0x::array<Bound, 4> BArray;
...
#undef CGAL_CHECK_UFUNCTION
    ...
    
  {
    ...
    // Comparisons   
    CGAL_assertion(compare_xy_2(ar1,ar2)==CGAL::EQUAL);
    CGAL_assertion(compare_xy_2(ar1,ar3)==CGAL::SMALLER);
    CGAL_assertion(compare_xy_2(ar2,ar3)==CGAL::SMALLER);
    CGAL_assertion(compare_y_2(ar1,ar3)==CGAL::LARGER);
    CGAL_assertion(compare_x_2(ar3,ar4)==CGAL::EQUAL);
    CGAL_assertion(compare_y_2(ar3,ar4)==CGAL::LARGER);
    CGAL_assertion(compare_xy_2(ar3,ar4)==CGAL::LARGER);
    CGAL_assertion(compare_xy_2(ar3,ar6)==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(ar1,ar5)==CGAL::LARGER);
    CGAL_assertion(compare_x_2(ar5,0)==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(ar5,Bound(0))==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(ar5,Coefficient(0))==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(ar5,construct_algebraic_real_1(0))==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(0,ar5)==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(Bound(0),ar5)==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(Coefficient(0),ar5)==CGAL::EQUAL);
    CGAL_assertion(compare_x_2(construct_algebraic_real_1(0),ar5)==CGAL::EQUAL);
    CGAL_assertion(compare_y_2(ar5,0)==CGAL::SMALLER);
    CGAL_assertion(compare_y_2(ar5,Bound(0))==CGAL::SMALLER);
    CGAL_assertion(compare_y_2(ar5,Coefficient(0))==CGAL::SMALLER);
    CGAL_assertion(compare_y_2(ar5,construct_algebraic_real_1(0))
		   ==CGAL::SMALLER);
    CGAL_assertion(compare_y_2(0,ar5)==CGAL::LARGER);
    CGAL_assertion(compare_y_2(Bound(0),ar5)==CGAL::LARGER);
    CGAL_assertion(compare_y_2(Coefficient(0),ar5)==CGAL::LARGER);
    CGAL_assertion(compare_y_2(construct_algebraic_real_1(0),ar5)==CGAL::LARGER);
    CGAL_assertion(compare_xy_2(ar5,0,0)==CGAL::SMALLER);
    CGAL_assertion(compare_xy_2(ar5,Bound(0),Bound(0))==CGAL::SMALLER);
    CGAL_assertion(compare_xy_2(ar5,Coefficient(0),Coefficient(0))
		   ==CGAL::SMALLER);
    CGAL_assertion(compare_xy_2(ar5,construct_algebraic_real_1(0),
				construct_algebraic_real_1(0))==CGAL::SMALLER);
    CGAL_assertion(compare_xy_2(0,0,ar5)==CGAL::LARGER);
    CGAL_assertion(compare_xy_2(Bound(0),Bound(0),ar5)==CGAL::LARGER);
    CGAL_assertion(compare_xy_2(Coefficient(0),Coefficient(0),ar5)
		   ==CGAL::LARGER);
    CGAL_assertion(compare_xy_2(construct_algebraic_real_1(0),
				construct_algebraic_real_1(0),
				ar5)==CGAL::LARGER);
    CGAL_assertion(compare_y_2(0,ar5)==CGAL::LARGER);
    CGAL_assertion(compare_y_2(-1,ar5)==CGAL::SMALLER);
    CGAL_assertion(compare_xy_2(ar5,-1,1000)==CGAL::LARGER);
    CGAL_assertion(compare_xy_2(ar5,ar7)==CGAL::EQUAL);

    // Compute_x/y_2
    Algebraic_real_1 ar1_x = compute_x_2(ar1);
    CGAL_assertion(compare_1(1,ar1_x)==CGAL::EQUAL);
    CGAL_assertion(compare_1(ar1_x,1)==CGAL::EQUAL);
    Algebraic_real_1 ar6_y = compute_y_2(ar6);
    CGAL_assertion(compare_1(Bound(-2),ar6_y)==CGAL::EQUAL);
    CGAL_assertion(compare_1(ar6_y,Bound(-2))==CGAL::EQUAL);

    // SignAt_2, IsZeroAt_2
    CGAL_assertion(sign_at_2(pol1_2,ar4)==CGAL::NEGATIVE);
    CGAL_assertion(! is_zero_at_2(pol1_2,ar4));
    CGAL_assertion(sign_at_2(pol2_2,ar7)==CGAL::ZERO);
    CGAL_assertion(is_zero_at_2(pol2_2,ar7));
    CGAL_assertion(sign_at_2(pol2_2,ar1)==CGAL::POSITIVE);
    CGAL_assertion(! is_zero_at_2(pol1_2,ar4));

    // ComputePolynomial
    Polynomial_1 pol1_x = compute_polynomial_x_2(ar1);
    CGAL_assertion(is_zero_at_1(pol1_x,compute_x_2(ar1)));
    Polynomial_1 pol1_y = compute_polynomial_y_2(ar1);
    CGAL_assertion(is_zero_at_1(pol1_y,compute_y_2(ar1)));

    // Is_square_free, Make_square_free
    CGAL_assertion(is_square_free_2(pol1_2));
    CGAL_assertion(! is_square_free_2(pol1_2*pol1_2));
    Polynomial_2 pol1_2_prime = make_square_free_2(pol1_2*pol1_2);
    CGAL_assertion(CGAL::canonicalize(pol1_2)
		   ==CGAL::canonicalize(pol1_2_prime));
    // Is_coprime, Make_coprime
    CGAL_assertion(is_coprime_2(pol1_2,pol2_2));
    CGAL_assertion(is_coprime_2(pol1_2*Coefficient(3),pol2_2*Coefficient(3)));
    CGAL_assertion(! is_coprime_2(pol1_2,pol1_2*pol2_2));
    Polynomial_2 g,q1,q2;
    bool check = make_coprime_2(pol1_2,pol1_2*pol2_2,g,q1,q2);
    CGAL_assertion(! check);
    CGAL_assertion(CGAL::canonicalize(q1)
		   ==CGAL::canonicalize(one));
    CGAL_assertion(CGAL::canonicalize(q2)==CGAL::canonicalize(pol2_2));
    CGAL_assertion(CGAL::canonicalize(g)==CGAL::canonicalize(pol1_2));
    check = make_coprime_2(pol2_2,pol1_2,g,q1,q2);
    CGAL_assertion(check);
    CGAL_assertion(CGAL::canonicalize(q1)==CGAL::canonicalize(pol2_2));
    CGAL_assertion(CGAL::canonicalize(q2)==CGAL::canonicalize(pol1_2));
    CGAL_assertion(CGAL::total_degree(g)==0);
    // Test coprime also for factors in x only
    Polynomial_2 pol3_2 = pow(x,2)-3;
    CGAL_assertion(! is_coprime_2(pol3_2*pol1_2, pol3_2*pol3_2*pol2_2));
    check = make_coprime_2(pol3_2*pol1_2, pol3_2*pol3_2*pol2_2,g,q1,q2);
    CGAL_assertion(! check);
    CGAL_assertion(CGAL::canonicalize(g)==CGAL::canonicalize(pol3_2));
    CGAL_assertion(CGAL::canonicalize(q1)==CGAL::canonicalize(pol1_2));
    CGAL_assertion(CGAL::canonicalize(q2)==CGAL::canonicalize(pol3_2*pol2_2));
    ...
    for(unsigned int i=0;i<sqfr_factors.size();i++) {
      CGAL_assertion(is_square_free_2(sqfr_factors[i].first));
      sqfr_fac_checksum
	*=CGAL::ipower(sqfr_factors[i].first, sqfr_factors[i].second);
    }
    CGAL_assertion(CGAL::canonicalize(sqfr_fac_checksum) ==
		   CGAL::canonicalize(sqfr_fac_test_pol));
  
    // BoundBetween
    Bound b = bound_between_x_2(ar1,ar3);
    CGAL_assertion(compare_1(compute_x_2(ar1),b)==CGAL::SMALLER);
    CGAL_assertion(compare_1(b,compute_x_2(ar3))==CGAL::SMALLER);
    b = bound_between_x_2(ar3,ar1);
    CGAL_assertion(compare_1(compute_x_2(ar1),b)==CGAL::SMALLER);
    CGAL_assertion(compare_1(b,compute_x_2(ar3))==CGAL::SMALLER);
    b = bound_between_y_2(ar5,ar6);
    CGAL_assertion(compare_1(compute_y_2(ar5),b)==CGAL::LARGER);
    CGAL_assertion(compare_1(b,compute_y_2(ar6))==CGAL::LARGER);
...

  {
    ...
    CGAL_assertion(number_of_solutions_2(one,x)==0);
    CGAL_assertion(number_of_solutions_2(one,y)==0);
    CGAL_assertion(number_of_solutions_2(y,x)==1);
    ...
    CGAL_assertion(is_square_free_2(pol1));
    CGAL_assertion(is_square_free_2(pol2));
    CGAL_assertion(is_coprime_2(pol1,pol2));
    CGAL_assertion(number_of_solutions_2(pol1,pol2)==4);
    ...
    for(size_type i = 0; i < 4; i++) {
      CGAL_assertion(roots[i].second==1);
    }
    solve_2(pol1,pol2,Bound(-7),Bound(-1),Bound(-123),Bound(1),
	    std::back_inserter(roots2));
    CGAL_assertion(roots2.size()==1);
    solve_2(pol1,pol2,Bound(-7),Bound(17),Bound(1),Bound(2),
	    std::back_inserter(roots2));
    CGAL_assertion(roots2.size()==2); // sum of the roots so far
    solve_2(pol1,pol2,Bound(-1),Bound(8),Bound(-9),Bound(20),
	    std::back_inserter(roots2));
    CGAL_assertion(roots2.size()==4); // sum of the roots so far
    std::sort(roots.begin(),roots.end());
    std::sort(roots2.begin(),roots2.end());
    CGAL_assertion(std::equal(roots.begin(),roots.end(),roots2.begin()));

    CGAL_assertion(number_of_solutions_2(pol1,pol2*pol3)==7);
    roots2.clear();
    solve_2(pol1,pol2*pol3,Bound(-2),Bound(0),Bound(0),Bound(1),
	    std::back_inserter(roots2));
    CGAL_assertion(roots2.size()==5);
    ...
    CGAL_assertion(box[0]>-1);
    CGAL_assertion(box[1]<1);
    CGAL_assertion(box[2]>-1);
    CGAL_assertion(box[3]<1);
    CGAL_assertion(sign_at_2(circle,construct_algebraic_real_2(box[0],box[2]))
		   == CGAL::NEGATIVE);
    CGAL_assertion(sign_at_2(circle,construct_algebraic_real_2(box[1],box[2]))
		   == CGAL::NEGATIVE);
    CGAL_assertion(sign_at_2(circle,construct_algebraic_real_2(box[0],box[3]))
		   == CGAL::NEGATIVE);
    CGAL_assertion(sign_at_2(circle,construct_algebraic_real_2(box[1],box[3]))
		   == CGAL::NEGATIVE);
    isolate_2(ar1,one);
    ...
    CGAL_assertion(!is_zero_at_1(q,compute_x_2(ar1)));
    BInterval bounds = isolate_x_2(ar1,q);
    CGAL_assertion(bounds.first<=bounds.second);
    ...
    CGAL_assertion(roots_1.size()==0);
    solve_1(q,false,std::back_inserter(roots_1));
    CGAL_assertion(roots_1.size()==4);
    for(size_type i=0;i<4;i++) {
    ...
    CGAL_assertion(roots2_1.size()==roots3_1.size());
    CGAL_assertion(roots_1.size()==roots3_1.size());
    CGAL_assertion(std::equal(roots_1.begin(),roots_1.end(),roots2_1.begin()));
    CGAL_assertion(std::equal(roots_1.begin(),roots_1.end(),
			      roots3_1.rbegin()));
    ...
    for(int i=1;i<1024;i*=2) {
      ...
      CGAL_assertion(bounds.first<=bounds.second);
      CGAL_assertion(compare_x_2(bounds.first,ar2)!=CGAL::LARGER);
      CGAL_assertion(compare_x_2(bounds.second,ar2)!=CGAL::SMALLER);
      // NOTE: The following check is not sufficient for ensuring
      //       the postcondition, but if it fails, the postcondition
      //       cannot be satisfied
      CGAL_assertion(dist*(bounds.second-bounds.first)<=Bound(2));
      ...
      CGAL_assertion(dist*(bounds.second-bounds.first)<=Bound(1));
      bounds = approximate_absolute_y_2(ar2,i);
      CGAL_assertion(bounds.first<=bounds.second);
      CGAL_assertion(compare_y_2(bounds.first,ar2)!=CGAL::LARGER);
      CGAL_assertion(compare_y_2(bounds.second,ar2)!=CGAL::SMALLER);
      // NOTE: The following check is not sufficient for ensuring
      //       the postcondition, but if it fails, the postcondition
      //       cannot be satisfied
      CGAL_assertion(dist*(bounds.second-bounds.first)<=Bound(2));
    ...
    for(int i=1;i<1024;i*=2) {
      ...
      CGAL_assertion(bounds.first<=bounds.second);
      CGAL_assertion(CGAL::sign(bounds.first)==CGAL::sign(bounds.second));
      CGAL_assertion(compare_x_2(bounds.first,ar2)!=CGAL::LARGER);
      CGAL_assertion(compare_x_2(bounds.second,ar2)!=CGAL::SMALLER);
      // NOTE: The following check is not sufficient for ensuring
      //       the postcondition, but if it fails, the postcondition
      //       cannot be satisfied
      CGAL_assertion(dist*(bounds.second-bounds.first)<=Bound(2)*max);
      // For the default implementation, we can test this - this
      // is sufficient for ensuring the postcondition, but other
      // kernels might not satisfy this property
      CGAL_assertion(dist*(bounds.second-bounds.first)<=Bound(1)*min);
