...
\ccMethod{bool has_x_critical_point();}{
  returns \ccc{true} if the curve $f$ has an intersection with the
  algebraic curve defined by its partial derivative with respect to $y$,
  namely $f_y := \frac{\partial f}{\partial y}$, at $x$.
}
