...
and bivariate polynomial systems. Such a black-box implementation is called an {\bf Algebraic Kernel}. 
Since this package provides more than one implementation, the interface of the algebraic kernels 
