...
struct Algebraic_kernel_rs_1{
    ...
    // time to do it
    Algebraic_kernel_rs_1(){init_solver();};
    // destructor
    ~Algebraic_kernel_rs_1(){reset_solver();};
...
#define CGALRS_CREATE_FUNCTION_OBJECT(T,N) \
    ...
    CGALRS_CREATE_FUNCTION_OBJECT(Number_of_solutions_1,number_of_solutions_1)
    ...
    CGALRS_CREATE_FUNCTION_OBJECT(Approximate_absolute_1,approximate_absolute_1)
    CGALRS_CREATE_FUNCTION_OBJECT(Approximate_relative_1,approximate_relative_1)
