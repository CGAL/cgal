...
#ifndef CGAL_GENERIC_DESCARTES_BFS
#define CGAL_GENERIC_DESCARTES_BFS 1
...
CGAL_BEGIN_NAMESPACE
    ...
    enum Bitstream_descartes_bfs_type {
        GENERIC_DESCARTES = 0, 
 ...
 */
    ...
    class Generic_descartes_bfs_rep 
    ...
    public:
            ...
            //! The Handle class
            typedef 
                Bitstream_descartes_bfs<Bitstream_descartes_rndl_tree_traits>
                Handle;
            ...
            Generic_descartes_bfs_rep(Bitstream_descartes_bfs_type type
                                      =GENERIC_DESCARTES) :
                type_(type) {
            };
                ...
                Generic_descartes_bfs_rep(Bitstream_descartes_bfs_type type, 
                    ...
                    Generic_descartes_bfs_rep(Bitstream_descartes_bfs_type type, 
                        ...
                        Bitstream_descartes_bfs_type type_;
 ...
 */
    template<typename BitstreamDescartesRndlTreeTraits,
      typename Policy=CGAL::Handle_policy_no_union>
    class Square_free_descartes_bfs_rep 
        : public Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> {
    ...
    public:
        ...
        typedef Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits,
	Policy> Base;
        ...
        virtual CGAL::Reference_counted_hierarchy<>* clone() {
            return new Square_free_descartes_bfs_rep(*this);
        }
 ...
 */
    ...
    public:
         ...
         */ 
        M_k_descartes_bfs_rep(Polynomial f,int m, int k,
                              Bitstream_descartes_rndl_tree_traits traits) :
        ...
        //! Default constructor
        M_k_descartes_bfs_rep() { 
        }

        //! Needed for reference counting
        virtual CGAL::Reference_counted_hierarchy<>* clone() {
            return new M_k_descartes_bfs_rep(*this);
        }
 ...
 */
    template<typename BitstreamDescartesRndlTreeTraits,
      typename Policy=CGAL::Handle_policy_no_union>
    class Exchange_descartes_bfs_rep 
        : public Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> {
    ...
    public:
         ...
         */ 
        Exchange_descartes_bfs_rep(Polynomial f,Polynomial sq_free_f,
                                   Bitstream_descartes_rndl_tree_traits traits)
        ...
        //! Default constructor
        Exchange_descartes_bfs_rep()
        {}

        //! Needed for reference counting
        virtual CGAL::Reference_counted_hierarchy<>* clone() {
            return new Exchange_descartes_bfs_rep(*this);
        }
 ...
 */
    template<typename BitstreamDescartesRndlTreeTraits,
      typename Policy=CGAL::Handle_policy_no_union>
    class M_ki_descartes_bfs_rep : public 
    Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> {
    ...
    public:
         ...
         * free
         */ 
        M_ki_descartes_bfs_rep(Polynomial f, Polynomial sqf,
                               Bitstream_descartes_rndl_tree_traits traits) :
        ...
        //! Default constructor
        M_ki_descartes_bfs_rep() {
        }
      
      
        //! Needed for reference counting
        virtual CGAL::Reference_counted_hierarchy<>* clone() {
            return new M_ki_descartes_bfs_rep(*this);
        }
    ...
    template<typename BitstreamDescartesRndlTreeTraits,typename EventRefinement,
      typename Policy=CGAL::Handle_policy_no_union>
    class Backshear_descartes_bfs_rep 
        : public Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> {
    ...
    public:
        ...
        virtual CGAL::Reference_counted_hierarchy<>* clone() {
            return new Backshear_descartes_bfs_rep(*this);
        }
 ...
 */
    template<typename BitstreamDescartesRndlTreeTraits,
      typename Policy=CGAL::Handle_policy_no_union>
    class Inverse_transform_descartes_bfs_rep 
        : public Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> {
    ...
    public:
        ...
        typedef Inverse_transform_descartes_bfs_rep
        ...
        typedef Generic_descartes_bfs_rep<Bitstream_descartes_rndl_tree_traits>
        Base;
         ...
         * \brief Constructor
         */
        Inverse_transform_descartes_bfs_rep(const Polynomial& f,
        ...
        //! Destructor (does nothing)
        virtual ~Inverse_transform_descartes_bfs_rep() {
        }

        //! Needed for the referencing counting mechanism
        virtual CGAL::Reference_counted_hierarchy<>* clone() {
            return new Inverse_transform_descartes_bfs_rep(*this);
        }
 ...
 */
    template<typename BitstreamDescartesRndlTreeTraits,
      typename VertLine,
      typename Policy=CGAL::Handle_policy_no_union>
    class Vert_line_adapter_descartes_bfs_rep 
        : public Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> {
    ...
    public:
        ...
        Vert_line_adapter_descartes_bfs_rep(InputIterator begin,
                                            InputIterator end,
                                            Bitstream_descartes_rndl_tree_traits traits)
        ...
        //! Destructor (does nothing)
        virtual ~Vert_line_adapter_descartes_bfs_rep() {
            
        }

        //! Needed for the referencing counting mechanism
        virtual CGAL::Reference_counted_hierarchy<>* clone() {
            return new Vert_line_adapter_descartes_bfs_rep(*this);
        }
    ...
    CGAL::CGALi::Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> > {
    ...
    public:
        ...
        typedef 
        CGAL::CGALi::Generic_descartes_bfs_rep<BitstreamDescartesRndlTreeTraits> Rep;
        ...
        typedef Bitstream_descartes_bfs<Bitstream_descartes_rndl_tree_traits> 
        Self;
        ...
        //! Default constructor
        Bitstream_descartes_bfs() : Base(new Rep()) {} 
         ...
         */
        Bitstream_descartes_bfs(Square_free_descartes_tag t,
                                Polynomial f,
                                Bitstream_descartes_rndl_tree_traits traits
                                = Bitstream_descartes_rndl_tree_traits(),
                                bool isolate=true)
            : Base(new CGAL::CGALi::Square_free_descartes_bfs_rep
         ...
         */
        Bitstream_descartes_bfs(M_k_descartes_tag t,
                                Polynomial f,int m,int k,
                                Bitstream_descartes_rndl_tree_traits traits
                                = Bitstream_descartes_rndl_tree_traits(),
                                bool isolate=true)
            : Base(new CGAL::CGALi::M_k_descartes_bfs_rep
         ...
         */
        Bitstream_descartes_bfs(Exchange_descartes_tag t,
                                Polynomial f,
                                Polynomial sqf,
                                Bitstream_descartes_rndl_tree_traits traits =
                                Bitstream_descartes_rndl_tree_traits(),
                                bool isolate = true)
            : Base(new CGAL::CGALi::Exchange_descartes_bfs_rep
         ...
         * The value of \c must represent the its square-free counterpart.
         */
        Bitstream_descartes_bfs(M_ki_descartes_tag t,
                                Polynomial f,
                                Polynomial sqf,
                                Bitstream_descartes_rndl_tree_traits traits =
                                Bitstream_descartes_rndl_tree_traits(),
                                bool isolate = true)
            : Base(new CGAL::CGALi::M_ki_descartes_bfs_rep
                   <Bitstream_descartes_rndl_tree_traits>(f,sqf,traits))
        {
            if(isolate) {
                this->isolate();
        ...
        Bitstream_descartes_bfs(Backshear_descartes_tag t,
                                Polynomial f,
                                ...
                                bool isolate=true)
            : Base(new 
                   CGAL::CGALi::Backshear_descartes_bfs_rep
         ...
         *
         */
        Bitstream_descartes_bfs(Inverse_transform_descartes_tag t,
                                Polynomial f,
                                Self inv_descartes,
                                Boundary translation = Boundary(0))
            : Base(new CGAL::CGALi::Inverse_transform_descartes_bfs_rep
         ...
         */
        template<typename InputIterator>
        Bitstream_descartes_bfs(Vert_line_adapter_descartes_tag t,
                                InputIterator begin,
                                InputIterator end,
                                Bitstream_descartes_rndl_tree_traits traits)
            : Base(new CGAL::CGALi::Vert_line_adapter_descartes_bfs_rep
                   <Bitstream_descartes_rndl_tree_traits,
        ...
        Bitstream_descartes_bfs_type type() const {
