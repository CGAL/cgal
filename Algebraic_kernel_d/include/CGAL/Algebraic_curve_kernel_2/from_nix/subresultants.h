...
//#include <CGAL/Algebraic_curve_kernel_2/from_nix/bezout_matrix.h>
...
CGAL_BEGIN_NAMESPACE
  ...
  template <typename NT,typename OutputIterator> inline
    ...
    Matrix M = CGAL::polynomial_subresultant_matrix(P,Q);
  ...
  template <typename NT,typename OutputIterator> inline
    ...
    CGAL::prs_polynomial_subresultants(P,Q,std::back_inserter(sres));
  ...
  template <typename NT,typename OutputIterator> inline
    ...
    typedef CGAL::CGALi::Simple_matrix<NT> Matrix;
    Matrix M = CGAL::polynomial_subresultant_matrix(P,Q,1);
