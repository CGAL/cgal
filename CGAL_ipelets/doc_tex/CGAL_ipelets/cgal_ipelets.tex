...
Ipe version 7 (up to 7.10) is supported when setting the cmake option \ccc{WITH_IPE_7} to \ccc{ON}
(adding \ccc{-DWITH_IPE_7=ON} while running \ccc{cmake} for example).
Internally, it activates the Ipe 7 compatibility by defining the preprocessor macro \ccc{CGAL_USE_IPE_7}.
