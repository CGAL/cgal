...
template<class GeometricTraits_2> std::ostream& operator<<(std::ostream& s, Hyperbolic_surface_triangulation_2<GeometricTraits_2>& Hyperbolic_surface_triangulation_2);
template<class GeometricTraits_2> void operator>>(std::istream& s, Hyperbolic_surface_triangulation_2<GeometricTraits_2>& triangulation);
...
template<class GeometricTraits_2>
Hyperbolic_surface_triangulation_2<GeometricTraits_2>::Hyperbolic_surface_triangulation_2(const _Domain& domain){
  ...
  for (int k=1; k<size-2; k++){
    ...
    _combinatorial_map.template set_attribute<1>(dart_1, _combinatorial_map.template create_attribute<1>(cross_ratio(p0.get_z(),p1.get_z(),p2.get_z(),p3.get_z())));
  }
...
template<class GeometricTraits_2>
Hyperbolic_surface_triangulation_2<GeometricTraits_2>::Hyperbolic_surface_triangulation_2(const Combinatorial_map_with_cross_ratios& cmap){
  copy_from(cmap);
}

template<class GeometricTraits_2>
Hyperbolic_surface_triangulation_2<GeometricTraits_2>::Hyperbolic_surface_triangulation_2(const Combinatorial_map_with_cross_ratios& cmap, const Anchor& anchor){
...
template<class GeometricTraits_2>
//Hyperbolic_surface_triangulation_2<GeometricTraits_2>& Hyperbolic_surface_triangulation_2<GeometricTraits_2>::operator=(Hyperbolic_surface_triangulation_2<GeometricTraits_2>&& other){
Hyperbolic_surface_triangulation_2<GeometricTraits_2>& Hyperbolic_surface_triangulation_2<GeometricTraits_2>::operator=(Hyperbolic_surface_triangulation_2<GeometricTraits_2> other){
  if (other.has_anchor()){
...
template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::Combinatorial_map_with_cross_ratios& Hyperbolic_surface_triangulation_2<GeometricTraits_2>::get_combinatorial_map_ref(){
  return _combinatorial_map;
}

template<class GeometricTraits_2>
bool Hyperbolic_surface_triangulation_2<GeometricTraits_2>::has_anchor() const {
  return _has_anchor;
}

template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::Anchor& Hyperbolic_surface_triangulation_2<GeometricTraits_2>::get_anchor_ref(){
  return _anchor;
}
...
template<class GeometricTraits_2>
bool Hyperbolic_surface_triangulation_2<GeometricTraits_2>::is_delaunay_flippable(_Dart_handle dart) const{
  return ( get_cross_ratio(dart).imag()>_Number(0) );
}

template<class GeometricTraits_2>
void Hyperbolic_surface_triangulation_2<GeometricTraits_2>::flip(_Dart_handle dart){
  ...
  // First gather all the information needed
   ...
   if (_anchor.dart == a){
     _anchor.dart = e;
     _anchor.vertices[1] = _Point(fourth_point_from_cross_ratio(_anchor.vertices[1].get_z(), _anchor.vertices[2].get_z(), _anchor.vertices[0].get_z(), cross_ratio_AC));
   } else if (_anchor.dart == b){
     _anchor.vertices[2] = _Point(fourth_point_from_cross_ratio(_anchor.vertices[0].get_z(), _anchor.vertices[1].get_z(), _anchor.vertices[2].get_z(), cross_ratio_AC));
   } else if (_anchor.dart == c){
     _anchor.vertices[2] = _Point(fourth_point_from_cross_ratio(_anchor.vertices[2].get_z(), _anchor.vertices[0].get_z(), _anchor.vertices[1].get_z(), cross_ratio_AC));
...
template<class GeometricTraits_2>
int Hyperbolic_surface_triangulation_2<GeometricTraits_2>::make_delaunay(){
...
template<class GeometricTraits_2>
std::vector<std::tuple<typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::Combinatorial_map_with_cross_ratios::Dart_const_handle,typename GeometricTraits_2::Point_2,typename GeometricTraits_2::Point_2,typename GeometricTraits_2::Point_2>> Hyperbolic_surface_triangulation_2<GeometricTraits_2>::lift(bool center) const{
  ...
  std::map<_Dart_const_handle, _Complex_number> positions;
  ...
  if (center){
    _Isometry center_the_drawing = hyperbolic_translation<GeometricTraits_2>(_anchor.vertices[0]);
    positions[_anchor.dart] = center_the_drawing.evaluate(_anchor.vertices[0]).get_z();
    positions[const_ccw(_anchor.dart)] = center_the_drawing.evaluate(_anchor.vertices[1]).get_z();
    positions[const_cw(_anchor.dart)] = center_the_drawing.evaluate(_anchor.vertices[2]).get_z();
  } else {
    positions[_anchor.dart] = _anchor.vertices[0].get_z();
    positions[const_ccw(_anchor.dart)] = _anchor.vertices[1].get_z();
    positions[const_cw(_anchor.dart)] = _anchor.vertices[2].get_z();
  }
  ...
  double weight_of_anchor_dart = CGAL::to_double(_anchor.vertices[0].get_z().squared_modulus()) + CGAL::to_double(_anchor.vertices[1].get_z().squared_modulus());
  double weight_of_ccw_anchor_dart = CGAL::to_double(_anchor.vertices[1].get_z().squared_modulus() )+ CGAL::to_double(_anchor.vertices[2].get_z().squared_modulus());
  double weight_of_cw_anchor_dart = CGAL::to_double(_anchor.vertices[2].get_z().squared_modulus()) + CGAL::to_double(_anchor.vertices[0].get_z().squared_modulus());
  ...
  while( ! queue.empty() ){
    ...
    if (!_combinatorial_map.is_marked(invaded, visited_darts_mark)){
      ...
      _Complex_number a = positions[const_ccw(invader)];
      _Complex_number b = positions[const_cw(invader)];
      _Complex_number c = positions[invader];
      _Complex_number cross_ratio = get_cross_ratio(invader);

      positions[invaded] = a;
      positions[const_ccw(invaded)] = c;
      _Complex_number d = fourth_point_from_cross_ratio(a, b, c, cross_ratio);
      positions[const_cw(invaded)] = d;

      double invaded_distance_to_zero = CGAL::to_double(a.squared_modulus());
      double invaded_ccw_distance_to_zero = CGAL::to_double(c.squared_modulus());
      double invaded_cw_distance_to_zero = CGAL::to_double(positions[const_cw(invaded)].squared_modulus());
...
template<class GeometricTraits_2>
bool Hyperbolic_surface_triangulation_2<GeometricTraits_2>::is_valid() const{
...
template<class GeometricTraits_2>
void Hyperbolic_surface_triangulation_2<GeometricTraits_2>::to_stream(std::ostream& s) const{
...
template<class GeometricTraits_2>
void Hyperbolic_surface_triangulation_2<GeometricTraits_2>::from_stream(std::istream& s){
  _combinatorial_map.clear();
...
template<class GeometricTraits_2>
std::ostream& operator<<(std::ostream& s, Hyperbolic_surface_triangulation_2<GeometricTraits_2>& triangulation){
  triangulation.to_stream(s);
  return s;
}

template<class GeometricTraits_2>
void operator>>(std::istream& s, Hyperbolic_surface_triangulation_2<GeometricTraits_2>& triangulation){
...
template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Dart_handle Hyperbolic_surface_triangulation_2<GeometricTraits_2>::ccw(_Dart_handle dart){
  return _combinatorial_map.beta(dart, 1);
}

template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Dart_handle Hyperbolic_surface_triangulation_2<GeometricTraits_2>::cw(_Dart_handle dart){
  return _combinatorial_map.beta(dart, 0);
}

template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Dart_handle Hyperbolic_surface_triangulation_2<GeometricTraits_2>::opposite(_Dart_handle dart){
  return _combinatorial_map.opposite(dart);
}

template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Dart_const_handle Hyperbolic_surface_triangulation_2<GeometricTraits_2>::const_ccw(_Dart_const_handle dart) const{
  return _combinatorial_map.beta(dart, 1);
}

template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Dart_const_handle Hyperbolic_surface_triangulation_2<GeometricTraits_2>::const_cw(_Dart_const_handle dart)  const{
  return _combinatorial_map.beta(dart, 0);
}

template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Dart_const_handle Hyperbolic_surface_triangulation_2<GeometricTraits_2>::const_opposite(_Dart_const_handle dart) const{
  return _combinatorial_map.opposite(dart);
}
...
template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Complex_number Hyperbolic_surface_triangulation_2<GeometricTraits_2>::get_cross_ratio(_Dart_const_handle dart) const{
...
template<class GeometricTraits_2>
typename Hyperbolic_surface_triangulation_2<GeometricTraits_2>::_Dart_handle Hyperbolic_surface_triangulation_2<GeometricTraits_2>::pick_edge_to_flip(){
...
template<class GeometricTraits_2>
void Hyperbolic_surface_triangulation_2<GeometricTraits_2>::copy_from(const Combinatorial_map_with_cross_ratios& cmap, const Anchor& anchor){
