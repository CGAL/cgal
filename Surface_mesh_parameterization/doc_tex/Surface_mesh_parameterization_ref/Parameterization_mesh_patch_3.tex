...
\item \ccc{first_seam_vertex} -$>$ \ccc{end_seam_vertex} defines the outer seam, ie \ccc{Parameterization_mesh_patch_3} will export the {\em right} of the seam.\item the {\em seam} is given as a container of \ccc{Adaptor::Vertex_handle} elements. \end{itemize}
}
\ccGlue
