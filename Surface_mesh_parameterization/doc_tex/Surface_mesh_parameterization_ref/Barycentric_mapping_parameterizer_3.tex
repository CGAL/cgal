...
\ccMethod{virtual NT compute_w_ij(const Adaptor& , Vertex_const_handle, Vertex_around_vertex_const_circulator);}
{
[protected, virtual] \\
...
\ccGlue
\ccMethod{virtual bool is_one_to_one_mapping(const Adaptor& , const Matrix& , const Vector& , const Vector& );}
{
[protected, virtual] \\
