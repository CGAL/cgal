...
\ccGlue
\ccMethod{Error_code check_parameterize_preconditions(Adaptor& mesh);}
{
[protected, virtual] \\
...
\ccGlue
\ccMethod{Error_code setup_inner_vertex_relations(Matrix& A, Vector& Bu, Vector& Bv, const Adaptor& mesh, Vertex_const_handle vertex);}
{
[protected, virtual] \\
...
\ccGlue
\ccMethod{Error_code check_parameterize_postconditions(const Adaptor& mesh, const Matrix& A, const Vector& Bu, const Vector& Bv);}
{
[protected, virtual] \\
