...
This class parameterizes the border of a 3D surface onto a circle, with an arc-length parameterization: (u,v) values are proportional to the length of border edges. Circular\_border\_parameterizer\_3 implements most of the border parameterization algorithm. This class implements only compute\_edge\_length() to compute a segment's length.
