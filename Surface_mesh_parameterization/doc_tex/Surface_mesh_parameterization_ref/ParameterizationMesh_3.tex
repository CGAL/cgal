...
\begin{itemize}
\item Adaptator for \ccc{Polyhedron_3} is provided.\item \ccc{Parameterization_mesh_patch_3<M>} is a model of \ccc{ParameterizationMesh_3} if M is a model of \ccc{ParameterizationPatchableMesh_3}.\end{itemize}
