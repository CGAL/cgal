...
{
Constructor.
CAUTION: This class caches the result of feature extractions =$>$ The caller must NOT modify 'mesh' during the \ccc{Parameterization_mesh_feature_extractor} life cycle.
}
\ccGlue
