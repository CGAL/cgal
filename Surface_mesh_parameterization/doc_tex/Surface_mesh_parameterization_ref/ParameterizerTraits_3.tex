...
\ccEnum{enum Error_code { OK, ERROR_EMPTY_MESH, ERROR_NON_TRIANGULAR_MESH, ERROR_NO_TOPOLOGICAL_DISC,  ERROR_INVALID_BORDER, ERROR_CANNOT_SOLVE_LINEAR_SYSTEM, ERROR_NO_1_TO_1_MAPPING, ERROR_OUT_OF_MEMORY,  ERROR_WRONG_PARAMETER  };}
{
...
]Error: input mesh is empty. \item[\ccc{ERROR_NON_TRIANGULAR_MESH}
]Error: input mesh is not triangular. \item[\ccc{ERROR_NO_TOPOLOGICAL_DISC}
