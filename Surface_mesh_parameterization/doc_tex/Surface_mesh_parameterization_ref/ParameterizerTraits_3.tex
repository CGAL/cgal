...
\ccc{ParameterizerTraits_3} is a concept of parameterization object for a given type of mesh, 'Adaptor', which is a model of the \ccc{ParameterizationMesh_3} concept.
