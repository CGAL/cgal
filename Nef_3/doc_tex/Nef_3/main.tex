...
\ccIncludeExampleCode{Nef_3/simple.cpp}
...
\ccIncludeExampleCode{Nef_3/construction.cpp}
...
% +------------------------------------------------------------------------+
\subsection{The Interface between \texttt{Polyhedron_3} and 
    \texttt{Nef_polyhedron_3}}
...
\ccIncludeExampleCode{Nef_3/point_location.cpp}
