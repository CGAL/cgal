...
template<class K>
Uncertain<Comparison_result> compare_offset_against_isec_timeC2 ( typename K::FT const& t, Trisegment_2<K> const& trisegment )
{
  ...
  Optional_rational et_ = compute_offset_lines_isec_timeC2(trisegment);
