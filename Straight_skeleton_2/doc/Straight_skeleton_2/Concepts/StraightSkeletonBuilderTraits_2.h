...
\cgalHasModelsBegin CGAL::Straight_skeleton_builder_traits_2<K>
\cgalHasModelsEnd
*/
...
which determines if the events given by `l` and `r` are coincident in time and space; that is, both triples
