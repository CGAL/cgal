...
The function `arrange_offset_polygons_2()` arranges the sequence of `Polygon_2` objects obtained
by `create_offset_polygons_2()` into `Polygon_with_holes_2` objects by determining geometric parent-hole
