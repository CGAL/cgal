...
holes</I> at distance \f$ offset\f$ of the 2D polygon \f$ poly\f$.
...
returns a container with all the inner offset polygons at distance \f$ offset\f$ of the 2D polygon with holes \f$ poly_with_holes\f$.
...
returns a container with all the inner offset polygons <I>with holes</I> at distance \f$ offset\f$ of the 2D polygon \f$ poly\f$.
...
returns a container with all the inner offset polygons <I>with holes</I> at distance \f$ offset\f$ of the 2D polygon with holes \f$ poly_with_holes\f$.
