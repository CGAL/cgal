...
{
  return CGAL::Do_ss_event_exist_2(aTraits)(aTriedge.triple());
}
...
{
  return CGAL::Compare_ss_event_times_2(aTraits)(aTriedgeA.triple(),aTriedgeB.triple());
}
...
{
  return CGAL::Compare_ss_event_distance_to_seed_2(aTraits)(aP,aTriedgeA.triple(),aTriedgeB.triple());
}
...
{
  return CGAL::Compare_ss_event_distance_to_seed_2(aTraits)(aTriedgeA.triple(),aTriedgeB.triple(),aTriedgeC.triple());
}
...
{
  return CGAL::Is_ss_event_inside_offset_zone_2(aTraits)(aTriedgeA.triple(),aTriedgeB.triple());
}
