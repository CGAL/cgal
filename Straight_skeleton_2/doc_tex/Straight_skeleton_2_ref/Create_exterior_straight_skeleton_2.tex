...
$d$ is a margin sufficiently large to allow an outer offset at distance \ccc{max_offset} to be obtained from this exterior skeleton, as computed by the function \ccc{compute_outer_frame_margin} 
}
