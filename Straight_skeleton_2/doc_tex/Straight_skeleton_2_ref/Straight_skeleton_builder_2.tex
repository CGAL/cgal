...
After \ccc{construct_skeleton} completes, you cannot enter more contours and/or call construct_skeleton() again. If you need another stright skeleton for another polygon you must instantiate and use another builder.}
