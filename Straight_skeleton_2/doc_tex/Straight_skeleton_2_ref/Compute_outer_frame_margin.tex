...
If the result is {\em absent}, any attempt to construct an exterior offset polygon at distance \ccc{offset} will fail. This will ocurr whenever the polygon has a vertex with an internal angle approaching \ccc{0} (because the offset vertex of a vertex whose internal angle equals 0 is at {\em infinity} ).\\
\ccPrecond offset $>$ 0.
