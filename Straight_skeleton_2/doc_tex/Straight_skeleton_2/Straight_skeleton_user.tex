...
\end{center}
\begin{center}
\includegraphics{Straight_skeleton_2/poly_hole_skeleton} % omit suffix .eps to supprt PS and PDF
\end{center}
\end{ccTexOnly}
...
<TD>
<CENTER>
<IMG BORDER=0 SRC="./poly_hole_skeleton.png" ALIGN=center ALT="Complex Straight Skeleton">
</CENTER>
</TD>
</TR>
</TABLE>
...
\caption{Other examples: A vertex-event (left), Input with several collinear edges (middle) and Outer skelton obtained by embeeding the shape in a big rectangle (right)
\label{MoreSLS}}
\end{figure}
