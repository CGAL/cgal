...
\begin{ccPkgDescription}{2D Straight Skeleton and Polygon Inward Offseting \label{Pkg:StraightSkeleton2}}
...
\ccPkgDependsOn{ \ccRef[Halfedge Data Structure]{Pkg:HalfedgeDS}}
