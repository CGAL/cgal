...
\begin{ccRefClass}{QtVoronoiGraphicsItem<DT>}
...
\ccInclude{CGAL/IO/QtVoronoiGraphicsItem.h}

\ccParameters

The template parameter \ccc{DT} of \ccc{QtVoronoiGraphicsItem<DT>} must be a \cgal\ Delaunay triangulation class.
...
\ccConstructor{QtVoronoiGraphicsItem<DT>(DT* dt);}{Constucts a graphics item for the dual of the 
