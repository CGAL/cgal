...
\ccInclude{CGAL/IO/GraphicsViewPolylineInput.h}
...
\ccConstructor{GraphicsViewPolylineInput<T>(QGraphicsScene* s, int n = 0, bool closed = true);}{\ccc{s} is the scene where we want to draw the polyline. \ccc{n} is the number of points of the polyline to generate. When \ccc{closed} is \ccc{true} the function displays a polygon.}
