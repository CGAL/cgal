...
that come from the Qt Graphics View Framework. The \ccAnchor{http://doc.trolltech.com/4.4/qgraphicsscene.html}{\ccc{QGraphicsScene}}
contains \ccAnchor{http://doc.trolltech.com/4.4/qgraphicsitem.html}{\ccc{QGraphicsItem}}s, which get displayed in any number
