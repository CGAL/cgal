...
typedef CGAL::Segment_Delaunay_graph_Linf_hv_filtered_traits_2<Rep,
							  MTag,
							  ERep,
							  EMTag>
Gt;
#else
typedef CGAL::Segment_Delaunay_graph_Linf_hv_filtered_traits_2<Rep> Gt;
#endif
#else
typedef CGAL::Segment_Delaunay_graph_Linf_hv_traits_2<Rep,CGAL::Field_tag> Gt;
#endif
