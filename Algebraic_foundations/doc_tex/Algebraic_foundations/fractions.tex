...
An related class is \ccc{CGAL::Rational_traits} wich has been kept for backward 
compatibility reasons. However, we recommmend to use \ccc{Fraction_traits} since
