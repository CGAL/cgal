...
In case \ccc{Algebraic_structure} is a model of \ccc{FieldWithKthRoot} this is not \ccc{CGAL::Null_functor}.
}

\ccNestedType{Root_of}{ 
This is either \ccc{CGAL::Null_functor} or a model of 
\ccc{AlgebraicStructureTraits::RootOf}.\\
In case \ccc{Algebraic_structure} is a model of \ccc{FieldWithRootOf} this is not \ccc{CGAL::Null_functor}.
}
%\end{ccAdvanced}
