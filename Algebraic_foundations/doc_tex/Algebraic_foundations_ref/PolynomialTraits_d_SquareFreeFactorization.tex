...
int operator()(PolynomialTraits_d::Polynomial_d  p,
          ...
          factorization of $p$.\\
          precond: \ccc{OutputIterator_1} must allow the value type 
          \ccc{PolynomialTraits_d:.Polynomial_d}. \\    
          precond: \ccc{OutputIterator_2} must allow the value type int.}
...
%          
%          precond: \ccc{OutputIterator_1} must allow the value type \ccc{PolynomialTraits_d:.Polynomial_d}. \\
%          precond: \ccc{OutputIterator_1} must allow the value type int.
%         }
