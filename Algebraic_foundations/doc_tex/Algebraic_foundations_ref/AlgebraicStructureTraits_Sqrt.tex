...
\ccc{AdaptableUnaryFunction} provinding the square root. 
...
\ccMethod{result_type operator()(
        const first_argument_type&  x);}{ returns  $\sqrt(x)$.\\
        
        {\tt

        NOTE: \\
        There are models that provide an exact sqrt i.e. CORE::Expr\\
