...
A model of \ccRefName\ is associated with a type \ccc{Fraction}.
...
\ccNestedType{Fraction}{the associated type}
\ccNestedType{Is_fraction}{ 
        Type indicating whether the associated type is a fraction and can be 
        decomposed into a numerator and denominator. \\
        This is either \ccc{CGAL::Tag_true} or \ccc{CGAL::Tag_false}.}
\ccNestedType{Numerator  }{The type to represent the numerator. 
        This is undefined in case the associated type is not a fraction. }
\ccNestedType{Denominator}{The (simpler) type to represent the denominator.
        This is undefined in case the associated type is not a fraction. }

\ccHeading{Functors}

\ccNestedType{Decompose}{If \ccc{Fraction} is decomposable this is a model of \ccc{FractionTraits::Decompose} otherwise this is \ccc{CGAL::Null_functor}.}
\ccNestedType{Compose}{If \ccc{Fraction} is decomposable this is a model of \ccc{FractionTraits::Compose} otherwise this is \ccc{CGAL::Null_functor}.}
\ccNestedType{Common_factor}{If \ccc{Fraction} is decomposable this is a model of \ccc{FractionTraits::CommonFactor} otherwise this is \ccc{CGAL::Null_functor}.}
