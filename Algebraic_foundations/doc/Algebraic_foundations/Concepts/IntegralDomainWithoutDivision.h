...
- \link AlgebraicStructureTraits::Square `CGAL::Algebraic_structure_traits< IntegralDomainWithoutDivision >::Is_invertible` \endlink  which is a model of `AlgebraicStructureTraits_::IsInvertible`
