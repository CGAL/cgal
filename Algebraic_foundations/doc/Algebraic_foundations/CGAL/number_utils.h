...
///  \sa `CGAL::mod`
///  \sa `CGAL::div`
/// computes the quotient \f$q\f$ and remainder \f$r\f$, such that \f$x = q*y + r\f$    and \f$r\f$ minimal with respect to the Euclidean Norm of the    `result_type`. 
template <class NT1, class NT2> 
void 
...
/// returns the k-th real root of the univariate polynomial,          which is defined by the iterator range,          where begin refers to the constant term.          \pre The polynomial is square-free.          
