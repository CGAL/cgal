...
\ccGlue
\ccMethod{void convert_to_needed_covering() const;}
{Converts the current triangulation into the covering that is needed
  to be able to perform point insertion and vertex removal.}
