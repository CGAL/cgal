...
{Removes the vertex \ccc{v} from the triangulation. When computing in
  27-sheeted covering space it removes all 27 copies of \ccc{v}.}
...
The iterator must not iterate over several periodic copies of the
same vertex, use e.g.\ the \ccc{Unique_vertex_iterator}.
