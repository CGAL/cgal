...
int main(int, char**)
{
  test("data-snapping/non_conform_snapping.off", 0.2, 0.01, 0.0001);
  test("data-snapping/non-conform_snapping-hole.off", 0.2, 0.01, 0.0001);
  test("data-snapping/non_conform_snapping-multiple_ccs.off", 0.02, 0.01, 0.0001);
  test("data-snapping/non-conform_snapping-overlap.off", 0.2, 0.01, 0.0001);

  test("data-snapping/real_data.off", 1., 0.05, 0.0008);
  test("data-snapping/real_data_2.off", 2, 0.05, 0.000001);
