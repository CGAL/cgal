...
void test_1()
{
  ...
  std::ifstream source_input("data-snapping/border_snapping_source.off");
  ...
  std::ifstream target_input("data-snapping/border_snapping_target.off");
...
void test_2()
{
  ...
  std::ifstream source_input("data-snapping/border_snapping_source_2.off");
  if(!source_input || !(source_input >> fg_source))
  {
    std::cerr << "Error: cannot open source mesh\n";
    return;
  ...
  std::ifstream target_input("data-snapping/border_snapping_target_2.off");
  if(!target_input || !(target_input >> fg_target))
  {
    std::cerr << "Error: cannot open target mesh\n";
    return;
