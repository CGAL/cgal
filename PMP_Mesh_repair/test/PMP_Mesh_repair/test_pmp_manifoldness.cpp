...
void test_nm_cubes()
{
  std::cout << "  test: data-repair/nm_closed_cubes.off" << std::endl;

  PolygonMesh mesh;
  read_mesh("data-repair/nm_closed_cubes.off", mesh);
...
void test_many_umbrellas()
{
  ...
  std::cout << "  test: data-repair/many_umbrellas.off" << std::endl;

  PolygonMesh mesh;
  read_mesh("data-repair/many_umbrellas.off", mesh);
...
void test_torso()
{
  ...
  std::cout << "  test: data-repair/torso.off" << std::endl;

  PolygonMesh mesh;
  read_mesh("data-repair/torso.off", mesh);
...
int main(int /*argc*/, char** /*argv*/)
{
  ...
  test_nm_cubes<Surface_mesh>(); // data-repair/nm_closed_cubes.off
  test_pinched_triangles<Surface_mesh>("data-repair/two_triangles_sharing_a_vertex.off", 1);
  test_pinched_triangles<Surface_mesh>("data-repair/three_triangles_sharing_a_vertex.off", 2);
  test_many_umbrellas<Surface_mesh>(); // data-repair/many_umbrellas.off
  test_torso<Surface_mesh>(); // data-repair/torso.off (only for SM because Polyhedron cannot even read it)

  std::cout << "Test Vertex Manifoldness Functions (Polyhedron)" << std::endl;

  test_blobby<Polyhedron>(); // data/blobby.off
  test_nm_cubes<Polyhedron>(); // data-repair/nm_closed_cubes.off
  test_pinched_triangles<Polyhedron>("data-repair/two_triangles_sharing_a_vertex.off", 1);
  test_pinched_triangles<Polyhedron>("data-repair/three_triangles_sharing_a_vertex.off", 2);
  test_many_umbrellas<Polyhedron>(); // data-repair/many_umbrellas.off
