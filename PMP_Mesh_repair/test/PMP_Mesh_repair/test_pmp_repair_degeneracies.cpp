...
template <typename K, typename Mesh>
void remove_degeneracies(const std::filesystem::path filename,
...
template <typename K, typename Mesh>
void remove_negligible_connected_components(const std::filesystem::path filename)
{
  typedef typename boost::graph_traits<Mesh>::face_descriptor           face_descriptor;
...
void test()
{
  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/degtri_2dt_1edge_split_twice.off"),
  ...
  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/all_degen.off"),
  ...
  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/degtri_four.off"),
                               std::initializer_list<std::size_t>({1}),
                               std::initializer_list<std::size_t>({3}),
                               0, 1, 0, 0, 0, 1);

  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/degtri_four-2.off"),
                               std::initializer_list<std::size_t>({2}),
                               std::initializer_list<std::size_t>({3}),
                               0, 1, 0, 0, 0, 1);

  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/degtri_on_border.off"),
                               std::initializer_list<std::size_t>({2}),
                               std::initializer_list<std::size_t>({0}),
                               0, 1, 0, 1, 0, 0);

  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/degtri_three.off"),
                               std::initializer_list<std::size_t>({2}),
                               std::initializer_list<std::size_t>({1}),
                               0, 1, 0, 0, 0, 1);

  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/degtri_single.off"),
                               std::initializer_list<std::size_t>({0, 1, 2}),
                               std::initializer_list<std::size_t>({0}),
                               0, 1, 0, 1, 0, 0);

  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/degtri_nullface.off"),
                               std::initializer_list<std::size_t>({3, 6, 7}),
                               std::initializer_list<std::size_t>({0, 1, 2}),
                               3, 4, 1, 2, 0, 0);

  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/trihole.off"),
  ...
  remove_degeneracies<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/fused_vertices.off"),
                               std::initializer_list<std::size_t>({5, 10, 13, 15, 27, 45}),
                               std::initializer_list<std::size_t>({1, 3, 5, 10, 19}),
                               6, 7, 2, 4, 3, 3);

  remove_negligible_connected_components<K, Mesh>(CGAL::data_file_path("meshes/degeneracies/small_ccs.off"));
}
