...
void test_stitch_boundary_cycles(const std::filesystem::path fname,
...
{
  test_stitch_boundary_cycles<Mesh>("data-stitching/boundary_cycle.off", 4);
  test_stitch_boundary_cycles<Mesh>("data-stitching/boundary_cycle_2.off", 2);
  test_stitch_boundary_cycles<Mesh>("data-stitching/complex_hole.off", 3);
  test_stitch_boundary_cycles<Mesh>("data-stitching/folded_cycle.off", 2);
}
...
template <typename Mesh>
void test_stitch_borders(const std::filesystem::path fname,
                         const std::size_t expected_n,
...
{
  test_stitch_borders<Mesh>("data-stitching/complex_hole.off", 3, false, {}, {83});
  test_stitch_borders<Mesh>("data-stitching/pinched.off", 2, false, {130, 94});
  test_stitch_borders<Mesh>("data-stitching/pinched.off", 2, false, {130, 94}, {94});
  test_stitch_borders<Mesh>("data-stitching/pinched.off", 0, false, {}, {140}); // outer border, nothing to stitch
  test_stitch_borders<Mesh>("data-stitching/full_border.off", 4);
  test_stitch_borders<Mesh>(CGAL::data_file_path("meshes/quads_to_stitch.off"), 4);
  test_stitch_borders<Mesh>("data-stitching/half_border.off", 2, false, {23, 15});
  test_stitch_borders<Mesh>("data-stitching/incidence_3.off", 3);
  test_stitch_borders<Mesh>("data-stitching/incoherent_patch_orientation.off", 1);
  test_stitch_borders<Mesh>("data-stitching/mid_border.off", 2);
  test_stitch_borders<Mesh>("data-stitching/multiple_incidence.off", 10, false, {3, 5, 16, 24, 31, 45, 53, 65});
  test_stitch_borders<Mesh>("data-stitching/non_stitchable.off", 0);
  test_stitch_borders<Mesh>("data-stitching/non_manifold.off", 0);
  test_stitch_borders<Mesh>("data-stitching/non_manifold2.off", 0);
  test_stitch_borders<Mesh>("data-stitching/two_patches.off", 3);
  test_stitch_borders<Mesh>("data-stitching/nm_cubes.off", 4, true /*per cc*/);
}
