...
int main()
{
  ...
  test<SM>("data-polygon_soup/nm_vertex_and_edge.off", false);
  test<Polyhedron>("data-polygon_soup/nm_vertex_and_edge.off", false);
  test<LCC>("data-polygon_soup/nm_vertex_and_edge.off", false);

  test<SM>("data-polygon_soup/incompatible_orientation.off", false);
  test<Polyhedron>("data-polygon_soup/incompatible_orientation.off", false);
  test<LCC>("data-polygon_soup/incompatible_orientation.off", false);
