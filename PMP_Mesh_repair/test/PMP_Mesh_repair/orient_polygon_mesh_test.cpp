...
int main()
{
  ...
  test_orient<Epic>(CGAL::data_file_path("meshes/cube.off"));
  test_orient<Epic>(CGAL::data_file_path("meshes/tetrahedron_flat.off"));
  test_orient<Epic>("data-repair/tetra2.off");
  test_orient<Epic>(CGAL::data_file_path("meshes/reference_tetrahedron.off"));
  test_orient<Epic>("data-repair/tetra4.off");
  test_orient<Epec>(CGAL::data_file_path("meshes/cube.off"));
