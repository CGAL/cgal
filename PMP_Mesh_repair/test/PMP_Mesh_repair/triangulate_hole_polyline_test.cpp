...
void test_should_be_no_output(const char* file_name, bool use_DT) {
 ...
 Main() {
  ...
  input_files_1.push_back("data-repair/triangle.polylines.txt");
  input_files_1.push_back("data-repair/quad.polylines.txt");
  input_files_1.push_back("data-repair/U.polylines.txt");
  input_files_1.push_back("data-repair/planar.polylines.txt");
  ...
  input_files_2.push_back("data-repair/hole1.txt");
  input_files_2.push_back("data-repair/hole2.txt");
  input_files_2.push_back("data-repair/hole3.txt");
  input_files_2.push_back("data-repair/hole4.txt");
  ...
  test_should_be_no_output("data-repair/collinear.polylines.txt", true);
  test_should_be_no_output("data-repair/collinear.polylines.txt", false);
  test_should_be_no_output("data-repair/null_edge.polylines.txt", true);
  test_should_be_no_output("data-repair/null_edge.polylines.txt", false);
