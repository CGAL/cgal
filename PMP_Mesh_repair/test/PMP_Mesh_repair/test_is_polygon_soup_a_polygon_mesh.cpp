...
int main()
{
  ...
  test_polygon_soup<SC>("data-polygon_soup/isolated_vertices.off", false);

  test_polygon_soup<SC>("data-polygon_soup/nm_vertex_and_edge.off", false);
  test_polygon_soup<SC>("data-polygon_soup/one_duplicated_edge.off", false);
  test_polygon_soup<SC>("data-polygon_soup/one_duplicated_edge_sharing_vertex.off", false);
  test_polygon_soup<SC>("data-polygon_soup/partial_overlap.off", false);
  test_polygon_soup<SC>("data-polygon_soup/incompatible_orientation.off", false);
  ...
  test_polygon_soup<SC>(CGAL::data_file_path("meshes/joint_refined.off"), true);
  test_polygon_soup<SC>(CGAL::data_file_path("meshes/mech-holes-shark.off"), true);
  test_polygon_soup<SC>("data-repair/non_manifold_vertex.off", false);
  test_polygon_soup<SC>("data-repair/two_tris_collinear.off", true);
  test_polygon_soup<SC>(CGAL::data_file_path("meshes/U_sheet.off"), true);
