...
#if 0
  fix_local_self_intersections("data-repair/brain.off");
  fix_self_intersections("data-repair/brain.off")

  fix_self_intersections("data-repair/flute.off");
  fix_self_intersections("data-repair/dinosaur.off");
  fix_self_intersections("data-repair/hemispheres.off");

  // selection is adjacent to a self-intersection but does not contain any intersection
  fix_self_intersections("data-repair/brain.off", "data-repair/brain-complete.selection.txt");

  // selection covers nicely a self-intersection
  fix_self_intersections("data-repair/brain.off", "data-repair/brain-adjacent.selection.txt");

  // selection contains part of a self intersection
  fix_self_intersections("data-repair/brain.off", "data-repair/brain-partial.selection.txt");

  // selection contains disjoint parts of a self intersection
  fix_self_intersections("data-repair/brain.off", "data-repair/brain-disjoint.selection.txt");

  // Remove only self-intersections within a single hemisphere
  fix_self_intersections("data-repair/hemispheres.off");
  fix_self_intersections("data-repair/hemispheres.off", "data-repair/hemispheres-half.selection.txt");
#endif
