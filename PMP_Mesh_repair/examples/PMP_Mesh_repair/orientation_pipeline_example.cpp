...
{
  const std::filesystem::path input_filename = (argc < 2) ? CGAL::data_file_path("meshes/blobby-shuffled.off") : argv[1];
  const std::filesystem::path reference_filename = (argc < 2) ? CGAL::data_file_path("meshes/blobby.off") : argv[2];
