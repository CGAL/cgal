...
\item \ccc{Visibility_complex_2_ellipse_traits<Kernel>}, defined in file
\ccc{CGAL/Visibility_complex_2/Ellipse_traits.h}, for ellipses of type
\ccc{Conic_2<Kernel>}.
\end{itemize}
...
class. \ccc{Visibility_complex_2_circle_traits} and
\ccc{Visibility_complex_2_ellipse_traits}  do not provide the
