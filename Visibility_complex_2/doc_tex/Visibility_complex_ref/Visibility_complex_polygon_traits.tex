...
defaulting to \ccc{Polygon_2<Kernel>::Container} the container to use to
represent the polygon, the third is the number type used for distance
computations, the fourth is a functor to convert \ccc{Kernel::FT} into
\ccc{DistanceNT}.


\ccInclude{CGAL/Visibility_complex_2/Polygon_traits.h}
