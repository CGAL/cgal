...
Nevertheless, the nested \ccc{Xy_monotone_surface_3} and \ccc{Surface_3} 
types are however constructible from a \ccc{Kernel::Triangle_3}
instance and are also convertible to a \ccc{Kernel::Triangle_3} object.
Both types, \ccc{Xy_monotone_surface_3} and \ccc{Surface_3}, refer to the 
