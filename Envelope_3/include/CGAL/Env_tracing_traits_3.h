    ...
    public:
      Comparison_result operator()(const X_monotone_curve_2& cv,
                                   ...
                                   const Xy_monotone_surface_3& h2)
        {
          ...
          std::cerr << "Surface1: " << h1 << std::endl;
          std::cerr << "Surface2: " << h2 << std::endl;
          Comparison_result res = base.compare_z_at_xy_above_3_object() (cv, h1, h2);
          std::cerr << "Result: " << res << std::endl;
          return res;
        }
    };
    ...
    public:
      Comparison_result operator()(const X_monotone_curve_2& cv,
                                   ...
                                   const Xy_monotone_surface_3& h2)
        {
          ...
          std::cerr << "Surface1: " << h1 << std::endl;
          std::cerr << "Surface2: " << h2 << std::endl;
          Comparison_result res = base.compare_z_at_xy_below_3_object() (cv, h1, h2);
          std::cerr << "Result: " << res << std::endl;
          return res;
        }
  ...
  class Construct_projected_intersections_2
    ...
    public:
      ...
      template <class OutputIterator>
        ...
        {
          Base base;
          std::cerr << "Construct_projected_intersections_2: JUST FIRST" << std::endl;
          std::cerr << "Surface1: " << s1 << std::endl;
          std::cerr << "Surface2: " << s2 << std::endl;
          std::list<CGAL::Object> l;
          base.construct_projected_intersections_2_object() (s1, s2, std::back_inserter(l));
