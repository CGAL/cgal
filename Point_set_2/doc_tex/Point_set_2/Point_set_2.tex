...
The \ccc{CGAL::Point\_set\_2} class depends on two template parameters \ccc{T1} and \ccc{T2}.
They are used as template parameters for the \ccc{CGAL::Delaunay\_triangulation\_2}
class \ccc{CGAL::Point\_set\_2} is inherited from. \ccc{T1} is a model for the
...
\ccIncludeExampleCode{Point_set_2/rs_example.cpp}
