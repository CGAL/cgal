...
\ccCreation
\ccConstructor{Hilbert_sort_2(const Traits &traits = Traits())}{constructs an instance with \ccc{traits} as traits class instance.}
\ccOperations
\ccThree{void;;}{A}{}
...
\ccMethod{template <class RandomAccessIterator> void operator() (RandomAccessIterator begin, RandomAccessIterator end) const;}{sorts the range [\ccc{begin}, \ccc{end}).
    \ccRequire \ccc{RandomAccessIterator::value_type} equals to \ccc{Traits::Point_2}.}
