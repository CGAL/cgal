...
The ommited policies default to:

\begin{enumerate}
\item \ccc{There are no fixed vertices in the surface.}
\item \ccc{The cost strategy is that of Lindstrom-Turk, computed with default parameters and caching onlt the cost (partial cache).}
\end{enumerate}
