...
But this is a tradeoff: the cost of a collapse is a function of the placment
(the new position choosen for the remaining vertex) so before \ccc{GetCost}
...
Sice the algorithm is free from robustness issues there is no need for exact predicates nor constructions and \ccc{Simple_cartesian<double>} can be used safely.
...
Say there is a function \ccc{f()} that takes 3 parameters called \ccc{name}, 
\ccc{age} and \ccc{gender}, and you have variables \ccc{n,a and g} 
