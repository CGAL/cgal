...
The mapping indicates that no vertex in the surface is to be considered fixed by the \ccc{edge_collapse} algorithm.
...
\ccConstructor{CGAL::Vertex_is_fixed_property_map_always_false<ECM>(); }
{Default constructor.}
