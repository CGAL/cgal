...
\ccHeading{Classes}
\ccc{CGAL::Triangulated_surface_mesh::Simplification::Edge_collapse::edge_collapse}\\
\ccRefIdfierPage{Triangulated_surface_mesh::Simplification::Edge_collapse::Empty_collapse_data}\\
