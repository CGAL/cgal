...
If \ccc{Collapse_data} is a model of \ccc{EmptyCollapseData}, the objects assigned is a default constructed empty objects holding no values. In this case, only the {data} argument is used and the cost/placement {\em params} can be null pointers.\\
