...
class LindstromTurk_placement : protected Placement_functor_base< Collapse_data_, LindstromTurk_placement<Collapse_data_> >
{
  typedef Placement_functor_base<Collapse_data_, LindstromTurk_placement<Collapse_data_> > Base ;
