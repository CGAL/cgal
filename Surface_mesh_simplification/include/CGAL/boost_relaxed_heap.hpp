// This file is a modified copy of the file
//
//    boost/pending/relaxed_heap.hpp
// 
// which has been added to boost in version 1.33
//
// The header guard and the class name has been modified to avoid clashing problems
// with boost version 1.33 or above.
//
// It is included here since at this point CGAL only requires boost 1.32.0, which lacks this file.
//
...
#ifndef CGAL_BOOST_RELAXED_HEAP_HEADER
#define CGAL_BOOST_RELAXED_HEAP_HEADER
...
class boost_relaxed_heap
{
  struct group;

  typedef boost_relaxed_heap self_type;
...
public:
  boost_relaxed_heap(size_type n, const Compare& compare = Compare(),
               const ID& id = ID())
  ...
  ~boost_relaxed_heap() { delete [] root.children; }
...
#endif // CGAL_BOOST_RELAXED_HEAP_HEADER
