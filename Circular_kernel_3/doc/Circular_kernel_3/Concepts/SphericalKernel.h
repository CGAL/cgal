...
Model of `Kernel`. 
*/ 
typedef Hidden_type Linear_kernel; 

/*! 
Model of `AlgebraicKernelForSpheres`. 
*/ 
typedef Hidden_type Algebraic_kernel; 
...
*/ 
typedef Hidden_type Polynomials_for_line_3; 
...
*/ 
typedef Hidden_type Polynomials_for_circle_3; 
...
*/ 
typedef Hidden_type Line_arc_3; 

/*! 
Model of `SphericalKernel::CircularArc_3`. 
*/ 
typedef Hidden_type Circular_arc_3; 

/*! 
Model of `SphericalKernel::CircularArcPoint_3`. 
*/ 
typedef Hidden_type Circular_arc_point_3; 
...
*/ 
typedef Hidden_type Compare_theta_3; 

/*! 
Model of `SphericalKernel::CompareThetaZ_3`. 
*/ 
typedef Hidden_type Compare_theta_z_3; 

/*! 
Model of `SphericalKernel::CompareZAtTheta_3`. 
*/ 
typedef Hidden_type Compare_z_at_theta_3; 

/*! 
Model of `SphericalKernel::CompareZToRight_3`. 
*/ 
typedef Hidden_type Compare_z_to_right_3; 
...
*/ 
typedef Hidden_type Do_overlap_3; 
...
*/ 
typedef Hidden_type Is_theta_monotone_3; 
...
*/ 
typedef Hidden_type Construct_line_arc_3; 

/*! 
Model of `SphericalKernel::ConstructCircularArc_3`. 
*/ 
typedef Hidden_type Construct_circular_arc_3; 

/*! 
Model of `SphericalKernel::ConstructCircularArcPoint_3`. 
*/ 
typedef Hidden_type Construct_circular_arc_point_3; 

/*! 
Model of `SphericalKernel::ConstructCircularMinVertex_3`. 
*/ 
typedef Hidden_type Construct_circular_min_vertex_3; 

/*! 
Model of `SphericalKernel::ConstructCircularMaxVertex_3`. 
*/ 
typedef Hidden_type Construct_circular_max_vertex_3; 

/*! 
Model of `SphericalKernel::ConstructCircularSourceVertex_3`. 
*/ 
typedef Hidden_type Construct_circular_source_vertex_3; 

/*! 
Model of `SphericalKernel::ConstructCircularTargetVertex_3`. 
*/ 
typedef Hidden_type Construct_circular_target_vertex_3; 
...
*/ 
typedef Hidden_type Split_3; 

/*! 
Model of `SphericalKernel::MakeThetaMonotone_3`. 
*/ 
typedef Hidden_type Make_theta_monotone_3; 
...
*/ 
typedef Hidden_type Compute_circular_x_3; 

/*! 
Model of `SphericalKernel::ComputeCircularY_3`. 
*/ 
typedef Hidden_type Compute_circular_y_3; 

/*! 
Model of `SphericalKernel::ComputeCircularZ_3`. 
*/ 
typedef Hidden_type Compute_circular_z_3; 
...
*/ 
typedef Hidden_type Compute_approximate_angle_3; 
...
*/ 
typedef Hidden_type Get_equation; 
