...
infinitesimally greater that the \f$ \theta\f$-coordinate of point \f$ p\f$. 
\pre `a0` and `a1` lie on the context sphere used by the function `SphericalKernel::compare_z_to_right_3_object`, `a0` and `a1` are \f$ \theta\f$-monotone, \f$ p\f$ lies on `a0` and `a1` and is not a \f$ \theta\f$-extremal point of the supporting circle of `a0` or `a1`. 
*/ 
