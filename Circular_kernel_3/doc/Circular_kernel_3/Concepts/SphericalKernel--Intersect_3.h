...
For the <B>first operator</B>, `Type1` and `Type2` can both
be either
...
CGAL::Objects can be assigned to

- std::pair<SphericalKernel::Circular_arc_point_3, unsigned>,
...
For the <B>second operator</B>, Type1, Type2 and Type3
can be either
...
and depending of these types, the computed CGAL::Objects can be
assigned to
