...
public:
  ...
  typedef RCircular_arc_point_on_reference_sphere_3 Rep;
  ...
  : RCircular_arc_point_on_reference_sphere_3(
    typename R::Construct_circular_arc_point_on_reference_sphere_3()(ftheta,xt,yt,zt,hq))
  {}
  ...
  Circular_arc_point_on_reference_sphere_3(const HQ_NT& _hq,const Root_of_2& ftheta,const typename SK::AK::Root_for_spheres_2_3& rfs)
  : RCircular_arc_point_on_reference_sphere_3(
