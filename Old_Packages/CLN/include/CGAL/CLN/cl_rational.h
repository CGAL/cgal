...
inline bool	is_valid	(const cl_RA & ) { return true; } 
inline bool	is_finite	(const cl_RA & ) { return true; } 
...
inline io_Operator io_tag         (const cl_RA&) { return io_Operator(); }
inline Number_tag number_type_tag (const cl_RA&) { return Number_tag(); }
