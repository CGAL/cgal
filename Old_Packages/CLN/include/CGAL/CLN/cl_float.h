...
inline bool	is_valid	(const cl_F & ) { return true; } 
inline bool	is_finite	(const cl_F & ) { return true; } 
...
inline io_Operator io_tag         (const cl_F&) { return io_Operator(); }
inline Number_tag number_type_tag (const cl_F&) { return Number_tag(); }
