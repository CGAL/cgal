...
inline bool	is_finite	(const cl_I & ) { return true; } 
...
inline io_Operator io_tag         (const cl_I&) { return io_Operator(); }
inline Number_tag number_type_tag (const cl_I&) { return Number_tag(); }
