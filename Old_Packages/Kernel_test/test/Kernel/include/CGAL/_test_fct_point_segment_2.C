...
// release_date  :
// 
// file          : _test_fct_point_segment_2.C
// revision      : $Revision$
// revision_date : $Date$
...
#ifndef CGAL__TEST_FCT_POINT_2_SEGMENT_2_C
#define CGAL__TEST_FCT_POINT_2_SEGMENT_2_C
...
#endif // CGAL__TEST_FCT_POINT_2_SEGMENT_2_C
