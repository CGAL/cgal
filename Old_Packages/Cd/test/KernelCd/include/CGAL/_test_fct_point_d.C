...
_test_fct_point_d(const R& )
{
 ...
 CGAL::Point_d<R> p1(RT(18), RT(15), RT(-21), RT(3) ); // 6,5,-7
 CGAL::Point_d<R> p2(RT(18), RT(15), RT( 12), RT(3) ); // 6,5,4
 CGAL::Point_d<R> p3(RT(18), RT(12), RT(-21), RT(3) ); // 6,4,-7
 CGAL::Point_d<R> p4(RT(28), RT(40), RT( 20), RT(4) ); // 7,10,5
 CGAL::Point_d<R> p5(RT(12), RT(-4), RT(-20), RT(4) ); // 3,-1,-5
 ...
 CGAL::Point_d<R> p6 ( RT(6), RT(4), RT(7) );
 ...
 CGAL::Point_d<R> pe0( RT(1), RT(0), RT(0) );
 CGAL::Point_d<R> pe1( RT(0), RT(1), RT(0) );
 CGAL::Point_d<R> pe2( RT(0), RT(0), RT(1) );

 assert( CGAL::orientation( CGAL::Point_d<R>(CGAL::ORIGIN), pe0, pe1, pe2 ) \
                           == CGAL::POSITIVE);

 assert( CGAL::orientation( p1, p2, p3, p6 ) == CGAL::ZERO );

 CGAL::Point_d<R> p7( RT(-8), RT(0), RT(0), RT(-2) );
 CGAL::Point_d<R> p8( RT(8), RT(4), RT(0), RT(2) );
 CGAL::Point_d<R> p9( RT(0), RT(12), RT(0), RT(4) );
 ...
 CGAL::Point_d<R> p10( RT(0), RT(0), RT(16), RT(8) );
...
// CGAL::side_of_bounded_sphere()
 ...
 CGAL::Vector_d<R> v001( RT(0), RT(0), RT(1) );
 CGAL::Vector_d<R> v010( RT(0), RT(1), RT(0) );
 CGAL::Vector_d<R> v100( RT(1), RT(0), RT(0) );
