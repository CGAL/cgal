...
template <class gnuR>
bool
_test_cls_triangle_2(const gnuR& )
{
 ...
 typename gnuR::Triangle_2 it;
 CGAL::Triangle_2<gnuR> t0(it);
 ...
 CGAL::Point_2<gnuR> p1( n6, n6, n6);    // ( 1, 1)
 CGAL::Point_2<gnuR> p2( n6, n9, n3);    // ( 2, 3)
 CGAL::Point_2<gnuR> p3( n6, n10, n2);   // ( 3, 5)
 CGAL::Point_2<gnuR> p4( n5, n4, n1);    // ( 5, 4)
 CGAL::Point_2<gnuR> p5( n21, n9, n3);   // ( 7, 3)
 CGAL::Point_2<gnuR> p6( n8, n4, n2);    // ( 4, 2)
 CGAL::Point_2<gnuR> p7( n4, n0);        // ( 4, 0)
 CGAL::Point_2<gnuR> p8(-n12,-n8,-n2);   // ( 6, 4)
 CGAL::Point_2<gnuR> p9( n9, n9, n3);    // ( 3, 3)

 CGAL::Triangle_2<gnuR> t1( p1, p3, p5);
 CGAL::Triangle_2<gnuR> t2( p3, p1, p5);
 CGAL::Triangle_2<gnuR> t3( p7, p8, p9);
 CGAL::Triangle_2<gnuR> t4( p3, p5, p1);
 CGAL::Triangle_2<gnuR> t5( p5, p1, p3);
 t0 = t3;
 ...
 assert( t1.has_on_bounded_side( CGAL::Point_2<gnuR>( n6, n8, n2)) );
 assert( t1.has_on_unbounded_side( CGAL::Point_2<gnuR>( -n4, n8, n6)) );
 ...
 CGAL::Triangle_2<gnuR> tdeg1( p1, p7, p7);
 CGAL::Triangle_2<gnuR> tdeg2( p6, p6, p6);
...
#endif // CGAL__TEST_CLS_TRIANGLE_2_C
