...
{
  PTR = new _Twotuple<typename R::FT>();
}
...
VectorC2<R CGAL_CTAG>::VectorC2(const typename R::FT &hx,
...
template < class R >
CGAL_KERNEL_CTOR_INLINE
VectorC2<R CGAL_CTAG>::VectorC2(const typename R::FT &x,
...
CGAL_KERNEL_INLINE
VectorC2<R CGAL_CTAG>
VectorC2<R CGAL_CTAG>::operator/(const typename R::FT &c) const
{
