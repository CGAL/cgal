\begin{ccRefFunctionObjectConcept}{Kernel::Construct_vector_2}
...
\ccMemberFunction{Kernel::Vector_2 operator()(const Kernel::RT &hx, const Kernel::RT &hy, const Kernel::RT &hw = Kernel::RT(1));}
