...
objects and constructions are exactly those of the kernel \ccc{CK}, which
means that there is no type equality between, say \ccc{Point_2<Kernel>} and
\ccc{R::Point_2}, when \ccc{R} is \ccClassTemplateName, which means that you
should always use \ccc{R::Point_2} instead of \ccc{Point_2<Kernel>}.
