\begin{ccRefClass}{Cartesian_converter<K1, K2, FT_Converter>}
...
The third template parameter \ccc{FT_Converter} is a function object that must
provide \ccc{K2::FT operator()(const K1::FT &n);} that
converts \ccc{n} to an \ccc{K2::FT} with the same value.
