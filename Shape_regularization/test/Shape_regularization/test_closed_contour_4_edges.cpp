...
void test_closed_contour_4_edges() {
  ...
  // saver.export_closed_contour(contour, "cl4_input", 100);
  ...
  // saver.export_closed_contour(regularized, "cl4_output", 100);
...
int main() {
  test_closed_contour_4_edges< CGAL::Simple_cartesian<double> >();
  test_closed_contour_4_edges< CGAL::Exact_predicates_inexact_constructions_kernel >();
  test_closed_contour_4_edges< CGAL::Exact_predicates_exact_constructions_kernel >();
  std::cout << "test_closed_contour_4_edges: SUCCESS" << std::endl;
  return EXIT_SUCCESS;
}
