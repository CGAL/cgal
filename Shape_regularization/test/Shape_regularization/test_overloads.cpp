...
void test_overloads() {
  ...
  SR::Segments::regularize_segments(
    segments, neighbor_query, angle_regularization, quadratic_program, CGAL::parameters::use_default_values());
  SR::Segments::regularize_segments(
  ...
  SR::Segments::parallel_groups(
    segments, std::back_inserter(indices), CGAL::parameters::use_default_values());
  SR::Segments::parallel_groups(
  ...
  SR::Segments::unique_segments(
    segments, std::back_inserter(unique), CGAL::parameters::use_default_values());
  SR::Segments::unique_segments(
    segments, std::back_inserter(unique));

  SR::Contours::regularize_closed_contour(
    points, cdirections, std::back_inserter(contour), CGAL::parameters::use_default_values());
  SR::Contours::regularize_closed_contour(
  ...
  SR::Contours::regularize_open_contour(
    points, odirections, std::back_inserter(contour), CGAL::parameters::use_default_values());
  SR::Contours::regularize_open_contour(
