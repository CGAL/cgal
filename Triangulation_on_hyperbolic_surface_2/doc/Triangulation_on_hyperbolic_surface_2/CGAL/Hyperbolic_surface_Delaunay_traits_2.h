...
/// \name Approximation
 ...
 /*!   \return the approximation precision.  */
   ...
   /*!
     This function sets the precision for approximations to `p`. In particular, it is used in the function `HyperbolicSurfaceDelaunayTraitsClass::Construct_approximate_hyperbolic_circumcenter_2` where the precision of computations is `p` times 53 bits, where 53 is the precision of a `double`.
  */
