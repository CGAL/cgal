...
#include "XML_exporter.h" //TODO: This is the same as in the test folder of the Mesh_3 package. I just copied it here but in the future this should be accessible by both packages

#define CGAL_MESH_3_EXPORT_PERFORMANCE_DATA
#define CGAL_TETRAHEDRAL_REMESHING_SET_PERFORMANCE_DATA(value_name, value) \
