...
public:
  static void
  split(C3t3& c3t3, const SizingFunction& sizing, const CellSelector& cell_selector, const bool protect_boundaries) {
  ...
  static void collapse(C3t3& c3t3,
  ...
  void smooth_init(C3t3& c3t3,
    ...
    m_context = std::make_shared<VertexSmoothingContext>(c3t3, sizing, cell_selector, protect_boundaries,
