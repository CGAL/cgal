// WARNING : Untested example. This exmaple is to understand how to create and use the feature graph for tetrahedral mesh creation. 
...
/// [Detector definition]
typedef Detect_sharp_features_on_labeled_image<K> Feature_graph_detector;
/// [Detector definition]
...
int main(int argc, char* argv[])
{
  ...
  Mesh_3::Polyline_visitor visitor(feature_graph_polylines, feature_graph);
