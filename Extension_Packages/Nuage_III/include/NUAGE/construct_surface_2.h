#ifndef NUAGE_CONSTRUCT_SURFACE_2
...
template <class Triangulation, class Kernel, class TDS>
typename TDS::Vertex_handle
construct_surface(TDS& tds, const Extract_surface<Triangulation,Kernel>& surface)
{
...
#endif // NUAGE_CONSTRUCT_SURFACE_2
