...
test_new_3(const R& rep)
{
  ...
  Plane_3 h6 = construct_plane(r2,p3);  // was p4 - but that would be a construction with 3 collinear points
  Plane_3 h7 = construct_plane(s2,p4);
  
  std::cout << "after plane construction ...\n";  
  ...
  std::cout << "after Construct_projected_point_3 ...\n";	  
  ...
  std::cout << "after lifted point construction ...\n"; 	  
  ...
  std::cout << "after supporting line construction ...\n";   
  ...
  std::cout << "after construct_cross_product_vector_3 ...\n";  
  ...
  std::cout << "after compute_squared_radius_3 ...\n";  

  // this came from deprecated code ...
  Triangle_3 tmp9b;
