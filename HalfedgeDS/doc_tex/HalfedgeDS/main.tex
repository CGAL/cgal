...
%\newcommand{\XHDS}{\bf\ttfamily}
\newcommand{\XHDS}{}

{\XHDS A halfedge data structure (abbreviated as \ccc{HalfedgeDS}, or
...
structure in this design, especially if compared to the
design of the \ccc{HDS} prior to {\sc Cgal} Rel 2.3.
