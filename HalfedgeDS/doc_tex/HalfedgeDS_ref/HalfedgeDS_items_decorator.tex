...
\ccGlue
\ccNestedType{ Halfedge_cycle}{ halfedge cycle type of \ccc{HalfedgeDS}.}
...
\ccGlue
\ccNestedType{ Halfedge_cycle_handle}{}
\ccGlue
...
\ccGlue
\ccNestedType{ Halfedge_cycle_iterator}{}
...
\ccGlue
\ccNestedType{ Supports_halfedge_halfedge_cycle}{}
\ccGlue
\ccNestedType{Supports_face_halfedge}{}
\ccGlue
\ccNestedType{ Supports_face_halfedge_cycle}{}
\ccGlue
\ccNestedType{ Supports_halfedge_cycle_face}{}
\ccGlue
...
\ccGlue
\ccMethod{ Face_handle get_face(Halfedge_cycle_handle c);}
    { returns the face of $c$ if supported, 
    \ccc{Face_handle()} otherwise.}
\ccGlue
\ccMethod{ Halfedge_cycle_handle get_halfedge_cycle(Halfedge_handle h);}
    { returns the halfedge cycle of $h$ if supported, 
    \ccc{Halfedge_cycle_handle()} otherwise.}
\ccGlue
\ccMethod{ Halfedge_cycle_handle get_halfedge_cycle(Face_handle f);}
    { returns the halfedge cycle of $f$ if supported, 
    \ccc{Halfedge_cycle_handle()} otherwise.}
\ccGlue
...
\ccGlue
\ccMethod{ void set_face( Halfedge_cycle_handle b, Face_handle f) const;}
    { sets $f$ as the face bounded by $b$.}
\ccGlue
...
\ccGlue
\ccMethod{ void set_halfedge_cycle( Halfedge_handle h, Halfedge_cycle_handle c) const;}
    { sets the halfedge cycle of $h$ to $c$.}
\ccGlue
\ccMethod{ void insert_outer_halfedge_cycle_to_face( Face_handle f, Halfedge_cycle_handle c, Halfedge_cycle_handle_iterator pos) const;}
    { inserts $c$ to sequence of outer cycles of $f$ before $pos$.}
\ccGlue
\ccMethod{ void insert_inner_halfedge_cycle_to_face( Face_handle f, Halfedge_cycle_handle c, Halfedge_cycle_handle_iterator pos) const;}
    { inserts $c$ to sequence of inner cycles of $f$ before $pos$.}
\ccGlue
\ccMethod{ void insert_isolated_vertex_to_face( Face_handle f, Halfedge_cycle_handle v, Halfedge_cycle_handle_iterator pos) const;}
    { inserts $v$ to sequence of isolated vertices of $f$ before $pos$.}
\ccGlue
\ccMethod{ void remove_outer_halfedge_cycle_of_face( Face_handle f, Halfedge_cycle_handle_iterator it) const;}
    { removes the entry $it$ in the sequence of outer cycles of $f$}
\ccGlue
\ccMethod{ void remove_inner_halfedge_cycle_of_face( Face_handle f, Halfedge_cycle_handle_iterator it) const;}
    { removes the entry $it$ in the sequence of inner cycles of $f$}
\ccGlue
\ccMethod{ void remove_isolated_vertex_of_face( Face_handle f, Halfedge_cycle_handle_iterator it) const;}        { removes the entry $it$ in the sequence of isolated vertices of $f$}
