...
\ccGlue
\ccNestedType{\bf\ttfamily Ccb}{\bf\ttfamily ccb type of \ccc{HalfedgeDS}.}
...
\ccGlue
\ccNestedType{\bf\ttfamily Ccb_handle}{}
\ccGlue
...
\ccGlue
\ccNestedType{\bf\ttfamily Ccb_iterator}{}
...
\ccGlue
\ccNestedType{\bf\ttfamily Supports_halfedge_ccb}{}
\ccGlue
\ccNestedType{Supports_face_halfedge}{}
\ccGlue
\ccNestedType{\bf\ttfamily Supports_face_ccb}{}
\ccGlue
\ccNestedType{\bf\ttfamily Supports_ccb_face}{}
\ccGlue
...
\ccGlue
\ccMethod{\bf\ttfamily Face_handle get_face(Ccb_handle b);}
    {\bf\ttfamily returns the bounded face of $b$ if supported, 
    \ccc{Face_handle()} otherwise.}
\ccGlue
\ccMethod{\bf\ttfamily Ccb_handle get_ccb(Halfedge_handle h);}
    {\bf\ttfamily returns the host ccb of $h$ if supported, 
    \ccc{Ccb_handle()} otherwise.}
\ccGlue
\ccMethod{\bf\ttfamily Ccb_handle get_ccb(Face_handle f);}
    {\bf\ttfamily returns the bounding ccb of $f$ if supported, 
    \ccc{Ccb_handle()} otherwise.}
\ccGlue
...
\ccGlue
\ccMethod{\bf\ttfamily void set_face( Ccb_handle b, Face_handle f) const;}
    {\bf\ttfamily sets $f$ as the face bounded by $b$.}
\ccGlue
...
\ccGlue
\ccMethod{\bf\ttfamily void set_halfedge_ccb( Halfedge_handle h, Ccb_handle b) const;}
    {\bf\ttfamily sets the host ccb of $h$ to $b$.}
\ccGlue
\ccMethod{\bf\ttfamily void insert_outer_ccb_to_face( Face_handle f, Ccb_handle b, Ccb_handle_iterator pos) const;}
    {\bf\ttfamily inserts $b$ to sequence of outer ccbs of $f$ before $pos$.}
\ccGlue
\ccMethod{\bf\ttfamily void insert_inner_ccb_to_face( Face_handle f, Ccb_handle b, Ccb_handle_iterator pos) const;}
    {\bf\ttfamily inserts $b$ to sequence of inner ccbs of $f$ before $pos$.}
\ccGlue
\ccMethod{\bf\ttfamily void insert_isolated_vertex_to_face( Face_handle f, Ccb_handle v, Ccb_handle_iterator pos) const;}
    {\bf\ttfamily inserts $v$ to sequence of isolated vertices of $f$ before $pos$.}
\ccGlue
\ccMethod{\bf\ttfamily void remove_outer_ccb_of_face( Face_handle f, Ccb_handle_iterator it) const;}
    {\bf\ttfamily removes the entry $it$ in the sequence of outer ccbs of $f$}
\ccGlue
\ccMethod{\bf\ttfamily void remove_inner_ccb_of_face( Face_handle f, Ccb_handle_iterator it) const;}
    {\bf\ttfamily removes the entry $it$ in the sequence of inner ccbs of $f$}
\ccGlue
\ccMethod{\bf\ttfamily void remove_isolated_vertex_of_face( Face_handle f, Ccb_handle_iterator it) const;}        {\bf\ttfamily removes the entry $it$ in the sequence of isolated vertices of $f$}
