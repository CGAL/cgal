...
concept.  It defines types for vertices, halfedges and faces 
hat declare the minimal required incidences for a \ccc{HalfedgeDS}, 
...
struct HalfedgeDS_min_items {
    ...
    // Halfedge_cycles are not supported if minimum items are used.
    template < class Refs, class Traits>
