...
\ccGlue
\ccNestedType{Halfedge_cycle}{model of \ccc{HalfedgeDSHalfedgeCycle} concept.}
%\ccNestedType{ Halfedge_cycle}{ model of \ccc{HalfedgeDSHalfedgeCycle} concept.}
...
\ccGlue
\ccNestedType{ Halfedge_cycle_iterator}{ iterator over all \ccc{halfedge_cycles}.}
...
\ccGlue
\ccNestedType{ Supports_halfedge_halfedge_cycle}{ \ccc{Halfedge::halfedge_cycle()}.}
\ccGlue
\ccNestedType{Supports_face_halfedge}{\ccc{Face::halfedge()}.}
\ccGlue
\ccNestedType{ Supports_face_halfedge_cycle}{ \ccc{Face::outer_halfedge_cycle()}.}
\ccGlue
\ccNestedType{ Supports_halfedge_cycle_face}{ \ccc{Halfedge_cycle::face()}.}
\ccGlue
...
\ccFunction{ static Halfedge_cycle_handle HalfedgeDS::halfedge_cycle_handle( Halfedge_cycle_base* f);}{}
\ccGlue
\ccFunction{ static Halfedge_cycle_const_handle HalfedgeDS::halfedge_cycle_handle( const Halfedge_cycle_base* f);}{}
...
\ccGlue
\ccMethod{ Size size_of_halfedge_cycles() const;}{ number of \ccc{halfedge_cycles}.}
\ccGlue
...
\ccGlue
\ccMethod{ Size capacity_of_halfedge_cycles() const;}{ space reserved for \ccc{halfedge_cycles}.}
\ccGlue
...
\ccGlue
\ccMethod{ Halfedge_cycle_iterator      halfedge_cycles_begin();}{ iterator over all \ccc{halfedge_cycles}.}
\ccGlue
\ccMethod{ Halfedge_cycle_iterator      halfedge_cycles_end();}{}
...
\ccMethod{ Halfedge_cycle_handle halfedge_cycles_push_back( const Halfedge_cycle& c);}
    { appends a copy of $c$ to \ccc{hds}. Returns a handle of the new cycle.}
...
\ccMethod{ void halfedge_cycles_erase( Halfedge_cycle_handle c);}{ 
...
\ccGlue
\ccMethod{ void halfedge_cycles_clear();}{ removes all \ccc{halfedge_cycles}.}
