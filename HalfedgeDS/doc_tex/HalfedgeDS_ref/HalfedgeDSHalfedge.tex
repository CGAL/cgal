...
{ a reference to the halfedge cycle containing it},
...
\ccMethod{ Halfedge_cycle_handle       halfedge_cycle();}{}
\ccGlue
\ccMethod{ Halfedge_cycle_const_handle halfedge_cycle() const;}
    { the \ccc{halfedge_cycle} of \ccVar.}
\ccGlue
\ccMethod{ void set_halfedge_cycle( Halfedge_cycle_handle c);}{ 
