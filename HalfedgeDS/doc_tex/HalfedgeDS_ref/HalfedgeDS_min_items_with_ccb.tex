...
\begin{ccRefClass}{HalfedgeDS_min_items_with_halfedge_cycle}
\label{pageHalfedgeDSminitemswithhalfedge_cycleRef}

\ccDefinition
  
The class \ccRefName\ is a model of the \ccc{HalfedgeDSItems}
concept.  It defines types for vertices, halfedges, faces 
and \ccc{halfedge_cycles} that declare the minimal required incidences for a \ccc{HalfedgeDS}, 
...
\ccc{CGAL::HalfedgeDS_min_items_with_halfedge_cycle} class. It uses the base classes for the
