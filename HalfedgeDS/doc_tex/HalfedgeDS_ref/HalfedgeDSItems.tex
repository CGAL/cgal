...
halfedge, { \ccc{halfedge_cycle}}, and face-- for a halfedge data structure.
A \ccRefName\ contains four member class templates named \ccc{Vertex_wrapper},
\ccc{Halfedge_wrapper}, { \ccc{Halfedge_cycle_wrapper}},
...
{ \ccc{Halfedge_cycle}}, and \ccc{Face} respectively.
...
\ccGlue
\ccNestedType{ Halfedge_cycle_wrapper<Refs,Traits>::Halfedge_cycle}
    { model of \ccc{HalfedgeDSHalfedgeCycle}.}
