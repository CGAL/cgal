...
\ccFunction{KernelD_converter::KernelD_converter(K1 const&,K2 const&)}{main constructor}
\ccFunction{KernelD_converter::KernelD_converter()}{default constructor, only if \ccc{K1} and \ccc{K2} are stateless.}
\ccFunction{K2::SomeThing operator()(K1::SomeThing)const}{returns a converted object.}
