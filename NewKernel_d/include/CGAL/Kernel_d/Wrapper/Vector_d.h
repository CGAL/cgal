...
template <class R_>
class Vector_d : public R_::Kernel_base::template Type<Vector_tag>::type
{
...
public:
  ...
  typedef typename R_::template Iterator<Vector_cartesian_const_iterator_tag>::type Cartesian_const_iterator;
