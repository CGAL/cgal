...
\section{OS Specific Installation \label{sec:shippedcgal}}
...
The setup is similar for \textsc{homebrew} (\path+http://mxcl.github.com/homebrew/+).
...
\subsection{\cgal\ on Windows\label{ssec:cgalwindows}}

You can download and run \texttt{\cgalrel-Setup.exe} from \cgaldownloadpage.

It is a self extracting executable that installs the \cgal\ source, and that allows you
to select and download some precompiled third party libraries.

However, you will need to compile the library using your favorite compiler.

A tutorial (\path+http://www.cgal.org/windows_installation.html+) is provided on how to proceed with Microsoft Visual Studio 2010.
...
\subsection{NTL \label{thirdparty:NTL}}
