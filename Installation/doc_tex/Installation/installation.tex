...
\cmake\ version~2.4-patch-7 or higher is required, but we recommend
...
binaries. Version 1.33.1 is needed. In case
...
and {\tt C:\Program Files} under Windows. If you want to install to a different location, you must override that \cmake{}
...
for dependencies so you need to specify these variables if they are given a value 
