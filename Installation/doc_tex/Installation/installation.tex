...
Use, for instance in debian/Ubuntu, apt-get in the following way:
...
If compiling no demos at all, you might skip some of the essential libraries (as \qt\ or
\opengl), as the corresponding \cgal-libraries are not linked. But for
your own demos you might these \cgal-libraries.
