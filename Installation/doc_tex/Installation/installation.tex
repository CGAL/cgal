...
\core\ can be downloaded from \path'http://www.cs.nyu.edu/exact/',
...
You can download it from \path'http://www.coin3d.org/'.
...
It can be downloaded from  \path'http://esbtl.sourceforge.net/'.
