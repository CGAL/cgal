...
together with \ccc{CGAL::Qt_widget}, a widget and some helper
classes that allow to interact with two dimensional \cgal\ objects.
The demos we made for \cgal\ Rel.\ 3.4 use Trolltech's 
\ccAnchor{http://doc.trolltech.com/4.4/graphicsview.html}{Qt Graphics View Framework}
for the 2D demos and Gille Debunne's \ccAnchor{http://www.libqglviewer.com/}{libQGLViewer} 
for the 3D demos. \index{visualization!Qt}.
...
({\tt .lib}), but in the other platforms, including \texttt{cygwin}, they are by default shared libraries ({\tt .so}).
