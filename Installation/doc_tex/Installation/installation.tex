...
BOOST, BOOSTPROGRAMOPTIONS, X11, GMP, GMPXX, MPFR, CORE, CGALCORE, ZLIB, ZLIBMS,
LEDA, LEDAWIN, LEDAMS, LEDAWINMS, QT3MT, QT3ST, QT3MSMT, QT3MSST, TAUCSSOLARIS,
TAUCSWINMKL, TAUCSWINATLAS, TAUCSLINUXATLAS, TAUCSLINUXMKL, TAUCSLINUXINTEL,
TAUCSLINUXMUMPS, TAUCSDARWIN, TAUCSFREEBSDATLAS, TAUCSIRIX32, TAUCSIRIX64, done.
...
``\texttt{--with-TAUCSSOLARIS}'',
``\texttt{--with-TAUCSWINMKL}'',
``\texttt{--with-TAUCSWINATLAS}'',
``\texttt{--with-TAUCSLINUXATLAS}'',
``\texttt{--with-TAUCSLINUXMKL}'',
``\texttt{--with-TAUCSLINUXINTEL}'',
``\texttt{--with-TAUCSLINUXMUMPS}'',
``\texttt{--with-TAUCSDARWIN}'',
``\texttt{--with-TAUCSFREEBSDATLAS}'',
``\texttt{--with-TAUCSIRIX32}'',
and ``\texttt{--with-TAUCSIRIX64}'' (depending of your platform and BLAS library).
