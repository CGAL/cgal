...
binaries. Version 1.33.1 (or higher) is needed. In case
...
As said before, only the CGAL's univariate algebraic kernel depends on the
...
RS needs GMP 4.2 or later and MPFI 1.3.4 or later. The variables related
to the latter library may also need to be defined.
