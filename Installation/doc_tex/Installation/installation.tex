...
\cgal~3.7 is supported for the following compilers/operating systems:
...
binaries. Version 1.39 (or higher) is needed. In case
...
installer from \path'http://www.boostpro.com/download/'.
...
After you have downloaded the file \texttt{CGAL-3.7.tar.gz} containing the
\cgal\ sources, you have to unpack it. Under a Unix-like shell, use the
command:

\begin{verbatim}
      tar xzf CGAL-3.7.tar.gz
\end{verbatim}


When you are on Windows you may download and run the \texttt{CGAL-3.7-Setup.exe}. It is a
...
For CGAL-3.7, the configuration is generated with \cmake, a
...
{\ccTexHtml{\scriptsize}{}
\begin{verbatim}
mkdir CGAL-3.7/cmake/platforms/debug
cd CGAL-3.7/cmake/platforms/debug
cmake -DCMAKE_BUILD_TYPE=Debug ../../..

mkdir CGAL-3.7/cmake/platforms/release
cd CGAL-3.7/cmake/platforms/release
...
\texttt{\$CMAKE\_INSTALLED\_PREFIX/lib/CGAL-3.7}.
...
cd CGAL-3.7/examples/Straight_skeleton_2
cmake -DCGAL_DIR=$HOME/CGAL-3.7 .
make
...
cmake -DCGAL_DIR=CGAL-3.7 -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CXX_FLAGS=-O2 -DCGAL_DONT_OVERRIDE_CMAKE_FLAGS=TRUE . 
...
-- Configuring done
-- Generating done
-- Build files have been written to: C:/Work/Active/GeometryFactory/CGAL/Autotest/CGAL-3.7/cmake/platforms/a
\end{verbatim}
}
