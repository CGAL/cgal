...
all entries are grayed. You are now ready to press 'Generate' and you
...
To do that you must explicitly build the \texttt{examples} or \texttt{demos} make targets (or IDE projects).
...
targets named \texttt{examples} and \texttt{demos}, plus one target for each example and each demo.
