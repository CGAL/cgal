...
\begin{center}\index{cgal!components}\index{cgal components}
  ...
  \begin{tabular}{|l|l|l|l|} \hline
    ...
    \\\hline
    {\tt CGAL-core++} & {\tt WITH\_CGAL\_Core} & The CORE library used for robust numerical and geometric computation.
    ...
    & GMP and MPFR
    \\\hline
    {\tt CGAL-Qt3} & {\tt WITH\_CGAL\_Qt3} & \ccc{CGAL::Qt_widget} used by some old Qt3-based demos & Qt3 and OpenGL
    \\\hline
    {\tt CGAL-Qt4} & {\tt WITH\_CGAL\_Qt4} & \ccc{CGAL::GraphicsView} used by the Qt4-based demos & Qt4 and OpenGL
    \\\hline
    {\tt CGAL-ImageIO} & {\tt WITH\_CGAL\_ImageIO} & Utilities to read and write image files in various formats 
    & OpenGL and ZLib and VTK\footnote{Only if VTK is available}
    \\\hline
    {\tt CGAL-PDB} & {\tt WITH\_CGA\_PDB} & \ccc{CGAL::PDB} used to manipulate {\tt PDB} files & {\em none}
    \\\hline
  \end{tabular}
\end{center}
...
Notice that by make rules, an error in the default target will abort compilation/linking of
