...
\eigen\ is a \texttt{C++} template library for linear algebra. \eigen\ supports all
 ...
 an alternative to \taucs\ which also provides sparse linear solvers. The version 3.1 (or greater) of \eigen\
 is required.
...
package. Note that since CGAL 4.0, \eigen\ is recommended to be used instead of \taucs.
