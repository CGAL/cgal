...
\cgalhomepage
\end{alltt}
or send an email to \texttt{info at cgal dot org}. In case of problems
or questions related to installation, please include a copy of the
\texttt{install.log} file for reference.
