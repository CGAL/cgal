...
IF (QT4_QMAKE_FOUND)
  ...
  MACRO (QT4_CREATE_MOC_COMMAND infile outfile moc_flags moc_options)
    ...
    IF (WIN32)
      ...
      # If the outfile is relative, use the current binary cmake files directory
      # as the working diretory where the parameters file is created
      IF( NOT _moc_outfile_dir)
        SET(_moc_outfile_dir ${CMAKE_CURRENT_BINARY_DIR} )
      ENDIF( NOT _moc_outfile_dir)
      
      SET(_moc_working_dir WORKING_DIRECTORY ${_moc_outfile_dir})
      
      SET (_moc_parameters_file "${_moc_outfile_dir}/${_moc_outfile_name}_parameters")
