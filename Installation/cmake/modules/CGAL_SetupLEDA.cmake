...
function(use_CGAL_LEDA_support target)
  ...
  if(NOT LEDA_FOUND)
    message(FATAL_ERROR "use_CGAL_LEDA_support is used whereas LEDA_FOUND is false.")
    return()
  endif()
...
if(LEDA_FOUND AND NOT TARGET CGAL::Exact_rational_support)
  add_library(Exact_rational_support INTERFACE)
  use_CGAL_LEDA_support(Exact_rational_support INTERFACE)
  add_library(CGAL::Exact_rational_support ALIAS Exact_rational_support)
endif()
