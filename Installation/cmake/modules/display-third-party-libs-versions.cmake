...
function(check_library cgal_3rdparty_lib)
  ...
  if(${cgal_3rdparty_lib}_FOUND)
    ...
    elseif(${cgal_3rdparty_lib} STREQUAL "OpenMesh")
      set(CONFIG_FILE_PATH "${OpenMesh_DIR}/OpenMeshConfig-release.cmake")
      file(READ ${CONFIG_FILE_PATH} FILE_CONTENT)
      if("${FILE_CONTENT}" MATCHES "IMPORTED_LOCATION_RELEASE[ \t]+\".*\\.so\\.([0-9]+\\.[0-9]+)\"")
        set(version_var "${CMAKE_MATCH_1}")
      endif()
    endif()
    if(version_var)
