...
if(NOT USE_CGAL_FILE_INCLUDED) 
  ...
  foreach ( CGAL_COMPONENT ${CGAL_FIND_COMPONENTS} )
    ...
    set( CGAL_LIBRARIES                ${CGAL_LIBRARIES}                ${CGAL-${CGAL_COMPONENT}_LIBRARY}                  )
    set( CGAL_3RD_PARTY_INCLUDE_DIRS   ${CGAL_3RD_PARTY_INCLUDE_DIRS}   ${CGAL-${CGAL_COMPONENT}_3RD_PARTY_INCLUDE_DIRS}   )
    set( CGAL_3RD_PARTY_DEFINITIONS    ${CGAL_3RD_PARTY_DEFINITIONS}    ${CGAL-${CGAL_COMPONENT}_3RD_PARTY_DEFINITIONS}    )
    set( CGAL_3RD_PARTY_LIBRARIES_DIRS ${CGAL_3RD_PARTY_LIBRARIES_DIRS} ${CGAL-${CGAL_COMPONENT}_3RD_PARTY_LIBRARIES_DIRS} )
    set( CGAL_3RD_PARTY_LIBRARIES      ${CGAL_3RD_PARTY_LIBRARIES}      ${CGAL-${CGAL_COMPONENT}_3RD_PARTY_LIBRARIES}      )
