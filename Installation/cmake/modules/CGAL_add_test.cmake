...
#  message("Add test ${test_name}")
  ...
  if(NOT ARGS AND EXISTS ${cin_file})
    if(CGAL_RUN_TESTS_THROUGH_SSH)
      add_test(NAME ${test_name} COMMAND bash -c "${TIME_COMMAND} ${ssh_executable}  ${SSH_HOST} \"cd ${CGAL_REMOTE_TEST_DIR_PREFIX}${PROJECT_NAME} && ${CGAL_REMOTE_TEST_DIR_PREFIX}${PROJECT_NAME}/${exe_name} < ${exe_name}.cin 3< <(cat; kill -INT 0)\" <&1")
    else()
      if(ANDROID)
        set(cmd ${exe_name})
      else()
