...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_SURFACE_MESH_PARAMETERIZATION_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL Triangulated Surface Mesh Parameterization package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_SURFACE_MESH_PARAMETERIZATION_COMMERCIAL_LICENSE is not defined,\
