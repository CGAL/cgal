...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL L Infinity Segment Delaunay Graphs package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_COMMERCIAL_LICENSE is not defined,\
