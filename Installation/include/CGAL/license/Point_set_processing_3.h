...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_POINT_SET_PROCESSING_3_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL Point Set Processing package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_POINT_SET_PROCESSING_3_COMMERCIAL_LICENSE is not defined,\
...
#endif // CGAL_LICENSE_CHECK_POINT_SET_PROCESSING_3_H
