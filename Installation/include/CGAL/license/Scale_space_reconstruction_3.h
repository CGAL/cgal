...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_SCALE_SPACE_RECONSTRUCTION_3_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL Scale-Space Surface Reconstruction package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_SCALE_SPACE_RECONSTRUCTION_3_COMMERCIAL_LICENSE is not defined,\
