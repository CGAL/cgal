...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_OPTIMAL_TRANSPORTATION_RECONSTRUCTION_2_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL Optimal Transportation Curve Reconstruction package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_OPTIMAL_TRANSPORTATION_RECONSTRUCTION_2_COMMERCIAL_LICENSE is not defined,\
