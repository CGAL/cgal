...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("You use the CGAL 2D Regularized Boolean Set-Operations package under "
                         "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "You use the CGAL 2D Regularized Boolean Set-Operations package under the terms of \
