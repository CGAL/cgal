...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_POLYGON_MESH_PROCESSING_MESHING_HOLE_FILLING_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL Polygon Mesh Processing - Meshing and Hole Filling package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_POLYGON_MESH_PROCESSING_MESHING_HOLE_FILLING_COMMERCIAL_LICENSE is not defined,\
