...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_POLYGON_MESH_PROCESSING_PREDICATE_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL Polygon Mesh Processing - Predicate package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_POLYGON_MESH_PROCESSING_PREDICATE_COMMERCIAL_LICENSE is not defined,\
...
#endif // CGAL_LICENSE_CHECK_POLYGON_MESH_PROCESSING_PREDICATE_H
