...
#    if defined(CGAL_LICENSE_WARNING)
       ...
       CGAL_pragma_warning("Your commercial license for CGAL does not cover "
                           "this release of the Polygon Mesh Processing - Detect Features package.")
#    endif

#    ifdef CGAL_LICENSE_ERROR
#      error "Your commercial license for CGAL does not cover this release \
of the Polygon Mesh Processing - Detect Features package. \
...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("You use the CGAL Polygon Mesh Processing - Detect Features package under "
                         "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "You use the CGAL Polygon Mesh Processing - Detect Features package under the terms of \
the GPLv3+. You get this error, as you defined CGAL_LICENSE_ERROR."
#  endif // CGAL_LICENSE_ERROR

#endif // no CGAL_POLYGON_MESH_PROCESSING_DETECT_FEATURES_COMMERCIAL_LICENSE

#endif // CGAL_LICENSE_CHECK_POLYGON_MESH_PROCESSING_DETECT_FEATURES_H
