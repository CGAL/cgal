...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_POISSON_SURFACE_RECONSTRUCTION_3_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL Poisson Surface Reconstruction package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_POISSON_SURFACE_RECONSTRUCTION_3_COMMERCIAL_LICENSE is not defined,\
...
#endif // CGAL_LICENSE_CHECK_POISSON_SURFACE_RECONSTRUCTION_3_H
