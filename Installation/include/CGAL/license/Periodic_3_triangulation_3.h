...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_PERIODIC_3_TRIANGULATION_3_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL 3D Periodic Triangulations package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_PERIODIC_3_TRIANGULATION_3_COMMERCIAL_LICENSE is not defined,\
...
#endif // CGAL_LICENSE_CHECK_PERIODIC_3_TRIANGULATION_3_H
