...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("CGAL_BARYCENTRIC_COORDINATES_2_COMMERCIAL_LICENSE is not defined, "
                          "you use the CGAL 2D Generalized Barycentric Coordinates package under "
                          "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "CGAL_BARYCENTRIC_COORDINATES_2_COMMERCIAL_LICENSE is not defined,\
