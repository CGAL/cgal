...
#  if defined(CGAL_LICENSE_WARNING)
     CGAL_pragma_warning("You use the CGAL 2D Range and Neighbor Search package under "
                         "the terms of the GPLv3+.")
#  endif // CGAL_LICENSE_WARNING

#  ifdef CGAL_LICENSE_ERROR
#    error "You use the CGAL 2D Range and Neighbor Search package under the terms of \
the GPLv3+. You get this error, as you defined CGAL_LICENSE_ERROR."
#  endif // CGAL_LICENSE_ERROR

#endif // no CGAL_POINT_SET_2_COMMERCIAL_LICENSE

#endif // CGAL_LICENSE_CHECK_POINT_SET_2_H
