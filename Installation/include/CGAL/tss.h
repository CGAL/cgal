...
#define CGAL_THREAD_LOCAL_DECLARE_POD(TYPE, VAR,VAL)  static boost::thread_specific_ptr<TYPE> VAR##_ptr

#define CGAL_THREAD_LOCAL_DECLARE_POD2(TYPE, VAR)  static boost::thread_specific_ptr<TYPE> VAR##_ptr
...
#define CGAL_THREAD_LOCAL_DECLARE_POD(TYPE, VAR, VAL)  static CGAL_THREAD_LOCAL TYPE VAR = VAL

#define CGAL_THREAD_LOCAL_DECLARE_POD2(TYPE, VAR)  static CGAL_THREAD_LOCAL TYPE VAR
...
#define CGAL_THREAD_LOCAL_DECLARE_POD(TYPE, VAR, VAL)  static TYPE VAR = VAL
#define CGAL_THREAD_LOCAL_DECLARE_POD2(TYPE, VAR)  static TYPE VAR;
#define CGAL_THREAD_LOCAL_IS_UNINITIALIZED_POD(VAR) true
#define CGAL_THREAD_LOCAL_SET_POD(TYPE, VAR, VAL)
#define CGAL_THREAD_LOCAL_ASSIGN_POD(VAR, VAL) VAR = VAL
#define CGAL_THREAD_LOCAL_GET_POD(TYPE, VAR)
