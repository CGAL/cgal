...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Configuration/config/testfiles/CGAL_CFG_NO_GMP.C $
// $Id: CGAL_CFG_NO_GMP.C 28567 2006-02-16 14:30:13Z lsaboret $
// 
//
// Author(s)     : various
