...
//
// $URL: svn+ssh://hoffmann@scm.gforge.inria.fr/svn/cgal/trunk/Configuration/config/testfiles/CGAL_CFG_NO_MPFR.C $
// $Id: CGAL_CFG_NO_MPFR.C 28567 2006-02-16 14:30:13Z lsaboret $
// 
//
// Author(s)     : various
