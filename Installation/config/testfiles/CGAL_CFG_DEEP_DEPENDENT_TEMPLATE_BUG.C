...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Configuration/config/testfiles/CGAL_CFG_DEEP_DEPENDENT_TEMPLATE_BUG.C $
// $Id: CGAL_CFG_DEEP_DEPENDENT_TEMPLATE_BUG.C 28738 2006-02-28 14:30:13Z glisse $
// 
//
