                          ...
                          const Traits& traits)
{
  ...
  CGAL_FOREACH(vertex_descriptor vd, vertices_in_disk)
  {
    CGAL_FOREACH(edge_descriptor ed, out_edges(vd, hg))
    {
      ...
      bool in = true;
      CGAL_FOREACH(halfedge_descriptor h, halfedges_around_face(hd, hg))
      {
                             ...
                             const Traits& traits)
{
  ...
  while (!Q.empty())
  {
    ...
    CGAL_FOREACH(edge_descriptor ed, out_edges(v, hg))
    {
