...
\begin{ccRefConcept}{MinSphereAnnulusDTraits}
...
\ccSaveThreeColumns
\ccSetTwoColumns{MinSphereAnnulusDTraits:: Rep_tag}{}
...
\ccConstructor{ MinSphereAnnulusDTraits( );}{}

\ccConstructor{ MinSphereAnnulusDTraits( const MinSphereAnnulusDTraits&);}{}
...
\ccRefIdfierPage{CGAL::Min_sphere_annulus_d_traits_d<K,ET,NT>}
