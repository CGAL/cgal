...
int main() {
  ...
  auto os = CGAL::Regularized_boolean_set_operations_2::oriented_side(Point_2(0, 0), pwh);
  std::cout << "(0,0) is : " << nice(os) << std::endl;
  os = CGAL::Regularized_boolean_set_operations_2::oriented_side(Point_2(0.5, 0.5), pwh);
  std::cout << "(0,0) is : " << nice(os) << std::endl;
  os = CGAL::Regularized_boolean_set_operations_2::oriented_side(Point_2(1, 1), pwh);
  std::cout << "(0,0) is : " << nice(os) << std::endl;
  os = CGAL::Regularized_boolean_set_operations_2::oriented_side(Point_2(2.5, 2.5), pwh);
  std::cout << "(0,0) is : " << nice(os) << std::endl;
  os = CGAL::Regularized_boolean_set_operations_2::oriented_side(Point_2(3, 3), pwh);
  std::cout << "(0,0) is : " << nice(os) << std::endl;
  os = CGAL::Regularized_boolean_set_operations_2::oriented_side(Point_2(3.5, 3.5), pwh);
  std::cout << "(0,0) is : " << nice(os) << std::endl;
  return 0;
}
