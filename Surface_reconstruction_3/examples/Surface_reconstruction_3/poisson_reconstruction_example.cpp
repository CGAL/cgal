...
int main(void)
{
    ...
    // Poisson options
    FT sm_angle_poisson = 20.0; // lower bound of facets angles (degrees)
    FT sm_radius_poisson = 0.1; // upper bound of Delaunay balls radii
    FT sm_distance_poisson = 0.002; // upper bound of distance to surface
