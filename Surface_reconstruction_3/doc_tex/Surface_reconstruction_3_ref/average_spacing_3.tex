...
\ccFunction{template<typename InputIterator, typename Kernel> Kernel::FT average_spacing_3(InputIterator first, InputIterator beyond, unsigned int k, const Kernel& );}
{
...
\begin{description}
\item \ccc{first}: first iterator over input points \item \ccc{beyond}: past-the-end iterator over input points \item \ccc{k}: number of neighbors \end{description}
}
\ccGlue
