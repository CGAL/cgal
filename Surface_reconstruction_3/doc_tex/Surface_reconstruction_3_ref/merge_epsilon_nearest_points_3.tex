...
\ccFunction{OutputIterator merge_epsilon_nearest_points_3(InputIterator first, InputIterator beyond, OutputIterator output, const Kernel &, double epsilon);}
{
...
\end{description}
\ccGlue
\ccFunction{void merge_epsilon_nearest_points_3(ForwardIterator first, ForwardIterator beyond, const Kernel &, double epsilon);}
{
...
\end{description}
\ccGlue
\ccFunction{void merge_epsilon_nearest_points_3(ForwardIterator first, ForwardIterator beyond, double epsilon);}
{
...
typename Kernel$>$  \\
OutputIterator  \\
\ccc{merge_epsilon_nearest_points_3} (InputIterator first, InputIterator beyond, OutputIterator output, const Kernel \&, double epsilon);  \\
  \\
template$<$  \\
typename ForwardIterator,   \\
typename Kernel$>$  \\
void  \\
\ccc{merge_epsilon_nearest_points_3} (ForwardIterator first, ForwardIterator beyond, const Kernel \&, double epsilon);  \\
  \\
template$<$  \\
typename InputIterator,   \\
typename OutputIterator$>$  \\
