...
The \ccc{Reconstruction_vertex_base_3} class is the default vertex class of the \ccc{Reconstruction_triangulation_3} class. It provides the interface requested by the \ccc{Poisson_reconstruction_function} class.
