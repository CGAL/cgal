...
{
Iteratively merges pairs of points which are epsilon closed. This variant requires the kernel.
\ccPrecond epsilon $>$ 0.
...
{
Iteratively merges pairs of points which are epsilon closed.  This function is mutating the input point set. This variant requires the kernel.
...
{
Iteratively merges pairs of points which are epsilon closed.  This variant deduces the kernel from iterator types.
\ccPrecond epsilon $>$ 0.
\ccCommentHeading{Template Parameters}
\begin{description}
...
{
Iteratively merges pairs of points which are epsilon closed.  This function is mutating the input point set. This variant deduces the kernel from iterator types.
Warning: This method modifies the order of points, thus should not be called on sorted containers.
\ccPrecond epsilon $>$ 0.
\ccCommentHeading{Template Parameters}
