...
\begin{description}
\item \ccc{first}: input points \item \ccc{output}: output points \item \ccc{k}: number of neighbors \end{description}
}
\ccGlue
...
\ccCommentHeading{Parameters}
\begin{description}
\item \ccc{first}: input/output points \item \ccc{k}: number of neighbors \end{description}
}
\ccGlue
