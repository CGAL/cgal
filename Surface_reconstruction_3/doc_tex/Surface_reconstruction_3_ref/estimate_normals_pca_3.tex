...
\ccFunction{void estimate_normals_pca_3(InputIterator first, InputIterator beyond, OutputIterator normals, const unsigned int K, const Kernel &);}
{
...
typename Kernel$>$  \\
void  \\
\ccc{estimate_normals_pca_3} (InputIterator first, InputIterator beyond, OutputIterator normals, const unsigned int K, const Kernel \&);  \\
  \\
template$<$  \\
typename InputIterator,   \\
typename OutputIterator$>$  \\
