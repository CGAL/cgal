...
The \ccc{ReconstructionVertexBase_3} concept defines the interface of the vertex class of the \ccc{ReconstructionTriangulation_3} concept. It provides the interface requested by the \ccc{Poisson_reconstruction_function} class.
