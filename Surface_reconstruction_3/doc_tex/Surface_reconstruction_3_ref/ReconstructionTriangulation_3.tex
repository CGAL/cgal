...
The \ccc{ReconstructionTriangulation_3} concept defines the interface of a 3D Delaunay triangulation requested by the \ccc{Poisson_reconstruction_function} class. The cell base class must be a model of \ccc{ReconstructionCellBase_3} and the vertex base class must be a model of \ccc{ReconstructionVertexBase_3}.
