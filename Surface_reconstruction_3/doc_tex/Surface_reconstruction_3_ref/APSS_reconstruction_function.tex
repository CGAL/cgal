...
\begin{description}
\item \ccc{Gt}: Geometric traits class. \end{description}
...
\ccConstructor{APSS_reconstruction_function(InputIterator first, InputIterator beyond, unsigned int k, FT projection_error = 3.16e-4);}
{
