...
\ccFunction{void estimate_normals_jet_fitting_3(InputIterator first, InputIterator beyond, OutputIterator normals, const unsigned int K, const Kernel& kernel, const unsigned int degre_fitting = 2);}
{
...
typename Kernel$>$  \\
void  \\
\ccc{estimate_normals_jet_fitting_3} (InputIterator first, InputIterator beyond, OutputIterator normals, const unsigned int K, const Kernel \&kernel, const unsigned int \ccc{degre_fitting}=2);  \\
  \\
template$<$  \\
typename InputIterator,   \\
typename OutputIterator$>$  \\
