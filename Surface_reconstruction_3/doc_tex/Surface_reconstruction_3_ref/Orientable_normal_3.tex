...
\ccRefIdfierPage{CGAL::Vector_3<Geom_traits>} \\
\ccRefIdfierPage{CGAL::Lightweight_vector_3<Geom_traits>} \\
\ccRefIdfierPage{CGAL::Point_with_normal_3<Geom_traits, Normal_3>}
