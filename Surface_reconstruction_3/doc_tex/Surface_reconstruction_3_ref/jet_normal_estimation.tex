...
\ccFunction{OrientableNormal_3 jet_normal_estimation(const typename Kernel::Point_3& query, Tree& tree, unsigned int KNN, unsigned int degre_fitting);}
{
...
\ccc{jet_normal_estimation} (const typename \ccc{Kernel::Point_3}\& query, Tree\& tree, unsigned int KNN, unsigned int \ccc{degre_fitting});  \\
  \\
template$<$  \\
