...
inline
CImg <unsigned char> to_grayscale(CImg<unsigned char> image)
{
...
//3x3 Gaussian kernel 
inline
CImg <unsigned char> gauss3(CImg<unsigned char> image) {
...
//3x3 Average kernel 
inline
CImg <unsigned char> average3(CImg<unsigned char> image) {
...
inline
CImg <unsigned char> highP1(CImg<unsigned char> image) {
...
//Frei-Chen Mask
inline
CImg <unsigned char> grad_freiChen(CImg<unsigned char> image,int threshold) {
  ...
  cimg_for_insideXY(image,row,column,1){
    ...
    */
    ...
    { 
      // Non edge is black (0,0,0)       // Temporarily Dark goldenrod for Opengl visualisation problems
      grad(row,column,0,0) = 184;
      grad(row,column,0,1) = 134;
      grad(row,column,0,2) = 11;
    }
    else 
    {
    // Edge is white
...
//inline
//CImg <unsigned char> grad_pdiff(CImg<unsigned char> image,int threshold) {
//
...
//inline
//CImg <unsigned char> grad_spdiff(CImg<unsigned char> image,int threshold) {
//
//  unsigned char grad_x, grad_y;  
//  CImg <unsigned char> grad (image.dimx(),image.dimy(),1,1,0);
//
...
//Roberts Mask
//inline
//CImg <unsigned char> grad_roberts(CImg<unsigned char> image,int threshold) {
//
//  unsigned char grad_x, grad_y;  
//  CImg <unsigned char> grad (image.dimx(),image.dimy(),1,1,0);
//
