...
#ifndef _Gyroviz_dt2_
#define _Gyroviz_dt2_
...
#include "Gyroviz_info_for_dt2.h"
...
class Gyroviz_dt2 : public CGAL::Delaunay_triangulation_2<Gt, Tds>
{
// Private types
private:
...
public:
  ...
  void gl_draw_2D_delaunay_triangles(const unsigned char r, const unsigned char g,
  ...
  // 3D projection of the tracked 2D points triangulation
  void gl_draw_soup_edges(const unsigned char r, const unsigned char g,
    const unsigned char b, const float width)
  {
    ...
    {
      Face_handle fh  = fe->first;	
      int i		        = fe->second;
      Vertex_handle v1 = fh->vertex(this->ccw(i));
      Vertex_handle v2 = fh->vertex(this->cw(i));
