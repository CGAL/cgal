// GyrovizView_4.h : interface of the CGyrovizView_4 class
//
...
class CGyrovizView_4 : public CView
{
protected: // create from serialization only
	CGyrovizView_4();
	DECLARE_DYNCREATE(CGyrovizView_4)

	// Attributes
public:
	CGyrovizDoc_4* GetDocument() const;
...
public:
	...
	bool m_view_border_delaunay_vertices;
...
public:
	...
	afx_msg void OnRenderBordervertices32845();
	afx_msg void OnUpdateRenderBordervertices32845(CCmdUI *pCmdUI);
};

#ifndef _DEBUG  // debug version in GyrovizView_4.cpp
inline CGyrovizDoc_4* CGyrovizView_4::GetDocument() const
{ return reinterpret_cast<CGyrovizDoc_4*>(m_pDocument); }
#endif
