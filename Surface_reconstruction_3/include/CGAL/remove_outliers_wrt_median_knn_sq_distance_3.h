...
#ifndef CGAL_REMOVE_OUTLIERS_WRT_MEDIAN_KNN_SQ_DISTANCE_3_H
#define CGAL_REMOVE_OUTLIERS_WRT_MEDIAN_KNN_SQ_DISTANCE_3_H
...
>
OutputIterator
remove_outliers_wrt_median_knn_sq_distance_3(
                     InputIterator first,       ///< input points
                     InputIterator beyond,
                     OutputIterator output,     ///< output points
                     unsigned int KNN,          ///< number of neighbors
                     ...
                     double threshold_percent)  ///< percentage of points to remove
{
  ...
  return remove_outliers_wrt_median_knn_sq_distance_3(first,beyond,output,KNN,Kernel(),threshold_percent);
}
                     ...
                     double threshold_percent)  ///< percentage of points to remove
{
  ...
  typedef typename Kernel_traits<Value_type>::Kernel Kernel;
  return remove_outliers_wrt_median_knn_sq_distance_3(first,beyond,KNN,Kernel(),threshold_percent);
}


CGAL_END_NAMESPACE

#endif // CGAL_REMOVE_OUTLIERS_WRT_MEDIAN_KNN_SQ_DISTANCE_3_H
