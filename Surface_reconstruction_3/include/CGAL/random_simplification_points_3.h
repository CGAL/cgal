...
#ifndef CGAL_RANDOM_SIMPLIFICATION_POINTS_3_H
#define CGAL_RANDOM_SIMPLIFICATION_POINTS_3_H
           ...
           double threshold_percent)  ///< percentage of points to remove
{
  ...
  return random_simplification_points_3(first,beyond,output,threshold_percent,Kernel());
}
       ...
       double threshold_percent)  ///< percentage of points to remove
{
  ...
  typedef typename Kernel_traits<Value_type>::Kernel Kernel;
  return random_simplification_points_3(first,beyond,threshold_percent,Kernel());
}


CGAL_END_NAMESPACE

#endif // CGAL_RANDOM_SIMPLIFICATION_POINTS_3_H
