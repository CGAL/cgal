...
#ifndef CGAL_SURFACE_RECONSTRUCTION_WRITE_PWN_H
#define CGAL_SURFACE_RECONSTRUCTION_WRITE_PWN_H
...
bool surface_reconstruction_write_pwn(const char* pFilename, 
...
#endif // CGAL_SURFACE_RECONSTRUCTION_WRITE_PWN_H
