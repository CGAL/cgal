...
#ifndef CGAL_SURFACE_RECONSTRUCTION_READ_PNB_H
#define CGAL_SURFACE_RECONSTRUCTION_READ_PNB_H
...
bool surface_reconstruction_read_pnb(const char* pFilename, OutputIterator output)
{
...
#endif // CGAL_SURFACE_RECONSTRUCTION_READ_PNB_H
