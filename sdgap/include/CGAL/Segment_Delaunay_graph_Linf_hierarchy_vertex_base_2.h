...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Segment_Delaunay_graph_Linf_2/include/CGAL/Segment_Delaunay_graph_Linf_hierarchy_vertex_base_2.h $
// $Id: Segment_Delaunay_graph_Linf_hierarchy_vertex_base_2.h 56667 2010-06-09 07:37:13Z sloriot $
// 
//
// Author(s)     : Menelaos Karavelas <mkaravel@cse.nd.edu>


#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_HIERARCHY_VERTEX_BASE_2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_HIERARCHY_VERTEX_BASE_2_H
...
template <class Vbb>
class Segment_Delaunay_graph_Linf_hierarchy_vertex_base_2
 : public Vbb
{
public:
  typedef Vbb V_Base;
  ...
  struct Rebind_TDS {
    ...
    typedef Segment_Delaunay_graph_Linf_hierarchy_vertex_base_2<Vb2>   Other;
  };

  Segment_Delaunay_graph_Linf_hierarchy_vertex_base_2()
    : V_Base(), up_( Vertex_handle() ), down_( Vertex_handle() ) {}

  Segment_Delaunay_graph_Linf_hierarchy_vertex_base_2(const Storage_site_2& ss,
						 Face_handle f)
...
#endif // CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_HIERARCHY_VERTEX_BASE_2_H
