...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Segment_Delaunay_graph_Linf_2/include/CGAL/Segment_Delaunay_graph_Linf_vertex_base_2.h $
// $Id: Segment_Delaunay_graph_Linf_vertex_base_2.h 56667 2010-06-09 07:37:13Z sloriot $
// 
//
...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_VERTEX_BASE_2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_VERTEX_BASE_2_H
...
class Segment_Delaunay_graph_Linf_vertex_base_2
  : public Vb
{
private:
...
public:
  ...
  struct Rebind_TDS {
    ...
    typedef Segment_Delaunay_graph_Linf_vertex_base_2<STraits,Vb2>  Other;
  };

  
  Segment_Delaunay_graph_Linf_vertex_base_2 () : Vb(), ss_() {}
    
  Segment_Delaunay_graph_Linf_vertex_base_2(const Storage_site_2& ss,
				       Face_handle f)
    : Vb(f), ss_(ss)  {}
...
#endif // CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_VERTEX_BASE_2_H
