          ...
          p.segment().is_vertical()))      ) {
           ...
           if ( p.is_point() && q.is_segment() ) {
             ...
             if ( CGAL::is_certain(o == RIGHT_TURN) )  {
               ...
               Line_2 lperp = same_points(p, q.source_site()) ? compute_cw_perpendicular(l, p.point())
             ...
             if ( CGAL::is_certain(o == RIGHT_TURN) )  {
               ...
               Line_2 lperp = same_points(q, p.source_site()) ? compute_cw_perpendicular(l, q.point())
