...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Segment_Delaunay_graph_Linf_2/include/CGAL/Segment_Delaunay_graph_Linf_2/Arrangement_type_C2.h $
// $Id: Arrangement_type_C2.h 56668 2010-06-09 08:45:58Z sloriot $
// 
//
...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_ARRANGEMENT_TYPE_C2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_ARRANGEMENT_TYPE_C2_H
...
#include <CGAL/Segment_Delaunay_graph_Linf_2/Arrangement_enum.h>
...
private:
  ...
  typedef typename K::Kernel::Orientation_2  Orientation_L2_2;
...
private:
			      ...
			      unsigned int ip, unsigned int iq) const
  {
    ...
    if ( Orientation_L2_2()(p1, p2, p3) != COLLINEAR ) {
      if ( ip == 0 ) {
	if ( iq == 0 ) {
	  return TOUCH_11;
	} else {
...
#endif // CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_ARRANGEMENT_TYPE_C2_H
