...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_IS_PLUS45_2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_IS_PLUS45_2_H
...
public:
  ...
  Boolean operator()(const Site_2& s) const
  {
    ...
    return CGAL::compare( s.source().x() - s.target().x(),
