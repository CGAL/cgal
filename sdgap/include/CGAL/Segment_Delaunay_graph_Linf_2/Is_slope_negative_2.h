...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_IS_SLOPE_NEGATIVE_2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_IS_SLOPE_NEGATIVE_2_H
...
public:
  ...
  Boolean operator()(const Site_2& s) const
  {
    ...
    return CGAL::sign(s.target().x() - s.source().x()) ==
           CGAL::sign(s.source().y() - s.target().y());
  }
...
#endif //  CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_IS_SLOPE_NEGATIVE_2_H
