...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/Segment_Delaunay_graph_Linf_2/include/CGAL/Segment_Delaunay_graph_Linf_storage_site_with_info_2.h $
// $Id: Segment_Delaunay_graph_Linf_storage_site_with_info_2.h 56668 2010-06-09 08:45:58Z sloriot $
// 
//
// Author(s)     : Menelaos Karavelas <mkaravel@iacm.forth.gr>

#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_STORAGE_SITE_WITH_INFO_2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_STORAGE_SITE_WITH_INFO_2_H 1
...
class Segment_Delaunay_graph_Linf_storage_site_with_info_2
  : public Base_storage_site
{
  typedef Base_storage_site                       Base;

  friend class
  CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_2_NS::Construct_storage_site_2<STraits>;
...
protected:
  ...
  typedef
  Segment_Delaunay_graph_Linf_storage_site_with_info_2<Storage_traits,Info,Base>
  Self;

public:
  // DEFAULT CONSTRUCTOR
  //--------------------
  Segment_Delaunay_graph_Linf_storage_site_with_info_2()
    : Base(), info_set_(false) {}

private:
  // CONSTRUCTOR FROM BASE SITE
  //---------------------------
  Segment_Delaunay_graph_Linf_storage_site_with_info_2(const Base& base)
    : Base(base), info_set_(false) {}

public:
  // COPY CONSTRUCTOR
  //-----------------
  Segment_Delaunay_graph_Linf_storage_site_with_info_2(const Self& other) 
    : Base(other)
  {
...
#endif // CGAL_SEGMENT_DELAUNAY_GRAPH_LINF_STORAGE_SITE_WITH_INFO_2_H
