...
// General_polygon_set_on_sufrace_2
...
private:
  ...
  typedef General_polygon_set_on_surface_2 <
    Traits_2, Topology_traits>                         Self;
...
public:
  ...
  // default costructor
  General_polygon_set_on_surface_2() : m_traits(new Traits_2()),
  ...
  General_polygon_set_on_surface_2(Traits_2& tr) : m_traits(&tr),
                                        m_traits_adaptor(*m_traits),
  ...
  General_polygon_set_on_surface_2(const Self& ps) :
  ...
  explicit General_polygon_set_on_surface_2(const Polygon_with_holes_2& pgn_with_holes): 
    m_traits(new Traits_2()),
    m_traits_adaptor(*m_traits),
    m_traits_owner(true),
    m_arr(new Aos_2(m_traits))
...
private:
  General_polygon_set_on_surface_2(Aos_2* arr) : m_traits(new Traits_2()),
                                              m_traits_adaptor(*m_traits),
                                              m_traits_owner(true),
                                              m_arr(arr)
   {}
...
public:
  ...
  //test for intersection with another General_polygon_set_on_surface_2 object
  ...
  //intersection with another General_polygon_set_on_surface_2 object
  ...
  //join with another General_polygon_set_on_surface_2 object
  ...
  //difference with another General_polygon_set_on_surface_2 object
  ...
  //symmetric_difference with another General_polygon_set_on_surface_2 object
