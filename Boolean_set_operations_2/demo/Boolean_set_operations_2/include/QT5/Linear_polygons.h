...
class Linear_set_graphics_item : public Piecewise_set_graphics_item<Linear_set,Gps_traits,Draw_linear_X_monotone_curve,Linear_X_monotone_bbox>
{
  
  typedef Piecewise_set_graphics_item<Linear_set,Gps_traits,Draw_linear_X_monotone_curve,Linear_X_monotone_bbox> Base ;
  
public:

  Linear_set_graphics_item(Linear_set* aSet,Gps_traits Linear_traits) : Base(aSet,Linear_traits) {}
} ;
