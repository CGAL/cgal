...
\lcTex{\vspace{-20pt}}
\ccIncludeExampleCode{Boolean_set_operations_2/ex_do_intersect.cpp}
...
\ccIncludeExampleCode{Boolean_set_operations_2/ex_simple_join_intersect.cpp}
...
\ccIncludeExampleCode{Boolean_set_operations_2/ex_symmetric_difference.cpp}

We mention that in some cases it is convinient to connect the outer
boundary of a polygon with holes with the holes inside it. The
function \ccc{connect_polygon_with_holes_2()} accepts a polygon with
...
\ccIncludeExampleCode{Boolean_set_operations_2/ex_connect_polygon.cpp}
...
Chapter~\ref{chapterArrangement_2}. The instantiated \ccc{Dcel} type is 
...
\ccIncludeExampleCode{Boolean_set_operations_2/ex_sequence.cpp}
