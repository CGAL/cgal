...
\ccc{Traits::Polygon_with_holes_2} is valid, only if 
...
\ccGlue
\ccNestedType{Polygon_2}{the general polygon type. Must model the \ccc{GpsTraits::GeneralPolygon_2} Concept.}
\ccGlue
\ccNestedType{Polygon_with_holes_2}{the general polygon with holes type. Must model the \ccc{GpsTraits::GeneralPolygonWithHoles_2} Concept.} 
...
% ===============================
The following bibariate function replace \ccc{gps} with the result.
