...
\begin{ccRefClass}{Min_sphere_annulus_d_traits_3<K,ET,NT>}
\ccIndexTraitsClassBegin{Min_sphere_annulus_d_traits_3}{%
...
\ccInclude{CGAL/Min_sphere_annulus_d_traits_3.h}
...
\ccSaveThreeColumns
\ccSetTwoColumns{Min_sphere_annulus_d_traits_3<K,ET,NT>:: Rep_tag}{}
...
\ccConstructor{ Min_sphere_annulus_d_traits_3( );}{default constructor.}
\ccConstructor{ Min_sphere_annulus_d_traits_3(
                  const Min_sphere_annulus_d_traits_3<K,ET,NT>&);}{copy constructor.}
...
\ccRefConceptPage{Min_sphere_annulusDTraits}
