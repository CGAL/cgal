...
as input. Most importantly, \ccc{CGAL::Min_sphere_of_spheres_d<Traits>} has
...
divide.
    ...
    \ccc{OptimisationDTraits} as its template argument.
      We provide the models \ccc{CGAL::Optimisation_d_traits_2},
      \ccc{CGAL::Optimisation_d_traits_3} and 
\ccc{CGAL::Optimisation_d_traits_d}
...
sphere from scratch. The clear operation and the check for validity
    ...
    \ccExample
    \ccIncludeExampleCode{Min_sphere_d/min_sphere_d.cpp}
