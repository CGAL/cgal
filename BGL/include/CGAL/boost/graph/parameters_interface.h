...
CGAL_add_named_parameter(do_erase_all_duplicates_t, do_erase_all_duplicates, do_erase_all_duplicates)
CGAL_add_named_parameter(do_require_same_orientation_t, do_require_same_orientation, do_require_same_orientation)
