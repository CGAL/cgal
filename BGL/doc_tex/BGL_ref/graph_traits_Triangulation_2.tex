...
\ccNestedType{out_edge_iterator}{An iterator for the edges adjacent to a vertex. Its value type is \ccc{edge_descriptor}.}
\ccNestedType{in_edge_iterator}{An iterator for the edges adjacent to a vertex. Its value type is \ccc{edge_descriptor}.}
