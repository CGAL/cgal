...
{PropertyTag} which identifies the {\em is-border} property attached to the edge of a Boost \ccAnchor{http://www.boost.org/libs/graph/doc/graph_concepts.html}{graph}.
