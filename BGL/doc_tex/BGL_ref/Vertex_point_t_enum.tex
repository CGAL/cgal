...
{property tag} which identifies the {\em Point} property attached to the vertex of a \ccc{HalfedgeGraph}.
...
for a \ccc{vertex_point} can be extracted from any proper model of \ccc{HalfedgeGraph}
using the {\sc Bgl}
