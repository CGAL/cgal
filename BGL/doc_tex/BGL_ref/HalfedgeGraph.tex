...
\ccNestedType{halfedge_graph_traits<HalfedeGraph>::Point}{The type of the geometric location of a vertex.}
...
Any model of the concept \ccRefIdfierPage{CGAL::HalfedgeDS}\\
