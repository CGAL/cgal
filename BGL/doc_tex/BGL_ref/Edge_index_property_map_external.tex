...
number in the range \ccc{[0,num_edges(g)]} to each edge in \ccc{g}.}

\ccOperations

\ccMethod
  {reference operator[]( key_type const& edge ) const;}
  {Returns the unique index for \ccc{edge} as mantained by this map.\\
  {\em Precondition}: if \ccc{edge} is no longer in the graph this function shows undefined-behaviour.
  }
...
\ccSeeAlso
\ccRefIdfierPage{CGAL::Edge_index_property_stored<Graph>}\\
