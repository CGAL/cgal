...
\ccConstructor{CGAL::Polyhedron_edge_is_border_map<Traits>( CGAL::Polyhedron_3<Traits> const& poly); }
...
\ccMethod
  ...
  {Returns the value of edge->is\_border().}  
    
\ccIsModel
\ccc{EdgeIsBorderProperyMap}
