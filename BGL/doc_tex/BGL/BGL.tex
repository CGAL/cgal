...
{\bf Remark for the reviewer:} We will replace Disjkstra with the Euclidean
...
\subsubsection{The Primal Arrangement Representation\label{arr_sssec:bgl_primal}}
%-------------------------------------------------
...
\subsubsection{The Dual Arrangement Representation\label{arr_sssec:bgl_dual}}
%-----------------------------------------------
