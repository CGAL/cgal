...
\ccHeading{Example: Using Vertices, and Edges with an ID}
...
{\bf Remark for the reviewer:} We will replace Dijkstra with the Euclidean
minimum spanning tree example as it is more relevant. 
...
\ccHeading{Example for the Arrangement as Graph\label{arr_sssec:bgl_primal}}
%-------------------------------------------------
...
\ccHeading{Example for the Dual of an Arrangement as Graph\label{arr_sssec:bgl_dual}}
%-----------------------------------------------
