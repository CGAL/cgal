...
join_vertex_interior_test()
{
  ...
  assert(CGAL::internal::exact_num_vertices(f.m) == 5);
  assert(CGAL::internal::exact_num_edges(f.m) == 6);
  assert(std::distance(CGAL::halfedges_around_face(halfedge(f.f1, f.m), f.m)) == 3);
  assert(std::distance(CGAL::halfedges_around_face(halfedge(f.f2, f.m), f.m)) == 3);
...
join_vertex_exterior_test()
{
...

  {
    ...
    assert(CGAL::internal::exact_num_vertices(f.m) == 5);
    assert(CGAL::internal::exact_num_edges(f.m) == 6);
    assert(std::distance(CGAL::halfedges_around_face(halfedge(f.f1, f.m), f.m)) == 4);
    assert(std::distance(CGAL::halfedges_around_face(halfedge(f.f2, f.m), f.m)) == 3);
...
split_vertex()
{
  ...
  assert(std::distance(CGAL::halfedges_around_face(h1, f.m)) == 5);
  assert(std::distance(CGAL::halfedges_around_face(h2, f.m)) == 7);
}
...
split_join_vertex_inverse()
{
  ...
  assert(std::distance(CGAL::halfedges_around_face(h1, f.m)) == 3);
  assert(std::distance(CGAL::halfedges_around_face(h2, f.m)) == 3);
}
