...
void test(const NamedParameters& np)
{
  ...
  check_same_type<9026>(get_param(np, CGAL::internal_np::transformation));
  check_same_type<9027>(get_param(np, CGAL::internal_np::point_set_filters));
  check_same_type<9028>(get_param(np, CGAL::internal_np::matcher));
  check_same_type<9029>(get_param(np, CGAL::internal_np::outlier_filters));
  check_same_type<9030>(get_param(np, CGAL::internal_np::error_minimizer));
  check_same_type<9031>(get_param(np, CGAL::internal_np::transformation_checkers));
  check_same_type<9032>(get_param(np, CGAL::internal_np::inspector));
  check_same_type<9033>(get_param(np, CGAL::internal_np::logger));
}
