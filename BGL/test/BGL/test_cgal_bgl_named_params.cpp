...
void test(const NamedParameters& np)
{
  ...
  assert(get_parameter(np, CGAL::internal_np::halfedges_comparator).v == 58);
  ...
  check_same_type<58>(get_parameter(np, CGAL::internal_np::halfedges_comparator));
