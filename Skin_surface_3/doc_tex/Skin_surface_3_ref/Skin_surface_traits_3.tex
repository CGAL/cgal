...
\begin{ccRefClass}{Skin_surface_traits_3<K>}
  ...
  class \ccc{Skin_surface_3<SkinSurfaceTraits_3>}. Since, it is a
  model of the \ccc{SkinSurfaceTraits_3}, it has to provide the
  functionality of \ccc{RegularTriangulationTraits_3}. Moreover, it
