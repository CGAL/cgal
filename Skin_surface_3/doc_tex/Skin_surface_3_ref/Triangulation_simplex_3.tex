...
\ccTypedef{typedef Triangulation_3::Vertex Vertex;}{}
\ccGlue
\ccTypedef{typedef Triangulation_3::Edge Edge;}{}
\ccGlue
\ccTypedef{typedef Triangulation_3::Facet Facet;}{}
\ccGlue
\ccTypedef{typedef Triangulation_3::Cell Cell;}{}
...
\ccConstructor{Triangulation_simplex_3(const Vertex &vh);}{}
\ccGlue
\ccConstructor{Triangulation_simplex_3(Edge e);}{}
\ccGlue
\ccConstructor{Triangulation_simplex_3(Facet f);}{}
\ccGlue
\ccConstructor{Triangulation_simplex_3(const Cell &ch);}{}
...
\ccMethod{bool operator==(const Triangulation_simplex_3<Triangulation_3> &s1);}{Test
  whether two simplices are equal.}
\ccGlue
\ccMethod{bool operator< (const Triangulation_simplex_3<Triangulation_3> &s1);}{Defines
