...
\ccRefChapter{3D Skin Surface Meshing}
...
\ccRefIdfierPage{CGAL::Skin_surface_traits_3}
...
\ccRefIdfierPage{CGAL::make_skin_surface_3}\\
\ccRefIdfierPage{CGAL::mesh_skin_surface_3}\\
\ccRefIdfierPage{CGAL::subdivide_skin_surface_3}
