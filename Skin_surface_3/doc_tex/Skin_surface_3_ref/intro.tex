...
\subsection*{Classes}
\ccRefIdfierPage{CGAL::Skin_surface_3<RegularTriangulationTraits_3>}\\
\ccRefIdfierPage{CGAL::Skin_surface_traits_3}
\ccRefIdfierPage{CGAL::Union_of_balls_3<UnionOfBallsTraits_3>}\\
\ccRefIdfierPage{CGAL::Union_of_balls_traits_3}
...
\ccRefIdfierPage{CGAL::mesh_union_of_balls_3}\\
\ccRefIdfierPage{CGAL::subdivide_skin_surface_mesh_3}
