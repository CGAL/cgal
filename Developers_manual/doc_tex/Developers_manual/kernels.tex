...
\lcRawHtml{
<CENTER>
<IMG BORDER=0 SRC="fig/Cartesian_orientation.png"
...
\ccc{Lazy_kernel<EK,AK,Conv>} (where \ccc{EK} is an exact kernel, \ccc{AK} a fast approximate kernel, and \ccc{Conv} a converter from \ccc{EK} to \ccc{AK}). Objects contain a DAG that led to their
