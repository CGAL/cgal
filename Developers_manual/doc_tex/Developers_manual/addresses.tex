...
\item[\ccAnchor{mailto:cgal-cvs-l@postino.mpi-sb.mpg.de}{{\tt cgal-cvs-l@postino.mpi-sb.mpg.de}}] 
     \index{cgal-cvs-l mailing list@{\tt cgal-cvs-l} mailing list}
     ...
     \ccAnchor{mailto:ameyer@mpi-sb.mpg.de}{ameyer@mpi-sb.mpg.de}.
     An \ccAnchor{http://postino.mpi-sb.mpg.de/cgi-bin/lyris.pl?enter=cgal-cvs-l}{archive} 
     of this mailing list is maintained%
     \begin{ccTexOnly}
