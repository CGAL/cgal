...
The shell script
\ccAnchor{https://gforge.inria.fr/plugins/scmsvn/viewcvs.php/trunk/Scripts/scripts/create_makefile?root=cgal&view=markup}
{{\tt create\_makefile}} creates a \cgal\ makefile
...
host. If you do not want to run the testsuite, but only to install a new release of CGAL,
you may not define {\tt COMPILERS\_localhost} and put only localhost in the {\tt BUILD\_HOSTS} variable.
