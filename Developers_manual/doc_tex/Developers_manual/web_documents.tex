...
\begin{itemize}
   ...
   \item \ccAnchor{https://gforge.inria.fr/plugins/scmsvn/viewcvs.php/?root=cgal}{SVN Repository}
   \begin{ccTexOnly}
      --- \path|https://gforge.inria.fr/plugins/scmsvn/viewcvs.php/?root=cgal|
   \end{ccTexOnly}

   \item \ccAnchor{http://cgal.inria.fr/CGAL/Members/Releases/}{Internal release page}
   \begin{ccTexOnly}
      --- \path|http://cgal.inria.fr/CGAL/Members/Releases/|
   \end{ccTexOnly}

   \item \ccAnchor{http://cgal.inria.fr/CGAL/Members/testsuite/}{Test suite results}
   \begin{ccTexOnly}
