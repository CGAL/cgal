...
{
  const std::filesystem::path filename1 = (argc>1) ? argv[1] : CGAL::data_file_path("meshes/triangle.off");
  const std::filesystem::path filename2 = (argc>2) ? argv[2] : CGAL::data_file_path("meshes/quad.off");
