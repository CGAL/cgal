...
{
  std::filesystem::path P_name = argc==1?CGAL::data_file_path("meshes/knot1.off") : argv[1];
  std::filesystem::path Q_name = argc<3 ?CGAL::data_file_path("meshes/elephant.off") : argv[2];
  if(argc < 3) {
