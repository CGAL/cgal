...
seed = 42
# curve directory
curve_name_prefix = "../curves/generated_3d/"
...
for i in range(num_start_end):
    starts.append(create_random_point(np.array(D*[0.])))
    ends.append(create_random_point(np.array(D*[100.])))
