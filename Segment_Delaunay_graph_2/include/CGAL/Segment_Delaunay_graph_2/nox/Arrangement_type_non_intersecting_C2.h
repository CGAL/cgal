...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_2_NOX_ARRANGEMENT_TYPE_NON_INTERSECTING_C2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_2_NOX_ARRANGEMENT_TYPE_NON_INTERSECTING_C2_H
...
private:
  ...
  {
    bool same_p1q1 = same_points(p.source(), q.source());
    bool same_p1q2 = same_points(p.source(), q.target());
    bool same_p2q1 = same_points(p.target(), q.source());
    bool same_p2q2 = same_points(p.target(), q.target());
...
#endif // CGAL_SEGMENT_DELAUNAY_GRAPH_2_NOX_ARRANGEMENT_TYPE_NON_INTERSECTING_C2_H
