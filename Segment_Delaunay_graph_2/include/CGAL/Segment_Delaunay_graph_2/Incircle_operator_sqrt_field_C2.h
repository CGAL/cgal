...
#ifndef CGAL_SEGMENT_DELAUNAY_GRAPH_2_OPERATOR_INCIRCLE_SQRT_FIELD_C2_H
#define CGAL_SEGMENT_DELAUNAY_GRAPH_2_OPERATOR_INCIRCLE_SQRT_FIELD_C2_H
...
template<class K>
class Incircle_operator_sqrt_field_C2
