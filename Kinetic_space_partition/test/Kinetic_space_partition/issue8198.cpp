...
exact_segments.push_back(Segment_2(Point_2( 2.44818 , 3.57048 ), Point_2( 1.39451 , 5.39643 )));
exact_segments.push_back(Segment_2(Point_2( 0.340843 , 7.22239 ), Point_2( -0.712823 , 9.04835 )));
exact_segments.push_back(Segment_2(Point_2( 92.528 , 27.2597 ), Point_2( 96.4776 , 33.6026 )));

#ifdef OUTPUT_FILES
std::ofstream output_file(
  test_name + "_exact" + "_output.polylines.txt");
output_file << "2 2.44818 3.57048 0 1.39451 5.39643 0" << std::endl;
output_file << "2 0.340843 7.22239 0 -0.712823 9.04835 0" << std::endl;
output_file << "2 92.528 27.2597 0 96.4776 33.6026 0" << std::endl;
output_file.close();
#endif
