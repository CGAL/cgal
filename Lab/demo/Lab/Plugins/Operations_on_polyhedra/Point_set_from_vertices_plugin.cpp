...
class CGAL_Lab_point_set_from_vertices_plugin :
  public QObject,
...
}; // end CGAL_Lab_point_set_from_vertices_plugin

void CGAL_Lab_point_set_from_vertices_plugin::init(QMainWindow* mainWindow,
...
QList<QAction*> CGAL_Lab_point_set_from_vertices_plugin::actions() const {
  return QList<QAction*>() << actionPointSetFromPolyhedronVertices;
}

template<typename Item>
void CGAL_Lab_point_set_from_vertices_plugin::apply(Item *item)
{
...
void CGAL_Lab_point_set_from_vertices_plugin::createPointSet()
{
