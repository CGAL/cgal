...
class CGAL_Lab_fairing_plugin :
  public QObject,
  public CGAL_Lab_plugin_helper
{
  Q_OBJECT
  Q_INTERFACES(CGAL::Three::CGAL_Lab_plugin_interface)
  Q_PLUGIN_METADATA(IID "com.geometryfactory.CGALLab.PluginInterface/1.0" FILE "fairing_plugin.json")
public:
...
}; // end CGAL_Lab_fairing_plugin

// Q_EXPORT_PLUGIN2(CGAL_Lab_fairing_plugin, CGAL_Lab_fairing_plugin)
