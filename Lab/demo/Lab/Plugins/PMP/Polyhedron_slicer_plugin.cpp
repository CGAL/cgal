...
class CGAL_Lab_polyhedron_slicer_plugin :
  public QObject,
...
}; // end CGAL_Lab_polyhedron_slicer_plugin

void CGAL_Lab_polyhedron_slicer_plugin::init(QMainWindow* mainWindow,
...
QList<QAction*> CGAL_Lab_polyhedron_slicer_plugin::actions() const {
  return QList<QAction*>() << actionSlicerWidget;
}

void CGAL_Lab_polyhedron_slicer_plugin::slicer_widget_action(){
...
void CGAL_Lab_polyhedron_slicer_plugin::plane_manipulated_frame_modified() {
...
bool CGAL_Lab_polyhedron_slicer_plugin::on_Update_plane_button_clicked() {
  CGAL::qglviewer::ManipulatedFrame* mf = plane_item->manipulatedFrame();
  // get center
...
void CGAL_Lab_polyhedron_slicer_plugin::on_Generate_button_clicked()
{
...
void CGAL_Lab_polyhedron_slicer_plugin::item_about_to_be_destroyed(CGAL::Three::Scene_item* scene_item) {
...
void CGAL_Lab_polyhedron_slicer_plugin::dock_widget_closed() {
  CGAL_assertion(plane_item != NULL);
