...
*/ 
typedef Hidden_type Data_left_func; 
...
*/ 
typedef Hidden_type Data_right_func; 
...
*/ 
typedef Hidden_type Window_left_func; 
...
`Window` which has type `Key` 
*/ 
typedef Hidden_type Window_right_func; 
