...
\ccUserChapter{Nef Polyhedra embedded on the Sphere}
\label{chapterNef_S2}
...
\ccIncludeExampleCode{Nef_S2/exploration.C}
...
\ccIncludeExampleCode{Nef_S2/point_location.C}
...
\ccIncludeExampleCode{Nef_S2/visualization.C}
