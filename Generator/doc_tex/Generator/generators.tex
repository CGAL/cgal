...
The class \ccc{Combination_enumerator} represents one subset, and enumerates
all fixed-size subsets of a range of integers. It is useful in the context of
high-dimensional triangulations, e.g., for enumerating the faces of a simplex.
