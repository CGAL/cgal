...
This concept refines the concepts \ccc{DefaultConstructible},
\ccc{CopyConstructible}, and \ccc{Assignable}. (This means that a
model of concept \ccc{ApproximateMinEllipsoid_d_Traits_d} must also be
a model of the latter three concepts.)
