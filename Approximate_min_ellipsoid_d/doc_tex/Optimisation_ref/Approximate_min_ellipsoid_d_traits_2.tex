...
$2$-di\-men\-sional \cgal\ kernel. In order to use this class, 
...
number-type are \ccc{CGAL::MP_Float} and \ccc{CGAL::Gmpq}.)
...
\ccNestedType{Point}{\ccc{typedef K::Point_2 Point}}
\ccNestedType{Cartesian_const_iterator}{\ccc{typedef K::Cartesian_const_iterator_2 Cartesian_const_iterator}}
