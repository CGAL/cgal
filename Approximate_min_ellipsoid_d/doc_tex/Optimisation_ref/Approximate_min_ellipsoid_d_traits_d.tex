...
$d$-di\-men\-sional \cgal\ kernel. In order to use this class, you
...
\ccNestedType{Point}{typedef to \ccc{K::Point_d}.}
\ccNestedType{Cartesian_const_iterator}{typedef to
\ccc{K::Cartesian_const_iterator}.}
...
corresponding routines of class \ccc{K::Point_d}:
...
\ccConstructor{ApproximateMinEllipsoid_d_Traits_d();}{default constructor.}
