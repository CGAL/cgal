...
#ifndef CGAL_BENCHMARK_BENCHMARK_VISITOR_HPP
#define CGAL_BENCHMARK_BENCHMARK_VISITOR_HPP
...
public:
    ...
    virtual void begin_vector_2() {
        tnh( "Begin_vector_2" );
    }

    virtual void end_vector_2() {
        tnh( "End_vector_2" );
    }
    ...
    virtual void begin_polynomial( unsigned int variables,
                                   std::string coeff_typename ) {
      tnh( "Begin_polynomial");
    }
    ...
    virtual void begin_monom( std::string coefficient ) { tnh( "Begin_monom"); }
    virtual void end_monom() { tnh( "End_monom");   }
    ...
    virtual void begin_rotate_2() {
        tnh( "Begin_rotate_2" );
    }

    virtual void end_rotate_2() {
        tnh( "End_rotate_2" );
    }

    virtual void begin_translate_2() {
        tnh( "Begin_translate_2" );
    }

    virtual void end_translate_2() {
        tnh( "End_translate_2" );
    }
    ...
    virtual void begin_csg_union_3() { tnh("Begin_csg_union_3"); }
    virtual void end_csg_union_3() { tnh("End_csg_union_3"); }

    virtual void begin_csg_intersection_3() { tnh("Begin_csg_intersection_3"); }
    virtual void end_csg_intersection_3() { tnh("End_csg_intersection_3"); }

    virtual void begin_csg_negation_3() { tnh("Begin_csg_negation_3"); }
    virtual void end_csg_negation_3() { tnh("End_csg_negation_3"); }
};
