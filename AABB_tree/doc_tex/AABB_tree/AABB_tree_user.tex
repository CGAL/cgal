...
The main entry point to the component is the class \ccc{AABB_tree} which stores a static AABB tree constructed from an iterator range of primitives. The tree can then be queried for intersection and projection.
