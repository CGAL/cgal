...
\ccGlue
\ccTypedef{AT::Point_3 Point;}
          {Type of 3D point.}
\ccGlue
\ccTypedef{AT::Primitive Primitive;}
          {Type of input primitive.}
\ccGlue
\ccTypedef{AT::Bounding_box Bounding_box;}
          {Type of bounding box.}
\ccGlue
\ccTypedef{std::pair<Point, Primitive::Id> Point_and_primitive_id;}
          {}
\ccGlue
