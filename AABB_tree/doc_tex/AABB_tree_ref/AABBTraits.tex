...
\ccGlue
\ccNestedType{FT}{Number type returned by the distance method.}
\ccGlue
...
{Returns the intersection as a pair composed of a point and a primitive id, iff the query intersects the primitive.}
\ccGlue	
...
{Returns the closest point to \ccc{p}, among \ccc{q} and the points of the primitive.}
\ccGlue
\ccMethod{FT squared_distance(const Point_3 & p, const Point_3 & q);}
{Returns the distance between \ccc{p} and \ccc{q}.}
