...
\ccNestedType{Point_reference}{The type of a reference to an element of type \ccc{Point} returned by the \ccc{point()} function.}

\ccNestedType{Datum_reference}{The type of a reference to an element of type \ccc{Datum} returned by the \ccc{datum()} function.}
