...
\ccNestedType{Id}{Type of identifiers by which the input objects are referred to. It should be a model of the concepts DefaultConstructible and Assignable.}
