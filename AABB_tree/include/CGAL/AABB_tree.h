  ...
  public:
    ...
    void traversal_with_priority_and_group_traversal(const Query& query, Traversal_traits& traits, const std::size_t group_traversal_bound) const
    {
      ...
      case 1:
        ...
        break;
      default: // if(size() >= 2)
        root_node()->template traversal_with_priority_and_group_traversal<Query, Traversal_traits>(m_primitives, query, traits, m_primitives.size(), 0, group_traversal_bound);
      }
    }
