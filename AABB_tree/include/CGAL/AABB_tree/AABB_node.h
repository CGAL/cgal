...
//        traits.intersection(query, left_data());
//        if( traits.go_further() )
//          if( traits.do_intersect(query, right_child()) )
//            right_child().traversal<Traits>(query, traits, 2);
//        break;
//      }
//    default:
//      if( traits.do_intersect(query, left_child()) )
//      {
//        left_child().traversal<Traits>(query, traits, nb_primitives/2);
//        if(traits.go_further())
//          if( traits.do_intersect(query, right_child()) )
//            right_child().traversal<Traits>(query, traits, nb_primitives - nb_primitives/2);
//      }
...
//private:
//  /// Helper functions
//  Node& left_child() const { return *static_cast<Node*>(m_left_child); }
//  Node& right_child() const { return *static_cast<Node*>(m_right_child); }
//  Input& left_data() const { return *static_cast<Input*>(m_left_child); }
//  Input& right_data() const { return *static_cast<Input*>(m_right_child); }
//
//private:
//
