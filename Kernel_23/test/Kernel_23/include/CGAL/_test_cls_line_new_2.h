...
_test_cls_line_new_2(const R& )
{
 ...
 CGAL_test_assert( labc.direction() == Direction_2(labc.b(), - labc.a() ) );
 ...
 CGAL_test_assert( Line_2( n1, n0, n3 ).is_vertical() );
 CGAL_test_assert( Line_2( n0, n2, n3 ).is_horizontal() );
 ...
 CGAL_test_assert( labcperp.direction() == Direction_2( labc.a(), labc.b()) );
 ...
 CGAL_test_assert( Line_2( n0, n0, n6 ).is_degenerate() );
 CGAL_test_assert( Line_2( p1, p1 ).is_degenerate() );
 CGAL_test_assert( ! Line_2( p1, p3 ).is_degenerate() );
 ...
 CGAL_test_assert( l43.has_on( construct_point( n8, n2 )) );
 CGAL_test_assert( l43.has_on_boundary( construct_point( n8, n2 )) );
 CGAL_test_assert( lr21.has_on( construct_point( -n1, n0 )) );
