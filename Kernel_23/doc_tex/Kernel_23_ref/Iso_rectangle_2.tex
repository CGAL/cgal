...
\ccConstructor{Iso_rectangle_2(const Kernel::Bbox_2& bbox);}
{If \ccc{Kernel::RT} is constructible from double, introduces an iso-oriented rectangle from \ccc{bbox}.}
