...
\ccNestedType{Cartesian_const_iterator_d}{a model of \ccc{Kernel::CartesianConstIterator_d}}


\ccHeading{Geometric Objects}

\ccNestedType{Point_d}{a model of \ccc{Kernel::Point_d}}

\ccHeading{Constructions}

\ccNestedType{Construct_Point_d}{a model of \ccc{Kernel::ConstructPoint_d}}
