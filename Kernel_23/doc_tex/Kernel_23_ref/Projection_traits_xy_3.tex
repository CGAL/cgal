...
on 3D data in the \ccc{xy}-plane.
...
\ccGlue
\ccNestedType{Less_xy_2}{Predicate object. Provides the operator~:\\
\ccc{bool operator()(Point_2 p, Point_2 q)}.}
\ccGlue
\ccNestedType{Less_yx_2}{Predicate object. Provides the operator~:\\
\ccc{bool operator()(Point_2 p, Point_2 q)}.}
\ccGlue
