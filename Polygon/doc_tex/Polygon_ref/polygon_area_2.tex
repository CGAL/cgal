% +------------------------------------------------------------------------+
% | Reference manual page: polygon_area_2.tex
% +------------------------------------------------------------------------+
% | 21.06.2001   Author
% | Package: Polygon
% | 
...
\begin{ccRefFunction}{polygon_area_2}  %% add template arg's if necessary
...
%% \ccIncludeExampleCode{examples/Polygon/polygon_area_2_prog.cpp}
