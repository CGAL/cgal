...
#endif
{
  ...
  try {
    ...
    desc.add_options()
      ...
      ("input-file,f", po::value<string>(&if_name_string)->default_value(CGAL::data_file_path("meshes/ellipe0.003.off").string()),
    ...
    if_name_string = CGAL::data_file_path("meshes/ellipe0.003.off").string();
    d_fitting = 2;
    d_monge = 2;
    nb_rings = 0;
    nb_points_to_use = 0;
