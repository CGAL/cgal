...
information on the computational issues are stored in a Monge\_form_condition_numbers
class.
...
computations (ii)\ to store the Monge\_form_condition_numbers class members. Input
...
Monge\_form_condition_numbers data;
\item
