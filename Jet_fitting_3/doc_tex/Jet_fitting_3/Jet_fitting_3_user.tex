...
\ccc{Monge_via_jet_fitting<DataKernel, LocalKernel = Cartesian<double>, SvdTraits = Lapack>} 
...
\ccc{Data_Kernel::Point_3} are converted to
\ccc{Local_Kernel::Point_3}. For output of the \ccc{Monge_form} class,
...
\begin{itemize}
\item
a human readable text file featuring the \ccc{Monge_form} and the
