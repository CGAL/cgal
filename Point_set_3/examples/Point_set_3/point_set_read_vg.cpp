...
bool detect_and_export_spheres() {
  ...
  CGAL::IO::write_VG("spheres_point_set_3.vg", point_set, regions, CGAL::parameters::point_map(point_set.point_map()));
...
int main(int argc, char** argv) {
  detect_and_export_spheres();
  detect_and_export_cylinders();
  /*
  std::vector<Point_3> points;
