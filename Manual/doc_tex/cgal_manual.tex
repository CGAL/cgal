...
\cgalchapters{
    \entry{\part{General Introduction}}

    \lcTex{\entryright{\listofrefpages}}

    \packageleft{General Introduction}
...
% ------------------
    ...
    \entry{\part{Convex-Hull Algorithms}}
    ...
    \entry{\part{Polygons and Polyhedra}}
    ...
    \entry{\part{Polygon and Polyhedron Operations}}
    ...
    \entry{\part{Triangulations and Delaunay Triangulations}}
...
%    \packageleftright{Skin_surface_3}{Skin_surface_3_ref}
    ...
    \entry{\part{Geometric Optimization}}
