...
% -----------
    ...
    \entry{\part{Kernels\label{Kernels}}}
...
% ------------------
    ...
    \entry{\part{Polygon and Polyhedron Operations\label{Part:PolygonAndPolyhedraOperations}}}
    ...
    \entry{\part{Triangulations and Delaunay Triangulations\label{Part:Triangulations}}}
    ...
    \entry{\part{Meshing\label{Part:Meshing}}}
...
%    \packageleftright{Skin_surface_3}{Skin_surface_3_ref}
    ...
    \entry{\part{Geometric Optimization\label{Part:Optimisation}}}
