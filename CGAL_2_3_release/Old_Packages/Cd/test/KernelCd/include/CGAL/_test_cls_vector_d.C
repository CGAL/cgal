#ifndef CGAL__TEST_CLS_VECTOR_D_C
#define CGAL__TEST_CLS_VECTOR_D_C

#include <CGAL/_test_cls_vector_d.h>

template <class R>
bool
_test_cls_vector_d(const R& )
{
 std::cout << "Testing class Vector_d" ;

 typedef typename  R::RT    RT;
 typedef typename  R::FT    FT;

 typename R::Vector_d       iv;
...
#endif // CGAL__TEST_CLS_VECTOR_D_C
