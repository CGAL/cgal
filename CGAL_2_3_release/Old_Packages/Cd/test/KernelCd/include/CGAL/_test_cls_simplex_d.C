...
#ifndef CGAL__TEST_CLS_SIMPLEX_D_C
#define CGAL__TEST_CLS_SIMPLEX_D_C
#include <CGAL/_test_cls_simplex_d.h>

template <class R>
bool
_test_cls_simplex_d(const R& )
{
 std::cout << "Testing class Simplex_d" ;

 typedef typename  R::RT    RT;
 typedef typename  R::FT    FT;

 typename R::Simplex_d it;
 CGAL::Simplex_d<R>  t0(it);
 ...
 CGAL::Simplex_d<R> t1(p1,p2,p3,p4);
 CGAL::Simplex_d<R> t2(p2,p1,p3,p4);
 CGAL::Simplex_d<R> t3(ps0,ps1,ps2,ps3); // positive oriented
 CGAL::Simplex_d<R> t4(ps0,ps1,ps3,ps2); // negative oriented
 CGAL::Simplex_d<R> t5(ps0,p1,p3,ps2);
 CGAL::Simplex_d<R> t6(t3);
 CGAL::Simplex_d<R> the(p2,p3,p1,p4);
 CGAL::Simplex_d<R> td1(p2,p3,p3,p4);
 CGAL::Simplex_d<R> td2(p2,p2,p3,p4);
 t0 = t4;
 ...
 assert( t1.orientation() == opposite(t2.orientation()) );
 assert( t3.orientation() == CGAL::POSITIVE );
 assert( t4.orientation() == CGAL::NEGATIVE );
 CGAL::Simplex_d<R> t7( p1,p1,p2,p3);
 CGAL::Simplex_d<R> t8( p2,p2,p2,p2);
 ...
 CGAL::Point_d<R> p6(3, n4,n4,n4,n9); // cerr << "p6 = " << p6 << endl;
...
#endif // CGAL__TEST_CLS_SIMPLEX_D_C
