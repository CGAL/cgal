...
#ifndef CGAL__TEST_CLS_AFF_TRANSFORMATION_D_C
#define CGAL__TEST_CLS_AFF_TRANSFORMATION_D_C

#include <CGAL/_test_cls_aff_transformation_d.h>

template <class R>
bool
_test_cls_aff_transformation_d(const R& )
{
 std::cout << "Testing class Aff_transformation_d" ;

 typedef typename  R::RT    RT;
 typedef typename  R::FT    FT;

 typename R::Aff_transformation_d ia;
 CGAL::Aff_transformation_d<R> a1(ia);
 ...
 CGAL::Vector_d<R> vec(3, n3, n8, n7,  n6 );  // (-2,-9,-4)
 CGAL::Vector_d<R> tvec;
 CGAL::Point_d<R>  pnt(3, n8, n1, n9, n10 );  // ( 6,-5, 3)
 CGAL::Point_d<R>  tpnt;
 CGAL::Point_d<R>  pvec = CGAL::ORIGIN + vec;
 CGAL::Vector_d<R> vpnt = pnt - CGAL::ORIGIN;

 CGAL::Point_d<R>  p1(3,-n3, n7, n11, n3 );   // (-1, 2,-3)
 CGAL::Point_d<R>  p2(3, n5, n4,-n12, n4 );   // ( 5, 1,-4)
 CGAL::Point_d<R>  p3(3, n1, n0, n14, n4 );   // (-3, 0, 7)
 CGAL::Point_d<R>  p4(3, n7, n2, n8, -n6 );   // ( 4,11, 9)

 CGAL::Direction_d<R> d0(3, n13, n0, n0);
 CGAL::Direction_d<R> d1(3, n0, n13, n0);
 CGAL::Direction_d<R> d2(3, n0, n0, n13);
 CGAL::Direction_d<R> dir = (p2 - p4).direction();
 CGAL::Direction_d<R> tdir;

 CGAL::Plane_d<R>  pla(3, p1,p2,p3);
 CGAL::Plane_d<R>  tpla;
 ...
 CGAL::Segment_d<R> tseg;
 CGAL::Ray_d<R>     ray(p3,p2);
 CGAL::Ray_d<R>     tray;
 CGAL::Line_d<R>    lin(p2,p4);
 CGAL::Line_d<R>    tlin;
 CGAL::Triangle_d<R>     tri(p2,p3,p4);
 CGAL::Triangle_d<R>     ttri;
 CGAL::Tetrahedron_d<R>  tet(p1, p2, p3, p4);
 CGAL::Tetrahedron_d<R>  ttet;


 CGAL::Aff_transformation_d<R> ident(n8,  n0,  n0,  n0,
                                    n0,  n8,  n0,  n0,
                                    n0,  n0,  n8,  n0,
                                                   n8 );
 ...
 CGAL::Aff_transformation_d<R> gat1( n7,  n9,  n8,  n2,
                                    n5, n11, n10,  n4,
                                    n3,  n6, n12,  n2,
                                                   n3 );
 assert( p1 == (p1.transform(gat1)).transform(gat1.inverse() )  );

 CGAL::Aff_transformation_d<R> gat2( n7,  n9,  n8,  n2,
                                    n5, n11, n10,  n4,
                                    n3,  n6, n12,  n2,
                                                  n13 );

 CGAL::Aff_transformation_d<R> gat3( n4,  n6,  n7,  n0,
                                   n12,  n8,  n8,  n0,
                                   n11,  n3,  n9,  n0,
                                                  n13 );

 CGAL::Aff_transformation_d<R> scale11( CGAL::SCALING, 3, n2, n3 );

 CGAL::Aff_transformation_d<R> gscale(n2,  n0, n0,  n0,    // n2 = 44
                                     n0,  n2, n0,  n0,    // n3 =  4
                                     n0,  n0, n2,  n0,
                                                   n3 );


 CGAL::Aff_transformation_d<R> gtrans(n10, n0,  n0,  n8,
                                     n0, n10,  n0,  n1,
                                     n0,  n0, n10,  n9,
                                                   n10 );

 CGAL::Aff_transformation_d<R> translate( CGAL::TRANSLATION, vpnt );

 CGAL::Aff_transformation_d<R> xrefl(-n4,  n0, n0,  n0,
                                     n0,  n4, n0,  n0,
                                     n0,  n0, n4,  n0,
                                                   n4 );

 CGAL::Aff_transformation_d<R> gat4( gat3);

 CGAL::Aff_transformation_d<R> gat5( n7,  n9,  n8,
                                    n5, n11, n10,
                                    n3,  n6, n12,
                                                  n13 );

 CGAL::Aff_transformation_d<R> gat6( n4,  n6,  n7,
                                   n12,  n8,  n8,
                                   n11,  n3,  n9,
                                                  n13 );
 ...
 CGAL::Aff_transformation_d<R> a[11];
 ...
 CGAL::Aff_transformation_d<R> inv;
 ...
 for (int i = 0; i< 10; i++)
 {
    ...
    assert( tseg == CGAL::Segment_d<R>(tp1, tp2) );
    assert( tray == CGAL::Ray_d<R>(tp3, tp2) );
    assert( tlin == CGAL::Line_d<R>(tp2, tp4) );
    assert( ttri == CGAL::Triangle_d<R>(tp2, tp3, tp4) );
    assert( ttet == CGAL::Tetrahedron_d<R>(tp1, tp2, tp3, tp4) );
    cerr << tpla << endl << CGAL::Plane_d<R>( 3, tp1, tp2, tp3) << endl;
    assert( tpla == CGAL::Plane_d<R>( 3, tp1, tp2, tp3) );
    inv = a[i].inverse();
 ...
 CGAL::Aff_transformation_d<R> co1 = xrefl * xrefl;
...
#endif // CGAL__TEST_CLS_AFF_TRANSFORMATION_D_C
