...
\begin{ccRefClass}{Direction_d<R>}\ccCreationVariable{dir}
...
\ccConstructor{Direction_d<R>()}{ introduces a variable \ccc{dir} of
  type \ccc{Direction_d<R>}. }

\ccConstructor{Direction_d<R>(Vector_d<R> v)}{
  introduces a variable \ccc{dir} of type \ccc{Direction_d<R>}
  initialized to the direction of \ccc{v}. }

\ccConstructor{template <class InputIterator>
Direction_d<R>(int d, InputIterator first, InputIterator last)}{
  introduces a variable \ccc{dir} of type \ccc{Direction_d<R>} in
...
\ccConstructor{Direction_d<R>(int d, Base_direction, int i)}{ returns
  a variable \ccc{dir} of type \ccc{Direction_d<R>} initialized to the
  direction of the $i$-th base vector of dimension $d$.  \ccPrecond $0
  \leq i < d$.}

\ccConstructor{Direction_d<R>(RT x, RT y)}{
  introduces a variable \ccc{dir} of type \ccc{Direction_d<R>} in 
  $2$-dimensional space.}

\ccConstructor{Direction_d<R>(RT x, RT y, RT z)}{
  introduces a variable \ccc{dir} of type \ccc{Direction_d<R>} in 
  $3$-dimensional space.}
...
\ccMethod{Direction_d<R> transform(const Aff_transformation_d<R>& t) ;}{
  returns $t(p)$.}

\ccMethod{Direction_d<R>  opposite() ;}{
  returns the direction opposite to \ccc{dir}.}

\ccMethod{Direction_d<R> operator- () ;}{
  returns the direction opposite to \ccc{dir}.}
