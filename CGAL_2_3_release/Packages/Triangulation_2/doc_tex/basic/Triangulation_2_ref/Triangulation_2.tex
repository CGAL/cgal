...
\ccc{Traits} expects a model of the \ccc{TriangulationTraits_2}
concept described on page~\ccRefPage{TriangulationTraits_2}.
The second parameter expects a model of the
\ccc{TriangulationDataStructure_2} described
 on page~\ccRefPage{TriangulationDataStructure_2}.
By befault, the second template parameter is instanciated by
