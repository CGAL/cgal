...
%    \ccRefConceptPage{Kernel::Construct_iso_rectangle_2}.}
  ...
  \ccNestedType{Iso_rectangle_2}{model for Kernel::IsoRectangle\_2.}
  
  \ccNestedType{Less_x_2}{model for Kernel::LessX\_2.}
  
  \ccNestedType{Less_y_2}{model for Kernel::LessY\_2.}
  
  \ccNestedType{Construct_vertex_2}{model for Kernel::ConstructVertex\_2.}
  
  \ccNestedType{Construct_iso_rectangle_2}{model for
    Kernel::ConstructIsoRectangle\_2.}
