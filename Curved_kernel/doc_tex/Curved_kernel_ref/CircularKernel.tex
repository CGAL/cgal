...
\ccHasModels
\ccc{CGAL::Circular_kernel_2<LinearKernel,AlgebraicKernelForCircles>}\\
\ccc{CGAL::Exact_circular_kernel}
...
\ccNestedType{Root_of_2}{Model of \ccc{AlgebraicKernelForCircles::RootOf_2}.}
\ccGlue
