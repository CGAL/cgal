...
\ccIncludeExampleCode{Curved_kernel/example_arrangement_random_circles.cpp}
...
\ccIncludeExampleCode{Curved_kernel/example_arrangement_random_circles_segments.cpp}

	\subsection{Using the Predefined Kernel} 

\ccIncludeExampleCode{Curved_kernel/example_Exact_circular_kernel.cpp}
