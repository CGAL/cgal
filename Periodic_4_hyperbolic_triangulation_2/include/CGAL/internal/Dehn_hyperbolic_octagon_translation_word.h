...
private:
  ...
  void simplify_adjacent_inverses(vector<Word_idx_type>& w) {
  ...
  Word_idx_type longest_relation_subsequence(vector<Word_idx_type>& seq, vector<Word_idx_type> const w) {
  ...
  void invert_word(vector<Word_idx_type>& w, vector<Word_idx_type> const original) {
	w.clear();
  ...
  void invert_4_word(vector<Word_idx_type>& w, vector<Word_idx_type> const original) {
	w.clear();
	for (int i = original.size() - 1; i >= 0; i--) {
  ...
  void complementary_relation_indices(vector<Word_idx_type>& v, Word_idx_type begin, Word_idx_type end) {
  ...
  void complementary_relation_indices(vector<Word_idx_type>& v, vector<Word_idx_type> const original) {
  ...
  bool replace_relation_subword(vector<Word_idx_type>& w, const vector<Word_idx_type> original) {
...
public:
	...
	bool operator()(vector<Word_idx_type>& w, vector<Word_idx_type> const original) {
