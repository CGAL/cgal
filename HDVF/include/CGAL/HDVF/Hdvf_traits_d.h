...
struct Hdvf_traits_d {
     ...
     *
     * \return The projected `Point3`.
     */
    static std::function<Point3(const Point& p)> to_point3;
    ...
    /** \brief Builds a projector over an affine subspace of dimension 3.
     *
     * Builds the projector over the affine space generated by the point `p0` and an orthonormal basis `d1`, `d2` and `d3`.
     *
     * \param p0 A `Point_d` contained in the affine subspace.
     * \param d1 First direction of the subspace.
     * \param d2 Second direction of the subspace.
     * \param d3 Third direction of the subspace.
     *
     * \return The orthogonal projector of a `Point` onto this affine subspace of dimension 3.
     */
    ...
    /** \brief Builds a projector over the affine subspace of dimension 3 given by the principal components analysis of a set of points.
     *
     ...
     *
     * \return The projector (performing dimension reduction) over the subspace of dimension 3 given by the PCA of the points.
     */
