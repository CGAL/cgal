...
int main(int argc, char **argv)
{
    ...
    std::string filename;
    if (argc > 2) std::cout << "usage: persistent_hdvf_cubical_restrict pgm_file" << std::endl;
    ...
    /* Build a lower star filtration "slicing" the object according to the "z" coordinate of vertices
    ...
    HDVF_type hdvf(complex, filtration, HDVF::OPT_FULL, true, 1);
